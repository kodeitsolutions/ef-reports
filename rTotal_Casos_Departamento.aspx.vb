...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Casos_Departamento"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Casos_Departamento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT       (CASE Casos.departamento")
            loConsulta.AppendLine("		            WHEN '' THEN '[SIN DEPARTAMENTO]'")
            ...
            loConsulta.AppendLine("GROUP BY    Casos.departamento")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Casos_Departamento", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Casos_Departamento.ReportSource = loObjetoReporte

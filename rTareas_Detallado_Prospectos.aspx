<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTareas_Detallado_Prospectos.aspx.vb" Inherits="rTareas_Detallado_Prospectos" %>
...
<head runat="server">
    <title>Reporte de Tareas de Prospectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTareas_Detallado_Prospectos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Ventas_LIRIO" CodeFile="fFacturas_Ventas_LIRIO.aspx.vb" %>
...
<head runat="server">
    <title>Packing List (LIRIO)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Ventas_LIRIO" runat="server" AutoDataBind="true"

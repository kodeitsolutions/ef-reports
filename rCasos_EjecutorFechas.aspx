<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCasos_EjecutorFechas.aspx.vb" Inherits="rCasos_EjecutorFechas" %>
...
<head runat="server">
    <title>Total Casos por Ejecutor y Fecha</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCasos_EjecutorFechas" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fAuditorias_Clientes"
'-------------------------------------------------------------------------------------------'
Partial Class fAuditorias_Clientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" FROM Auditorias,Clientes ")
            loComandoSeleccionar.AppendLine(" WHERE     " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Codigo	=	Clientes.Cod_Cli ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tabla	=	'Clientes' ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tipo		=	'Datos' ")
            loComandoSeleccionar.AppendLine("			AND	(Auditorias.Opcion	=	'Clientes' OR Auditorias.Opcion	=	'Sin opción' OR Auditorias.Opcion	=	'ListarClientesCRM')  ")
           ...
           '--------------------------------------------------'
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fAuditorias_Clientes", laDatosReporte)
            
            Me.mTraducirReporte(loObjetoReporte)
            
            Me.mFormatearCamposReporte(loObjetoReporte)
            
            Me.crvfAuditorias_Clientes.ReportSource = loObjetoReporte

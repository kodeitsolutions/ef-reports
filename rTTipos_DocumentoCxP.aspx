<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTTipos_DocumentoCxP.aspx.vb" Inherits="rTTipos_DocumentoCxP" %>
...
<head runat="server">
    <title>Reporte de Total Documentos por Tipo de Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTTipos_DocumentoCxP" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rRDetallada_ISLRRProveedoresXML" CodeFile="rRDetallada_ISLRRProveedoresXML.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Detallada de ISLR Retenido por Proveedores XML</title>
...
<body>
    ...
    <div>
        <%--<CR:CrystalReportViewer ID="crvrrRDetallada_ISLRRProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

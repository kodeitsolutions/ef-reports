<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores" CodeFile="rCRetencion_ISLRProveedores.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_ISLRProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

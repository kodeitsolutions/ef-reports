<%@ page language="VB" autoeventwireup="false" inherits="fFicha_Expedientes" CodeFile="fFicha_Expedientes.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Expedientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_Expedientes" runat="server" AutoDataBind="true"

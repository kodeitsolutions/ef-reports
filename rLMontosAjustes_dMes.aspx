<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLMontosAjustes_dMes.aspx.vb" Inherits="rLMontosAjustes_dMes" %>
...
<head runat="server">
    <title>Reporte de Montos de Ajustes por Departamentos Totalizados Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLMontosAjustes_dMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

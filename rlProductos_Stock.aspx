<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rlProductos_Stock.aspx.vb" Inherits="rlProductos_Stock" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrlProductos_Stock" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

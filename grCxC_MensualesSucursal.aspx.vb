...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "grCxC_MensualesSucursal"
'-------------------------------------------------------------------------------------------'
Partial Class grCxC_MensualesSucursal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" EXEC sp_CalculoCxC_MensualSucursal")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("grCxC_MensualesSucursal", laDatosReporte)
            ...
            Me.crvgrCxC_MensualesSucursal.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' DLC: 24/05/2010: Codigo inicial
'-------------------------------------------------------------------------------------------'
' DLC: 07/09/2010: - Ajuste de la consulta en el procedimiento almacenado.
'                   - Ajuste en los filtros para el calculo de las cuentas por cobrar.
'                   - Ajuste en los filtros para el calculo de los cobros.
'-------------------------------------------------------------------------------------------'
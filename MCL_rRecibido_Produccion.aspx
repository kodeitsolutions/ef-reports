<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rRecibido_Produccion.aspx.vb" Inherits="MCL_rRecibido_Produccion" %>
...
<head runat="server">
    <title>Listado de Recepciones de Producción [reducido] (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rRecibido_Produccion" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fRequisiciones_Internas_Ingles" CodeFile="fRequisiciones_Internas_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones de Proveedores en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRequisiciones_Internas_Ingles" runat="server" AutoDataBind="true"

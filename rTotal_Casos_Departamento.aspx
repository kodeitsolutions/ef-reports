<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Departamento.aspx.vb" Inherits="rTotal_Casos_Departamento" %>
...
<head runat="server">
    <title>Total Casos por Etapas</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Departamento" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOProduccion_cRenglones.aspx.vb" Inherits="rOProduccion_cRenglones" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Producción con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOProduccion_cRenglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

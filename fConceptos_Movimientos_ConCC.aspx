<%@ Page Language="VB" AutoEventWireup="false" Inherits="fConceptos_Movimientos_ConCC"
    CodeFile="fConceptos_Movimientos_ConCC.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Conceptos de Movimientos con sus Cuentas Contables</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfConceptos_Movimientos_ConCC" runat="server" AutoDataBind="true"

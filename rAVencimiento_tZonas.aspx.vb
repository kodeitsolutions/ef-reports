...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rAVencimiento_tZonas"
'-------------------------------------------------------------------------------------------'
Partial Class rAVencimiento_tZonas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("     AND Zonas.Status In (" & lcParametro12Desde & ")")


            loComandoSeleccionar.AppendLine("  SELECT   ")
            loComandoSeleccionar.AppendLine("  			#Temporal.Cod_Zon,   ")
            loComandoSeleccionar.AppendLine("  			#Temporal.Nom_Zon,   ")
            ...
            loComandoSeleccionar.AppendLine("  GROUP BY #Temporal.Cod_Zon, #Temporal.Nom_Zon   ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAVencimiento_tZonas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrAVencimiento_tZonas.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS:  22/06/10: Filtro “Estatus de la Zona:”
'-------------------------------------------------------------------------------------------'
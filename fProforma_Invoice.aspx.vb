...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fProforma_Invoice"
'-------------------------------------------------------------------------------------------'
Partial Class fProforma_Invoice
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Cotizaciones.Doc_Ori, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fProforma_Invoice", laDatosReporte)
            ...
            Me.crvfProforma_Invoice.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="PAS_fAjustes_Consumos" CodeFile="PAS_fAjustes_Consumos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fAjustes_Consumos" runat="server" AutoDataBind="true"

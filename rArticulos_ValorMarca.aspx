<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_ValorMarca" CodeFile="rArticulos_ValorMarca.aspx.vb"  %>
...
<head runat="server">
    <title>Reporte del Valor Actual del Inventario por Marca</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_ValorMarca" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

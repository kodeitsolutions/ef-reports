<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_OEnvio_OnyxTD" CodeFile="fFacturas_OEnvio_OnyxTD.aspx.vb" %>
...
<head runat="server">
    <title>Shipping Order OnyxTD</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_OEnvio_OnyxTD" runat="server" AutoDataBind="true"

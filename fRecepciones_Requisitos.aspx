<%@ Page Language="VB" AutoEventWireup="false" Inherits="fRecepciones_Requisitos" CodeFile="fRecepciones_Requisitos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Notas de Recepción con sus Requisitos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfRecepciones_Requisitos" runat="server" AutoDataBind="true"

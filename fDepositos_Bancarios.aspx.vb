...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fDepositos_Bancarios"
'-------------------------------------------------------------------------------------------'
Partial Class fDepositos_Bancarios
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           SUBSTRING((CASE WHEN Renglones_Depositos.Tipo = 'Efectivo' Then ' Efectivo ' Else 'Origen: ' + CAST(UPPER(RTRIM(Renglones_Depositos.Tip_Ori)) AS VARCHAR(20)) + '   Número: ' + CAST(RTRIM(Renglones_Depositos.Doc_Ori) AS VARCHAR(20)) End),1,50) AS Origen, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fDepositos_Bancarios", laDatosReporte)
            
            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfDepositos_Bancarios.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' JJD: 12/02/09: Programacion inicial
'-------------------------------------------------------------------------------------------'
' JJD: 21/02/09: Continuacion de la Programacion 
'-------------------------------------------------------------------------------------------'

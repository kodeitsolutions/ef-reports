Imports System.Data
Partial Class CGS_rEntrada_Inventario_Auto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        loComandoSeleccionar.AppendLine(" WHERE     Articulos.Cod_Dep = 'MP'    ")
        loComandoSeleccionar.AppendLine("       AND Ordenes_Compras.Status IN ('Confirmado', 'Afectado')")
        loComandoSeleccionar.AppendLine("       AND Ordenes_Compras.Fec_Ini > '15/07/2016'")
        ...
        loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("CGS_rEntrada_Inventario_Auto", laDatosReporte)

        Me.mTraducirReporte(loObjetoReporte)

        Me.mFormatearCamposReporte(loObjetoReporte)

        Me.crvCGS_rEntrada_Inventario_Auto.ReportSource = loObjetoReporte

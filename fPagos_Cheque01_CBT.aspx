<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque01_CBT" CodeFile="fPagos_Cheque01_CBT.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque01_CBT" runat="server" AutoDataBind="true"

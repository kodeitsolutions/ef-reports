<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLista_DResumidas.aspx.vb" Inherits="rLista_DResumidas" %>
...
<head runat="server">
    <title>Reporte de Listas Desplegables Resumida</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLista_DResumidas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

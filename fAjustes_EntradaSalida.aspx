<%@ page language="VB" Debug="true" autoeventwireup="false" inherits="fAjustes_EntradaSalida" CodeFile="fAjustes_EntradaSalida.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ajustes de Entrada y Salida</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAjustes_EntradaSalida" runat="server" AutoDataBind="true"

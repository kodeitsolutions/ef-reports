<%@ page language="VB" autoeventwireup="false" inherits="CGS_rOCPendientes_AUTO" CodeFile="CGS_rOCPendientes_AUTO.aspx.vb" %>
...
<head runat="server">
    <title>Órdenes de Compras Pendientes Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOCPendientes_AUTO" runat="server" AutoDataBind="true"

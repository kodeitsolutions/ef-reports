<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Usuarios_Ipos.aspx.vb" Inherits="rAuditorias_Usuarios_Ipos" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Usuarios iPos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Usuarios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

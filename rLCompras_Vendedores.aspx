<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLCompras_Vendedores.aspx.vb" Inherits="rLCompras_Vendedores" %>
...
<head id="Head1" runat="server">
    <title>Reporte de Formas Libres de Compras por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLCompras_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

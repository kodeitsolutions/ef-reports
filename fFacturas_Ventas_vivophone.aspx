<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Vivophone" CodeFile="fFacturas_Ventas_vivophone.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Vivophone" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEntregas_Articulos.aspx.vb" Inherits="rEntregas_Articulos" %>
...
<head runat="server">
    <title>Reporte de Notas de Entregas por Articulos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEntregas_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

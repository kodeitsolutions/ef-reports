<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCondominio_AlicuotaVs25_ClaseLocal.aspx.vb" Inherits="rCondominio_AlicuotaVs25_ClaseLocal" %>
...
<head runat="server">
    <title>Condominio Alicuota vs 25%Canon por Clase de Local</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCondominio_AlicuotaVs25_ClaseLocal" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fAuditorias_Articulos" CodeFile="fAuditorias_Articulos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAuditorias_Articulos" runat="server" AutoDataBind="true"

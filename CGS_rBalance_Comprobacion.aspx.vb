...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_rBalance_Comprobacion"													'
'-------------------------------------------------------------------------------------------'
Partial Class CGS_rBalance_Comprobacion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		CASE WHEN SUBSTRING(CC.Cod_Cue, 1,1) < 5 ")
            loComandoSeleccionar.AppendLine("			 THEN COALESCE(Renglones_Comprobantes.Cod_Aux,'') ")
            loComandoSeleccionar.AppendLine("			 ELSE '' END							AS Auxiliar,")
            loComandoSeleccionar.AppendLine("		CASE WHEN SUBSTRING(CC.Cod_Cue, 1,1) < 5 ")
            loComandoSeleccionar.AppendLine("			 THEN COALESCE(Auxiliares.Nom_Aux,'') ")
            loComandoSeleccionar.AppendLine("			 ELSE '' END							AS Nom_Auxiliar,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("CGS_rBalance_Comprobacion", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvCGS_rBalance_Comprobacion.ReportSource = loObjetoReporte

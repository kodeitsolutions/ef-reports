<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMaximosMinimos_Almacen.aspx.vb" Inherits="rMaximosMinimos_Almacen" %>
...
<head runat="server">
    <title>Listado de Máximos y Mínimos por Almacén</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMaximosMinimos_Almacen" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Clinicas" CodeFile="fCotizaciones_Clinicas.aspx.vb" %>
...
<head runat="server">
    <title>Cotizaciones Clínicas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Clinicas" runat="server" AutoDataBind="true"

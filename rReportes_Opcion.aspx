<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReportes_Opcion.aspx.vb" Inherits="rReportes_Opcion" %>
...
<head runat="server">
    <title>Total Reportes por Opciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReportes_Opcion" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rContraPedidos_Articulos_Stratos.aspx.vb" Inherits="rContraPedidos_Articulos_Stratos" %>
...
<head runat="server">
    <title>Reporte de Artículos en ContraPedido (Backorders Stratos)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrContraPedidos_Articulos_Stratos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

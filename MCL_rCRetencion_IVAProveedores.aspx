<%@ page language="VB" autoeventwireup="false" inherits="MCL_rCRetencion_IVAProveedores" 
CodeFile="MCL_rCRetencion_IVAProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Retención de IVA de Proveedores (MERCALUM)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMCL_rCRetencion_IVAProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="CGS_fPagos_Cheque01" CodeFile="CGS_fPagos_Cheque01.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque en Pagos (CEGASA)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvCGS_fPagos_Cheque01" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rStock_Availability_Warehouse.aspx.vb" Inherits="rStock_Availability_Warehouse" %>
...
<head runat="server">
    <title>Stock Availability by Warehouse</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrStock_Availability_Warehouse" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rAuditorias_HorasOpcion"
'-------------------------------------------------------------------------------------------'
Partial Class rAuditorias_HorasOpcion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    SubString(CONVERT(nchar(30), Registro,114),1,(Case When '''' <> 'NO' Then 2 Else 5 End))    AS	Hora,")
            loComandoSeleccionar.AppendLine(" 	   (CASE WHEN Opcion = '' THEN 'Vacío' ELSE Opcion END)    As  Opcion, ")
            ...
            loComandoSeleccionar.AppendLine(" SELECT    Hora,")
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY  Opcion, Hora  ")
            loComandoSeleccionar.AppendLine(" ORDER BY  Opcion, Hora  ")
            loComandoSeleccionar.AppendLine(" SELECT    Hora, ")
            loComandoSeleccionar.AppendLine(" 	        Opcion, ")
            ...
            'loComandoSeleccionar.AppendLine(" ORDER BY  Hora DESC ")
            loComandoSeleccionar.AppendLine("ORDER BY    Opcion, " & lcOrdenamiento)

            Dim loServicios As New cusDatos.goDatos

            Dim laDatosReporte As DataSet = loServicios.mObtenerTodosSinEsquema(loComandoSeleccionar.ToString(), "curReportes")

            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAuditorias_HorasOpcion", laDatosReporte)
            ...
            Me.crvrAuditorias_HorasOpcion.ReportSource = loObjetoReporte

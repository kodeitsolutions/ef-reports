<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rLibro_Compras.aspx.vb"
    Inherits="MCL_rLibro_Compras" %>
...
<head runat="server">
    <title>Libro de Compras (MCL)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrMCL_rLibro_Compras" runat="server" AutoDataBind="true"

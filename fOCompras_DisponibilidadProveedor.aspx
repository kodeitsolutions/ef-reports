<%@ Page Language="VB" AutoEventWireup="false" Inherits="fOCompras_DisponibilidadProveedor" CodeFile="fOCompras_DisponibilidadProveedor.aspx.vb" %>
...
<head runat="server">
    <title>Ordenes de Compras - Disponibilidad de Artículos por Proveedores</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfOCompras_DisponibilidadProveedor" runat="server" AutoDataBind="true"

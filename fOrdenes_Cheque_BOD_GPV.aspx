<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque_BOD_GPV" CodeFile="fOrdenes_Cheque_BOD_GPV.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque BOD GPV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque_BOD_GPV" runat="server" AutoDataBind="true"

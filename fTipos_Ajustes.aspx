<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Ajustes" CodeFile="fTipos_Ajustes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Ajustes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Ajustes" runat="server" AutoDataBind="true"

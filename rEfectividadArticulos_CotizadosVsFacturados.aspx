<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEfectividadArticulos_CotizadosVsFacturados.aspx.vb" Inherits="rEfectividadArticulos_CotizadosVsFacturados" %>
...
<head runat="server">
    <title>Reporte de Efectividad de Articulos Cotizados Vs Facturados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEfectividadArticulos_CotizadosVsFacturados" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrazabilidad_Compras_Traslados.aspx.vb"
    Inherits="rTrazabilidad_Compras_Traslados" %>
...
<head runat="server">
    <title>Trazabilidad de Compras y Traslados</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTrazabilidad_Compras_Traslados" runat="server" AutoDataBind="true"

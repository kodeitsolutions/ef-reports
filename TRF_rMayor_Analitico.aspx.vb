...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "TRF_rMayor_Analitico"
'-------------------------------------------------------------------------------------------'
Partial Class TRF_rMayor_Analitico
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		Saldo_Inicial = COALESCE(Mov.Saldo_Inicial,0)")
            loComandoSeleccionar.AppendLine("FROM	(SELECT ROW_NUMBER () OVER (PARTITION BY #tmpMovimientos.Cod_Cuenta ORDER BY #tmpMovimientos.Fecha, #tmpMovimientos.Renglon ASC) AS Orden,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("TRF_rMayor_Analitico", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvTRF_rMayor_Analitico.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTAlmacenes_Renglones.aspx.vb" Inherits="rTAlmacenes_Renglones" %>
...
<head runat="server">
    <title>Listado de Traslados entre Almacenes con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTAlmacenes_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

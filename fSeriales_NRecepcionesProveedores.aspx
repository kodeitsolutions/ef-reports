<%@ page language="VB" autoeventwireup="false" inherits="fSeriales_NRecepcionesProveedores" CodeFile="fSeriales_NRecepcionesProveedores.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeriales_NRecepcionesProveedores" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fPedidos_Clientes_GPV"
'-------------------------------------------------------------------------------------------'
Partial Class fPedidos_Clientes_GPV
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fPedidos_Clientes_GPV", laDatosReporte)
            lcPorcentajesImpuesto = lcPorcentajesImpuesto.Replace(".", ",")
            ...
            Me.crvfPedidos_Clientes_GPV.ReportSource = loObjetoReporte

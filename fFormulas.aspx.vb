...
Partial Class fFormulas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           AND Formulas.Cod_Art    =   Articulos.Cod_Art ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFormulas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfFormulas.ReportSource = loObjetoReporte

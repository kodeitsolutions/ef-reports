<%@ page language="VB" autoeventwireup="false" inherits="PAS_fConsumos_Produccion" CodeFile="PAS_fConsumos_Produccion.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Consumo de Producción (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fConsumos_Produccion" runat="server" AutoDataBind="true"

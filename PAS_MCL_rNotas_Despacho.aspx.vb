Imports System.Data
Partial Class PAS_MCL_rNotas_Despacho
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("		Ajustes.Status								AS Estatus,")
            ...
            lcComandoSeleccionar.AppendLine("		AND Operaciones_Lotes.Tip_Doc = 'Ajustes_Inventarios' AND Operaciones_Lotes.Tip_Ope = 'Salida'")
            ...
            If lcEmpresa.Trim() = "PAS" Then
                lcComandoSeleccionar.AppendLine("	LEFT JOIN Renglones_Mediciones AS Longitud ON Mediciones.Documento = Desperdicio.Documento")
                lcComandoSeleccionar.AppendLine("		AND Longitud.Cod_Var = 'AINV-LARG'")
            End If
            lcComandoSeleccionar.AppendLine("WHERE Renglones_Ajustes.Cod_Tip = 'S10'")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("PAS_MCL_rNotas_Despacho", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvPAS_MCL_rNotas_Despacho.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFrecuanecia_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class rFrecuanecia_Articulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" JOIN Articulos ON (Articulos.Cod_Art = Frecuencias.Cod_Reg) AND ('Articulos' = Frecuencias.Origen)")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFrecuanecia_Articulos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFrecuanecia_Articulos.ReportSource = loObjetoReporte

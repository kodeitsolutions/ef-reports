<%@ page language="VB" autoeventwireup="false" inherits="TRF_fOrdenes_Cheque" CodeFile="TRF_fOrdenes_Cheque.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque en Orden de Pago(TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_fOrdenes_Cheque" runat="server" AutoDataBind="true"

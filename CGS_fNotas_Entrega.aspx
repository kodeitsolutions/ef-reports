<%@ page language="VB" autoeventwireup="false" inherits="CGS_fNotas_Entrega" CodeFile="CGS_fNotas_Entrega.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Notas de Entrega (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fNotas_Entrega" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "PAS_rCRetencion_PatenteProveedores"
'-------------------------------------------------------------------------------------------'
Partial Class PAS_rCRetencion_PatenteProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("DECLARE @lcFactura_Desde AS VARCHAR(20) = " & lcParametro2Desde)
            loComandoSeleccionar.AppendLine("DECLARE @lcFactura_Hasta AS VARCHAR(20) = " & lcParametro2Hasta)
            loComandoSeleccionar.AppendLine("DECLARE @lcAgrupar AS VARCHAR(4) = " & lcParametro4Desde)
            ...
            loComandoSeleccionar.AppendLine("       @lcAgrupar                          AS Agrupar")
            ...
            loComandoSeleccionar.AppendLine("			                            WHERE Cuentas_Pagar.Factura BETWEEN @lcFactura_Desde AND @lcFactura_Hasta")
            ...
            loComandoSeleccionar.AppendLine("   AND Renglones_Pagos.Factura BETWEEN @lcFactura_Desde AND @lcFactura_Hasta")
            loComandoSeleccionar.AppendLine("")
            ...
            loComandoSeleccionar.AppendLine("   AND Ordenes_Pagos.Factura BETWEEN @lcFactura_Desde AND @lcFactura_Hasta")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("UNION ")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT	Cuentas_Pagar.Tip_Ori				AS Tipo_Origen,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("PAS_rCRetencion_PatenteProveedores", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrPAS_rCRetencion_PatenteProveedores.ReportSource = loObjetoReporte

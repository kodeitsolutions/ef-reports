...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Casos_Ejecutor"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Casos_Ejecutor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT      Ejecutores.Cod_Ven                                          AS Cod_Eje,")
            loConsulta.AppendLine("            Ejecutores.Nom_Ven                                          AS Nombre,")
            ...
            loConsulta.AppendLine("GROUP BY    Ejecutores.Cod_Ven, Ejecutores.Nom_Ven")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Casos_Ejecutor", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Casos_Ejecutor.ReportSource = loObjetoReporte

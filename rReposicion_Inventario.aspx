<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReposicion_Inventario.aspx.vb" Inherits="rReposicion_Inventario" %>
...
<head runat="server">
    <title>Reporte de Reposición de Inventario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReposicion_Inventario" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

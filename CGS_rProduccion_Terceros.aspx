<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rProduccion_Terceros.aspx.vb" Inherits="CGS_rProduccion_Terceros" %>
...
<head runat="server">
    <title>Listado de Producción para Terceros (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rProduccion_Terceros" runat="server" AutoDataBind="true"

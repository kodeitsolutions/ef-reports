<%@ page language="VB" autoeventwireup="false" inherits="fEstado_Cuenta_SalesT" CodeFile="fEstado_Cuenta_SalesT.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Estado de Cuenta Sales T</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEstado_Cuenta_SalesT" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Renglones.aspx.vb" Inherits="rCPagar_Renglones" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Pagar con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

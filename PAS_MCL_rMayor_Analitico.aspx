<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_MCL_rMayor_Analitico.aspx.vb" Inherits="PAS_MCL_rMayor_Analitico" %>
...
<head runat="server">
    <title>Mayor Analítico (PAS - MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_MCL_rMayor_Analitico" runat="server" AutoDataBind="true"

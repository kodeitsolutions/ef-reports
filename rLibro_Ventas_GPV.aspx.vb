...
Partial Class rLibro_Ventas_GPV
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("							Impresora			VARCHAR(100),")
            ...
            loConsulta.AppendLine("							Ret_MontoRetenido,Documento_Afect,Impresora)")
            ...
            loConsulta.AppendLine("			Renglones_Facturas.Cod_Alm 							AS imp")
            ...
            loConsulta.AppendLine("			0 							                        AS Ret_MontoRetenido,")
            loConsulta.AppendLine("			'' 							                        AS doc,")
            loConsulta.AppendLine("			Renglones_Documentos.Cod_Alm 						AS imp")

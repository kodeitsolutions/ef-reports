<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rLibro_Compras.aspx.vb"
    Inherits="CGS_rLibro_Compras" %>
...
<head runat="server">
    <title>Libro de Compras (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCGS_rLibro_Compras" runat="server" AutoDataBind="true"

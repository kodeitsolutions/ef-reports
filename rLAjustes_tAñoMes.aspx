<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLAjustes_tAñoMes.aspx.vb" Inherits="rLAjustes_tAñoMes" %>
...
<head runat="server">
    <title>Reporte de Ajustes por Tipo de Ajuste Totalizados por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLAjustes_tAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fCiudades" CodeFile="fAgrupaciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Agrupaciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCiudades" runat="server" AutoDataBind="true"

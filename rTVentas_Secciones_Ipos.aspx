<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Secciones_Ipos.aspx.vb" Inherits="rTVentas_Secciones_Ipos" %>
...
<head runat="server">
    <title>Ventas del Día por Secciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Secciones_Ipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

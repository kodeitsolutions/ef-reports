<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rAsistencia_Trabajadores.aspx.vb" Inherits="CGS_rAsistencia_Trabajadores" %>
...
<head runat="server">
    <title>Total de Asistencias de Trabajadores (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rAsistencia_Trabajadores" runat="server" AutoDataBind="true"

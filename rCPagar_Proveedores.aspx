<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Proveedores.aspx.vb" Inherits="rCPagar_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Pagar por Proveedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Proveedores" runat="server" AutoDataBind="true"

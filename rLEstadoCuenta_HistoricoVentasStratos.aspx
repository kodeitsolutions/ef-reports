<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLEstadoCuenta_HistoricoVentasStratos.aspx.vb" Inherits="rLEstadoCuenta_HistoricoVentasStratos" %>
...
<head runat="server">
    <title>Reporte de Listado de Estado de Cuenta Stratos (Historico Ventas)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLEstadoCuenta_HistoricoVentas" runat="server" AutoDataBind="true"

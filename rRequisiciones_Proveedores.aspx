<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRequisiciones_Proveedores.aspx.vb" Inherits="rRequisiciones_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Requisiciones por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRequisiciones_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

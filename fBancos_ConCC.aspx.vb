...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fBancos_ConCC"
'-------------------------------------------------------------------------------------------'
Partial Class fBancos_ConCC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT  Cod_Ban, ")
            loConsulta.AppendLine("        Nom_Ban,")
            ...
            loConsulta.AppendLine("FROM    Bancos")
            loConsulta.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fBancos_ConCC", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfBancos_ConCC.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' JJD: 31/10/14: Adecuacion para Bancos'
'-------------------------------------------------------------------------------------------'

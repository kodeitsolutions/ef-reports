<%@ page language="VB" autoeventwireup="false" inherits="IGE_IGE_fFacturas_Ventas" CodeFile="IGE_IGE_fFacturas_Ventas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvIGE_IGE_fFacturas_Ventas" runat="server" AutoDataBind="true"

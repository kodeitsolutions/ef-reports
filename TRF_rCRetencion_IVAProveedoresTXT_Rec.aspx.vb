...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "TRF_rCRetencion_IVAProveedoresTXT_Rec"
'-------------------------------------------------------------------------------------------'
Partial Class TRF_rCRetencion_IVAProveedoresTXT_Rec
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("	LEFT JOIN Cuentas_Pagar AS Documentos ON Documentos.Documento = Renglones_Pagos.Doc_Ori					")
            ...
            loComandoSeleccionar.AppendLine("                              )")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT	Fecha_Retencion						AS Fecha_Retencion,")
            ...
            'loComandoSeleccionar.AppendLine("		(Monto_Documento/100000)			AS Monto_Neto,")
            'loComandoSeleccionar.AppendLine("		(Monto_BaseDoc/100000)				AS Base_Imponible,")
            'loComandoSeleccionar.AppendLine("		(Monto_Retenido/100000)				AS Monto_Retencion,")
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN Fecha_Retencion < '20180820' AND Fecha_Retencion >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (Monto_Documento/100000)")
            loComandoSeleccionar.AppendLine("            ELSE Monto_Documento")
            loComandoSeleccionar.AppendLine("       END                                 AS Monto_Neto,")
            'loComandoSeleccionar.AppendLine("		Monto_BaseDoc					    AS Base_Imponible,")
            loComandoSeleccionar.AppendLine("       CASE WHEN Fecha_Retencion < '20180820' AND Fecha_Retencion >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (Monto_BaseDoc/100000)")
            loComandoSeleccionar.AppendLine("            ELSE Monto_BaseDoc")
            loComandoSeleccionar.AppendLine("       END                                 AS Base_Imponible,")
            'loComandoSeleccionar.AppendLine("		Monto_Retenido						AS Monto_Retencion,")
            loComandoSeleccionar.AppendLine("       CASE WHEN Fecha_Retencion < '20180820' AND Fecha_Retencion >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (Monto_Retenido/100000)")
            loComandoSeleccionar.AppendLine("            ELSE Monto_Retenido")
            loComandoSeleccionar.AppendLine("       END                                 AS Monto_Retencion,")
            loComandoSeleccionar.AppendLine("		'0'									AS Numero_Factura,")
            loComandoSeleccionar.AppendLine("		Numero_Comprobante					AS Numero_Comprobante,")
            'loComandoSeleccionar.AppendLine("		Monto_ExentoDoc						AS Monto_Exento,")
            loComandoSeleccionar.AppendLine("       CASE WHEN Fecha_Retencion < '20180820' AND Fecha_Retencion >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (Monto_ExentoDoc/100000)")
            loComandoSeleccionar.AppendLine("            ELSE Monto_ExentoDoc")

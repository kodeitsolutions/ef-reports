...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rABC_Proveedores"
'-------------------------------------------------------------------------------------------'
Partial Class rABC_Proveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" 		COUNT(Cod_Pro) AS Can_Pro, ")
            ...
            loComandoSeleccionar.AppendLine(" FROM Proveedores AS Proveedores_Abc ")
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 				Cod_Pro between " & lcParametro0Desde)
            ...
            loComandoSeleccionar.AppendLine(" FROM Proveedores AS Proveedores_Status ")
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 				Cod_Pro between " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine(" 				AND " & lcParametro0Hasta)
			loComandoSeleccionar.AppendLine(" 				AND status IN (" & lcParametro1Desde & ")")
            ...
            loComandoSeleccionar.AppendLine(" FROM Proveedores AS Proveedores_Sexo ")
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 				Cod_Pro between " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine(" 				AND " & lcParametro0Hasta)
			loComandoSeleccionar.AppendLine(" 				AND status IN (" & lcParametro1Desde & ")")
            ...
            loComandoSeleccionar.AppendLine(" FROM Proveedores AS Proveedores_Crm_Sec ")
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 				Cod_Pro between " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine(" 				AND " & lcParametro0Hasta)
			loComandoSeleccionar.AppendLine(" 				AND status IN (" & lcParametro1Desde & ")")
            ...
            loComandoSeleccionar.AppendLine(" FROM Proveedores AS Proveedores_Tip_Con ")
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 				Cod_Pro between " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine(" 				AND " & lcParametro0Hasta)
			loComandoSeleccionar.AppendLine(" 				AND status IN (" & lcParametro1Desde & ")")
            ...
            loComandoSeleccionar.AppendLine(" FROM Proveedores AS Proveedores_Pol_Com ")
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 				Cod_Pro between " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine(" 				AND " & lcParametro0Hasta)
			loComandoSeleccionar.AppendLine(" 				AND status IN (" & lcParametro1Desde & ")")
            ...
            loComandoSeleccionar.AppendLine(" SELECT  ")
            loComandoSeleccionar.AppendLine(" 		COUNT(Cod_Pro) AS Can_Pro, ")
            loComandoSeleccionar.AppendLine(" 		Tip_Pro AS Valor, ")
            loComandoSeleccionar.AppendLine(" 		'NORSUCMAT' AS Cod_Com ")
            loComandoSeleccionar.AppendLine(" FROM Proveedores AS Proveedores_Tip_Pro ")
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 				Cod_Pro between " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine(" 				AND " & lcParametro0Hasta)
			loComandoSeleccionar.AppendLine(" 				AND status IN (" & lcParametro1Desde & ")")
			...
			loComandoSeleccionar.AppendLine(" 				AND Cod_Ven between " & lcParametro5Desde)
			loComandoSeleccionar.AppendLine(" 				AND " & lcParametro5Hasta)
            loComandoSeleccionar.AppendLine(" GROUP BY Tip_Pro ")
            loComandoSeleccionar.AppendLine(" ORDER BY 3, 2 ")
            loComandoSeleccionar.AppendLine("  ")
            loComandoSeleccionar.AppendLine("  ")
            loComandoSeleccionar.AppendLine(" SELECT  ")
            loComandoSeleccionar.AppendLine(" 	Can_Pro, ")
	...
	'******************************************************************************************
		...
		loColumna = New DataColumn("can_Pro", GetType(Integer))
		loTabla.Columns.Add(loColumna)
		...
		loColumnaFinal = New DataColumn("can_Pro", GetType(Integer))
		loTablaFinal.Columns.Add(loColumnaFinal)
	...
	'******************************************************************************************
            ...
            'loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rABC_Proveedores", laDatosReporte)
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rABC_Proveedores", loDatosReporteFinal)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrABC_Proveedores.ReportSource = loObjetoReporte

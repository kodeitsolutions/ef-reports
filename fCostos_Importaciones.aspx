<%@ page language="VB" autoeventwireup="false" inherits="fCostos_Importaciones" CodeFile="fCostos_Importaciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Costos de Importaciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCostos_Importaciones" runat="server" AutoDataBind="true"

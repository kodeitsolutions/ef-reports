<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNentregas_Vendedores.aspx.vb" Inherits="rNentregas_Vendedores" %>
...
<head runat="server">
    <title>Reporte de las Notas de Entregas por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNentregas_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grEstado_CXP.aspx.vb" Inherits="grEstado_CXP" %>
...
<head runat="server">
    <title>Gráfico de Estado de Cuentas por Pagar</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvgrEstado_CXP" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

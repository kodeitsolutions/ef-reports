<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTPagos_Fechas.aspx.vb" Inherits="rTPagos_Fechas" %>
...
<head runat="server">
    <title>Total Pagos por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTPagos_Fechas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCobros_Fechas.aspx.vb" Inherits="rCobros_Fechas" %>
...
<head runat="server">
    <title>Reporte de Cobros por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCobros_Fechas" runat="server" AutoDataBind="true"

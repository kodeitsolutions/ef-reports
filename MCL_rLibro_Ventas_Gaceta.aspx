<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rLibro_Ventas_Gaceta.aspx.vb" Inherits="MCL_rLibro_Ventas_Gaceta" %>
...
<head runat="server">
	<title>Libro de Ventas Gaceta N° 41.239 (MCL)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvMCL_rLibro_Ventas_Gaceta" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False"  HasPrintButton="False" />

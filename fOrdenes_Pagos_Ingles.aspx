<%@ page language="VB" autoeventwireup="false" CodeFile="fOrdenes_Pagos_Ingles.aspx.vb" inherits="fOrdenes_Pagos_Ingles" %>
...
<head runat="server">
    <title>Formato de Órdenes de Pagos en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Pagos_Ingles" runat="server" AutoDataBind="true"

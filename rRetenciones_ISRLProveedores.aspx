<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRetenciones_ISRLProveedores.aspx.vb" Inherits="rRetenciones_ISRLProveedores" %>
...
<head runat="server">
    <title>Reporte de Retenciones de ISRL Por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRetenciones_ISRLProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

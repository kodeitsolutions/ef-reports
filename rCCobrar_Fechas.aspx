<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Fechas.aspx.vb" Inherits="rCCobrar_Fechas" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Cobrar por Fecha</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Fechas" runat="server" AutoDataBind="true"

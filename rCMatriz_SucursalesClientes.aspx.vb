...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCMatriz_SucursalesClientes"
'-------------------------------------------------------------------------------------------'
Partial Class rCMatriz_SucursalesClientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCMatriz_SucursalesClientes", laDatosReporte)
            ...
            Me.crvrCMatriz_SucursalesClientes.ReportSource = loObjetoReporte

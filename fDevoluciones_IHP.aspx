<%@ page language="VB" autoeventwireup="false" CodeFile="fDevoluciones_IHP.aspx.vb" inherits="fDevoluciones_IHP" %>
...
<head runat="server">
    <title>Formato de Devoluciones In Hand Provider</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDevoluciones_IHP" runat="server" AutoDataBind="true"

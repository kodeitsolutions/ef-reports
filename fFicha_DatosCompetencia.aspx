<%@ page language="VB" autoeventwireup="false" inherits="fFicha_DatosCompetencia" CodeFile="fFicha_DatosCompetencia.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Competencia</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_DatosCompetencia" runat="server" AutoDataBind="true"

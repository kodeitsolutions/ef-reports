<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNentregas_Fechas.aspx.vb" Inherits="rNentregas_Fechas" %>
...
<head runat="server">
    <title>Reporte de las Notas de Entregas por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNentregas_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

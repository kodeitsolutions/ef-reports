<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_MensualesPaises.aspx.vb" Inherits="rRVentas_MensualesPaises" %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas Mensuales por Paises</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_MensualesPaises" runat="server" AutoDataBind="true"

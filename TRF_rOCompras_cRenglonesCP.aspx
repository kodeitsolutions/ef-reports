<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rOCompras_cRenglonesCP.aspx.vb" Inherits="TRF_rOCompras_cRenglonesCP" %>
...
<head runat="server">
    <title>Reporte Administrativo de Órdenes de Compras (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rOCompras_cRenglonesCP" runat="server" AutoDataBind="true"

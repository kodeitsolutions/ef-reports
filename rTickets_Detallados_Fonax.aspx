<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTickets_Detallados_Fonax.aspx.vb" Inherits="rTickets_Detallados_Fonax" %>
...
<head runat="server">
    <title>Listado de tickets Detallados Fonax</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTickets_Detallados_Fonax" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

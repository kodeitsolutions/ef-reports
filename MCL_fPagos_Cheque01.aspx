<%@ page language="VB" autoeventwireup="false" inherits="MCL_fPagos_Cheque01" CodeFile="MCL_fPagos_Cheque01.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque en Pagos (MERCALUM) [BOD]</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_fPagos_Cheque01" runat="server" AutoDataBind="true"

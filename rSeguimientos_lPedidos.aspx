<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSeguimientos_lPedidos.aspx.vb" Inherits="rSeguimientos_lPedidos" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrSeguimientos_lPedidos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_aMes.aspx.vb" Inherits="rPedidos_aMes" %>
...
<head runat="server">
    <title>Reporte Total de Pedidos por Artículos Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_aMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

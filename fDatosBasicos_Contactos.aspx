<%@ page language="VB" autoeventwireup="false" inherits="fDatosBasicos_Contactos" CodeFile="fDatosBasicos_Contactos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Contactos: Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatosBasicos_Contactos" runat="server" AutoDataBind="true"

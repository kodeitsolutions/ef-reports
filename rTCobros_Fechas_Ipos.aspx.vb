...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTCobros_Fechas_Ipos"
'-------------------------------------------------------------------------------------------'
Partial Class rTCobros_Fechas_Ipos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    DATEPART(YEAR, Cuentas_Cobrar.Fec_Ini)     AS Año,")
            loComandoSeleccionar.AppendLine("           DATEPART(MONTH, Cuentas_Cobrar.Fec_Ini)    AS Mes,")
            loComandoSeleccionar.AppendLine("           DATEPART(DAY, Cuentas_Cobrar.Fec_Ini)      AS Dia,")
            ...
            loComandoSeleccionar.AppendLine("			AND Cuentas_Cobrar.Ipos = '1'")
            ...
            loComandoSeleccionar.AppendLine("           AND Cuentas_Cobrar.Usu_Cre     BETWEEN " & lcParametro6Desde)
            ...
            loComandoSeleccionar.AppendLine("           AND " & lcParametro0Hasta)
            loComandoSeleccionar.AppendLine("			AND Cobros.Ipos = '1'")
            ...
            loComandoSeleccionar.AppendLine("           AND " & lcParametro5Hasta)
            loComandoSeleccionar.AppendLine("           AND Cobros.Cod_Usu     BETWEEN " & lcParametro6Desde)
            loComandoSeleccionar.AppendLine("           AND " & lcParametro6Hasta)
            ...
            loComandoSeleccionar.AppendLine("            #temporal.Mon_Net				        AS Mon_Net, ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTCobros_Fechas_Ipos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTCobros_Fechas_Ipos.ReportSource = loObjetoReporte

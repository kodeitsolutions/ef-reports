<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gClienteVendedorArticulos_Resumido_MOL.aspx.vb" Inherits="rMargen_gClienteVendedorArticulos_Resumido_MOL" %>
...
<head runat="server">
    <title>Margen de Ganancia por Cliente, Vendedor y Artículo Resumido (MOL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gClienteVendedorArticulos_Resumido_MOL" runat="server" AutoDataBind="true"

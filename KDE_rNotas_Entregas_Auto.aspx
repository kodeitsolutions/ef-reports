<%@ page language="VB" autoeventwireup="false" inherits="KDE_rNotas_Entregas_Auto" CodeFile="KDE_rNotas_Entregas_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Notas de Entregas Confirmadas (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_rNotas_Entregas_Auto" runat="server" AutoDataBind="true"

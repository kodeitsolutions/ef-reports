<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_cVendedor.aspx.vb" Inherits="rCotizaciones_cVendedor" %>
...
<head runat="server">
    <title>Reporte de Cotizaciones a Clientes por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_cVendedor" runat="server" AutoDataBind="true"

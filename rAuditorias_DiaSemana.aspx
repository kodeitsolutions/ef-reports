<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_DiaSemana.aspx.vb" Inherits="rAuditorias_DiaSemana" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Día de la Semana</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_DiaSemana" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

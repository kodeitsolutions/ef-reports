<%@ page language="VB" autoeventwireup="false" inherits="fAuditorias_Clientes" CodeFile="fAuditorias_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAuditorias_Clientes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLAjustesAlmacenes_AñoMes.aspx.vb" Inherits="rLAjustesAlmacenes_AñoMes" %>
...
<head runat="server">
    <title>Reporte de Ajustes por Almacén Totalizados por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLAjustesAlmacenes_AñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

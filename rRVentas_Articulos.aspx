<%@ page language="VB" autoeventwireup="false" inherits="rRVentas_Articulos" CodeFile="rRVentas_Articulos.aspx.vb"  %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

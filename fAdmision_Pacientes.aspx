<%@ page language="VB" autoeventwireup="false" inherits="fAdmision_Pacientes" CodeFile="fAdmision_Pacientes.aspx.vb" %>
...
<head runat="server">
    <title>Admisión de Pacientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAdmision_Pacientes" runat="server" AutoDataBind="true"

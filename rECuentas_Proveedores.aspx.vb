...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rECuentas_Proveedores"
'-------------------------------------------------------------------------------------------'
Partial Class rECuentas_Proveedores
        ...
        Try
		  ...
		  ' Me.mEscribirConsulta(loComandoSeleccionar.ToString())
            If laDatosReporte.Tables(0).Rows.Count <> 0 Then
                ...
                loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rECuentas_Proveedores", loDatosReporteFinal)
            Else
                ...
                loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rECuentas_Proveedores", laDatosReporte)
            End If

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrECuentas_Proveedores.ReportSource = loObjetoReporte

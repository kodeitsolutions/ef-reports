<%@ page language="VB" autoeventwireup="false" inherits="fSeriales_FacturasVentas" CodeFile="fSeriales_FacturasVentas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeriales_FacturasVentas" runat="server" AutoDataBind="true"

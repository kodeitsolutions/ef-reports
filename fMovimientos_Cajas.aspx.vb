...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fMovimientos_Cajas"
'-------------------------------------------------------------------------------------------'
Partial Class fMovimientos_Cajas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fMovimientos_Cajas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)   
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfMovimientos_Cajas.ReportSource = loObjetoReporte

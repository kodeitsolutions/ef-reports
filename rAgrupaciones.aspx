<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAgrupaciones.aspx.vb" Inherits="rAgrupaciones" %>
...
<head runat="server">
    <title>Reporte de Agrupaciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAgrupaciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

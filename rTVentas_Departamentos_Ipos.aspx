<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Departamentos_Ipos.aspx.vb" Inherits="rTVentas_Departamentos_Ipos" %>
...
<head runat="server">
    <title>Ventas del Día por Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Departamentos_Ipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

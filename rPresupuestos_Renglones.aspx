<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPresupuestos_Renglones.aspx.vb" Inherits="rPresupuestos_Renglones" %>
...
<head runat="server">
    <title>Reporte de Presupuestos con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPresupuestos_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTIncidencias_Fechas"
'-------------------------------------------------------------------------------------------'
Partial Class rTIncidencias_Fechas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    CONVERT(NCHAR(10), Registro, 102)	AS	Fec_Ini01, ")
            loComandoSeleccionar.AppendLine("           CONVERT(NCHAR(10), Registro, 103)	AS	Fec_Ini02, ")
            ...
            loComandoSeleccionar.AppendLine(" SELECT    Fec_Ini01, ")
            loComandoSeleccionar.AppendLine("           Fec_Ini02, ")
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY  Fec_Ini01, Fec_Ini02 ")

            loComandoSeleccionar.AppendLine(" SELECT    Fec_Ini01, ")
            loComandoSeleccionar.AppendLine("           Fec_Ini02               AS  Fec_Ini, ")
            loComandoSeleccionar.AppendLine("           SUM(Can_Opc)            AS  Can_Opc, ")
            loComandoSeleccionar.AppendLine("           SUM(Can_Err)            AS  Can_Err, ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTIncidencias_Fechas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTIncidencias_Fechas.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS: 03/08/2010: Se redondearon los parametros lcParametro0Desde as inicio del dia y
'					lcParametro0Hasta al final del dia
'-------------------------------------------------------------------------------------------'
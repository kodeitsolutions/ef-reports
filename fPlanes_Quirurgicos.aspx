<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPlanes_Quirurgicos" CodeFile="fPlanes_Quirurgicos.aspx.vb" %>
...
<head runat="server">
    <title>Planes Quirúrgicos Pendientes</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPlanes_Quirurgicos" runat="server" AutoDataBind="true"

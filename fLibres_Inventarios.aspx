<%@ page language="VB" autoeventwireup="false" CodeFile="fLibres_Inventarios.aspx.vb"  inherits="fLibres_Inventarios" %>
...
<head runat="server">
    <title>Formas Libres de Inventarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfLibres_Inventarios" runat="server" AutoDataBind="true"

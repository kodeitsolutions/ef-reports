<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDSMS_UResumido.aspx.vb" Inherits="rDSMS_UResumido" %>
...
<head runat="server">
    <title>Reporte de Detalle de SMS por Usuarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDSMS_UResumido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

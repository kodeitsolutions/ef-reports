<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFormas_Pagos.aspx.vb" Inherits="rFormas_Pagos" %>
...
<head runat="server">
    <title>Reporte de Formas de Pagos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFormas_Pagos" runat="server" AutoDataBind="true"

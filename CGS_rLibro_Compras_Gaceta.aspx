<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rLibro_Compras_Gaceta.aspx.vb"
    Inherits="CGS_rLibro_Compras_Gaceta" %>
...
<head runat="server">
    <title>Libro de Compras Gaceta N° 41.239 (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCGS_rLibro_Compras_Gaceta" runat="server" AutoDataBind="true"

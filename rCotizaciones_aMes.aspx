<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_aMes.aspx.vb" Inherits="rCotizaciones_aMes" %>
...
<head runat="server">
    <title>Reporte de Total de Cotizaciones por Artículos Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_aMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Movimientos_Bancarios" CodeFile="fTipos_Movimientos_Bancarios.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Movimientos Bancarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Movimientos_Bancarios" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rMediciones.aspx.vb" Inherits="CGS_rMediciones" %>
...
<head runat="server">
    <title>Listado de Mediciones (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rMediciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

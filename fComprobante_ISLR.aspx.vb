Imports System.Data
Partial Class fComprobante_ISLR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("      AND  Cuentas_Pagar.Cod_Tip   = 'ISLR' ")  
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fComprobante_ISLR", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfComprobante_ISLR.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' JJD: 10/06/15: Adecuacion para CDTA
'-------------------------------------------------------------------------------------------'

<%@ page language="VB" autoeventwireup="false" inherits="rCobros_Renglones" CodeFile="rCobros_Renglones.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Cobros con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCobros_Renglones" runat="server" AutoDataBind="true"

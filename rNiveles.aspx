<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNiveles.aspx.vb" Inherits="rNiveles" %>
...
<head runat="server">
    <title>Reporte de Listado de Niveles  </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNiveles" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

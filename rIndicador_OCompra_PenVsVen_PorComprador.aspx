<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIndicador_OCompra_PenVsVen_PorComprador.aspx.vb" Inherits="rIndicador_OCompra_PenVsVen_PorComprador" %>
...
<head runat="server">
    <title>Indicador de Órdenes de Compra por Procesar vs Vencidas por Comprador</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrIndicador_OCompra_PenVsVen_PorComprador" runat="server" AutoDataBind="true"

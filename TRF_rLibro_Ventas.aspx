<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLibro_Ventas.aspx.vb" Inherits="TRF_rLibro_Ventas" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvTRF_rLibro_Ventas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

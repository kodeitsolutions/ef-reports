<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAInventarios_Renglones.aspx.vb" Inherits="rAInventarios_Renglones" %>
...
<head runat="server">
    <title>Reporte de Ajustes de Inventarios con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAInventarios_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

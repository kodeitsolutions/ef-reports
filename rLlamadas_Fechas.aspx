<%@ page language="VB" autoeventwireup="false" inherits="rLlamadas_Fechas" CodeFile="rLlamadas_Fechas.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Llamadas por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLlamadas_Fechas" runat="server" AutoDataBind="true"

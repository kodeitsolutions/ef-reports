<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCRetencion_ISLR_PagoProveedores_TUR" CodeFile="fCRetencion_ISLR_PagoProveedores_TUR.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Pago a Proveedores (AT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCRetencion_ISLR_PagoProveedores_TUR" runat="server" AutoDataBind="true"

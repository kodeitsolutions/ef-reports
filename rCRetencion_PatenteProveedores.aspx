<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_PatenteProveedores" CodeFile="rCRetencion_PatenteProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de Patente de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCRetencion_PatenteProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

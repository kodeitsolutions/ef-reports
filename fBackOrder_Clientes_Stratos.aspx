<%@ page language="VB" autoeventwireup="false" inherits="fBackOrder_Clientes_Stratos" CodeFile="fBackOrder_Clientes_Stratos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de BackOrder (Stratos)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfBackOrder_Clientes_Stratos" runat="server" AutoDataBind="true"

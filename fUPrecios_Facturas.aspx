<%@ page language="VB" autoeventwireup="false" inherits="fUPrecios_Facturas" CodeFile="fUPrecios_Facturas.aspx.vb" %>
...
<head runat="server">
    <title>Últimos Precios en Facturas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfUPrecios_Facturas" runat="server" AutoDataBind="true"

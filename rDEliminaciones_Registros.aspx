<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDEliminaciones_Registros.aspx.vb" Inherits="rDEliminaciones_Registros" %>
...
<head runat="server">
    <title>Detalle de Eliminaciones de Registros</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDEliminaciones_Registros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

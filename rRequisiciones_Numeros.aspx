<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRequisiciones_Numeros.aspx.vb" Inherits="rRequisiciones_Numeros" %>
...
<head runat="server">
    <title>Reporte de Requisiciones Internas por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRequisiciones_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rExpedientes.aspx.vb" Inherits="rExpedientes" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrExpedientes" runat="server" AutoDataBind="true"

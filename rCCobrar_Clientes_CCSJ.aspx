<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Clientes_CCSJ.aspx.vb" Inherits="rCCobrar_Clientes_CCSJ" %>
...
<head runat="server">
    <title>* Estado de Cuenta de Clientes (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Clientes_CCSJ" runat="server" AutoDataBind="true"

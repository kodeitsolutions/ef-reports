<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNRecepcion_Articulos.aspx.vb" Inherits="rNRecepcion_Articulos" %>
...
<head runat="server">
    <title>Reporte de Notas de Recepción por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNRecepcion_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

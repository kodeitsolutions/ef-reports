<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCFormulaciones_Numeros.aspx.vb" Inherits="rCFormulaciones_Numeros" %>
...
<head runat="server">
    <title>Control de Formulaciones por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCFormulaciones_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

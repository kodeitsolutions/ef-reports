...
Partial Class CGS_rGastos_Trabajadores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'lcComandoSeleccionar.AppendLine("WHERE Renglones_Recibos.Cod_Con IN ('A000','A001','A002','A005','A030','A031','A032','A033','A034','A035','A036','A037','A038',")
            'lcComandoSeleccionar.AppendLine("									'A039','A040','A050','A051','A320','A330','A501','A502','A504','A600','A601','B001','B002',")
            'lcComandoSeleccionar.AppendLine("									'B004','B005','B008','B012','B013','B015','B016','B017','B020','B021','B030','B031','B032',")
            'lcComandoSeleccionar.AppendLine("									'B033','B060','B061','B100','B104')")
            lcComandoSeleccionar.AppendLine("	AND	Conceptos_Nomina.Status = 'A'")
            ...
            lcComandoSeleccionar.AppendLine("	    AND Cuentas_Pagar.Cod_Pro BETWEEN @lcTrabIni AND @lcTrabFin)")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Incidencias.aspx.vb" Inherits="rTipos_Incidencias" %>
...
<head runat="server">
    <title>Reporte de Tipos de Incidencias</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Incidencias" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

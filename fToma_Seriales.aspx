<%@ page language="VB" autoeventwireup="false" inherits="fToma_Seriales" CodeFile="fToma_Seriales.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Toma de seriales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfToma_Seriales" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCobros_Usuarios_Ipos.aspx.vb" Inherits="rTCobros_Usuarios_Ipos" %>
...
<head runat="server">
    <title>Total Cobros por Usuarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCobros_Usuarios_Ipos" runat="server" AutoDataBind="true"

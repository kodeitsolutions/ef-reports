...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFaltantes_Renglones"
'-------------------------------------------------------------------------------------------'
Partial Class rFaltantes_Renglones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		Renglones_Faltantes.Cod_Alm,")
            loComandoSeleccionar.AppendLine("		Renglones_Faltantes.Can_Art1,")
            loComandoSeleccionar.AppendLine("		Renglones_Faltantes.Precio1, ")
            loComandoSeleccionar.AppendLine("		Renglones_Faltantes.Cod_Uni, ")
            loComandoSeleccionar.AppendLine("		Renglones_Faltantes.Mon_Des, ")
            ...
            loComandoSeleccionar.AppendLine(" 		Renglones_Faltantes.Mon_Imp1,")
            ...
            loComandoSeleccionar.AppendLine("           AND Renglones_Faltantes.Cod_Art Between " & lcParametro1Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro1Hasta)
            loComandoSeleccionar.AppendLine("           AND Faltantes.Cod_Cli Between " & lcParametro2Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro2Hasta)
            loComandoSeleccionar.AppendLine("           And Faltantes.Status IN (" & lcParametro3Desde & ")")
            loComandoSeleccionar.AppendLine(" ORDER BY Faltantes.Documento," & lcOrdenamiento)
...
'me.mEscribirConsulta(loComandoSeleccionar.ToString())
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFaltantes_Renglones", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFaltantes_Renglones.ReportSource = loObjetoReporte

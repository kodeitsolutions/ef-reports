<%@ page language="VB" autoeventwireup="false" inherits="PAS_fOrdenes_ComprasPro" CodeFile="PAS_fOrdenes_ComprasPro.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compras para Proveedor(PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fOrdenes_ComprasPro" runat="server" AutoDataBind="true"

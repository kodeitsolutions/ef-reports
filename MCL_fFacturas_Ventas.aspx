<%@ page language="VB" autoeventwireup="false" inherits="MCL_fFacturas_Ventas" CodeFile="MCL_fFacturas_Ventas.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_fFacturas_Ventas" runat="server" AutoDataBind="true"

...
Partial Class rTransportes
   Inherits vis2Formularios.frmReporte
	...
	Try	
			...
			loComandoSeleccionar.AppendLine("			(Case When Status = 'A' Then 'Activo' Else 'Inactivo' End) as Status_Transportes " )
            ...
            'loComandoSeleccionar.AppendLine(" ORDER BY	Cod_Tra, Nom_Tra " )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTransportes", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrTransportes.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' YJP:  28/04/09: Agregar combo estatus y estandarizacion
'-------------------------------------------------------------------------------------------'

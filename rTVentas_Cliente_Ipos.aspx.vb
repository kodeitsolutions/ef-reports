...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTVentas_Cliente_Ipos"
'-------------------------------------------------------------------------------------------'
Partial Class rTVentas_Cliente_Ipos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
           ...
           ' Me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTVentas_Cliente_Ipos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTVentas_Cliente_Ipos.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Documentos" CodeFile="fTipos_Documentos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Documentos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCobros_Clientes.aspx.vb" Inherits="rCobros_Clientes" %>
...
<head runat="server">
    <title>Reporte de Cobros por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCobros_Clientes" runat="server" AutoDataBind="true"

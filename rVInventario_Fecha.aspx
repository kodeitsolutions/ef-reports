<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVInventario_Fecha.aspx.vb" Inherits="rVInventario_Fecha" %>
...
<head runat="server">
    <title>Reporte Valor del Inventario a una Fecha</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVInventario_Fecha" runat="server" AutoDataBind="true"

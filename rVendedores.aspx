<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVendedores.aspx.vb" Inherits="rVendedores" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVendedores" runat="server" AutoDataBind="true"

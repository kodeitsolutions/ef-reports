<%@ Page Language="VB" AutoEventWireup="false" Inherits="fRequisiciones_Posiciones" CodeFile="fRequisiciones_Posiciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Requisición con sus Posiciones</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfRequisiciones_Posiciones" runat="server" AutoDataBind="true"

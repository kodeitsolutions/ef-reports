<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rLibro_Compras.aspx.vb"
    Inherits="KDE_rLibro_Compras" %>
...
<head runat="server">
    <title>Libro de Compras (KDE)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrKDE_rLibro_Compras" runat="server" AutoDataBind="true"

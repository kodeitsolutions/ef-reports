<%@ page language="VB" autoeventwireup="false" CodeFile="fOrdenes_Pagos.aspx.vb" inherits="fOrdenes_Pagos" %>
...
<head runat="server">
    <title>Formato de Ordenes de Pagos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Pagos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rProcesado_Produccion.aspx.vb" Inherits="MCL_rProcesado_Produccion" %>
...
<head runat="server">
    <title>Listado de Procesado en Producción [reducido] (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rProcesado_Produccion" runat="server" AutoDataBind="true"

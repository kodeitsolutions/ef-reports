<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Maquinarias.aspx.vb" Inherits="rTipos_Maquinarias" %>
...
<head runat="server">
    <title>Reporte de Tipos de Maquinarias</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Maquinarias" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

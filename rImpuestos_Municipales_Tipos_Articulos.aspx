<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rImpuestos_Municipales_Tipos_Articulos.aspx.vb" Inherits="rImpuestos_Municipales_Tipos_Articulos" %>
...
<head runat="server">
    <title>Listado de Impuestos Municipales por Tipos de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrImpuestos_Municipales_Tipos_Articulos" runat="server" AutoDataBind="true"

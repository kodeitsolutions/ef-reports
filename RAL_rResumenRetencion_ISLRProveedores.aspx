<%@ page language="VB" autoeventwireup="false" inherits="RAL_rResumenRetencion_ISLRProveedores" 
CodeFile="RAL_rResumenRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Retención de ISLR (RAL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRAL_rResumenRetencion_ISLRProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLEstadoCuenta_HistoricoComprasStratos.aspx.vb" Inherits="rLEstadoCuenta_HistoricoComprasStratos" %>
...
<head runat="server">
    <title>Reporte de Listado de Estado de Cuenta Stratos (Historico Compras)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLEstadoCuenta_HistoricoCompras" runat="server" AutoDataBind="true"

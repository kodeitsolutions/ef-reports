<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_GPV" CodeFile="fFacturas_Ventas_GPV.aspx.vb" %>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_GPV" runat="server" AutoDataBind="true"

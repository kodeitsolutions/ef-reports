...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFacturas_Articulos_CCSJ"
'-------------------------------------------------------------------------------------------'
Partial Class rFacturas_Articulos_CCSJ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" 			(CASE WHEN Facturas.Status = 'Anulado' THEN 0.00 ELSE Renglones_Facturas.Precio1 END) As Precio1,  ")
            loComandoSeleccionar.AppendLine(" 				Renglones_Facturas.Por_Des, ")

            loComandoSeleccionar.AppendLine("			    Facturas.Status AS  Status_Cotizacion,  ")
            loComandoSeleccionar.AppendLine("			(CASE WHEN Facturas.Status = 'Anulado' THEN 0.00 ELSE Renglones_Facturas.Mon_Bru END) As Mon_Bru,  ")
            loComandoSeleccionar.AppendLine("			(CASE WHEN Facturas.Status = 'Anulado' THEN 0.00 ELSE Renglones_Facturas.Mon_Imp1 END) As Mon_Imp1,  ")
            loComandoSeleccionar.AppendLine("			(CASE WHEN Facturas.Status = 'Anulado' THEN 0.00 ELSE Renglones_Facturas.Mon_Net END) As Mon_Net  ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFacturas_Articulos_CCSJ", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrFacturas_Articulos_CCSJ.ReportSource = loObjetoReporte

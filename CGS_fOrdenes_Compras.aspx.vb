...
Partial Class CGS_fOrdenes_Compras
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar3.AppendLine("      Proveedores.Nom_Pro, ")
            loComandoSeleccionar3.AppendLine("      Proveedores.Rif, ")
            loComandoSeleccionar3.AppendLine("      Proveedores.Nit, ")
            loComandoSeleccionar3.AppendLine("      Proveedores.Dir_Fis, ")
            loComandoSeleccionar3.AppendLine("      Proveedores.Telefonos,")
            ...
            loComandoSeleccionar3.AppendLine("      COALESCE((SELECT TOP 1 Auditorias.Cod_Usu")
            loComandoSeleccionar3.AppendLine("                FROM Auditorias")
            loComandoSeleccionar3.AppendLine("                WHERE	Ordenes_Compras.Documento = Auditorias.Documento")
            loComandoSeleccionar3.AppendLine("                  AND Auditorias.Tabla = 'Ordenes_Compras'")
            loComandoSeleccionar3.AppendLine("                  AND Auditorias.Accion = 'Confirmar'")
            loComandoSeleccionar3.AppendLine("                ORDER BY Auditorias.Registro DESC)")
            loComandoSeleccionar3.AppendLine("      ,'')	AS Usu_Aut,")
            loComandoSeleccionar3.AppendLine("      Ordenes_Compras.Prioridad		AS Tipo")
            loComandoSeleccionar3.AppendLine("FROM Ordenes_Compras")
            loComandoSeleccionar3.AppendLine("  JOIN Renglones_OCompras ON Ordenes_Compras.Documento = Renglones_OCompras.Documento")
            loComandoSeleccionar3.AppendLine("  JOIN Proveedores ON  Ordenes_Compras.Cod_Pro = Proveedores.Cod_Pro")
            loComandoSeleccionar3.AppendLine("  JOIN Formas_Pagos ON Ordenes_Compras.Cod_For = Formas_Pagos.Cod_For")
            loComandoSeleccionar3.AppendLine("  JOIN Articulos ON Articulos.Cod_Art = Renglones_OCompras.Cod_Art")

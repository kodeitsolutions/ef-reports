<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_Proveedores.aspx.vb" Inherits="rArticulos_Proveedores" %>
...
<head runat="server">
    <title>Listado de Artículos por Proveedor</title>
...
<body>
    ...
    <div >
         <CR:CrystalReportViewer ID="crvrArticulos_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

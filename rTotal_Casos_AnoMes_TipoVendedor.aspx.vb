...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Casos_AnoMes_TipoVendedor"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Casos_AnoMes_TipoVendedor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("            Tipos_Ejecutores.Cod_Tip                                            AS Cod_Tip,")
            loConsulta.AppendLine("            Tipos_Ejecutores.Nom_Tip                                            AS Nom_Tip,")
            ...
            loConsulta.AppendLine("    JOIN    Tipos_Vendedores AS Tipos_Ejecutores")
            loConsulta.AppendLine("        ON  Tipos_Ejecutores.Cod_Tip = Ejecutores.Cod_Tip")
            ...
            loConsulta.AppendLine("            Tipos_Ejecutores.Cod_Tip, Tipos_Ejecutores.Nom_Tip")
            loConsulta.AppendLine("ORDER BY    Tipos_Ejecutores.Cod_Tip," & lcOrdenamiento)
            loConsulta.AppendLine("            ")
            loConsulta.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Casos_AnoMes_TipoVendedor", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Casos_AnoMes_TipoVendedor.ReportSource = loObjetoReporte

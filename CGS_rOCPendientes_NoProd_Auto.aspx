<%@ page language="VB" autoeventwireup="false" inherits="CGS_rOCPendientes_NoProd_Auto" CodeFile="CGS_rOCPendientes_NoProd_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Órdenes de Compras No producción Pendientes Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOCPendientes_NoProd_Auto" runat="server" AutoDataBind="true"

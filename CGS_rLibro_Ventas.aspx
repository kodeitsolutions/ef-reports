<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rLibro_Ventas.aspx.vb" Inherits="CGS_rLibro_Ventas" %>
...
<head runat="server">
	<title>Libro de Ventas (CGS)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvCGS_rLibro_Ventas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

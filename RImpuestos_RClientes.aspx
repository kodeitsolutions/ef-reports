<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RImpuestos_RClientes.aspx.vb" Inherits="RImpuestos_RClientes" %>
...
<head runat="server">
    <title>Reporte de Impuestos Retenidos a Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvRImpuestos_RClientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

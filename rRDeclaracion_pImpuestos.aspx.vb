...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRDeclaracion_pImpuestos"
'-------------------------------------------------------------------------------------------'
Partial Class rRDeclaracion_pImpuestos 
	...
	Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SET	@lnExcedenteCF = " & lcCreditoFiscalAnterior)
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rRDeclaracion_pImpuestos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRDeclaracion_pImpuestos.ReportSource =	 loObjetoReporte	

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCobros_Numeros.aspx.vb" Inherits="rCobros_Numeros" %>
...
<head runat="server">
    <title>Reporte de Cobros por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCobros_Numeros" runat="server" AutoDataBind="true"

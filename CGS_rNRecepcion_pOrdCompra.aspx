<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rNRecepcion_pOrdCompra.aspx.vb" Inherits="CGS_rNRecepcion_pOrdCompra" %>
...
<head runat="server">
    <title>Reporte de Notas de Recepción por Órdenes de Compras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNRecepcion_cRenglones" runat="server" AutoDataBind="true"

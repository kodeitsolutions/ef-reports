<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOProduccion_Desperdicio" CodeFile="CGS_fOProduccion_Desperdicio.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Producción para Verificación de Desperdicios (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOProduccion_Desperdicio" runat="server" AutoDataBind="true"

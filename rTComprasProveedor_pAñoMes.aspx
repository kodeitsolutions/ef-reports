<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTComprasProveedor_pAñoMes.aspx.vb" Inherits="rTComprasProveedor_pAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Compras a Proveedores por Proveedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTComprasProveedor_pAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

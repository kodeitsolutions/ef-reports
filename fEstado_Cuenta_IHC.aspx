<%@ page language="VB" autoeventwireup="false" inherits="fEstado_Cuenta_IHC" CodeFile="fEstado_Cuenta_IHC.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Estado de Cuenta In Hand Customer</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEstado_Cuenta_IHC" runat="server" AutoDataBind="true"

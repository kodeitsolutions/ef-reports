<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCotizaciones_LIRIO" CodeFile="fCotizaciones_LIRIO.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCotizaciones_LIRIO" runat="server" AutoDataBind="true"

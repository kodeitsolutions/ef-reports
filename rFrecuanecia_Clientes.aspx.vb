...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFrecuanecia_Clientes"
'-------------------------------------------------------------------------------------------'
Partial Class rFrecuanecia_Clientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" JOIN Clientes ON (Clientes.Cod_Cli = Frecuencias.Cod_Reg) AND ('Clientes' = Frecuencias.Origen)")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFrecuanecia_Clientes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFrecuanecia_Clientes.ReportSource = loObjetoReporte

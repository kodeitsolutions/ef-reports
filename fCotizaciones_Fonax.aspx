<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Fonax" CodeFile="fCotizaciones_Fonax.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Fonax" runat="server" AutoDataBind="true"

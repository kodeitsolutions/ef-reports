<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rgqrFacturas_Vendedores.aspx.vb" Inherits="rgqrFacturas_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Facturas por Vendedores pruebargq</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrgqrFacturas_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

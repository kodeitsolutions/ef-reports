<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSeguimientos_Articulos.aspx.vb" Inherits="rSeguimientos_Articulos" %>
...
<head runat="server">
    <title>Reporte de Seguimientos de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSeguimientos_Articulos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_EquiposUsuarios.aspx.vb" Inherits="rAuditorias_EquiposUsuarios" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Equipos y Usuarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_EquiposUsuarios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

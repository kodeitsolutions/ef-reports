<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Proveedores" CodeFile="fTipos_Proveedores.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Proveedores" runat="server" AutoDataBind="true"

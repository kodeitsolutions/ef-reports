<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAInventarios_Fechas.aspx.vb" Inherits="rAInventarios_Fechas" %>
...
<head runat="server">
    <title>Reporte de Ajustes de Inventarios por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAInventarios_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

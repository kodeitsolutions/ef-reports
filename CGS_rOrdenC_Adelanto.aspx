<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rOrdenC_Adelanto.aspx.vb" Inherits="CGS_rOrdenC_Adelanto" %>
...
<head runat="server">
    <title>Listado de Órdenes de Compras con sus adelantos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOrdenC_Adelanto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

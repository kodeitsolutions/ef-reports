<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIncidencias_Fechas.aspx.vb" Inherits="rIncidencias_Fechas" %>
...
<head runat="server">
    <title>Listado de Incidencias por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrIncidencias_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

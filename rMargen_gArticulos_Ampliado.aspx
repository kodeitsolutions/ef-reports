<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gArticulos_Ampliado.aspx.vb" Inherits="rMargen_gArticulos_Ampliado" %>
...
<head runat="server">
    <title>Margen de Ganancia por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gArticulos_Ampliado" runat="server" AutoDataBind="true"

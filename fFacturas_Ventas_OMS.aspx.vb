...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFacturas_Ventas_OMS"
'-------------------------------------------------------------------------------------------'
Partial Class fFacturas_Ventas_OMS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Facturas.Ord_Tra        				AS  Numero_Adicional, 		")
            loComandoSeleccionar.AppendLine("           Facturas.Fec_Ini,											")
            loComandoSeleccionar.AppendLine("           YEAR(Facturas.Fec_Ini)  AS Anno,							")
            loComandoSeleccionar.AppendLine("           MONTH(Facturas.Fec_Ini) AS Mes, 							")
            loComandoSeleccionar.AppendLine("           DAY(Facturas.Fec_Ini)   AS Dia, 							")
            ...
            loComandoSeleccionar.AppendLine("           (Facturas.Mon_Bru - Facturas.Mon_Exe) AS Base_Imponible,	")
            ...
            loComandoSeleccionar.AppendLine("           AND Almacenes.Cod_Alm   =   Renglones_Facturas.Cod_Alm AND " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            loComandoSeleccionar.AppendLine(" ORDER BY  Facturas.Documento,  ")
            loComandoSeleccionar.AppendLine("			(CASE Renglones_Facturas.Cod_Alm ")
            loComandoSeleccionar.AppendLine("				WHEN 'ING' THEN 0")
            loComandoSeleccionar.AppendLine("				WHEN 'GAS' THEN 1")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFacturas_Ventas_OMS", laDatosReporte)
            lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".", ",")
            ...
            Me.crvfFacturas_Ventas_OMS.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' RJG: 27/10/11: Agregados campos adicionales al formato.									'
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFrecuanecia_Vendedores.aspx.vb" Inherits="rFrecuanecia_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Frecuencia de Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFrecuanecia_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

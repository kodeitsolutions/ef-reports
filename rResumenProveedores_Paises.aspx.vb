...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rResumenProveedores_Paises"
'-------------------------------------------------------------------------------------------'
Partial Class rResumenProveedores_Paises 
	...
	Try
			...
			loConsulta.AppendLine(" 	    AND Proveedores.Cod_Ven BETWEEN " & lcParametro2Desde)
			...
			loConsulta.AppendLine(" 	    AND Proveedores.Cod_Cla BETWEEN " & lcParametro6Desde)
			loConsulta.AppendLine(" 	    AND " & lcParametro6Hasta)
			loConsulta.AppendLine(" 	    AND Proveedores.Cod_Tip BETWEEN " & lcParametro7Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rResumenProveedores_Paises", laDatosReporte)
            
            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrResumenProveedores_Paises.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Clientes_Seguros_CCSJ.aspx.vb" Inherits="rCCobrar_Clientes_Seguros_CCSJ" %>
...
<head runat="server">
    <title>Estado de Cuenta de Clientes para Seguros (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Clientes_Seguros_CCSJ" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fNEntregas_Generica" CodeFile="fNEntregas_Generica.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Nota de Entrega Genérica</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfNEntregas_Generica" runat="server" AutoDataBind="true"

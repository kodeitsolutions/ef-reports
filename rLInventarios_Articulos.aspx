<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLInventarios_Articulos.aspx.vb" Inherits="rLInventarios_Articulos" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Inventarios por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLInventarios_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

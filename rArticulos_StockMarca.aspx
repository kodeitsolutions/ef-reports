<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_StockMarca" CodeFile="rArticulos_StockMarca.aspx.vb"  %>
...
<head runat="server">
    <title>Reporte de Artículos con sus Stock por Marca</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_StockMarca" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

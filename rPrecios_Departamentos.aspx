<%@ page language="VB" autoeventwireup="false" inherits="rPrecios_Departamentos" CodeFile="rPrecios_Departamentos.aspx.vb"  %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPrecios_Departamentos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

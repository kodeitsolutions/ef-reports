...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rResumenClientes_Paises"
'-------------------------------------------------------------------------------------------'
Partial Class rResumenClientes_Paises 
	...
	Try
			...
			loConsulta.AppendLine(" 	    AND Clientes.Cod_Ven BETWEEN " & lcParametro2Desde)
			...
			loConsulta.AppendLine(" 	    AND Clientes.Cod_Cla BETWEEN " & lcParametro6Desde)
			loConsulta.AppendLine(" 	    AND " & lcParametro6Hasta)
			loConsulta.AppendLine(" 	    AND Clientes.Cod_Tip BETWEEN " & lcParametro7Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rResumenClientes_Paises", laDatosReporte)
            
            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrResumenClientes_Paises.ReportSource = loObjetoReporte

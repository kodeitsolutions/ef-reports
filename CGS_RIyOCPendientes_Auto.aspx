<%@ page language="VB" autoeventwireup="false" inherits="CGS_RIyOCPendientes_Auto" CodeFile="CGS_RIyOCPendientes_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones Internas y Órdenes de Compras pendientes Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_RIyOCPendientes_Auto" runat="server" AutoDataBind="true"

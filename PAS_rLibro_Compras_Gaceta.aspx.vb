...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "PAS_rLibro_Compras_Gaceta"
'-------------------------------------------------------------------------------------------'
Partial Class PAS_rLibro_Compras_Gaceta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("PAS_rLibro_Compras_Gaceta", laDatosReporte)
            ...
            '    Dim lcFileName As String = Me.Server.MapPath("~\Administrativo\Temporales\PAS_rLibro_Compras_Gaceta_" & Guid.NewGuid().ToString("N") & ".xls")
            ...
            '    Me.Response.AppendHeader("content-disposition", "attachment; filename=PAS_rLibro_Compras_Gaceta.xls")
            ...
            Me.crvrPAS_rLibro_Compras_Gaceta.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rAInventarios_Renglones"
'-------------------------------------------------------------------------------------------'
Partial Class rAInventarios_Renglones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAInventarios_Renglones", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrAInventarios_Renglones.ReportSource = loObjetoReporte
...
'                        3.- Departamento
'                        4.- Sección
'                        5.- Clases de Articulo
'                        6.- Tipo de Artículo
'                        7.- Marca
'                        8.- Proveedor (Renglones_Ajustes.Cod_Art=Articulos.Cod_Art y Articulos.Cod_Pro=Proveedores.Cod_Pro)

<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque05" CodeFile="fOrdenes_Cheque05.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque (BNC)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque05" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fDescuentosPrepago_Cliente.aspx.vb" Inherits="fDescuentosPrepago_Cliente" %>
...
<head runat="server">
    <title>Descuentos por Prepago del Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDescuentosPrepago_Cliente" runat="server" AutoDataBind="true"

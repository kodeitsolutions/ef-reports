<%@ page language="VB" autoeventwireup="false" inherits="CGS_fFormulas" CodeFile="CGS_fFormulas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Fórmulas (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fFormulas" runat="server" AutoDataBind="true"

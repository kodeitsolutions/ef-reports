<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Ventas_Venezuela.aspx.vb" Inherits="rLibro_Ventas_Venezuela" %>
...
<head runat="server">
	<title>Libro de Ventas con sus Retenciones</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrLibro_Ventas_Venezuela" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCobros_cMensualmente.aspx.vb" Inherits="rTCobros_cMensualmente" %>
...
<head runat="server">
    <title>Reporte Total de Cobros por Cliente Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCobros_cMensualmente" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

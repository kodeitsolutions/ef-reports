<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRInventarios_Marca.aspx.vb" Inherits="rRInventarios_Marca" %>
...
<head runat="server">
    <title>Reporte Resumen de Inventario por Marcas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRInventarios_Marca" runat="server" AutoDataBind="true"

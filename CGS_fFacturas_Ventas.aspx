<%@ page language="VB" autoeventwireup="false" inherits="CGS_fFacturas_Ventas" CodeFile="CGS_fFacturas_Ventas.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fFacturas_Ventas" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fOrdenes_Pagos_Ingles"
'-------------------------------------------------------------------------------------------'
Partial Class fOrdenes_Pagos_Ingles
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("            Renglones_oPagos.Mon_Imp1                          AS  Mon_Imp,")
            ...
            loComandoSeleccionar.AppendLine("            Renglones_oPagos.Mon_Net                           AS  NetoConcepto,")
            ...
            loComandoSeleccionar.AppendLine("            CASE WHEN Detalles_oPagos.Tip_Ope = 'Efectivo' Then Detalles_oPagos.Cod_Caj ELSE RTRIM(ISNULL((SELECT Nom_Ban FROM Bancos WHERE Cod_Ban = Detalles_oPagos.Cod_Ban),''))+': '+ Detalles_oPagos.Cod_Cue END AS  Num_Doc_Ban_Caj,")
            ...
            loComandoSeleccionar.AppendLine("           Proveedores  ")
            loComandoSeleccionar.AppendLine("WHERE      Ordenes_Pagos.Documento    =   Detalles_oPagos.Documento AND ")
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fOrdenes_Pagos_Ingles", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfOrdenes_Pagos_Ingles.ReportSource = loObjetoReporte

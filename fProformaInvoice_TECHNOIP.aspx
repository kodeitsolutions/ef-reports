<%@ Page Language="VB" AutoEventWireup="false" Inherits="fProformaInvoice_TECHNOIP" CodeFile="fProformaInvoice_TECHNOIP.aspx.vb" %>
...
<head runat="server">
    <title>Proforma Invoice (TECHNOIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfProformaInvoice_TECHNOIP" runat="server" AutoDataBind="true"

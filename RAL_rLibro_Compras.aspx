<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RAL_rLibro_Compras.aspx.vb"
    Inherits="RAL_rLibro_Compras" %>
...
<head runat="server">
    <title>Libro de Compras (RAL)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrRAL_rLibro_Compras" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_Campos_Extras.aspx.vb" Inherits="rClientes_Campos_Extras" %>
...
<head runat="server">
    <title>Reporte de Clientes con sus Campos Extras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_Campos_Extras" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLVentas_Numeros"
'-------------------------------------------------------------------------------------------'
Partial Class rLVentas_Numeros
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    Libres_Ventas.Status, ")
            ...
            loComandoSeleccionar.AppendLine("           (Libres_Ventas.Mon_Imp1 + Libres_Ventas.Mon_Imp2 + Libres_Ventas.Mon_Imp3)  AS Mon_Imp, ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLVentas_Numeros", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrLVentas_Numeros.ReportSource = loObjetoReporte

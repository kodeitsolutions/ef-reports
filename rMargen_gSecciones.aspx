<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gSecciones.aspx.vb" Inherits="rMargen_gSecciones" %>
...
<head runat="server">
    <title>Margen de Ganancia por Seccion</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gSecciones" runat="server" AutoDataBind="true"

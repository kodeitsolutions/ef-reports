<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReclamos_Sugerencias.aspx.vb" Inherits="rReclamos_Sugerencias" %>
...
<head runat="server">
    <title>Reporte de Reclamos y Sugerencias</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReclamos_Sugerencias" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

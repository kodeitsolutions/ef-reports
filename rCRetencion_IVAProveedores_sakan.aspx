<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_IVAProveedores_sakan" 
CodeFile="rCRetencion_IVAProveedores_sakan.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Retención de IVA de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_IVAProveedores_sakan" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

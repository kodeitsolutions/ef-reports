<%@ page language="VB" autoeventwireup="false" inherits="fDatos_Reportes" CodeFile="fDatos_Reportes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Datos de Reportes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatos_Reportes" runat="server" AutoDataBind="true"

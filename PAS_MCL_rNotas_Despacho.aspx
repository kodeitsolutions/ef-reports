<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_MCL_rNotas_Despacho.aspx.vb" Inherits="PAS_MCL_rNotas_Despacho" %>
...
<head runat="server">
    <title>Listado de Despachos con sus renglones (PAS - MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_MCL_rNotas_Despacho" runat="server" AutoDataBind="true"

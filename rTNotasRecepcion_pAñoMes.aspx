<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTNotasRecepcion_pAñoMes.aspx.vb" Inherits="rTNotasRecepcion_pAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Notas de Recepción por Proveedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTNotasRecepcion_pAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

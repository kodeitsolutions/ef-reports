<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_vMes.aspx.vb" Inherits="rPedidos_vMes" %>
...
<head runat="server">
    <title>Reporte de Total de Pedidos por Vendedores Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_vMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

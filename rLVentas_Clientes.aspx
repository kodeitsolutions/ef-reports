<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Clientes.aspx.vb" Inherits="rLVentas_Clientes" %>
...
<head runat="server">
    <title>Reporte de Formas Libres por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLVentas_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

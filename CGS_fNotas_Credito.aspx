<%@ page language="VB" autoeventwireup="false" inherits="CGS_fNotas_Credito" CodeFile="CGS_fNotas_Credito.aspx.vb" %>
...
<head runat="server">
    <title>Notas de Crédito (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fNotas_Credito" runat="server" AutoDataBind="true"

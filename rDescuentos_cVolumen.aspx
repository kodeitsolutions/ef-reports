<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDescuentos_cVolumen.aspx.vb" Inherits="rDescuentos_cVolumen" %>
...
<head runat="server">
    <title>Listado de Descuentos Comerciales por Volumen</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDescuentos_cVolumen" runat="server" AutoDataBind="true"

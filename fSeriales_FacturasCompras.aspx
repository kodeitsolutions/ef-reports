<%@ page language="VB" autoeventwireup="false" inherits="fSeriales_FacturasCompras" CodeFile="fSeriales_FacturasCompras.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeriales_FacturasCompras" runat="server" AutoDataBind="true"

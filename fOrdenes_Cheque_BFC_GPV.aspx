<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque_BFC_GPV" CodeFile="fOrdenes_Cheque_BFC_GPV.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque BFC GPV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque_BFC_GPV" runat="server" AutoDataBind="true"

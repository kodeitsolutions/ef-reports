<%@ page language="VB" autoeventwireup="false" inherits="fSeguimiento_Clientes" CodeFile="fSeguimiento_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Seguimiento</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeguimiento_Clientes" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fUbicaciones_Articulos" CodeFile="fUbicaciones_Articulos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfUbicaciones_Articulos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPagos_FechasResumido.aspx.vb" Inherits="rPagos_FechasResumido" %>
...
<head runat="server">
    <title>Reporte de Pagos por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPagos_FechasResumido" runat="server" AutoDataBind="true"

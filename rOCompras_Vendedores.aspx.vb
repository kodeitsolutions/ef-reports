...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rOCompras_Vendedores"
'-------------------------------------------------------------------------------------------'
Partial Class rOCompras_Vendedores
	...
	Try
		...
		Dim loComandoSeleccionar As New StringBuilder()
            ...
            'loComandoSeleccionar.AppendLine(" ORDER BY  Ordenes_Compras.Cod_Ven, Ordenes_Compras.Fec_Ini, Ordenes_Compras.Documento ")
            loComandoSeleccionar.AppendLine("ORDER BY    Ordenes_Compras.Cod_Ven, " & lcOrdenamiento & ", CONVERT(nchar(30), Ordenes_Compras.Fec_Ini,112) ")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rOCompras_Vendedores", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrOCompras_Vendedores.ReportSource =	 loObjetoReporte	

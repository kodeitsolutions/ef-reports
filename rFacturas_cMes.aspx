<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_cMes.aspx.vb" Inherits="rFacturas_cMes" %>
...
<head runat="server">
    <title>Total Facturas por Clientes Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_cMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

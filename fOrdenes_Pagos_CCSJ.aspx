<%@ page language="VB" autoeventwireup="false" CodeFile="fOrdenes_Pagos_CCSJ.aspx.vb" inherits="fOrdenes_Pagos_CCSJ" %>
...
<head runat="server">
    <title>* Formato de Ordenes de Pagos (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Pagos_CCSJ" runat="server" AutoDataBind="true"

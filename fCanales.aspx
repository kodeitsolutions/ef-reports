<%@ page language="VB" autoeventwireup="false" inherits="fCanales" CodeFile="fCanales.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Canales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCanales" runat="server" AutoDataBind="true"

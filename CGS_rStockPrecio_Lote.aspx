<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rStockPrecio_Lote.aspx.vb" Inherits="CGS_rStockPrecio_Lote" %>
...
<head runat="server">
    <title>Listado de Lotes con Stock y Precios (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rStockPrecio_Lote" runat="server" AutoDataBind="true"

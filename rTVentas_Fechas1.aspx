<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Fechas1.aspx.vb" Inherits="rTVentas_Fechas1" %>
...
<head runat="server">
    <title>Reporte de Total de Ventas por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Fechas1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

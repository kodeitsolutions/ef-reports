<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fReuniones_Eventos_Demos.aspx.vb" Inherits="fReuniones_Eventos_Demos" %>
...
<head runat="server">
    <title>Formato de Campaña</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfReuniones_Eventos_Demos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

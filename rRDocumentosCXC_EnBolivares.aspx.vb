...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRDocumentosCXC_EnBolivares"
'-------------------------------------------------------------------------------------------'
Partial Class rRDocumentosCXC_EnBolivares
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT ")
            loComandoSeleccionar.AppendLine(" 		CASE")
            loComandoSeleccionar.AppendLine(" 			WHEN Tip_Ope = 'Cheque' THEN Detalles_Cobros.Mon_Net")
            loComandoSeleccionar.AppendLine(" 			ELSE 0")
            loComandoSeleccionar.AppendLine(" 		END Cheque,")
            loComandoSeleccionar.AppendLine(" 		CASE")
            loComandoSeleccionar.AppendLine(" 			WHEN Tip_Ope = 'Deposito' THEN Detalles_Cobros.Mon_Net")
            loComandoSeleccionar.AppendLine(" 			ELSE 0")
            loComandoSeleccionar.AppendLine(" 		END Deposito,")
            loComandoSeleccionar.AppendLine(" 		CASE")
            loComandoSeleccionar.AppendLine(" 			WHEN Tip_Ope = 'Efectivo' THEN Detalles_Cobros.Mon_Net")
            loComandoSeleccionar.AppendLine(" 			ELSE 0")
            loComandoSeleccionar.AppendLine(" 		END Efectivo,")
            loComandoSeleccionar.AppendLine(" 		CASE")
            loComandoSeleccionar.AppendLine(" 			WHEN Tip_Ope = 'Tarjeta' THEN Detalles_Cobros.Mon_Net")
            loComandoSeleccionar.AppendLine(" 			ELSE 0")
            loComandoSeleccionar.AppendLine(" 		END Tarjeta,")
            loComandoSeleccionar.AppendLine(" 		CASE")
            loComandoSeleccionar.AppendLine(" 			WHEN Tip_Ope = 'Ticket' THEN Detalles_Cobros.Mon_Net")
            loComandoSeleccionar.AppendLine(" 			ELSE 0")
            loComandoSeleccionar.AppendLine(" 		END Ticket,")
            loComandoSeleccionar.AppendLine(" 		CASE")
            loComandoSeleccionar.AppendLine(" 			WHEN Tip_Ope = 'Transferencia' THEN Detalles_Cobros.Mon_Net")
            loComandoSeleccionar.AppendLine(" 			ELSE 0")
            ...
            loComandoSeleccionar.AppendLine(" JOIN Cobros ON  Cobros.Documento = Detalles_Cobros.Documento ")
            ...
            loComandoSeleccionar.AppendLine(" select * from #temp3, #temp4 where #temp3.tabla = #temp4.Tabla")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRDocumentosCXC_EnBolivares", laDatosReporte)
            ...
            Me.crvrRDocumentosCXC_EnBolivares.ReportSource = loObjetoReporte

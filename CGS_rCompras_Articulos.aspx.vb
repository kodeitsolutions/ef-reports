...
Partial Class CGS_rCompras_Articulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(13)'),'')),'')									AS CCNom_Art,")
            ...
            loComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(13)'),'')),'')									AS CCNom_Sec,")

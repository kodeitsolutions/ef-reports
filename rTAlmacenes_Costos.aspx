<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTAlmacenes_Costos.aspx.vb" Inherits="rTAlmacenes_Costos" %>
...
<head runat="server">
    <title>Listado de Traslados entre Almacenes con sus Costos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTAlmacenes_Costos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

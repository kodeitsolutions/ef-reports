...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gSecciones"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gSecciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpGanancia(	Cod_Dep		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Dep		CHAR(100),			")
            loComandoSeleccionar.AppendLine("							Cod_Sec		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Sec		CHAR(100),			")
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpFinal(	Cod_Dep		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Dep		CHAR(100),			")
            loComandoSeleccionar.AppendLine("							Cod_Sec		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Sec		CHAR(100),			")
            loComandoSeleccionar.AppendLine("							Can_Fac		DECIMAL(28, 10),	")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Dep, Nom_Dep, Cod_Sec, Nom_Sec, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            loComandoSeleccionar.AppendLine("SELECT		Departamentos.Cod_Dep												AS Cod_Dep,")
            ...
            loComandoSeleccionar.AppendLine(" 		ON	Departamentos.Cod_Dep = Articulos.Cod_Dep")
            loComandoSeleccionar.AppendLine(" 	JOIN	Secciones ")
            loComandoSeleccionar.AppendLine(" 		ON	Secciones.Cod_Dep = Departamentos.Cod_Dep")
            loComandoSeleccionar.AppendLine(" 		AND	Secciones.Cod_Sec = Articulos.Cod_Sec")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Departamentos.Cod_Dep, Departamentos.Nom_Dep, Secciones.Cod_Sec, Secciones.Nom_Sec")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Dep, Nom_Dep, Cod_Sec, Nom_Sec, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            loComandoSeleccionar.AppendLine("SELECT	Cod_Dep				AS Cod_Dep,")
            loComandoSeleccionar.AppendLine("		Nom_Dep				AS Nom_Dep,")
            loComandoSeleccionar.AppendLine("		Cod_Sec				AS Cod_Sec,")
            loComandoSeleccionar.AppendLine("		Nom_Sec				AS Nom_Sec,")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Cod_Dep, Nom_Dep, Cod_Sec, Nom_Sec")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gSecciones", laDatosReporte)
            ...
            Me.crvrMargen_gSecciones.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' JJD: 22/04/10: Programacion inicial
'-------------------------------------------------------------------------------------------'

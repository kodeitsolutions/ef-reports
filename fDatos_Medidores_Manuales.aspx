<%@ page language="VB" autoeventwireup="false" inherits="fDatos_Medidores_Manuales" CodeFile="fDatos_Medidores_Manuales.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Medidores Manuales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatos_Medidores_Manuales" runat="server" AutoDataBind="true"

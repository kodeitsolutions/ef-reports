<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNRecepcion_Vendedores.aspx.vb" Inherits="rNRecepcion_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Notas de Recepción por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNRecepcion_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

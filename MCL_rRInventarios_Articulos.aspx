<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rRInventarios_Articulos.aspx.vb" Inherits="MCL_rRInventarios_Articulos" %>
...
<head runat="server">
    <title>Reporte Resumen de Inventario por Articulos (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rRInventarios_Articulos" runat="server" AutoDataBind="true"

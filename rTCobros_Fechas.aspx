<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCobros_Fechas.aspx.vb" Inherits="rTCobros_Fechas" %>
...
<head runat="server">
    <title>Total Cobros por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCobros_Fechas" runat="server" AutoDataBind="true"

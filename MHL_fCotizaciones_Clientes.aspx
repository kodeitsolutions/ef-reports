<%@ Page Language="VB" AutoEventWireup="false" Inherits="MHL_fCotizaciones_Clientes"
    CodeFile="MHL_fCotizaciones_Clientes.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvMHL_fCotizaciones_Clientes" runat="server" AutoDataBind="true"

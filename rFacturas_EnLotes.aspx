<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_EnLotes.aspx.vb" Inherits="rFacturas_EnLotes" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_EnLotes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

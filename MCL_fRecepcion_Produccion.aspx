<%@ page language="VB" autoeventwireup="false" inherits="MCL_fRecepcion_Produccion" CodeFile="MCL_fRecepcion_Produccion.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_fRecepcion_Produccion" runat="server" AutoDataBind="true"

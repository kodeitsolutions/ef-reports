<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rConceptos_Nomina.aspx.vb" Inherits="KDE_rConceptos_Nomina" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvKDE_rConceptos_Nomina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

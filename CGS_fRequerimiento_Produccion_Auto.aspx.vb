...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_fRequerimiento_Produccion_Auto"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_fRequerimiento_Produccion_Auto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("CGS_fRequerimiento_Produccion_Auto", laDatosReporte)

        Me.mTraducirReporte(loObjetoReporte)
        Me.mFormatearCamposReporte(loObjetoReporte)
        Me.crvCGS_fRequerimiento_Produccion_Auto.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque03" CodeFile="fPagos_Cheque03.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque BNC(Pagos)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque03" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grMargen_gEmpresa.aspx.vb" Inherits="grMargen_gEmpresa" Debug="true" %>
...
<head runat="server">
    <title>Gráfico de Ganancia de la Empresa</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrMargen_gEmpresa" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fEntrega_RmaCliente" CodeFile="fEntrega_RmaCliente.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Entrega de RMA de Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEntrega_RmaCliente" runat="server" AutoDataBind="true"

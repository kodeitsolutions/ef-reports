<%@ page language="VB" autoeventwireup="false" inherits="rpARC_oPagos" CodeFile ="rpARC_oPagos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrpARC_oPagos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

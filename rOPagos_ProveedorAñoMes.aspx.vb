...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rOPagos_ProveedorAñoMes"
'-------------------------------------------------------------------------------------------'
Partial Class rOPagos_ProveedorAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" FROM       Ordenes_Pagos, Renglones_OPagos, Proveedores")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY Cod_Pro, Nom_Pro, Anno, mes")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rOPagos_ProveedorAñoMes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrOPagos_ProveedorAñoMes.ReportSource = loObjetoReporte

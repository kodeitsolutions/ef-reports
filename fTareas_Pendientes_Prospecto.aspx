<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fTareas_Pendientes_Prospecto.aspx.vb" Inherits="fTareas_Pendientes_Prospecto" %>
...
<head runat="server">
    <title>Formato de Tareas Pendientes del Prospecto</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfTareas_Pendientes_Prospecto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

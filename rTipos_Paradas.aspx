<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Paradas.aspx.vb" Inherits="rTipos_Paradas" %>
...
<head runat="server">
    <title>Reporte de Tipos de Paradas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Paradas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

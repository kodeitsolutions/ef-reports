...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTComprasProveedor_vAñoMes"
'-------------------------------------------------------------------------------------------'
Partial Class rTComprasProveedor_vAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine(" compras, renglones_compras, proveedores, vendedores, articulos")
            lcComandoSeleccionar.AppendLine(" WHERE	")
            lcComandoSeleccionar.AppendLine("					compras.documento			 =			renglones_compras.documento ")
            lcComandoSeleccionar.AppendLine("			AND		compras.cod_pro				 =			proveedores.cod_pro")
            lcComandoSeleccionar.AppendLine("			AND		compras.cod_ven				 =			vendedores.cod_ven")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTComprasProveedor_vAñoMes", laDatosReporte)
            ...
            Me.crvrTComprasProveedor_vAñoMes.ReportSource = loObjetoReporte

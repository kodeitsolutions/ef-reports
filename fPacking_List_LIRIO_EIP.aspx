<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPacking_List_LIRIO_EIP" CodeFile="fPacking_List_LIRIO_EIP.aspx.vb" %>
...
<head runat="server">
    <title>Packing List (LIRIO/EverythingIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPacking_List_LIRIO_EIP" runat="server" AutoDataBind="true"

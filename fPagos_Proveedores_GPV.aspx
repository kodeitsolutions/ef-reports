<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Proveedores_GPV" CodeFile="fPagos_Proveedores_GPV.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Proveedores_GPV" runat="server" AutoDataBind="true"

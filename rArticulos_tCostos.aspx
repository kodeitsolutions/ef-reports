<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_tCostos.aspx.vb" Inherits="rArticulos_tCostos" %>
...
<head runat="server">
    <title>Reporte de Artículos con Todos sus Costos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_tCostos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

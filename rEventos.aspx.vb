...
Partial Class rEventos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" WHERE     Cod_Eve	Between " & lcParametro0Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rEventos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrEventos.ReportSource = loObjetoReporte

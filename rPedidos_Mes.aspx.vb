...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rPedidos_Mes"
'-------------------------------------------------------------------------------------------'
Partial Class rPedidos_Mes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("from renglones_pedidos, pedidos, articulos, clientes, departamentos ")
            ...
            lcComandoSeleccionar.AppendLine("group by clientes.cod_cli, clientes.nom_cli ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rPedidos_Mes", laDatosReporte)
            ...
            Me.crvrPedidos_Mes.ReportSource = loObjetoReporte

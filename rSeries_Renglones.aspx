<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSeries_Renglones.aspx.vb" Inherits="rSeries_Renglones" %>
...
<head runat="server">
    <title>Reporte de Series con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSeries_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

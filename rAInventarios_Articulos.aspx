<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAInventarios_Articulos.aspx.vb" Inherits="rAInventarios_Articulos" %>
...
<head runat="server">
    <title>Reporte de Ajustes de Inventarios por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAInventarios_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

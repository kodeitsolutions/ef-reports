<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Articulo.aspx.vb" Inherits="rTotal_Casos_Articulo" %>
...
<head runat="server">
    <title>Total Casos por Artículo</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Articulo" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fRequisiciones_Proveedores_CCMV" CodeFile="fRequisiciones_Proveedores_CCMV.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones de Proveedores Inversiones La Primera</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRequisiciones_Proveedores_CCMV" runat="server" AutoDataBind="true"

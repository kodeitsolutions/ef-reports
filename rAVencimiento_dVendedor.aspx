<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAVencimiento_dVendedor.aspx.vb" Inherits="rAVencimiento_dVendedor" %>
...
<head runat="server">
    <title>Análisis del Vencimiento Detallado por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAVencimiento_dVendedor" runat="server" AutoDataBind="true"

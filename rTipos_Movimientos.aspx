<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Movimientos.aspx.vb" Inherits="rTipos_Movimientos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Movimientos Bancarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Movimientos" runat="server" AutoDataBind="true"

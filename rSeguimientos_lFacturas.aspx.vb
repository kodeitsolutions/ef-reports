...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rSeguimientos_lFacturas"
'-------------------------------------------------------------------------------------------'
Partial Class rSeguimientos_lFacturas 
	...
	Try
            ...
            loComandoSeleccionar.AppendLine("				THEN	Facturas.Nom_Cli					")
            ...
            loComandoSeleccionar.AppendLine("			Facturas.For_Env				AS For_Env, 	")
            loComandoSeleccionar.AppendLine("			Facturas.Tip_Env				AS Tip_Env, 	")
            loComandoSeleccionar.AppendLine("			Facturas.Dir_Ent				AS Dir_Ent, 	")
            loComandoSeleccionar.AppendLine("			CAST(Facturas.Tie_Log AS XML)	AS Tie_Log, 	")
            loComandoSeleccionar.AppendLine("			CAST(Facturas.Embalaje AS XML)	AS Embalaje,	")
            loComandoSeleccionar.AppendLine("			CAST(Facturas.Tra_Adi AS XML)	AS Tra_Adi, 	")
            loComandoSeleccionar.AppendLine("			CAST(Facturas.Seg_Log AS XML)	AS Seg_Log  	")
            ...
            loComandoSeleccionar.AppendLine("SELECT	#tmpFacturas.Documento								AS Documento,")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Fec_Ini								AS Fec_Ini,")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Fec_Fin								AS Fec_Fin,")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Cod_Cli								AS Cod_Cli,")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Nom_Cli								AS Nom_Cli,")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Status									AS Status,")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Mon_Net								AS Mon_Net, ")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.For_Env								AS For_Env, ")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Tip_Env								AS Tip_Env, ")
            loComandoSeleccionar.AppendLine("		#tmpFacturas.Dir_Ent								AS Dir_Ent,")
            ...
            loComandoSeleccionar.AppendLine("			PARTITION BY #tmpFacturas.Documento							")
            ...
            loComandoSeleccionar.AppendLine("		ON	Documentacion.Cod_Reg = #tmpFacturas.Documento")
            loComandoSeleccionar.AppendLine("		AND	Documentacion.Origen = 'FacturasVentas'")		   
            loComandoSeleccionar.AppendLine("ORDER BY	#tmpFacturas.Documento, Documentacion.Nom_Doc")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("-- *********************************************************")
            loComandoSeleccionar.AppendLine("-- Resto de las facturas (las que no tienen Detalle XML de Logística)")
            loComandoSeleccionar.AppendLine("-- *********************************************************")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(	Documento, Fec_Ini, Fec_Fin, Cod_Cli, Nom_Cli, Status,")
            ...
            loComandoSeleccionar.AppendLine("			#tmpFacturas.Dir_Ent						AS Dir_Ent")
            loComandoSeleccionar.AppendLine("FROM		#tmpFacturas")
            loComandoSeleccionar.AppendLine("WHERE NOT EXISTS(SELECT * FROM #tmpFinal WHERE #tmpFinal.Documento = #tmpFacturas.Documento)")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rSeguimientos_lFacturas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrSeguimientos_lFacturas.ReportSource =	 loObjetoReporte	

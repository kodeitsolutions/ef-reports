...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rImpuestos_Municipales_Secciones"
'-------------------------------------------------------------------------------------------'
Partial Class rImpuestos_Municipales_Secciones
   Inherits vis2Formularios.frmReporte
	...
	Try	
			...
			Dim loComandoSeleccionar As New StringBuilder() 	
				...
				loComandoSeleccionar.AppendLine(" SELECT	CAST(Secciones.imp_mun as XML) AS impuesto,")
				loComandoSeleccionar.AppendLine(" 			Secciones.Cod_Dep AS Cod_Dep,")
				loComandoSeleccionar.AppendLine(" 			Secciones.Cod_Sec AS Cod_Sec")
				loComandoSeleccionar.AppendLine(" INTO	#tmpImpuesto")
				loComandoSeleccionar.AppendLine(" FROM	Secciones ")
				loComandoSeleccionar.AppendLine("")
				
				loComandoSeleccionar.AppendLine(" SELECT	#tmpImpuesto.Cod_Dep,")
				loComandoSeleccionar.AppendLine("			#tmpImpuesto.Cod_Sec,")
				...
				loComandoSeleccionar.AppendLine(" ORDER BY Cod_Sec ASC")
				loComandoSeleccionar.AppendLine("")
				...
				loComandoSeleccionar.AppendLine(" GROUP BY #tmpTemporal1.cod_dep,#tmpTemporal1.cod_sec,#tmpTemporal1.codigo, #tmpTemporal1.nombre,#tmpTemporal1.impuesto,Impuestos_Municipales.Nom_Imp,Impuestos_Municipales.Por_Imp")
				loComandoSeleccionar.AppendLine("")
				...
				loComandoSeleccionar.AppendLine(" JOIN Secciones ON (Secciones.Cod_Sec = #tmpTemporal2.Cod_Sec And Secciones.Cod_Dep = Departamentos.Cod_Dep)")
			...
			End If
				...
				loComandoSeleccionar.AppendLine(" GROUP BY Facturas.Cod_Suc,Secciones.Cod_Dep,Departamentos.Nom_Dep,Secciones.Cod_Sec,Secciones.Nom_Sec,#tmpTemporal2.nombre,#tmpTemporal2.impuesto,#tmpTemporal2.Nom_Impuesto,#tmpTemporal2.Por_Imp")
				loComandoSeleccionar.AppendLine("")
			...
			End If
				...
				loComandoSeleccionar.AppendLine("		AND" & lcParametro14Hasta)
				loComandoSeleccionar.AppendLine(" GROUP BY devoluciones_clientes.Cod_Suc,Secciones.Cod_Dep,Departamentos.Nom_Dep,Secciones.Cod_Sec,Secciones.Nom_Sec,#tmpTemporal2.nombre,#tmpTemporal2.impuesto,#tmpTemporal2.Nom_Impuesto,#tmpTemporal2.Por_Imp")
				loComandoSeleccionar.AppendLine("")
				
				
				loComandoSeleccionar.AppendLine(" SELECT ")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Cod_Suc As Cod_Suc,")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Cod_Dep As Cod_Dep,")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Nom_Dep As Nom_Dep,")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Cod_Sec As Cod_Sec,")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Nom_Sec As Nom_Sec,")
				...
				loComandoSeleccionar.AppendLine("			AND #tmpDevoluciones.Cod_Sec = #tmpVentas.Cod_Sec")
				loComandoSeleccionar.AppendLine("			AND #tmpDevoluciones.Cod_Dep = #tmpVentas.Cod_Dep")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rImpuestos_Municipales_Secciones_Secciones", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
			            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrImpuestos_Municipales_Secciones.ReportSource = loObjetoReporte

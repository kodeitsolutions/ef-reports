<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Fechas_Ipos.aspx.vb" Inherits="rTVentas_Fechas_Ipos" %>
...
<head runat="server">
    <title>Reporte de Total de Ventas por Fechas iPos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Fechas_Ipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

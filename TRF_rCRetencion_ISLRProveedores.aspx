<%@ Page Language="VB" AutoEventWireup="false" Inherits="TRF_rCRetencion_ISLRProveedores" CodeFile="TRF_rCRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (TRF)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTRF_rCRetencion_ISLRProveedores" runat="server" AutoDataBind="true"

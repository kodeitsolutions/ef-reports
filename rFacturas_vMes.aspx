<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_vMes.aspx.vb" Inherits="rFacturas_vMes" %>
...
<head runat="server">
    <title>Reporte de Total Facturas por Vendedores Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_vMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProspectos.aspx.vb" Inherits="rProspectos" %>
...
<head runat="server">
    <title>Reporte de Prospectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProspectos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLocales.aspx.vb" Inherits="rLocales" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLocales" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

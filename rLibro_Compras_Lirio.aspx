<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras_Lirio.aspx.vb" Inherits="rLibro_Compras_Lirio" %>
...
<head runat="server">
    <title>Libro de Compras Lirio</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrLibro_Compras_Lirio" runat="server" AutoDataBind="true"

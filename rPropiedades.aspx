<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPropiedades.aspx.vb" Inherits="rPropiedades" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPropiedades" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_Numeros.aspx.vb" Inherits="rCotizaciones_Numeros" %>
...
<head runat="server">
    <title>Reporte de Cotizaciones por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

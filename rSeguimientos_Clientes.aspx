<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSeguimientos_Clientes.aspx.vb" Inherits="rSeguimientos_Clientes" %>
...
<head runat="server">
    <title>Reporte de Seguimientos de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSeguimientos_Clientes" runat="server" AutoDataBind="true"

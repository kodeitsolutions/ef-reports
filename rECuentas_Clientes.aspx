<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rECuentas_Clientes.aspx.vb" Inherits="rECuentas_Clientes" %>
...
<head runat="server">
    <title>Reporte de Estado de Cuentas de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrECuentas_Clientes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReportes_MasUsadosGlobalmente.aspx.vb" Inherits="rReportes_MasUsadosGlobalmente" %>
...
<head runat="server">
    <title>Listado de Reportes Mas Usados Globalmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReportes_MasUsadosGlobalmente" runat="server" AutoDataBind="true"

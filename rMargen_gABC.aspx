<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gABC.aspx.vb" Inherits="rMargen_gABC" %>
...
<head runat="server">
    <title>Margen de Ganancia por Clasificación ABC</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gABC" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fShipping_Order_LIRIO_EIP" CodeFile="fShipping_Order_LIRIO_EIP.aspx.vb" %>
...
<head runat="server">
    <title>Shipping Order (LIRIO/EverythingIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfShipping_Order_LIRIO_EIP" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rPrecios_Generica" CodeFile="rPrecios_Generica.aspx.vb"  %>
...
<head runat="server">
    <title>Lista de Precios por Genérica</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPrecios_Generica" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Personas.aspx.vb" Inherits="rTipos_Personas" %>
...
<head runat="server">
    <title>Reporte de Tipos de Personas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Personas" runat="server" AutoDataBind="true"

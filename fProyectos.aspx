<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fProyectos.aspx.vb" Inherits="fProyectos" %>
...
<head runat="server">
    <title>Formato de Proyectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfProyectos" runat="server" AutoDataBind="true"

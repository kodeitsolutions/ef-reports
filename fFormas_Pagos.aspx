<%@ page language="VB" autoeventwireup="false" inherits="fFormas_Pagos" CodeFile="fFormas_Pagos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Formas de Pagos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFormas_Pagos" runat="server" AutoDataBind="true"

...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Casos_Etapas"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Casos_Etapas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT       (CASE Casos.etapa")
            loConsulta.AppendLine("		            WHEN '' THEN '[SIN ETAPA]'")
            loConsulta.AppendLine("		            else Casos.etapa")
            loConsulta.AppendLine("             END) AS etapa,")
            ...
            loConsulta.AppendLine("GROUP BY    Casos.Etapa")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Casos_Etapas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Casos_Etapas.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' RJG: 08/05/15: Se ajustó el filtro de Revisión y se agregó un filtro de Tipo de Ejecutor. '

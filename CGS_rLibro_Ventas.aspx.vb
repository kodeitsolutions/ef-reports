...
Partial Class CGS_rLibro_Ventas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("                ELSE Clientes.Rif")
            ...
            loComandoSeleccionar.AppendLine("			  	THEN CAST(@lnCero AS DECIMAL(28,2))")
            loComandoSeleccionar.AppendLine("			  	ELSE (CASE WHEN Cuentas_Cobrar.Cod_Mon = 'VEB'")
            loComandoSeleccionar.AppendLine("			  			THEN (CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            ...
            'loComandoSeleccionar.AppendLine("          CASE WHEN Cuentas_Cobrar.Status = 'Anulado'")
            'loComandoSeleccionar.AppendLine("			     THEN CAST(@lnCero AS DECIMAL(28,2))")
            'loComandoSeleccionar.AppendLine("			     ELSE (Cuentas_Cobrar.Mon_Bru - Cuentas_Cobrar.Mon_Exe)")
            ...
            loComandoSeleccionar.AppendLine("			@lnCero                                             AS Base_Ret, ")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("   SELECT  CASE WHEN Facturas.Cod_Mon = 'VEB'")
            loComandoSeleccionar.AppendLine("                THEN 'ANUL'")
            loComandoSeleccionar.AppendLine("                ELSE 'EXPT'")
            loComandoSeleccionar.AppendLine("           END                                                 AS Tipo,")
            ...
            loComandoSeleccionar.AppendLine("           (CASE WHEN Facturas.Cod_Mon = 'VEB'")
            loComandoSeleccionar.AppendLine("                THEN Clientes.Rif")
            loComandoSeleccionar.AppendLine("                ELSE @lcVacio")
            loComandoSeleccionar.AppendLine("			END)											    AS Rif,")
            ...
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("                THEN (Cuentas_Cobrar.Mon_Bru/100000)")
            ...
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("                THEN (Cuentas_Cobrar.Mon_Exe/100000)")
            loComandoSeleccionar.AppendLine("                ELSE Cuentas_Cobrar.Mon_Exe")
            loComandoSeleccionar.AppendLine("           END 				                                AS Mon_Exe,")
            loComandoSeleccionar.AppendLine("   		Cuentas_Cobrar.Cod_Imp								AS Cod_Imp,")
            loComandoSeleccionar.AppendLine("   		Cuentas_Cobrar.Por_Imp1 							AS Por_Imp1,")
            ...
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("                THEN (Cuentas_Cobrar.Mon_Net/100000)*(-1)")
            loComandoSeleccionar.AppendLine("                ELSE Cuentas_Cobrar.Mon_Net*(-1)")
            loComandoSeleccionar.AppendLine("           END 				                                AS Mon_Net,")
            'loComandoSeleccionar.AppendLine("			(Cuentas_Cobrar.Mon_Bru - Cuentas_Cobrar.Mon_Exe)*(-1) AS Mon_Bru,")
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("                THEN ((Cuentas_Cobrar.Mon_Bru - Cuentas_Cobrar.Mon_Exe)/100000)*(-1)")
            loComandoSeleccionar.AppendLine("                ELSE (Cuentas_Cobrar.Mon_Bru - Cuentas_Cobrar.Mon_Exe)*(-1)")
            loComandoSeleccionar.AppendLine("           END 				                                AS Mon_Bru,")
            'loComandoSeleccionar.AppendLine("			Cuentas_Cobrar.Mon_Exe*(-1) 						AS Mon_Exe,")
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("                THEN (Cuentas_Cobrar.Mon_Exe/100000)*(-1)")
            loComandoSeleccionar.AppendLine("                ELSE Cuentas_Cobrar.Mon_Exe*(-1)")
            loComandoSeleccionar.AppendLine("           END 				                                AS Mon_Exe,")
            loComandoSeleccionar.AppendLine("   		Cuentas_Cobrar.Cod_Imp								AS Cod_Imp,")
            loComandoSeleccionar.AppendLine("   		Cuentas_Cobrar.Por_Imp1 							AS Por_Imp1,")
            'loComandoSeleccionar.AppendLine("   		Cuentas_Cobrar.Mon_Imp1*(-1) 						AS Mon_Imp1,")
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("                THEN (Cuentas_Cobrar.Mon_Imp1/100000)*(-1)")
            loComandoSeleccionar.AppendLine("                ELSE Cuentas_Cobrar.Mon_Imp1*(-1)")
            loComandoSeleccionar.AppendLine("           END 				                                AS Mon_Imp1,     ")
            loComandoSeleccionar.AppendLine("           @lcVacio                                            AS Com_Ret, ")
            loComandoSeleccionar.AppendLine("			Cuentas_Cobrar.Fec_Ini                              AS Fec_Ret, ")
            loComandoSeleccionar.AppendLine("			@lnCero                                             AS Base_Ret, ")
            ...
            loComandoSeleccionar.AppendLine("           CASE WHEN Cuentas_Cobrar.Referencia = ''")
            loComandoSeleccionar.AppendLine("                THEN Cuentas_Cobrar.Num_Com")
            loComandoSeleccionar.AppendLine("                ELSE Cuentas_Cobrar.Referencia")
            loComandoSeleccionar.AppendLine("   		END                                                 AS Com_Ret, ")
            ...
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini >= '20180801'")

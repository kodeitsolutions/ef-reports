...
Partial Class rTComprasProveedor_pAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine(" compras, renglones_compras, proveedores, articulos")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTComprasProveedor_pAñoMes", laDatosReporte)
            ...
            Me.crvrTComprasProveedor_pAñoMes.ReportSource = loObjetoReporte
...
'                AND		renglones_compras.cod_art	 =			articulos.cod_Art
'-------------------------------------------------------------------------------------------'
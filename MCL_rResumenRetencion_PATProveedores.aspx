<%@ page language="VB" autoeventwireup="false" inherits="MCL_rResumenRetencion_PATProveedores" 
CodeFile="MCL_rResumenRetencion_PATProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Retención de Patente Municipal de Proveedores (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMCL_rResumenRetencion_PATProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

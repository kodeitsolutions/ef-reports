<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEstatus_Documentos.aspx.vb" Inherits="rEstatus_Documentos" %>
...
<head runat="server">
    <title>Reporte de Estatus de Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEstatus_Documentos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

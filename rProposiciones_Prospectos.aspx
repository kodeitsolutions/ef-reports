<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProposiciones_Prospectos.aspx.vb" Inherits="rProposiciones_Prospectos" %>
...
<head runat="server">
    <title>Reporte de Proposiciones por Prospecto</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProposiciones_Prospectos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

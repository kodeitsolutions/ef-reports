<%@ page language="VB" autoeventwireup="false" inherits="CGS_fPedidosSP" CodeFile="CGS_fPedidosSP.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Pedido [SIN PRECIO] (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fPedidosSP" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="PAS_rRDetallada_ISLRRProveedoresXML" CodeFile="PAS_rRDetallada_ISLRRProveedoresXML.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Detallada de ISLR Retenido (PAS) XML</title>

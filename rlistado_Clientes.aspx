<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rlistado_Clientes.aspx.vb" Inherits="rlistado_Clientes" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrlistado_Clientes" runat="server" AutoDataBind="true"

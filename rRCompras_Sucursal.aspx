<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRCompras_Sucursal.aspx.vb" Inherits="rRCompras_Sucursal" %>
...
<head runat="server">
    <title>Reporte Resumen de Compras por Sucursal</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRCompras_Sucursal" runat="server" AutoDataBind="true"

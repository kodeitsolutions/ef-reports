<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPedidos_LIRIO" CodeFile="fPedidos_LIRIO.aspx.vb" %>
...
<head runat="server">
    <title>Purchase Order(LIRIO)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPedidos_LIRIO" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPacking_List_LIRIO" CodeFile="fPacking_List_LIRIO.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPacking_List_LIRIO" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rECuentas_Cajas.aspx.vb" Inherits="rECuentas_Cajas" %>
...
<head runat="server">
    <title>Reporte de Estado de Cuentas de Cajas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrECuentas_Cajas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProspectos_VendedorAtributo.aspx.vb" Inherits="rProspectos_VendedorAtributo" %>
...
<head runat="server">
    <title>Resumen de Prospectos por Vendedor y Atributo</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrProspectos_VendedorAtributo" runat="server" AutoDataBind="true"

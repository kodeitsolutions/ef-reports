<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rgUsuarios_Miembros.aspx.vb" Inherits="rgUsuarios_Miembros" %>
...
<head runat="server">
    <title>Reporte de Grupos de Usuarios con sus miembros</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrgUsuarios_Miembros" runat="server" AutoDataBind="true"

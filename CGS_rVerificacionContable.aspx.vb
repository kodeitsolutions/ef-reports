    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If lcParametro1Desde = "'Compras'" Then
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Articulos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Art = Renglones_Compras.Cod_Art)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Art,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Secciones.Contable AS XML) ")
                lcComandoSeleccionar.AppendLine("				FROM Articulos")
                ...
                lcComandoSeleccionar.AppendLine("					WHERE Cod_Art = Renglones_Compras.Cod_Art)")
                lcComandoSeleccionar.AppendLine("					    .value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Sec,")
                lcComandoSeleccionar.AppendLine("		SUBSTRING(Departamentos.Contable, 141,12)		AS CC_Dep,")
                lcComandoSeleccionar.AppendLine("		Renglones_Compras.Cod_Imp              	        AS Cod_Imp,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Impuestos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Imp = Renglones_Compras.Cod_Imp)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Imp,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Tipos_Proveedores.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Tipos_Proveedores ")
                lcComandoSeleccionar.AppendLine("					JOIN Proveedores ON Tipos_Proveedores.Cod_Tip = Proveedores.Cod_Tip")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Pro = Compras.Cod_Pro)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Pro,")
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Impuestos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Imp = Cuentas_Pagar.Cod_Imp)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Imp,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Tipos_Proveedores.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Tipos_Proveedores ")
                lcComandoSeleccionar.AppendLine("				    JOIN Proveedores ON Tipos_Proveedores.Cod_Tip = Proveedores.Cod_Tip")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Pro = Cuentas_Pagar.Cod_Pro)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Pro,")
                lcComandoSeleccionar.AppendLine("		Tipos_Proveedores.Cod_Tip                   	AS Tip_Pro,")
                lcComandoSeleccionar.AppendLine("		Cuentas_Pagar.Cod_Con							AS Cod_Con,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Conceptos.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Conceptos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Con = Cuentas_Pagar.Cod_Con)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Concepto")
                ...
                lcComandoSeleccionar.AppendLine("ORDER BY Cod_Art")
            End If
            ...
            If lcParametro1Desde = "'Ventas'" Then
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Articulos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Art = Renglones_Facturas.Cod_Art)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'') AS CC_Art,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Secciones.Contable AS XML) ")
                lcComandoSeleccionar.AppendLine("				FROM Articulos")
                lcComandoSeleccionar.AppendLine("					JOIN Departamentos ON Departamentos.Cod_Dep = Articulos.Cod_Dep")
                lcComandoSeleccionar.AppendLine("					JOIN Secciones ON Secciones.Cod_Sec = Articulos.Cod_Sec")
                lcComandoSeleccionar.AppendLine("						AND Secciones.Cod_Dep = Departamentos.Cod_Dep")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Art = Renglones_Facturas.Cod_Art)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'') AS CC_Sec,")
                lcComandoSeleccionar.AppendLine("		SUBSTRING(Departamentos.Contable, 141,12)		AS CC_Dep,")
                lcComandoSeleccionar.AppendLine("		Renglones_Facturas.Cod_Imp                   	        AS Cod_Imp,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Impuestos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Imp = Renglones_Facturas.Cod_Imp)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'') AS CC_Imp,")
                lcComandoSeleccionar.AppendLine("		Tipos_Clientes.Cod_Tip                   	    AS Tip_Cli,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Tipos_Clientes.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Tipos_Clientes ")
                lcComandoSeleccionar.AppendLine("					JOIN Clientes ON Tipos_Clientes.Cod_Tip = Clientes.Cod_Tip")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cli = Facturas.Cod_Cli)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Cli,")
                lcComandoSeleccionar.AppendLine("		'N/A'											AS Cod_Con,")
                lcComandoSeleccionar.AppendLine("		'N/A'											AS CC_Concepto")
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Impuestos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Imp = Cuentas_Cobrar.Cod_Imp)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'') AS CC_Imp,")
                lcComandoSeleccionar.AppendLine("		Tipos_Clientes.Cod_Tip                      AS Tip_Cli,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT CAST(Tipos_Clientes.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Tipos_Clientes ")
                lcComandoSeleccionar.AppendLine("				    JOIN Clientes ON Tipos_Clientes.Cod_Tip = Clientes.Cod_Tip")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cli = Cuentas_Cobrar.Cod_Cli)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Cli,")
                lcComandoSeleccionar.AppendLine("		Cuentas_Cobrar.Cod_Con						AS Cod_Con,")
                lcComandoSeleccionar.AppendLine("		COALESCE((SELECT CAST(Conceptos.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Conceptos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Con = Cuentas_Cobrar.Cod_Con)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),")
                lcComandoSeleccionar.AppendLine("				(SELECT CAST(Conceptos.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				FROM Conceptos ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Con = Cuentas_Cobrar.Cod_Con)")
                lcComandoSeleccionar.AppendLine("					.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Concepto")
                ...
                lcComandoSeleccionar.AppendLine("ORDER BY Cod_Con")
            End If

    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If lcParametro1Desde = "'Compras'" Then
                ...
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Art,")
                ...
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Sec,")
                ...
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Dep,")
                ...
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Imp,")
                ...
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Pro,")
                ...
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Concepto")
            ...
            If lcParametro1Desde = "'Ventas'" Then
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Articulos.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'')),'')								AS Nom_CC_Art,")
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Secciones.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'')),'')								AS Nom_CC_Sec,")
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Departamentos.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'')),'')								AS Nom_CC_Dep,")
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Impuestos.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[2]', 'varchar(12)'),'')),'')								AS Nom_CC_Imp,")
                ...
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')								AS Nom_CC_Cli,")
                lcComandoSeleccionar.AppendLine("		'N/A'										AS Cod_Con,")
                lcComandoSeleccionar.AppendLine("		'N/A'										AS CC_Concepto,")
                lcComandoSeleccionar.AppendLine("		''											AS Nom_CC_Concepto")
                ...
                lcComandoSeleccionar.AppendLine("				ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Conceptos.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),''),'')")
            ...
            If lcParametro1Desde = "'Pagos'" Then
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL(CAST(Cuentas_Bancarias.Contable AS XML).value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')	AS CC_Cuenta,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Cuentas_Bancarias.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Cuenta,")
                lcComandoSeleccionar.AppendLine("		Tipos_Proveedores.Cod_Tip                   AS Tip_Pro,")
                lcComandoSeleccionar.AppendLine("		ISNULL(CAST(Tipos_Proveedores.Contable AS XML).value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'') AS CC_Pro,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Tipos_Proveedores.Contable AS XML)")
                ...
                lcComandoSeleccionar.AppendLine("		ISNULL(CAST(Cajas.Contable AS XML).value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')				AS CC_Caja,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Cajas.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Caja")
                lcComandoSeleccionar.AppendLine("FROM Pagos")
                lcComandoSeleccionar.AppendLine("	JOIN Detalles_Pagos ON Pagos.Documento = Detalles_Pagos.Documento")
            ...
            If lcParametro1Desde = "'Cajas'" Then
                ...
                lcComandoSeleccionar.AppendLine("		Cajas.nom_caj			                 	AS Nom_Cue,")
                lcComandoSeleccionar.AppendLine("		ISNULL(CAST(Cajas.Contable AS XML).value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')	AS CC_Cuenta,")
                lcComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")
                lcComandoSeleccionar.AppendLine("				WHERE Cod_Cue = ISNULL(CAST(Cajas.Contable AS XML)")
                lcComandoSeleccionar.AppendLine("				.value('(/contable/ficha/cue_con)[1]', 'varchar(12)'),'')),'')									AS Nom_CC_Cuenta,")

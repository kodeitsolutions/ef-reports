<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rEGanancias_Perdidas_Mensual.aspx.vb" Inherits="KDE_rEGanancias_Perdidas_Mensual" %>
...
<head runat="server">
    <title>Estado de Ganancias y Pérdidas por Meses (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_rEGanancias_Perdidas_Mensual" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rCasos_Renglones_MONO.aspx.vb" Inherits="KDE_rCasos_Renglones_MONO" %>
...
<head runat="server">
    <title>Listado de Casos con sus Renglones reducido (KDE)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvKDE_rCasos_Renglones_MONO" runat="server" AutoDataBind="true"

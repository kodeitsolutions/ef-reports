<%@ Page Language="VB" AutoEventWireup="false" CodeFile="OnyxTD_rSeriales_Asignar.aspx.vb" Inherits="OnyxTD_rSeriales_Asignar" %>
...
<head runat="server">
    <title>Listado de Seriales por Asignar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvOnyxTD_rSeriales_Asignar" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

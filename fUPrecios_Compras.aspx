<%@ page language="VB" autoeventwireup="false" inherits="fUPrecios_Compras" CodeFile="fUPrecios_Compras.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfUPrecios_Compras" runat="server" AutoDataBind="true"

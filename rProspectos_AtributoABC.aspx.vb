...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rProspectos_AtributoABC"
'-------------------------------------------------------------------------------------------'
Partial Class rProspectos_AtributoABC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT      " & lcNombreCampo & "                                                   AS Campo_Atributo,")
            ...
            loConsulta.AppendLine("            SUM( SUM(1) ) OVER()                                                    AS Total_Atributo,")
            ...
            loConsulta.AppendLine("GROUP BY     Prospectos." & lcCampoAtributo)
            loConsulta.AppendLine("ORDER BY     Prospectos." & lcCampoAtributo)
            loConsulta.AppendLine("")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rProspectos_AtributoABC", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrProspectos_AtributoABC.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fRVentas_CBancariasHoyAdministrativo.aspx.vb" Inherits="fRVentas_CBancariasHoyAdministrativo" %>
...
<head runat="server">
    <title>Formato de Ventas y Conciliacion de Caja de Hoy</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRVentas_CBancariasHoyAdministrativo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

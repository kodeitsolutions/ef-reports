<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_cMes.aspx.vb" Inherits="rCotizaciones_cMes" %>
...
<head runat="server">
    <title>Reporte de Total Cotizaciones por Clientes Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_cMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

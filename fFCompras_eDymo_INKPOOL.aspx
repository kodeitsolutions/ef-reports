<%@ page language="VB" autoeventwireup="false" inherits="fFCompras_eDymo_INKPOOL" CodeFile="fFCompras_eDymo_INKPOOL.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Facturas de Compras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFCompras_eDymo_INKPOOL" runat="server" AutoDataBind="true"

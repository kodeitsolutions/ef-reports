<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_IHC" CodeFile="fCotizaciones_IHC.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_IHC" runat="server" AutoDataBind="true"

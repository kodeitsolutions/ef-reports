<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_IVAClientes" 
CodeFile="rCRetencion_IVAClientes.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de IVA de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_IVAClientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

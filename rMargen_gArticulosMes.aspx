<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gArticulosMes.aspx.vb" Inherits="rMargen_gArticulosMes" %>
...
<head runat="server">
    <title>Margen de Ganancia por Artículos y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gArticulosMes" runat="server" AutoDataBind="true"

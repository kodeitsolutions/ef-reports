<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCAsistencia_Fecha.aspx.vb" Inherits="rCAsistencia_Fecha" %>
...
<head runat="server">
    <title>Control de Asistencia por Fecha</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCAsistencia_Fecha" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

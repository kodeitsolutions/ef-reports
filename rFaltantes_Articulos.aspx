<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFaltantes_Articulos.aspx.vb" Inherits="rFaltantes_Articulos" %>
...
<head runat="server">
    <title>Reporte de Faltantes por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFaltantes_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rROperaciones_Usuarios.aspx.vb" Inherits="rROperaciones_Usuarios" %>
...
<head runat="server">
    <title>Reporte de Resumen de Operaciones de Usuarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrROperaciones_Usuarios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

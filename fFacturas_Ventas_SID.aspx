<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_SID" CodeFile="fFacturas_Ventas_SID.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Factura SID</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_SID" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" CodeFile="rMInventarios_Articulos.aspx.vb" inherits="rMInventarios_Articulos" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Inventarios por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMInventarios_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

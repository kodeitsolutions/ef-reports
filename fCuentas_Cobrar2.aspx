<%@ page language="VB" autoeventwireup="false" inherits="fCuentas_Cobrar2" CodeFile="fCuentas_Cobrar2.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Correspondencia</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Cobrar2" runat="server" AutoDataBind="true"

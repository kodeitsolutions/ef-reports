<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMovimientosCajas_tTipos.aspx.vb" Inherits="rMovimientosCajas_tTipos" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Cajas Totalizados por Tipos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMovimientosCajas_tTipos" runat="server" AutoDataBind="true"

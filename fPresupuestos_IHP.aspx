<%@ page language="VB" autoeventwireup="false" inherits="fPresupuestos_IHP" CodeFile="fPresupuestos_IHP.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Presupuestos In Hand Provider</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPresupuestos_IHP" runat="server" AutoDataBind="true"

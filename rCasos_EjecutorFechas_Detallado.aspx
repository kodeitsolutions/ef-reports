<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCasos_EjecutorFechas_Detallado.aspx.vb" Inherits="rCasos_EjecutorFechas_Detallado" %>
...
<head runat="server">
    <title>Casos por Ejecutor y Fecha Detallado</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCasos_EjecutorFechas_Detallado" runat="server" AutoDataBind="true"

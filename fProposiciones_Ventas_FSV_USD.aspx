<%@ page language="VB" autoeventwireup="false" inherits="fProposiciones_Ventas_FSV_USD" CodeFile="fProposiciones_Ventas_FSV_USD.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Proposicion FSV (USD) </title>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="crvfProposiciones_Ventas_FSV_USD" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gClientes.aspx.vb" Inherits="rMargen_gClientes" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gClientes" runat="server" AutoDataBind="true"

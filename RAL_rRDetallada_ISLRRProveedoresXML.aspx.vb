...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "RAL_rRDetallada_ISLRRProveedoresXML"
'-------------------------------------------------------------------------------------------'
Partial Class RAL_rRDetallada_ISLRRProveedoresXML
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine(" JOIN Nominas ON Recibos.Doc_Ori = Nominas.Documento")
            loConsulta.AppendLine("WHERE Nominas.Fec_Ini BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            ...
            Me.Response.AppendHeader("content-disposition", "attachment; filename=RelacionRetencionesISLR_RAL_" & lcPeriodo & ".xml")

<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Compras_Ingles" CodeFile="fOrdenes_Compras_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras (USA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Compras_Ingles" runat="server" AutoDataBind="true"

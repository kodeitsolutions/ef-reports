<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rCompras_Articulos.aspx.vb" Inherits="TRF_rCompras_Articulos" %>
...
<head runat="server">
    <title>Reporte de Compras por Artículos (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rCompras_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

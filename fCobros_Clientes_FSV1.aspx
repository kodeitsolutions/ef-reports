<%@ page language="VB" autoeventwireup="false" inherits="fCobros_Clientes_FSV1" CodeFile="fCobros_Clientes_FSV1.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCobros_Clientes_FSV1" runat="server" AutoDataBind="true"

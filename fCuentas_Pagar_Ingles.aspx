<%@ page language="VB" autoeventwireup="false" CodeFile="fCuentas_Pagar_Ingles.aspx.vb" inherits="fCuentas_Pagar_Ingles" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Pagar_Ingles" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores_CCSJ" CodeFile="rCRetencion_ISLRProveedores_CCSJ.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCRetencion_ISLRProveedores_CCSJ" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

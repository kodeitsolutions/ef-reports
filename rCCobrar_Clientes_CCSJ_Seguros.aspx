<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Clientes_CCSJ_Seguros.aspx.vb" Inherits="rCCobrar_Clientes_CCSJ_Seguros" %>
...
<head runat="server">
    <title>* Estado de Cuenta de Clientes (CCSJ P/Seguros)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Clientes_CCSJ_Seguros" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCPagar_Giros" CodeFile="fCPagar_Giros.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCPagar_Giros" runat="server" AutoDataBind="true"

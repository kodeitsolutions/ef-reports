<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Ventas_Amazon" CodeFile="fFacturas_Ventas_Amazon.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Amazon" runat="server" AutoDataBind="true"

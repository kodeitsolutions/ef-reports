<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNentregas_Clientes.aspx.vb" Inherits="rNentregas_Clientes" %>
...
<head runat="server">
    <title>Reporte de las Notas de Entregas por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNentregas_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class TRF_rLEstadoCuenta_HistoricoCompras
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		A.Fec_Ini, A.Registro, A.Referencia, A.Sal_Ini, A.Mon_Deb, A.Mon_Hab,")
            loComandoSeleccionar.AppendLine("		SUM(B.Mon_Sal) +  A.Sal_Ini AS Sal_Doc, @sp_FecIni AS Desde, @sp_FecFin	AS Hasta,")
            loComandoSeleccionar.AppendLine("       ISNULL((SELECT Pendientes FROM #tmpMovPendientes WHERE Cod_Pro = A.Cod_Pro),0) AS Pendientes")
            ...
            If (laDatosReporte.Tables(0).Rows.Count <= 0) Then
                ...
                loComandoSeleccionar1.AppendLine("INTO #tmpMovPendientes")
                loComandoSeleccionar1.AppendLine("FROM Cuentas_Pagar")
                ...
                loComandoSeleccionar1.AppendLine("       ISNULL((SELECT Pendientes FROM #tmpMovPendientes WHERE Cod_Pro = #tmpSaldos_Iniciales.Cod_Pro),0) AS Pendientes")

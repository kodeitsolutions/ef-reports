<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditor_Facturas_Fechas_CCSJ.aspx.vb"
    Inherits="rAuditor_Facturas_Fechas_CCSJ" %>
...
<head runat="server">
    <title>Reporte de Facturas por Fechas (CCSJ)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrAuditor_Facturas_Fechas_CCSJ" runat="server" AutoDataBind="true"

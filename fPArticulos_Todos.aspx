<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fPArticulos_Todos.aspx.vb" Inherits="fPArticulos_Todos" %>
...
<head runat="server">
    <title>Lista de Precios (Todos los Artículos)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPArticulos_Todos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

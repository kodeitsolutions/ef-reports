<%@ Page Language="VB" AutoEventWireup="false" Inherits="TRF_rRecibo_Pago_BonoA" CodeFile="TRF_rRecibo_Pago_BonoA.aspx.vb" %>
...
<head runat="server">
	<title>Recibo de Pago de Cestaticket Socialista (TRF)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvTRF_rRecibo_Pago_BonoA" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

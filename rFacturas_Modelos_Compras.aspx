<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Modelos_Compras.aspx.vb"  Inherits="rFacturas_Modelos_Compras" %>
...
<head runat="server">
    <title>Reporte de Facturas por Modelos de Compras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Modelos_Compras" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

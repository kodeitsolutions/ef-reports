<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCentros_Costos.aspx.vb" Inherits="rCentros_Costos" %>
...
<head runat="server">
    <title>Reporte de Listado de Centros de Costos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCentros_Costos" runat="server" AutoDataBind="true"

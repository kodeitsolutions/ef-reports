<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rResumenInce_Trabajador.aspx.vb" Inherits="TRF_rResumenInce_Trabajador" %>
...
<head runat="server">
	<title>Resumen de Pago de INCE por Trabajador (TRF)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvTRF_rResumenInce_Trabajador" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False"  HasPrintButton="False" />

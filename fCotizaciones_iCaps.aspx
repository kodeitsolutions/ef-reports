<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_iCaps" CodeFile="fCotizaciones_iCaps.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cotizaciones iCaps</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_iCaps" runat="server" AutoDataBind="true"

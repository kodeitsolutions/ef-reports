<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConceptos_Retenciones.aspx.vb" Inherits="rConceptos_Retenciones" %>
...
<head runat="server">
    <title>Reporte de Conceptos de Retenciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrConceptos_Retenciones" runat="server" AutoDataBind="true"

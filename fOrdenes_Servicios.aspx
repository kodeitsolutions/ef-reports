<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Servicios" CodeFile="fOrdenes_Servicios.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Servicio</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Servicios" runat="server" AutoDataBind="true"

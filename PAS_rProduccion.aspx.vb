...
Partial Class PAS_rProduccion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("		AND Longitud.Res_Num > 0")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("PAS_rProduccion", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvPAS_rProduccion.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fFicha_DatosProspectos" CodeFile="fFicha_DatosProspectos.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Prospectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_DatosProspectos" runat="server" AutoDataBind="true"

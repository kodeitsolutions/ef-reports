<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReportes_MOpcion.aspx.vb" Inherits="rReportes_MOpcion" %>
...
<head runat="server">
    <title>Listado de Reportes por Módulo y Opción</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReportes_MOpcion" runat="server" AutoDataBind="true"

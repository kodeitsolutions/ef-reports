<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDetalle_Condominio001_CCMV_3_2014.aspx.vb" Inherits="rDetalle_Condominio001_CCMV_3_2014" %>
...
<head runat="server">
	<title>Aviso de Cobro Arrendatarios sin Reserva</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrDetalle_Condominio001_CCMV_3_2014" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

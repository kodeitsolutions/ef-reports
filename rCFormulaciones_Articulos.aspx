<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCFormulaciones_Articulos.aspx.vb" Inherits="rCFormulaciones_Articulos" %>
...
<head runat="server">
    <title>Reporte de Control de Formulaciones por Articulos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCFormulaciones_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

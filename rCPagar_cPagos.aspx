<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_cPagos.aspx.vb" Inherits="rCPagar_cPagos" %>
...
<head runat="server">
    <title>Listado de Documentos de Cuentas por Pagar con sus Pagos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_cPagos" runat="server" AutoDataBind="true"

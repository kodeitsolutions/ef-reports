<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Personas" CodeFile="fTipos_Personas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Personas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Personas" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fAjustes_EntradaSalida_Imagenes" CodeFile="fAjustes_EntradaSalida_Imagenes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ajustes de Entrada y Salida con Imágenes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAjustes_EntradaSalida_Imagenes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CSJ_rFacturas_Entregadas.aspx.vb" Inherits="CSJ_rFacturas_Entregadas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_rFacturas_Entregadas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fArticulos_Imagenes" CodeFile="fArticulos_Imagenes.aspx.vb" %>
...
<head runat="server">
    <title>Catalogo de Imágenes de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfArticulos_Imagenes" runat="server" AutoDataBind="true"

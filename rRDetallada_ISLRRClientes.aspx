<%@ page language="VB" autoeventwireup="false" inherits="rRDetallada_ISLRRClientes" CodeFile="rRDetallada_ISLRRClientes.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Detallada de de ISLR Retenido a Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrRDetallada_ISLRRClientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

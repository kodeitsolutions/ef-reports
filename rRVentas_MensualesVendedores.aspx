<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_MensualesVendedores.aspx.vb" Inherits="rRVentas_MensualesVendedores" %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas Mensuales por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_MensualesVendedores" runat="server" AutoDataBind="true"

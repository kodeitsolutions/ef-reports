<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Compuredes" CodeFile="fFacturas_Compuredes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Compuredes" runat="server" AutoDataBind="true"

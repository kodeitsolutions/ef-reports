<%@ page language="VB" autoeventwireup="false" inherits="fCCobrar_Giros" CodeFile="fCCobrar_Giros.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCCobrar_Giros" runat="server" AutoDataBind="true"

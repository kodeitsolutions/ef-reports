<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_ValorAlmacen" CodeFile="rArticulos_ValorAlmacen.aspx.vb"  %>
...
<head runat="server">
    <title>Valor Actual del Inventario por Almacén</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_ValorAlmacen" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

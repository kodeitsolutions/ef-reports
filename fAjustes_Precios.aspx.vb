Imports System.Data
Partial Class fAjustes_Precios
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           CONVERT(NCHAR(10), Ajustes_Precios.Fec_Ini, 103)    AS  Fec_Ini, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fAjustes_Precios", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfAjustes_Precios.ReportSource = loObjetoReporte

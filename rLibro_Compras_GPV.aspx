<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras_GPV.aspx.vb"
    Inherits="rLibro_Compras_GPV" %>
...
<head runat="server">
    <title>Libro de Compras GPV</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrLibro_Compras_GPV" runat="server" AutoDataBind="true"

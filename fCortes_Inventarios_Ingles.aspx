<%@ page language="VB" autoeventwireup="false" CodeFile="fCortes_Inventarios_Ingles.aspx.vb" inherits="fCortes_Inventarios_Ingles" %>
...
<head runat="server">
    <title>Formato de Cortes de Inventarios en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCortes_Inventarios_Ingles" runat="server" AutoDataBind="true"

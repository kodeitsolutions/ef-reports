<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Articulos.aspx.vb" Inherits="rCCobrar_Articulos" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Cobrar con Renglones por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

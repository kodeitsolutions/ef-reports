...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFacturas_Clinicas_CCSJ"
'-------------------------------------------------------------------------------------------'
Partial Class fFacturas_Clinicas_CCSJ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("                            Fecha_Ingreso           DATETIME,")
            loConsulta.AppendLine("                            Fecha_Egreso            DATETIME,")
            loConsulta.AppendLine("                            Clave_Seguro            VARCHAR(100) COLLATE DATABASE_DEFAULT")
            loConsulta.AppendLine("                            );")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("")
            ...
            loConsulta.AppendLine("")
            loConsulta.AppendLine("-- ******************************************************************************************")
            loConsulta.AppendLine("-- Datos de admisión (tomados de las propiedades del pedido de origen).                     *")
            loConsulta.AppendLine("-- ******************************************************************************************")
            loConsulta.AppendLine("DECLARE @ldFechaIngreso DATETIME;")
            loConsulta.AppendLine("DECLARE @ldFechaEgreso DATETIME;")
            loConsulta.AppendLine("DECLARE @lcClaveSeguro VARCHAR(100);")
            loConsulta.AppendLine("DECLARE @lnDiasHospitalizacion DECIMAL(28, 10);")
            loConsulta.AppendLine("DECLARE @lnHorasAproximadas DECIMAL(28, 10);")
            loConsulta.AppendLine("DECLARE @lcPedidoOrigen CHAR(10);")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("SET @lcPedidoOrigen = (SELECT TOP 1 R.Doc_Ori ")
            loConsulta.AppendLine("                       FROM Renglones_Facturas As R")
            loConsulta.AppendLine("                       WHERE Documento = @lcDocumento")
            loConsulta.AppendLine("                        AND  Tip_Ori = 'Pedidos')")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("IF (EXISTS(SELECT * FROM Pedidos WHERE Documento = @lcPedidoOrigen))")
            loConsulta.AppendLine("BEGIN")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("    SET @ldFechaIngreso = (SELECT Val_fec")
            loConsulta.AppendLine("                           FROM campos_propiedades CP")
            loConsulta.AppendLine("                           WHERE CP.Origen='Pedidos'")
            loConsulta.AppendLine("                           AND CP.Cod_Reg=@lcPedidoOrigen")
            loConsulta.AppendLine("                           AND CP.Cod_Pro='100-01-001'")
            loConsulta.AppendLine("                           AND CP.Val_fec>'19000101');")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("    SET @ldFechaEgreso = (SELECT Val_fec")
            loConsulta.AppendLine("                           FROM campos_propiedades CP")
            loConsulta.AppendLine("                           WHERE CP.Origen='Pedidos'")
            loConsulta.AppendLine("                           AND CP.Cod_Reg=@lcPedidoOrigen")
            loConsulta.AppendLine("                           AND CP.Cod_Pro='100-01-002'")
            loConsulta.AppendLine("                           AND CP.Val_fec>'19000101');")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("    SET @lcClaveSeguro = (SELECT Val_car")
            loConsulta.AppendLine("                           FROM campos_propiedades CP")
            loConsulta.AppendLine("                           WHERE CP.Origen='Pedidos'")
            loConsulta.AppendLine("                           AND CP.Cod_Reg=@lcPedidoOrigen")
            loConsulta.AppendLine("                           AND CP.Cod_Pro='400-01-002');")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("    SELECT @lnDiasHospitalizacion = Numerico1,")
            loConsulta.AppendLine("           @lnHorasAproximadas = Numerico2")
            loConsulta.AppendLine("    FROM   Pedidos ")
            loConsulta.AppendLine("    WHERE  Documento = @lcPedidoOrigen")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("    UPDATE #tmpFactura")
            loConsulta.AppendLine("    SET Fecha_Ingreso = @ldFechaIngreso,")
            loConsulta.AppendLine("        Fecha_Egreso = @ldFechaEgreso,")
            loConsulta.AppendLine("        Clave_Seguro = @lcClaveSeguro,")
            loConsulta.AppendLine("        Dias_Hospitalizacion = DATEDIFF(DAY, @ldFechaIngreso, @ldFechaEgreso),")
            loConsulta.AppendLine("        Horas_Aproximadas = @lnHorasAproximadas")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("    ")
            loConsulta.AppendLine("END;")
            loConsulta.AppendLine("")
            ...
            loConsulta.AppendLine("        Fecha_Ingreso, Fecha_Egreso, Clave_Seguro")
            loConsulta.AppendLine("FROM    #tmpFactura")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFacturas_Clinicas_CCSJ", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfFacturas_Clinicas_CCSJ.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' YJC: 10/03/14: Ajustes al formato en el nombre.                                           '
'-------------------------------------------------------------------------------------------'
...
'-------------------------------------------------------------------------------------------'
' RJG: 07/04/14: Se añadieron las CI/RIF del paciente, representante y seguro.              '
'-------------------------------------------------------------------------------------------'

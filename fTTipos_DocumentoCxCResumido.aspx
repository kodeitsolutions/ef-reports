<%@ page language="VB" autoeventwireup="false" inherits="fTTipos_DocumentoCxCResumido" CodeFile="fTTipos_DocumentoCxCResumido.aspx.vb" %>
...
<head runat="server">
    <title>Total Documentos por Tipo de Documento Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTTipos_DocumentoCxCResumido" runat="server" AutoDataBind="true"

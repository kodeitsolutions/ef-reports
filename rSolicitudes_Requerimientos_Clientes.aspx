<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSolicitudes_Requerimientos_Clientes.aspx.vb" Inherits="rSolicitudes_Requerimientos_Clientes" %>
...
<head runat="server">
    <title>Reporte de Solicitudes y Requerimientos por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSolicitudes_Requerimientos_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDepartamentos.aspx.vb" Inherits="rDepartamentos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDepartamentos" runat="server" AutoDataBind="true"

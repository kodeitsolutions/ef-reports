<%@ page language="VB" autoeventwireup="false" inherits="fRequisiciones_Internas" CodeFile="fRequisiciones_Internas.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones Internas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRequisiciones_Internas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gTipo_Precio.aspx.vb" Inherits="rMargen_gTipo_Precio" %>
...
<head runat="server">
    <title>Margen de Ganancia por Tipo de Precio</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gTipo_Precio" runat="server" AutoDataBind="true"

...
Partial Class CGS_fOrdenes_ComprasSP_AUTO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("CGS_fOrdenes_ComprasSP_AUTO", laDatosReporte)

        Me.mTraducirReporte(loObjetoReporte)

        Me.mFormatearCamposReporte(loObjetoReporte)

        Me.crvCGS_fOrdenes_ComprasSP_AUTO.ReportSource = loObjetoReporte

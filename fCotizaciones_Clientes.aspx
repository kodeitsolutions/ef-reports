<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Clientes" CodeFile="fCotizaciones_Clientes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Clientes" runat="server" AutoDataBind="true"

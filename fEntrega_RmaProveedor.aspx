<%@ page language="VB" autoeventwireup="false" inherits="fEntrega_RmaProveedor" CodeFile="fEntrega_RmaProveedor.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Entrega de RMA a Proveedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEntrega_RmaProveedor" runat="server" AutoDataBind="true"

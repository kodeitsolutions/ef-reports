<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProspectos_Contactos.aspx.vb" Inherits="rProspectos_Contactos" %>
...
<head runat="server">
    <title>Reporte de Prospectos con sus Contactos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProspectos_Contactos" runat="server" AutoDataBind="true"

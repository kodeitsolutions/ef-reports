<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAPrecios_Articulos.aspx.vb" Inherits="rAPrecios_Articulos" %>
...
<head runat="server">
    <title>Listado de Ajustes de Precios por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAPrecios_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

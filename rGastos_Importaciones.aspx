<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGastos_Importaciones.aspx.vb" Inherits="rGastos_Importaciones" %>
...
<head runat="server">
    <title>Reporte de Listado de Gastos de Importaciones </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGastos_Importaciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

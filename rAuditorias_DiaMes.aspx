<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_DiaMes.aspx.vb" Inherits="rAuditorias_DiaMes" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Día del Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_DiaMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

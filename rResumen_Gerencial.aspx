<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumen_Gerencial.aspx.vb" Inherits="rResumen_Gerencial" %>
...
<head runat="server">
    <title>Resumen Gerencial (MHL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrResumen_Gerencial" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

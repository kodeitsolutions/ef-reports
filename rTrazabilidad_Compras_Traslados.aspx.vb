...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTrazabilidad_Compras_Traslados"
'-------------------------------------------------------------------------------------------'
Partial Class rTrazabilidad_Compras_Traslados 
	...
	Try
            ...
            loConsulta.AppendLine("INSERT INTO #tmpOperaciones( Fecha, Articulo_Codigo, Articulo_Nombre,")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rTrazabilidad_Compras_Traslados", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTrazabilidad_Compras_Traslados.ReportSource = loObjetoReporte	

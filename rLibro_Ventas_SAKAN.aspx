<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Ventas_SAKAN.aspx.vb"
    Inherits="rLibro_Ventas_SAKAN" %>
...
<head runat="server">
    <title>Libro de Ventas SAKAN</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrrLibro_Ventas_SAKAN" runat="server" AutoDataBind="true"

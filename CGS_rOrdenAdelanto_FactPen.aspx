<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rOrdenAdelanto_FactPen.aspx.vb" Inherits="CGS_rOrdenAdelanto_FactPen" %>
...
<head runat="server">
    <title>Listado de ODC y facturas con sus documentos vinculados (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOrdenAdelanto_FactPen" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProspectos_PaisAtributo.aspx.vb" Inherits="rProspectos_PaisAtributo" %>
...
<head runat="server">
    <title>Resumen de Prospectos por País y Atributo</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrProspectos_PaisAtributo" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEfectividad_Pagos.aspx.vb" Inherits="rEfectividad_Pagos" %>
...
<head runat="server">
    <title>Efectividad de Pagos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEfectividad_Pagos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_Compras" CodeFile="CGS_fOrdenes_Compras.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras (Cegasa)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOrdenes_Compras" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVentas_aArticuloClientesMensual_SLFR.aspx.vb" Inherits="rVentas_aArticuloClientesMensual_SLFR" %>
...
<head runat="server">
    <title>Reporte de Ventas Agrupadas por Artículo y Cliente Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVentas_aArticuloClientesMensual_SLFR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Ano.aspx.vb" Inherits="rTotal_Casos_Ano" %>
...
<head runat="server">
    <title>Total Casos por Año</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Ano" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="PAS_fRequisiciones_Internas" CodeFile="PAS_fRequisiciones_Internas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Requisiciones Internas (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fRequisiciones_Internas" runat="server" AutoDataBind="true"

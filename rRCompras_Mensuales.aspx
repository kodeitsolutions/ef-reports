<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRCompras_Mensuales.aspx.vb" Inherits="rRCompras_Mensuales" %>
...
<head runat="server">
    <title>Reporte de Resumen de Compras Mensuales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRCompras_Mensuales" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTiempos_Documentos.aspx.vb" Inherits="rTiempos_Documentos" %>
...
<head runat="server">
    <title>Reporte de Tiempos de Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTiempos_Documentos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fCBancarias_ConCC"
'-------------------------------------------------------------------------------------------'
Partial Class fCBancarias_ConCC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT  Cod_Cue, ")
            loConsulta.AppendLine("        Nom_Cue,")
            ...
            loConsulta.AppendLine("FROM    Cuentas_Bancarias")
            loConsulta.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCBancarias_ConCC", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfCBancarias_ConCC.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRDetallada_ISLRRProveedores"
'-------------------------------------------------------------------------------------------'
Partial Class rRDetallada_ISLRRProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("				ISNULL(Detalles_Pagos.Tip_Ope, '-')		AS Tipo_Pago,							")
            loComandoSeleccionar.AppendLine("				CASE WHEN ISNULL(Detalles_Pagos.Tip_Ope, '-')='Efectivo'						")
            loComandoSeleccionar.AppendLine("					THEN 'Efectivo'																")
            loComandoSeleccionar.AppendLine("					ELSE ISNULL(Detalles_Pagos.Num_Doc,'-')										")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRDetallada_ISLRRProveedores", laDatosReporte)

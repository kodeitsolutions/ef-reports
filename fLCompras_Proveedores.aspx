<%@ page language="VB" autoeventwireup="false" inherits="fLCompras_Proveedores" CodeFile="fLCompras_Proveedores.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Formas Libres de Compra</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfLCompras_Proveedores" runat="server" AutoDataBind="true"

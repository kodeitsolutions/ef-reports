<%@ page language="VB" autoeventwireup="false" inherits="rFacturas_Ventas_Russo" CodeFile="rFacturas_Ventas_Russo.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Ventas_Russo" runat="server" AutoDataBind="true"

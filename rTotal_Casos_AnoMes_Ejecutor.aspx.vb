...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Casos_AnoMes_Ejecutor"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Casos_AnoMes_Ejecutor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("ORDER BY    Ejecutores.Cod_Ven," & lcOrdenamiento)
            loConsulta.AppendLine("            ")
            loConsulta.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Casos_AnoMes_Ejecutor", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Casos_AnoMes_Ejecutor.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rVentas_Conceptos.aspx.vb" Inherits="CGS_rVentas_Conceptos" %>
...
<head runat="server">
    <title>Listado de Ventas por Conceptos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rVentas_Conceptos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_cVendedores.aspx.vb" Inherits="rClientes_cVendedores" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_cVendedores" runat="server" AutoDataBind="true"

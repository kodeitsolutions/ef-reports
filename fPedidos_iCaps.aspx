<%@ page language="VB" Debug="true" autoeventwireup="false" inherits="fPedidos_iCaps" CodeFile="fPedidos_iCaps.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Pedidos iCaps</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPedidos_Clientes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="MHL_fCotizaciones_Clientes_SinNota"
    CodeFile="MHL_fCotizaciones_Clientes_SinNota.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cotizaciones de Clientes Sin Nota (MHL)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvMHL_fCotizaciones_Clientes_SinNota" runat="server"
                AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False"
                HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

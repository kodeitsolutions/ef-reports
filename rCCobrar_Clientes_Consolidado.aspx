<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Clientes_Consolidado.aspx.vb" Inherits="rCCobrar_Clientes_Consolidado" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Cobrar por Clientes (USA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Clientes" runat="server" AutoDataBind="true"

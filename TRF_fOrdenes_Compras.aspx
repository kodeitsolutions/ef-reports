<%@ page language="VB" autoeventwireup="false" inherits="TRF_fOrdenes_Compras" CodeFile="TRF_fOrdenes_Compras.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_fOrdenes_Compras" runat="server" AutoDataBind="true"

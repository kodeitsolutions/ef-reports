<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Año.aspx.vb" Inherits="rAuditorias_Año" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Año</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Año" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

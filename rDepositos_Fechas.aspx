<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDepositos_Fechas.aspx.vb" Inherits="rDepositos_Fechas" %>
...
<head runat="server">
    <title>Reporte de Depósitos Bancarios por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDepositos_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

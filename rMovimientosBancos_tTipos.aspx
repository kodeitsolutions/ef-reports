<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMovimientosBancos_tTipos.aspx.vb" Inherits="rMovimientosBancos_tTipos" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Cuentas Totalizados por Tipo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMovimientosBancos_tTipos" runat="server" AutoDataBind="true"

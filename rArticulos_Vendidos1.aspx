<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_Vendidos1.aspx.vb" Inherits="rArticulos_Vendidos1" %>
...
<head runat="server">
    <title>Reporte de Artículos más Vendidos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Vendidos1" runat="server" AutoDataBind="true"

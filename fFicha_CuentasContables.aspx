<%@ page language="VB" autoeventwireup="false" inherits="fFicha_CuentasContables" CodeFile="fFicha_CuentasContables.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Cuentas Contables </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_CuentasContables" runat="server" AutoDataBind="true"

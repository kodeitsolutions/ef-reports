<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_Proveedores.aspx.vb" Inherits="rOPagos_Proveedores" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_Proveedores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras_Venezuela.aspx.vb" Inherits="rLibro_Compras_Venezuela" %>
...
<head runat="server">
    <title>Libro de Compras 2013</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrLibro_Compras_Venezuela" runat="server" AutoDataBind="true"

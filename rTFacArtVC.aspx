<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTFacArtVC.aspx.vb" Inherits="rTFacArtVC" %>
...
<head runat="server">
    <title>Total de Facturas de Artículos por Vendedor por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTFacArtVC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

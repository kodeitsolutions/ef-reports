<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gNivelRotacion.aspx.vb" Inherits="rMargen_gNivelRotacion" %>
...
<head runat="server">
    <title>Margen de Ganancia por Nivel de Rotación</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gNivelRotacion" runat="server" AutoDataBind="true"

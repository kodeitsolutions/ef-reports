<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOportunidades_Prospectos.aspx.vb" Inherits="rOportunidades_Prospectos" %>
...
<head runat="server">
    <title>Listado de Oportunidades por Prospectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOportunidades_Prospectos" runat="server" AutoDataBind="true"

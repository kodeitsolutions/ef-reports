<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTareas_Detallado_Clientes.aspx.vb" Inherits="rTareas_Detallado_Clientes" %>
...
<head runat="server">
    <title>Reporte de Tareas de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTareas_Detallado_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

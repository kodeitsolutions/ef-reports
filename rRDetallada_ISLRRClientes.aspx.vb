...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRDetallada_ISLRRClientes"
'-------------------------------------------------------------------------------------------'
Partial Class rRDetallada_ISLRRClientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("				Detalles_Cobros.Tip_Ope					AS Tipo_Cobro,							")
            loComandoSeleccionar.AppendLine("				CASE WHEN Detalles_Cobros.Tip_Ope='Efectivo'										")
            loComandoSeleccionar.AppendLine("					THEN 'Efectivo'																")
            loComandoSeleccionar.AppendLine("					ELSE Detalles_Cobros.Num_Doc													")
            loComandoSeleccionar.AppendLine("				END										AS Numero_Cobro,							")
            ...
            loComandoSeleccionar.AppendLine("				SUBSTRING(Clientes.Nom_Cli, 0,30)		AS Nom_Cli,								")
            loComandoSeleccionar.AppendLine("				Clientes.Rif							AS Rif,									")
            loComandoSeleccionar.AppendLine("				SUBSTRING(Clientes.Dir_Fis, 0,25)		AS Direccion							")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRDetallada_ISLRRClientes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrrRDetallada_ISLRRClientes.ReportSource = loObjetoReporte
...
'                 Clientes y los beneficiarios y luego se unieron los resultados.

<%@ page language="VB" autoeventwireup="false" inherits="fCortes_ExistenciaDepartamentosTodos" CodeFile="fCortes_ExistenciaDepartamentosTodos.aspx.vb" %>
...
<head runat="server">
    <title>Cortes de Existencias por Departamentos de Todos los Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCortes_ExistenciaDepartamentosTodos" runat="server" AutoDataBind="true"

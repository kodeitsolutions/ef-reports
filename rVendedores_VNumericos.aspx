<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVendedores_VNumericos.aspx.vb" Inherits="rVendedores_VNumericos" %>
...
<head runat="server">
    <title>Reporte de Vendedores con Valores Numéricos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVendedores_VNumericos" runat="server" AutoDataBind="true"

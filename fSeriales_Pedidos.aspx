<%@ page language="VB" autoeventwireup="false" inherits="fSeriales_Pedidos" CodeFile="fSeriales_Pedidos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeriales_Pedidos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fDatosBasicos_Idiomas" CodeFile="fDatosBasicos_Idiomas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Idiomas: Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatosBasicos_Idiomas" runat="server" AutoDataBind="true"

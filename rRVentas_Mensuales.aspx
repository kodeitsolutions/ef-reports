<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_Mensuales.aspx.vb" Inherits="rRVentas_Mensuales" %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas Mensuales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_Mensuales" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fLVentas_Clientes_CCSJ" CodeFile="fLVentas_Clientes_CCSJ.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Baremos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfLVentas_Clientes_CCSJ" runat="server" AutoDataBind="true"

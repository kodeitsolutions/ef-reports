<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_cCobros.aspx.vb" Inherits="rCCobrar_cCobros" %>
...
<head runat="server">
    <title>Listado de Documentos de Cuentas por Cobrar con sus Cobrar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_cCobros" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUsuarios.aspx.vb" Inherits="rUsuarios" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrUsuarios" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gPais.aspx.vb" Inherits="rMargen_gPais" %>
...
<head runat="server">
    <title>Margen de Ganancia por País</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gPais" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rGastos_Importaciones_ConCC" CodeFile="rGastos_Importaciones_ConCC.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Gastos de Importaciones con su Informacion Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGastos_Importaciones_ConCC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

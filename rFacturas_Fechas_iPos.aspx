<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Fechas_iPos.aspx.vb" Inherits="rFacturas_Fechas_iPos" %>
...
<head runat="server">
    <title>Reporte de Facturas por Fechas iPos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Fechas_iPos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

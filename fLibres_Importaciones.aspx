<%@ page language="VB" autoeventwireup="false" CodeFile="fLibres_Importaciones.aspx.vb"  inherits="fLibres_Importaciones" %>
...
<head runat="server">
    <title>Formas Libres de Importaciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfLibres_Importaciones" runat="server" AutoDataBind="true"

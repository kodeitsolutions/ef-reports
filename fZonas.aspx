<%@ page language="VB" autoeventwireup="false" inherits="fZonas" CodeFile="fZonas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfZonas" runat="server" AutoDataBind="true"

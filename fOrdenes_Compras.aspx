<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Compras" CodeFile="fOrdenes_Compras.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Compras" runat="server" AutoDataBind="true"

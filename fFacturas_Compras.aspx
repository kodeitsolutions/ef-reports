<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Compras" CodeFile="fFacturas_Compras.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Compras" runat="server" AutoDataBind="true"

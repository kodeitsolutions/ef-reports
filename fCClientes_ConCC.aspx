<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCClientes_ConCC"
    CodeFile="fCClientes_ConCC.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Clases de Clientes con sus Cuentas Contables</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCClientes_ConCC" runat="server" AutoDataBind="true"

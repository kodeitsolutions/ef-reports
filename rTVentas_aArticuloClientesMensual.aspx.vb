...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTVentas_aArticuloClientesMensual"
'-------------------------------------------------------------------------------------------'
Partial Class rTVentas_aArticuloClientesMensual
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("					WHEN DATEPART(MONTH, Facturas.Fec_ini) = 1 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine("					else 0  ")
            loComandoSeleccionar.AppendLine("         END as Ene,")
            loComandoSeleccionar.AppendLine("         CASE  ")
            loComandoSeleccionar.AppendLine("					WHEN DATEPART(MONTH, Facturas.Fec_ini) = 2 THEN Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine("					else 0 ")
            loComandoSeleccionar.AppendLine("         END as Feb, ")
            loComandoSeleccionar.AppendLine("            CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 3 THEN Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Mar, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 4 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Abr, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 5 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as May, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 6 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Jun, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 7 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Jul, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 8 THEN Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Ago, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 9 THEN Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Sep, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 10 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Oct, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 11 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Nov, ")
            loComandoSeleccionar.AppendLine("             CASE  ")
            loComandoSeleccionar.AppendLine(" 	            WHEN DATEPART(MONTH, Facturas.Fec_ini) = 12 THEN  Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine(" 	            else 0 ")
            loComandoSeleccionar.AppendLine("             END as Dic, ")
            loComandoSeleccionar.AppendLine("             Renglones_Facturas.Mon_Net AS Total ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTVentas_aArticuloClientesMensual", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTVentas_aArticuloClientesMensual.ReportSource = (loObjetoReporte)

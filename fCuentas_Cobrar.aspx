<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fCuentas_Cobrar.aspx.vb"
    Inherits="fCuentas_Cobrar" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCuentas_Cobrar" runat="server" AutoDataBind="true"

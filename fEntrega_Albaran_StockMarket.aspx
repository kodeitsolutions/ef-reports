<%@ page language="VB" autoeventwireup="false" inherits="fEntrega_Albaran_StockMarket" CodeFile="fEntrega_Albaran_StockMarket.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEntrega_Albaran_StockMarket" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_Comprobacion.aspx.vb" Inherits="rBalance_Comprobacion" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_Comprobacion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

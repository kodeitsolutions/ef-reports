...
Partial Class rTPedidos_vAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine("   		vendedores.nom_ven, ") 
			...
			lcComandoSeleccionar.AppendLine(" pedidos, vendedores,renglones_pedidos, articulos, departamentos" )
			lcComandoSeleccionar.AppendLine(" WHERE	")
		 	lcComandoSeleccionar.AppendLine("pedidos.documento=renglones_pedidos.documento ") 
			lcComandoSeleccionar.AppendLine("AND pedidos.cod_ven = vendedores.cod_ven ")
			...
			lcComandoSeleccionar.AppendLine(" SELECT  ")  
            lcComandoSeleccionar.AppendLine(" 			ROW_NUMBER() OVER(PARTITION BY cod_ven ORDER BY cod_ven," & lcOrdenamiento & ") AS 'Renglon',  ")
            ...
            lcComandoSeleccionar.AppendLine("ORDER BY   cod_ven," & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTPedidos_vAñoMes", laDatosReporte)
            ...
            Me.crvrTPedidos_vAñoMes.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rECuentas_Bancos"
'-------------------------------------------------------------------------------------------'
Partial Class rECuentas_Bancos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		")
            loComandoSeleccionar.AppendLine("WHERE	Movimientos_Cuentas.Cod_Con BETWEEN " & lcParametro1Desde)
            loComandoSeleccionar.AppendLine("			AND " & lcParametro1Hasta)
            ...
            If laDatosReporte.Tables(0).Rows.Count <> 0 Then
                ...
                loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rECuentas_Bancos", loDatosReporteFinal)
            Else
                loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rECuentas_Bancos", laDatosReporte)
            End If

            If lcParametro5Desde.ToString = "Si" Then
            ...
            Me.crvrECuentas_Bancos.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCotizaciones_vAñoMes.aspx.vb" Inherits="rTCotizaciones_vAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Cotizaciones por Vendedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCotizaciones_vAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rlCasos_EjecutorCliente.aspx.vb" Inherits="rlCasos_EjecutorCliente" %>
...
<head runat="server">
    <title>Listado de Casos por Ejecutor y Cliente</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrlCasos_EjecutorCliente" runat="server" AutoDataBind="true"

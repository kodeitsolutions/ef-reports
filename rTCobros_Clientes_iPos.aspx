<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCobros_Clientes_iPos.aspx.vb" Inherits="rTCobros_Clientes_iPos" %>
...
<head runat="server">
    <title>Total Cobros por Clientes iPos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCobros_Clientes_iPos" runat="server" AutoDataBind="true"

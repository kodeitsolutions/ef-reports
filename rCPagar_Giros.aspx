<%@ page language="VB" autoeventwireup="false" inherits="rCPagar_Giros" CodeFile="rCPagar_Giros.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Giros" runat="server" AutoDataBind="true"

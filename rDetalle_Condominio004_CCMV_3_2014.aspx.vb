...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rDetalle_Condominio004_CCMV_3_2014"
'-------------------------------------------------------------------------------------------'
Partial Class rDetalle_Condominio004_CCMV_3_2014
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("DECLARE @lnMontoNeto DECIMAL(28, 10);")
            loComandoSeleccionar.AppendLine("DECLARE @lnReservas DECIMAL(28, 10);")
            ...
            loComandoSeleccionar.AppendLine("DECLARE @lnTotalServiciosMinitiendas DECIMAL(28, 10);")
            loComandoSeleccionar.AppendLine("")
            ...
            loComandoSeleccionar.AppendLine("FROM    #tmpDatosAdministrativos;")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("--Servicios Generales")
            loComandoSeleccionar.AppendLine("SELECT @lnMontoNeto = (SELECT ROUND(SUM(Mon_Net),2) FROM #tmpDatosAdministrativos WHERE cod_art = @lcClienteBase AND Alicuota = 1);")
            loComandoSeleccionar.AppendLine("SELECT @lnReservas = ROUND(@lnMontoNeto*@lnPorcentaje1/100, 2);")
            loComandoSeleccionar.AppendLine("SELECT @lnSubTotalGastos = @lnMontoNeto + @lnReservas;")
            loComandoSeleccionar.AppendLine("SELECT @lnGastosAdministativos = ROUND(@lnMontoNeto*(1 + @lnPorcentaje1/100)*(@lnPorcentaje2/100)*(1 + @lnImpuesto/100), 2);")
            loComandoSeleccionar.AppendLine("SELECT @lnTotalServiciosGenerales = @lnSubTotalGastos + @lnGastosAdministativos;")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("--Servicios Minitiendas ")
            loComandoSeleccionar.AppendLine("SELECT @lnTotalServiciosMinitiendas = (SELECT ROUND(SUM(Mon_Net),2) FROM #tmpDatosAdministrativos WHERE cod_art = @lcClienteBase AND Alicuota = 2);")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("-- ************************************************************")
            ...
            loComandoSeleccionar.AppendLine("       Totales.Total_AliCuota1                                              AS Total_AliCuota1_Local,")
            loComandoSeleccionar.AppendLine("       Totales.Total_AliCuota2                                              AS Total_AliCuota2_Local,")
            loComandoSeleccionar.AppendLine("       Totales.Total_Servicios_Generales                                    AS Total_Servicios_Generales,")
            loComandoSeleccionar.AppendLine("       Totales.Total_Servicios_Minitiendas                                  AS Total_Servicios_Minitiendas,")
            loComandoSeleccionar.AppendLine("       ROUND(Totales.Total_Servicios_Generales * Detalles.Por_Ali/100, 2)  ")
            loComandoSeleccionar.AppendLine("       +ROUND(Totales.Total_Servicios_Minitiendas * Detalles.Por_Ali2/100, 2)AS Cuota_Local,")
            loComandoSeleccionar.AppendLine("       (Detalles.Canon*.25)                                                 AS Tope_Canon,")
            loComandoSeleccionar.AppendLine("       (Total_Cuota1+Total_Cuota2)                                          AS Total_Cuota,")
            loComandoSeleccionar.AppendLine("       CAST(CASE WHEN ( Detalles.Canon > 0 ) AND (Detalles.Canon*.25< (Total_Cuota1+Total_Cuota2) )")
            ...
            loComandoSeleccionar.AppendLine("                    @lnTotalServiciosMinitiendas                AS Total_Servicios_Minitiendas,")
            loComandoSeleccionar.AppendLine("                    MAX(Total_Alicuotas.Total_Alicuota1)/100    AS Total_AliCuota1,")
            loComandoSeleccionar.AppendLine("                    MAX(Total_Alicuotas.Total_Alicuota2)/100    AS Total_AliCuota2,")
            loComandoSeleccionar.AppendLine("                    MAX(Total_Alicuotas.Total_Cuota1)           As Total_Cuota1,")
            loComandoSeleccionar.AppendLine("                    MAX(Total_Alicuotas.Total_Cuota2)           As Total_Cuota2")
            ...
            loComandoSeleccionar.AppendLine("                               SUM(tmp_Alicuotas.Por_Ali) AS Total_Alicuota1,")
            loComandoSeleccionar.AppendLine("                               SUM(tmp_Alicuotas.Por_Ali2) AS Total_Alicuota2,")
            loComandoSeleccionar.AppendLine("                               SUM(ROUND(@lnTotalServiciosGenerales*tmp_Alicuotas.Por_Ali/100,2)) AS Total_Cuota1,")
            loComandoSeleccionar.AppendLine("                               SUM(ROUND(@lnTotalServiciosMinitiendas*tmp_Alicuotas.Por_Ali2/100,2)) AS Total_Cuota2")
            loComandoSeleccionar.AppendLine("                        FROM (")
            loComandoSeleccionar.AppendLine("                            SELECT D2.Nom_Cli, D2.Por_Ali, D2.Por_Ali2")
            ...
            loComandoSeleccionar.AppendLine("                            GROUP BY D2.Nom_Cli, D2.Por_Ali, D2.Por_Ali2")
            ...
            loComandoSeleccionar.AppendLine("            GROUP BY Dat.nom_cli --order by Dat.nom_cli desc")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("--PARA DEPURAR:")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rDetalle_Condominio004_CCMV_3_2014", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrDetalle_Condominio004_CCMV_3_2014.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' RJG: 29/04/14: Ajuste en información de la coletilla de ley: ahora muestra cero si el tope'
'                no aplica.                                                                 '

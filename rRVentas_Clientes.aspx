<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_Clientes.aspx.vb" Inherits="rRVentas_Clientes" %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_Clientes" runat="server" AutoDataBind="true"

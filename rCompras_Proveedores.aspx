<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_Proveedores.aspx.vb" Inherits="rCompras_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Compras por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

Imports System.Data
Partial Class rTipos_Documentos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
			...
			loComandoSeleccionar.AppendLine("				Case When Status = 'A' Then 'Activo' Else 'Inactivo' End as Status_Tipos_Documentos " )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTipos_Documentos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
			            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrTipos_Documentos.ReportSource = loObjetoReporte

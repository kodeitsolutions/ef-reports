<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Ejecutor.aspx.vb" Inherits="rTotal_Casos_Ejecutor" %>
...
<head runat="server">
    <title>Total Casos por Ejecutor</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Ejecutor" runat="server" AutoDataBind="true"

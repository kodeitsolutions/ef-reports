...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFacturas_aMes"
'-------------------------------------------------------------------------------------------'
Partial Class rFacturas_aMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine(" SELECT	SUBSTRING(articulos.nom_art,0,30) as nom_art, ")
            ...
            lcComandoSeleccionar.AppendLine("from renglones_facturas, facturas, articulos, departamentos ")
            ...
            lcComandoSeleccionar.AppendLine("GROUP BY   articulos.nom_art ")

            lcComandoSeleccionar.AppendLine("select		nom_art,	")
            ...
            'lcComandoSeleccionar.AppendLine("ORDER BY   nom_art ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFacturas_aMes", laDatosReporte)
            ...
            Me.crvrFacturas_aMes.ReportSource = loObjetoReporte

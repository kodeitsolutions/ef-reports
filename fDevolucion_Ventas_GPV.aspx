<%@ page language="VB" autoeventwireup="false" inherits="fDevolucion_Ventas_GPV" CodeFile="fDevolucion_Ventas_GPV.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Factura GPV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDevolucion_Ventas_GPV" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="KDE_rCRetencion_ISLRProveedores" CodeFile="KDE_rCRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (KDE)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrKDE_rCRetencion_ISLRProveedores" runat="server" AutoDataBind="true"

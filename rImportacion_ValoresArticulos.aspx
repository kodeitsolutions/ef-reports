<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rImportacion_ValoresArticulos.aspx.vb"
    Inherits="rImportacion_ValoresArticulos" %>
...
<head runat="server">
    <title>Reporte de Importaciones con sus valores por Artículo</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrImportacion_ValoresArticulos" runat="server" AutoDataBind="true"

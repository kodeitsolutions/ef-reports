<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Proveedores_CCSJ002.aspx.vb" Inherits="rCPagar_Proveedores_CCSJ002" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Pagar por Proveedor (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Proveedores_CCSJ002" runat="server" AutoDataBind="true"

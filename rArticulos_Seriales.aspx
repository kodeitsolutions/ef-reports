<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_Seriales.aspx.vb" Inherits="rArticulos_Seriales" %>
...
<head runat="server">
    <title>Reporte de Artículos con sus Seriales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Seriales" runat="server" AutoDataBind="true"

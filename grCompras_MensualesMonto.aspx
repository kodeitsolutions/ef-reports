<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grCompras_MensualesMonto.aspx.vb" Inherits="grCompras_MensualesMonto" %>
...
<head runat="server">
    <title>Gráfico de Compras Mensuales en Montos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrCompras_MensualesMonto" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gSucursales.aspx.vb" Inherits="rMargen_gSucursales" %>
...
<head runat="server">
    <title>Margen de Ganancia por Sucursales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gSucursales" runat="server" AutoDataBind="true"

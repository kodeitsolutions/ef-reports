<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grPagos_Anualmente.aspx.vb" Inherits="grPagos_Anualmente" %>
...
<head runat="server">
    <title>Gráfico de Pagos Anualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrPagos_Anualmente" runat="server" AutoDataBind="true"

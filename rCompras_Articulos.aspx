<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_Articulos.aspx.vb" Inherits="rCompras_Articulos" %>
...
<head runat="server">
    <title>Reporte de Compras por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

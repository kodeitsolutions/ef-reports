...
Partial Class CGS_Resumen_Iva
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(Mon_Bas1) AS BaseCFactura,")
            loComandoSeleccionar.AppendLine("		SUM(Mon_Imp1) AS ImpuestoCFactura")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(Mon_Bas1),0) AS BaseVFactura,")
            loComandoSeleccionar.AppendLine("		ISNULL(SUM(Mon_Imp1),0) AS ImpuestoVFactura")
            ...
            loComandoSeleccionar.AppendLine("		#tmpBaseCFactura.BaseCFactura + #tmpBaseCNotaCre.BaseCNotaCre AS TotalBaseC,")
            loComandoSeleccionar.AppendLine("		#tmpBaseCFactura.ImpuestoCFactura + #tmpBaseCNotaCre.ImpuestoCNotaCre AS TotalImpuestoC,")

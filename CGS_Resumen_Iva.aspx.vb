...
Partial Class CGS_Resumen_Iva
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(Cuentas_Pagar.Mon_Bas1) AS BaseCFactura,")
            loComandoSeleccionar.AppendLine("		SUM(Cuentas_Pagar.Mon_Imp1) AS ImpuestoCFactura")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCFactura")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            ...
            loComandoSeleccionar.AppendLine("		#tmpBaseCFactura.BaseCFactura + #tmpBaseCNotaCre.BaseCNotaCre + #tmpBaseCNotaDeb.BaseCNotaDeb AS TotalBaseC,")
            loComandoSeleccionar.AppendLine("		#tmpBaseCFactura.ImpuestoCFactura + #tmpBaseCNotaCre.ImpuestoCNotaCre + #tmpBaseCNotaDeb.ImpuestoCNotaDeb AS TotalImpuestoC,")
            ...
            loComandoSeleccionar.AppendLine("	#tmpBaseCFactura,")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("DROP TABLE #tmpBaseCFactura")

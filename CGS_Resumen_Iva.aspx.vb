...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_Resumen_Iva"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_Resumen_Iva
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Exe/100000)ELSE Mon_Exe")
            loComandoSeleccionar.AppendLine("           END),0) AS TotalExentoC")
            loComandoSeleccionar.AppendLine("INTO #tmpExentoC")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("WHERE Mon_Exe <> 0")
            loComandoSeleccionar.AppendLine("	AND Cod_Tip = 'FACT'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Bas1/100000)ELSE Cuentas_Pagar.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END) AS BaseCFactura12,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Imp1/100000)ELSE Cuentas_Pagar.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END) AS ImpuestoCFactura12")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCFactura12")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Compras ON Compras.Documento = Cuentas_Pagar.Documento")
            loComandoSeleccionar.AppendLine("	    AND Compras.Referencia = ''")
            ...
            'loComandoSeleccionar.AppendLine("	    AND Compras.Referencia = ''")
            'loComandoSeleccionar.AppendLine("WHERE Cuentas_Pagar.Cod_Tip = 'FACT'")
            'loComandoSeleccionar.AppendLine("	AND Cuentas_Pagar.Cod_Imp = '8' ")
            'loComandoSeleccionar.AppendLine("	AND Cuentas_Pagar.Status <> 'Anulado'")
            'loComandoSeleccionar.AppendLine("	AND Cuentas_Pagar.Fec_Reg BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Bas1/100000)ELSE Cuentas_Pagar.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END) AS BaseCFactura8,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Imp1/100000)ELSE Cuentas_Pagar.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END) AS ImpuestoCFactura8")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCFactura8")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Compras ON Compras.Documento = Cuentas_Pagar.Documento")
            loComandoSeleccionar.AppendLine("	    AND Compras.Referencia = ''")
            ...
            'loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            'loComandoSeleccionar.AppendLine("	JOIN Compras ON Compras.Documento = Cuentas_Pagar.Documento")
            'loComandoSeleccionar.AppendLine("WHERE Cuentas_Pagar.Cod_Tip = 'FACT' ")
            'loComandoSeleccionar.AppendLine("	AND Cuentas_Pagar.Status <> 'Anulado'")
            'loComandoSeleccionar.AppendLine("	AND Compras.Referencia <> ''")
            'loComandoSeleccionar.AppendLine("	AND Cuentas_Pagar.Fec_Reg BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            ...
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Bas1/100000)ELSE Cuentas_Pagar.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END) AS BaseCFacturaImp,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Imp1/100000)ELSE Cuentas_Pagar.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END) AS ImpuestoCFacturaImp")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCFacturaImp")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("	JOIN Compras ON Compras.Documento = Cuentas_Pagar.Documento")
            loComandoSeleccionar.AppendLine("WHERE Cuentas_Pagar.Cod_Tip = 'FACT' ")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT	ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Bru/100000)ELSE Mon_Bru")
            loComandoSeleccionar.AppendLine("           END)*-1,0) AS BaseCNotaCre,")
            loComandoSeleccionar.AppendLine("		ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Imp1/100000)ELSE Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END)*-1,0) AS ImpuestoCNotaCre")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCNotaCre")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'N/CR'")
            loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            ...
            'loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            'loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'N/DB'")
            'loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            'loComandoSeleccionar.AppendLine("	AND Control <> 'NO'")
            'loComandoSeleccionar.AppendLine("	AND Fec_Reg BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Bru/100000)ELSE Mon_Bru")
            loComandoSeleccionar.AppendLine("           END)*-1,0) AS BaseCNotaDeb,")
            loComandoSeleccionar.AppendLine("		ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Imp1/100000)ELSE Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END)*-1,0) AS ImpuestoCNotaDeb")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCNotaDeb")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'N/DB'")
            loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Retenciones_Documentos.Mon_Ret/100000)ELSE Retenciones_Documentos.Mon_Ret")
            loComandoSeleccionar.AppendLine("           END),0) AS TotalRetenidoC")
            loComandoSeleccionar.AppendLine("INTO #tmpRetenidoC")
            loComandoSeleccionar.AppendLine("FROM Retenciones_Documentos")
            loComandoSeleccionar.AppendLine("	JOIN Cuentas_Pagar ")
            loComandoSeleccionar.AppendLine("		ON Retenciones_Documentos.Doc_Des = Cuentas_Pagar.Documento")
            ...
            'loComandoSeleccionar.AppendLine("WHERE Mon_Exe <> 0")
            'loComandoSeleccionar.AppendLine("	AND Cod_Tip = 'FACT'")
            'loComandoSeleccionar.AppendLine("	AND Fec_Ini BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Exe/100000)ELSE Mon_Exe")
            loComandoSeleccionar.AppendLine("           END),0) AS TotalExentoV")
            loComandoSeleccionar.AppendLine("INTO #tmpExentoV")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Cobrar")
            loComandoSeleccionar.AppendLine("WHERE Mon_Exe <> 0")
            loComandoSeleccionar.AppendLine("	AND Cod_Tip = 'FACT'")
            ...
            'loComandoSeleccionar.AppendLine("	AND Fec_Ini BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Bas1/100000)ELSE Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END) AS BaseVFactura,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Imp1/100000)ELSE Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END) AS ImpuestoVFactura")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseVFactura")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Cobrar")
            loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'FACT'")
            loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Otr1/100000)ELSE Mon_Otr1")
            loComandoSeleccionar.AppendLine("           END),0) AS BaseVFacturaExp")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseVFacturaExp")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Cobrar")
            loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'FACT'")
            loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            ...
            loComandoSeleccionar.AppendLine("SELECT	ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Bru/100000)ELSE Mon_Bru")
            loComandoSeleccionar.AppendLine("           END)*-1,0) AS BaseVNotaCre,")
            loComandoSeleccionar.AppendLine("		ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Imp1/100000)ELSE Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END)*-1,0) AS ImpuestoVNotaCre")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseVNotaCre")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Cobrar")
            loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'N/CR'")
            loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Retenciones_Documentos.Mon_Ret/100000)ELSE Retenciones_Documentos.Mon_Ret")
            loComandoSeleccionar.AppendLine("           END),0) AS TotalRetenidoV")
            loComandoSeleccionar.AppendLine("INTO #tmpRetenidoV")
            loComandoSeleccionar.AppendLine("FROM Retenciones_Documentos")
            loComandoSeleccionar.AppendLine("	JOIN Cuentas_Cobrar ")
            loComandoSeleccionar.AppendLine("		ON Retenciones_Documentos.Doc_Des = Cuentas_Cobrar.Documento")
            ...
            loComandoSeleccionar.AppendLine("		#tmpBaseCFactura12.BaseCFactura12 + #tmpBaseCNotaCre.BaseCNotaCre + #tmpBaseCNotaDeb.BaseCNotaDeb AS TotalBaseC12,")
            ...
            loComandoSeleccionar.AppendLine("		#tmpBaseVFactura.BaseVFactura + #tmpBaseVNotaCre.BaseVNotaCre AS TotalBaseV,")
            loComandoSeleccionar.AppendLine("		#tmpBaseVFactura.ImpuestoVFactura + #tmpBaseVNotaCre.ImpuestoVNotaCre AS TotalImpuestoV,")
            loComandoSeleccionar.AppendLine("		#tmpBaseVFacturaExp.BaseVFacturaExp	AS TotalExportacion,")
            loComandoSeleccionar.AppendLine("		#tmpRetenidoV.TotalRetenidoV,")
            loComandoSeleccionar.AppendLine("		CONCAT('" & lcMes & "' ,'/', '" & lcAño & "' ) AS Periodo,")
            ...
            loComandoSeleccionar.AppendLine("	#tmpBaseVFacturaExp,")
            ...
            loComandoSeleccionar.AppendLine("DROP TABLE #tmpBaseVFacturaExp")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("CGS_Resumen_Iva", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCGS_Resumen_Iva.ReportSource = loObjetoReporte

...
Partial Class CGS_Resumen_Iva
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Bas1/100000)ELSE Cuentas_Pagar.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END),0) AS BaseCFactura12,")
            loComandoSeleccionar.AppendLine("		COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Imp1/100000)ELSE Cuentas_Pagar.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END),0) AS ImpuestoCFactura12")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCFactura12")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Compras ON Compras.Documento = Cuentas_Pagar.Documento")
            loComandoSeleccionar.AppendLine("	    AND Compras.Referencia = ''")
            ...
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Bas1/100000)ELSE Cuentas_Pagar.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END),0) AS BaseCFactura8,")
            loComandoSeleccionar.AppendLine("		COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Imp1/100000)ELSE Cuentas_Pagar.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END),0) AS ImpuestoCFactura8")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCFactura8")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Compras ON Compras.Documento = Cuentas_Pagar.Documento")
            loComandoSeleccionar.AppendLine("	    AND Compras.Referencia = ''")
            ...
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Bas1/100000)ELSE Cuentas_Pagar.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END),0) AS BaseCFacturaImp,")
            loComandoSeleccionar.AppendLine("		COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Imp1/100000)ELSE Cuentas_Pagar.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END),0) AS ImpuestoCFacturaImp")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseCFacturaImp")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("	JOIN Compras ON Compras.Documento = Cuentas_Pagar.Documento")
            loComandoSeleccionar.AppendLine("WHERE Cuentas_Pagar.Cod_Tip = 'FACT' ")
            ...
            loComandoSeleccionar.AppendLine("		COALESCE(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Exe/100000)ELSE Mon_Exe")
            ...
            loComandoSeleccionar.AppendLine("           END),0) AS BaseVFactura,")
            loComandoSeleccionar.AppendLine("		COALESCE(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Imp1/100000)ELSE Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END),0) AS ImpuestoVFactura")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseVFactura")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Cobrar")
            loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'FACT'")
            loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini >= '20180801'")
            loComandoSeleccionar.AppendLine("					THEN (Retenciones_Documentos.Mon_Ret/100000)ELSE Retenciones_Documentos.Mon_Ret")

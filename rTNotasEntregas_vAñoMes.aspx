<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTNotasEntregas_vAñoMes.aspx.vb" Inherits="rTNotasEntregas_vAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Notas de Entrega de Cliente por Vendedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTNotasEntregas_vAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

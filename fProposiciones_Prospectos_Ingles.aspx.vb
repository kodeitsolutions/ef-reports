...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fProposiciones_Prospectos_Ingles"
'-------------------------------------------------------------------------------------------'
Partial Class fProposiciones_Prospectos_Ingles
  ...
  Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fProposiciones_Prospectos_Ingles", laDatosReporte)
            ...
            Me.crvfProposiciones_Prospectos_Ingles.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCasos_Articulos.aspx.vb" Inherits="rCasos_Articulos" %>
...
<head runat="server">
    <title>Reporte de Casos por Clientes</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCasos_Articulos" runat="server" AutoDataBind="true"

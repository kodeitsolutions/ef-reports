<%@ page language="VB" autoeventwireup="false" inherits="PAS_fFacturas_Ventas" CodeFile="PAS_fFacturas_Ventas.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fFacturas_Ventas" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTPagos_Año"
'-------------------------------------------------------------------------------------------'
Partial Class rTPagos_Año
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Else
                loComandoSeleccionar.AppendLine(" 				AND Cuentas_Pagar.Cod_Rev NOT between " & lcParametro6Desde)
            End If
...
'me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTPagos_Año", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTPagos_Año.ReportSource = loObjetoReporte

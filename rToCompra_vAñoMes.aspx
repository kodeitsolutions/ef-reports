<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rToCompra_vAñoMes.aspx.vb" Inherits="rToCompra_vAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Ordenes de Compra por Vendedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrToCompra_vAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

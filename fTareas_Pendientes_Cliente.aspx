<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fTareas_Pendientes_Cliente.aspx.vb" Inherits="fTareas_Pendientes_Cliente" %>
...
<head runat="server">
    <title>Formato de Tareas Pendientes del Cliente</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfTareas_Pendientes_Cliente" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

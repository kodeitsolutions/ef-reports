...
Partial Class CGS_fRecibo_Liquidacion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("			Recibos.Fecha								            AS Fecha,			")
            loConsulta.AppendLine("		    DATEDIFF(MONTH,Trabajadores.Fec_Ini,Recibos.Fec_Fin)/12 AS Año,")
            ...
            loConsulta.AppendLine("		    CASE WHEN DAY(Trabajadores.Fec_Ini) - DAY(Recibos.Fec_Fin) = 1")
            loConsulta.AppendLine("		              OR (DAY(Trabajadores.Fec_Ini) = 1 ")
            loConsulta.AppendLine("		                  AND DATEADD(DAY, - DAY(Recibos.Fec_Fin), DATEADD(MONTH, 1, Recibos.Fec_Fin)) = Recibos.Fec_Fin)")
            loConsulta.AppendLine("		         THEN 1")
            loConsulta.AppendLine("		         ELSE 0")
            loConsulta.AppendLine("		    END                                                     AS Mes,")
            loConsulta.AppendLine("         DATEDIFF(Day, DATEADD(Month,DATEDIFF(Month, (DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini)),Recibos.Fec_Fin) - CASE WHEN DATEADD(Month, DATEDIFF(Month,DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini),Recibos.Fec_Fin) , Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END  ,DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini)) ,Recibos.Fec_Fin) - CASE WHEN DATEADD(Day,DATEDIFF(Day, DATEADD(Month,DATEDIFF(Month, (DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini)),Recibos.Fec_Fin) - CASE WHEN DATEADD(Month, DATEDIFF(Month,DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini),Recibos.Fec_Fin) , Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END  ,DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini)) ,Recibos.Fec_Fin),DATEADD(Month,DATEDIFF(Month, (DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini)),Recibos.Fec_Fin) - CASE WHEN DATEADD(Month, DATEDIFF(Month,DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini),Recibos.Fec_Fin) , Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END  ,DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin) - CASE WHEN DATEADD(Year,DATEDIFF(Year,Trabajadores.Fec_Ini,Recibos.Fec_Fin), Trabajadores.Fec_Ini) > Recibos.Fec_Fin THEN 1 ELSE 0 END,Trabajadores.Fec_Ini))) > Recibos.Fec_Fin THEN 1 ELSE 0 END AS Dia,")

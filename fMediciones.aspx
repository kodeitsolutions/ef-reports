<%@ Page Language="VB" AutoEventWireup="false" Inherits="fMediciones" CodeFile="fMediciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Mediciones</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfMediciones" runat="server" AutoDataBind="true"

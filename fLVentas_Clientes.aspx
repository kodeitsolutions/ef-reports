<%@ page language="VB" autoeventwireup="false" inherits="fLVentas_Clientes" CodeFile="fLVentas_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Formas Libres de Venta</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfLVentas_Clientes" runat="server" AutoDataBind="true"

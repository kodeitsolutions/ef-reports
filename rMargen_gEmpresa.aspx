<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gEmpresa.aspx.vb" Inherits="rMargen_gEmpresa" %>
...
<head runat="server">
    <title>Margen de Ganancia de la Empresa</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gEmpresa" runat="server" AutoDataBind="true"

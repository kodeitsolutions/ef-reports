<%@ page language="VB" autoeventwireup="false" inherits="CGS_fEntrada_Almacen" CodeFile="CGS_fEntrada_Almacen.aspx.vb" %>
...
<head runat="server">
    <title>Entrada a Almacén de consumo (CGS)</title>

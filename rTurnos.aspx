<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTurnos.aspx.vb" Inherits="rTurnos" %>
...
<head runat="server">
    <title>Reporte de Listado de Turnos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTurnos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

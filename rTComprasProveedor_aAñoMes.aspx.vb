...
Partial Class rTComprasProveedor_aAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" compras, renglones_compras, proveedores, articulos, departamentos" )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTComprasProveedor_aAñoMes", laDatosReporte)
            ...
            Me.crvrTComprasProveedor_aAñoMes.ReportSource = loObjetoReporte

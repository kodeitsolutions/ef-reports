<%@ page language="VB" autoeventwireup="false" inherits="fMovimientos_Cuentas_Ingles" CodeFile="fMovimientos_Cuentas_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Movimientos de Cuentas en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfMovimientos_Cuentas_Ingles" runat="server" AutoDataBind="true"

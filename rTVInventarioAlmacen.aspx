<%@ page language="VB" autoeventwireup="false" inherits="rTVInventarioAlmacen" CodeFile="rTVInventarioAlmacen.aspx.vb"  %>
...
<head runat="server">
    <title>Total del Valor Actual del Inventario por Almacén</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVInventarioAlmacen" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

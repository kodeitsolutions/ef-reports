<%@ page language="VB" autoeventwireup="false" inherits="PMM_fDevolucion_Cliente" CodeFile="PMM_fDevolucion_Cliente.aspx.vb" %>
...
<head runat="server">
    <title>Nota de Crédito (PM Maquinas)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPMM_fDevolucion_Cliente" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCanales.aspx.vb" Inherits="rCanales" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCanales" runat="server" AutoDataBind="true"

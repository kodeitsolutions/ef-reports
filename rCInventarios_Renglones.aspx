<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCInventarios_Renglones.aspx.vb" Inherits="rCInventarios_Renglones" %>
...
<head runat="server">
    <title>Reporte de Cortes de Inventarios con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCInventarios_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

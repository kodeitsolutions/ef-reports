...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rResumenProspectos_Pais_AtributoB"
'-------------------------------------------------------------------------------------------'
Partial Class rResumenProspectos_Pais_AtributoB
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("            Prospectos.Atributo_A,")
            loConsulta.AppendLine("            Prospectos.Atributo_B,")
            loConsulta.AppendLine("            Prospectos.Atributo_C,")
            'loConsulta.AppendLine("            Prospectos.Cod_Pai,")
            ...
            If lcParametro8Desde <> "''" Then
                loConsulta.AppendLine(" 	    AND Prospectos.Atributo_A IN (" & lcParametro8Desde & ")")
            End If
            If lcParametro9Desde <> "''" Then
                loConsulta.AppendLine(" 	    AND Prospectos.Atributo_B IN (" & lcParametro9Desde & ")")
            End If
            If lcParametro10Desde <> "''" Then
                loConsulta.AppendLine(" 	    AND Prospectos.Atributo_C IN (" & lcParametro10Desde & ")")
            End If
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rResumenProspectos_Pais_AtributoB", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrResumenProspectos_Pais_AtributoB.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' RJG: 27/05/15: Modificacion en Atrbuto B y Filtros
'-------------------------------------------------------------------------------------------'

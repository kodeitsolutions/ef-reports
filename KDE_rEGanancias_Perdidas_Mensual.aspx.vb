...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "KDE_rEGanancias_Perdidas_Mensual"
'-------------------------------------------------------------------------------------------'
Partial Class KDE_rEGanancias_Perdidas_Mensual
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
            ...
            If lnAno = 2018 Then
                loComandoSeleccionar.AppendLine("       SUM(CASE	WHEN (Renglones_Comprobantes.Fec_Ini < " & lcCorte07 & ")")
                loComandoSeleccionar.AppendLine("					THEN ISNULL(Renglones_Comprobantes.Mon_Deb - Renglones_Comprobantes.Mon_Hab, @lnCero)")
                loComandoSeleccionar.AppendLine("					ELSE @lnCero")
                loComandoSeleccionar.AppendLine("			END")
                loComandoSeleccionar.AppendLine("		) ")
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("KDE_rEGanancias_Perdidas_Mensual", laDatosReporte)

			Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvKDE_rEGanancias_Perdidas_Mensual.ReportSource = loObjetoReporte

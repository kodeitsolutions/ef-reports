<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Seguimientos.aspx.vb" Inherits="rPedidos_Seguimientos" %>
...
<head runat="server">
    <title>Reporte de Seguimientos de Pedidos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Seguimientos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

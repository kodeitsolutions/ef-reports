<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLista_dFiadores.aspx.vb" Inherits="rLista_dFiadores" %>
...
<head runat="server">
    <title>Reporte de Listado de Fiadores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLista_dFiadores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

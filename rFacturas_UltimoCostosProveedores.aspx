<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_UltimoCostosProveedores.aspx.vb" Inherits="rFacturas_UltimoCostosProveedores" %>
...
<head runat="server">
    <title>Reporte de Últimos Costos por Proveedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_UltimoCostosProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

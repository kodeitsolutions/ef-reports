...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rAuditorias_DiaSemana"
'-------------------------------------------------------------------------------------------'
Partial Class rAuditorias_DiaSemana
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    DatePart(WeekDay, Registro) AS DiaSemana,")
            ...
            loComandoSeleccionar.AppendLine(" SELECT     DiaSemana,")
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY  DiaSemana ")
            loComandoSeleccionar.AppendLine(" ORDER BY  DiaSemana ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAuditorias_DiaSemana", laDatosReporte)
            ...
            Me.crvrAuditorias_DiaSemana.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="rRGlobal_IsrlRetenidoV" CodeFile ="~/Administrativo/Reportes/rRGlobal_IsrlRetenidoV.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Global de I.S.R.L. Retenido por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRGlobal_IsrlRetenidoV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

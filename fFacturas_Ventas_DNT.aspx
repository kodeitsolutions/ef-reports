<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_DNT" CodeFile="fFacturas_Ventas_DNT.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas DNT</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_DNT" runat="server" AutoDataBind="true"

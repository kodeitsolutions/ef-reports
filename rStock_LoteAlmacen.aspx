<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rStock_LoteAlmacen.aspx.vb" Inherits="rStock_LoteAlmacen" %>
...
<head runat="server">
    <title>Reporte de Stock por Lote por Almacén</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrStock_LoteAlmacen" runat="server" AutoDataBind="true"

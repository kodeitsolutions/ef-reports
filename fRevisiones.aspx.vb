...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fRevisiones"
'-------------------------------------------------------------------------------------------'
Partial Class fRevisiones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		(CASE Revisiones.status ")
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fRevisiones", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfRevisiones.ReportSource = loObjetoReporte

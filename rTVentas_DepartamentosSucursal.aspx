<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_DepartamentosSucursal.aspx.vb" Inherits="rTVentas_DepartamentosSucursal" %>
...
<head runat="server">
    <title>Total Ventas por Departamentos y Sucursales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_DepartamentosSucursal" runat="server" AutoDataBind="true"

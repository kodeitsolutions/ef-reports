<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Empresas.aspx.vb" Inherits="rAuditorias_Empresas" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Empresas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Empresas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

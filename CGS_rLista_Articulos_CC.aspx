<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rLista_Articulos_CC.aspx.vb" Inherits="CGS_rLista_Articulos_CC" %>
...
<head runat="server">
    <title>Listado de Artículos con sus Cuentas Contables (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rLista_Articulos_CC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMovimientosBancos_TConceptos"
'-------------------------------------------------------------------------------------------'
Partial Class rMovimientosBancos_TConceptos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
            ...
            loComandoSeleccionar.AppendLine("   GROUP BY Movimientos_Cuentas.Cod_Cue, Cuentas_Bancarias.Nom_Cue,Movimientos_Cuentas.Cod_Con, Conceptos.Nom_Con ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMovimientosBancos_TConceptos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrMovimientosBancos_TConceptos.ReportSource = loObjetoReporte

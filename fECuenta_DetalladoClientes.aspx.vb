...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fECuenta_DetalladoClientes"
'-------------------------------------------------------------------------------------------'
Partial Class fECuenta_DetalladoClientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           And Clientes.Cod_Cli = (SELECT Cod_cli FROM " & cusAplicacion.goFormatos.pcCondicionPrincipal.Split(".")(0).Replace("(", "") & " WHERE " & cusAplicacion.goFormatos.pcCondicionPrincipal & ")")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fECuenta_DetalladoClientes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfECuenta_DetalladoClientes.ReportSource = loObjetoReporte

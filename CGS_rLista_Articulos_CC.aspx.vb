...
Partial Class CGS_rLista_Articulos_CC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("        ISNULL(CAST(Articulos.Contable AS XML).value('(/contable/ficha/cue_con)[1]', 'varchar(13)'),'')		AS CC_Art,")
            ...
            loComandoSeleccionar.AppendLine("		ISNULL(CAST(Secciones.Contable AS XML) .value('(/contable/ficha/cue_con)[1]', 'varchar(13)'),'')		AS CC_Sec,")
            loComandoSeleccionar.AppendLine("		ISNULL((SELECT Nom_Cue FROM Cuentas_Contables ")

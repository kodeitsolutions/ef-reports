...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "TRF_rOCompras_cRenglonesCP"
'-------------------------------------------------------------------------------------------'
Partial Class TRF_rOCompras_cRenglonesCP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'lcComandoSeleccionar.AppendLine("		AND Renglones_OCompras.Cod_Alm BETWEEN " & lcParametro5Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("TRF_rOCompras_cRenglonesCP", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvTRF_rOCompras_cRenglonesCP.ReportSource = loObjetoReporte

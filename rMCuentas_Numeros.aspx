<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMCuentas_Numeros.aspx.vb" Inherits="rMCuentas_Numeros" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Cuentas Bancarias por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMCuentas_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

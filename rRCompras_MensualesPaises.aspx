<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRCompras_MensualesPaises.aspx.vb" Inherits="rRCompras_MensualesPaises" %>
...
<head runat="server">
    <title>Reporte Resumen de Compras Mensuales por Paises</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRCompras_MensualesPaises" runat="server" AutoDataBind="true"

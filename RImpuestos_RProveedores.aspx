<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RImpuestos_RProveedores.aspx.vb" Inherits="RImpuestos_RProveedores" %>
...
<head runat="server">
    <title>Reporte de Impuestos Retenido Por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvRImpuestos_RProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

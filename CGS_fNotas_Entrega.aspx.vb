Imports System.Data
Partial Class CGS_fNotas_Entrega
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		Entregas.Status							AS Estatus, ")
            ...
            loComandoSeleccionar.AppendLine("		Entregas.Notas						    AS Observaciones, ")
            ...
            loComandoSeleccionar.AppendLine("                 WHERE Cod_Usu COLLATE DATABASE_DEFAULT = Entregas.Usu_Cre COLLATE DATABASE_DEFAULT)")
            ...
            loComandoSeleccionar.AppendLine("	LEFT JOIN Operaciones_Lotes ON Operaciones_Lotes.Num_Doc = Renglones_Entregas.Documento")
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("CGS_fNotas_Entrega", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvCGS_fNotas_Entrega.ReportSource = loObjetoReporte

...
Partial Class CGS_fTraslados_Almacenes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar3.AppendLine("        COALESCE(Operaciones_Lotes.Cod_Lot,'')    AS Lote,")
            loComandoSeleccionar3.AppendLine("        COALESCE(Operaciones_Lotes.Cantidad,0)    AS Cant_Lote,")
            loComandoSeleccionar3.AppendLine("		  COALESCE(Mediciones.Rechazo,0)			AS Porc_Desperdicio,")
            loComandoSeleccionar3.AppendLine("		  COALESCE((Mediciones.Rechazo*Operaciones_Lotes.Cantidad)/100,0)	AS Cant_Desperdicio,")
            ...
            loComandoSeleccionar3.AppendLine("  LEFT JOIN Operaciones_Lotes ON Operaciones_Lotes.Num_Doc = Renglones_Traslados.Documento")
            loComandoSeleccionar3.AppendLine("      AND Operaciones_Lotes.Tip_Doc = 'Traslados' ")
            loComandoSeleccionar3.AppendLine("		AND Operaciones_Lotes.Ren_Ori = Renglones_Traslados.Renglon")
            loComandoSeleccionar3.AppendLine("		AND Operaciones_Lotes.Tip_Ope = 'Salida'")
            loComandoSeleccionar3.AppendLine("	LEFT JOIN Mediciones ON Traslados.Documento = Mediciones.Cod_Reg")

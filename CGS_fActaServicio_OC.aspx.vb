...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_fActaServicio_OC"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_fActaServicio_OC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		Renglones_OCompras.Comentario,")
            ...
            loComandoSeleccionar.AppendLine("WHERE Renglones_OCompras.Cod_Uni = 'SRV'")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("CGS_fActaServicio_OC", laDatosReporte)


            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvCGS_fActaServicio_OC.ReportSource = loObjetoReporte

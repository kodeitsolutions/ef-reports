...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "grVentas_MensualesCantidades"
'-------------------------------------------------------------------------------------------'
Partial Class grVentas_MensualesCantidades
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" 	CASE  ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 1 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 2 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 3 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 4 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 5 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 6 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 7 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 8 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 9 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 10 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 11 THEN SUM(Renglones_Facturas.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Facturas.Fec_Ini) = 12 THEN SUM(Renglones_Facturas.Can_Art1) ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("grVentas_MensualesCantidades", laDatosReporte)
            ...
            Me.crvgrVentas_MensualesCantidades.ReportSource = loObjetoReporte

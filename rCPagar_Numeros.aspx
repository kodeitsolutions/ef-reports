<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Numeros.aspx.vb" Inherits="rCPagar_Numeros" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Pagar por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Numeros" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fPresupuestos_Proveedores" CodeFile="fPresupuestos_Proveedores.aspx.vb" %>
...
<head runat="server">
    <title>Presupuestos de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPresupuestos_Proveedores" runat="server" AutoDataBind="true"

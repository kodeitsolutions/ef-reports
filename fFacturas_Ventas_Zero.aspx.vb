...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFacturas_Ventas_Zero"
'-------------------------------------------------------------------------------------------'
Partial Class fFacturas_Ventas_Zero
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           SUBSTRING(Transportes.Nom_Tra,1,25)     AS  Nom_Tra, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFacturas_Ventas_Zero", laDatosReporte)
            lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".", ",")
            ...
            Me.crvfFacturas_Ventas_Zero.ReportSource = loObjetoReporte

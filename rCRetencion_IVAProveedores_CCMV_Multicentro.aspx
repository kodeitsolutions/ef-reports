<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_IVAProveedores_CCMV_Multicentro" 
CodeFile="rCRetencion_IVAProveedores_CCMV_Multicentro.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Retención de IVA de Proveedores (Multicentro)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCRetencion_IVAProveedores_CCMV_Multicentro" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="TRF_fFacturas_Ventas" CodeFile="TRF_fFacturas_Ventas.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_fFacturas_Ventas" runat="server" AutoDataBind="true"

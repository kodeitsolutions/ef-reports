<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Articulos_SLFR.aspx.vb" Inherits="rFacturas_Articulos_SLFR" %>
...
<head runat="server">
    <title>Reporte de Facturas por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Articulos_SLFR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

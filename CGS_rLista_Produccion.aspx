<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rLista_Produccion.aspx.vb" Inherits="CGS_rLista_Produccion" %>
...
<head runat="server">
    <title>Resumen para verificación de desperdicio de Órdenes de Producción (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rLista_Produccion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDepositos_cRenglones.aspx.vb" Inherits="rDepositos_cRenglones" %>
...
<head runat="server">
    <title>Reporte Depositos Bancarios por Cajas con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDepositos_cRenglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

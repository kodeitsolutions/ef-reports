<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCompras_Fechas.aspx.vb" Inherits="rTCompras_Fechas" %>
...
<head runat="server">
    <title>Reporte de Total de Compras por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCompras_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

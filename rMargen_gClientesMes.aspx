<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gClientesMes.aspx.vb" Inherits="rMargen_gClientesMes" %>
...
<head runat="server">
    <title>Margen de Ganancia por Clientes y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gClientesMes" runat="server" AutoDataBind="true"

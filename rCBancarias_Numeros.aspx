<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCBancarias_Numeros.aspx.vb" Inherits="rCBancarias_Numeros" %>
...
<head runat="server">
    <title>Listado de Cuentas Bancarias por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCBancarias_Numeros" runat="server" AutoDataBind="true"

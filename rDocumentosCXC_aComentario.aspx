<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDocumentosCXC_aComentario.aspx.vb" Inherits="rDocumentosCXC_aComentario" %>
...
<head runat="server">
    <title>Reporte de Documentos Agrupados por Comentario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDocumentosCXC_aComentario" runat="server" AutoDataBind="true"

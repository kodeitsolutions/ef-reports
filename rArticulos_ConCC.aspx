<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_ConCC" CodeFile="rArticulos_ConCC.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Artículos con sus Cuentas Contables</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_ConCC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

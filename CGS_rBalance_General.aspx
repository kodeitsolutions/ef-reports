<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rBalance_General.aspx.vb" Inherits="CGS_rBalance_General" %>
...
<head runat="server">
    <title>Balance General (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rBalance_General" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLAjustes_tMes.aspx.vb" Inherits="rLAjustes_tMes" %>
...
<head runat="server">
    <title>Reporte de Ajustes por Tipo de Ajuste Totalizados por Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLAjustes_tMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

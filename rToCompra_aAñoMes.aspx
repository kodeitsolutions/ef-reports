<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rToCompra_aAñoMes.aspx.vb" Inherits="rToCompra_aAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Ordenes de Compra por Artículo por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrToCompra_aAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

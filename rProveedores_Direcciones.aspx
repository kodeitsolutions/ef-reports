<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_Direcciones.aspx.vb" Inherits="rProveedores_Direcciones" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Direcciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_Direcciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

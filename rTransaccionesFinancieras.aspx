<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTransaccionesFinancieras.aspx.vb" Inherits="rTransaccionesFinancieras" %>
...
<head runat="server">
    <title>Listado de Transacciones Financieras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTransaccionesFinancieras" runat="server" AutoDataBind="true"

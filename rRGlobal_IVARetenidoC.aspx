<%@ page language="VB" autoeventwireup="false" inherits="rRGlobal_IVARetenidoC" CodeFile ="~/Administrativo/Reportes/rRGlobal_IVARetenidoC.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Global de IVA Retenido a Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRGlobal_IVARetenidoC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

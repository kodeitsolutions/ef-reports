...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_fFacturas_Ventas"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_fFacturas_Ventas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("         Facturas.Dir_Fis                AS Dir_Fis, ")
            loConsulta.AppendLine("         Clientes.Telefonos              AS Telefonos, ")
            loConsulta.AppendLine("         Clientes.Correo                 AS Correo, ")
            ...
            lcPorcentajesImpueto = lcPorcentajesImpueto & " IVA"
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("CGS_fFacturas_Ventas", laDatosReporte)
            lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".", ",")
            ...
            Me.crvCGS_fFacturas_Ventas.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fTarjetas" CodeFile="fTarjetas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tarjetas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTarjetas" runat="server" AutoDataBind="true"

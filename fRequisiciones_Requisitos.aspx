<%@ Page Language="VB" AutoEventWireup="false" Inherits="fRequisiciones_Requisitos" CodeFile="fRequisiciones_Requisitos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Requisiciones con sus Requisitos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfRequisiciones_Requisitos" runat="server" AutoDataBind="true"

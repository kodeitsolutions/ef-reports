<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque_BFC_GPV" CodeFile="fPagos_Cheque_BFC_GPV.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque_BFC_GPV" runat="server" AutoDataBind="true"

...
Partial Class KDE_rRDetallada_ISLRRProveedoresXML
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("         CASE WHEN Ordenes_Pagos.Fec_Ini < '20180820' AND Ordenes_Pagos.Fec_Ini >= '20180801'")
            ...
            loConsulta.AppendLine("       COALESCE((SELECT CASE WHEN Ordenes_Pagos.Fec_Ini < '20180820' AND Ordenes_Pagos.Fec_Ini >= '20180801'")
            ...
            loConsulta.AppendLine("			COALESCE((SELECT CASE WHEN Recibos.Fec_Ini < '20180820' AND Recibos.Fec_Ini >= '20180801'")
            ...
            'loConsulta.AppendLine("						    AND Cod_Con IN ('R005', 'R405')")
            'loConsulta.AppendLine("			),@lnCero)														AS Monto_Retenido,")
            loConsulta.AppendLine("			COALESCE((SELECT CASE WHEN Renglones_Recibos.Fec_Ini < '20180820' AND Renglones_Recibos.Fec_Ini >= '20180801'")
            loConsulta.AppendLine("                               THEN (Renglones_Recibos.Mon_Net/100000)")
            loConsulta.AppendLine("                               ELSE Renglones_Recibos.Mon_Net")
            loConsulta.AppendLine("                         END")
            loConsulta.AppendLine("					  FROM Renglones_Recibos")

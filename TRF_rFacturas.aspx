<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rFacturas.aspx.vb"
    Inherits="TRF_rFacturas" %>
...
<head runat="server">
    <title>Listado de Facturas (TRF)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvTRF_rFacturas" runat="server" AutoDataBind="true"

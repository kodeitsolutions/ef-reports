<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fFechas_Seguimientos_Ventas.aspx.vb" Inherits="fFechas_Seguimientos_Ventas" %>
...
<head runat="server">
    <title>Formato de Fechas y Seguimientos de Ventas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFechas_Seguimientos_Ventas" runat="server" AutoDataBind="true"

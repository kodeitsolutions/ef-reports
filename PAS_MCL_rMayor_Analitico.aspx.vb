...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "PAS_MCL_rMayor_Analitico"
'-------------------------------------------------------------------------------------------'
Partial Class PAS_MCL_rMayor_Analitico
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		@lnCero AS Saldo_Inicial, A.Categoria, A.Fecha, A.Debe, A.Haber,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("PAS_MCL_rMayor_Analitico", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvPAS_MCL_rMayor_Analitico.ReportSource = loObjetoReporte

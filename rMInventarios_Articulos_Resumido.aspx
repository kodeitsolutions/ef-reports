<%@ page language="VB" autoeventwireup="false" CodeFile="rMInventarios_Articulos_Resumido.aspx.vb" inherits="rMInventarios_Articulos_Resumido" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Inventarios por Artículos Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMInventarios_Articulos_Resumido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

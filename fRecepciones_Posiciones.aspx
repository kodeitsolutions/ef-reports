<%@ Page Language="VB" AutoEventWireup="false" Inherits="fRecepciones_Posiciones" CodeFile="fRecepciones_Posiciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Notas de Recepción con sus Posiciones</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfRecepciones_Posiciones" runat="server" AutoDataBind="true"

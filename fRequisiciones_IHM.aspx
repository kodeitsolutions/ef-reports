<%@ page language="VB" autoeventwireup="false" inherits="fRequisiciones_IHM" CodeFile="fRequisiciones_IHM.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRequisiciones_IHM" runat="server" AutoDataBind="true"

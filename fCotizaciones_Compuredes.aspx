<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Compuredes" CodeFile="fCotizaciones_Compuredes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cotización COMPUREDES</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Compuredes" runat="server" AutoDataBind="true"

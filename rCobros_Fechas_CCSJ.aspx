<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCobros_Fechas_CCSJ.aspx.vb" Inherits="rCobros_Fechas_CCSJ" %>
...
<head runat="server">
    <title>Reporte de Cobros por Fechas CCSJ</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCobros_Fechas_CCSJ" runat="server" AutoDataBind="true"

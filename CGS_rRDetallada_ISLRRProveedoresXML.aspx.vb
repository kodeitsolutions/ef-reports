...
Partial Class CGS_rRDetallada_ISLRRProveedoresXML
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("                '-'                                     AS Tipo_Pago,")
            loConsulta.AppendLine("                '-'                                     AS Numero_Pago,")
            loConsulta.AppendLine("                ROUND(Renglones_Recibos.Mon_Net * 100 / CAST (SUBSTRING(Renglones_Recibos.val_car,0, LEN(Renglones_Recibos.val_car)) AS DECIMAL (28,2)),2) AS Base_Retencion,")
            ...
            loConsulta.AppendLine("                Renglones_Recibos.Mon_Net               AS Monto_Retenido,")
            ...
            'loConsulta.AppendLine("     AND Renglones_REcibos " & lcParametro0Hasta)

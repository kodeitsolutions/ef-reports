...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fCotizaciones_Ventas_Vivophone"
'-------------------------------------------------------------------------------------------'
Partial Class fCotizaciones_Ventas_Vivophone
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCotizaciones_Ventas_Vivophone", laDatosReporte)
            ...
            Me.crvfCotizaciones_Ventas_Vivophone.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS: 18/02/10: Ajusto el reporte para mostrar el logo de Stratos
'-------------------------------------------------------------------------------------------'

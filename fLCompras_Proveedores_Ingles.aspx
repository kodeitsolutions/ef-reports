<%@ page language="VB" autoeventwireup="false" inherits="fLCompras_Proveedores_Ingles" CodeFile="fLCompras_Proveedores_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Formas Libres a Proveedores en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfLCompras_Proveedores_Ingles" runat="server" AutoDataBind="true"

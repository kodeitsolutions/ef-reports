...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fPagos_Check_Format2"
'-------------------------------------------------------------------------------------------'
Partial Class fPagos_Check_Format2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Detalles_Pagos.Fec_Ini As Fec_Pag,")
            ...
            loComandoSeleccionar.AppendLine("                       AND Detalles_Pagos.Tip_Ope NOT IN ('Efectivo')")
            loComandoSeleccionar.AppendLine(" JOIN Proveedores ON Pagos.Cod_Pro   =   Proveedores.Cod_Pro")
            loComandoSeleccionar.AppendLine(" JOIN Cuentas_Bancarias ON  Detalles_Pagos.Cod_Cue =   Cuentas_Bancarias.Cod_Cue")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fPagos_Check_Format2", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfPagos_Check_Format2.ReportSource = loObjetoReporte

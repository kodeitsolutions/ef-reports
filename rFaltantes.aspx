<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFaltantes.aspx.vb" Inherits="rFaltantes" %>
...
<head runat="server">
    <title>Reporte de Faltantes por Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFaltantes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

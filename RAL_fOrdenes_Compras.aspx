<%@ page language="VB" autoeventwireup="false" inherits="RAL_fOrdenes_Compras" CodeFile="RAL_fOrdenes_Compras.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras (RAL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvRAL_fOrdenes_Compras" runat="server" AutoDataBind="true"

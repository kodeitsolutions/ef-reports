<%@ page language="VB" autoeventwireup="false" inherits="fBancos" CodeFile="fBancos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfBancos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rListado_CedulasProduccion.aspx.vb" Inherits="CGS_rListado_CedulasProduccion" %>
...
<head runat="server">
    <title>Listado de Cédulas de Producción (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rListado_CedulasProduccion" runat="server" AutoDataBind="true"

Imports System.Data
Partial Class rCCobrar_Clientes_2
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           And Cuentas_Cobrar.Mon_Sal      BETWEEN " & lcParametro14Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCCobrar_Clientes_2", laDatosReporte)
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' JFP: 14/08/12: Programacion inicial, adecuacion desde otro reporte.
'-------------------------------------------------------------------------------------------'

<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_VentasFiscal" 
	CodeFile="fFacturas_VentasFiscal.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas Fiscal</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_VentasFiscal" runat="server" AutoDataBind="true"

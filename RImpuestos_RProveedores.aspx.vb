...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "RImpuestos_RProveedores"
'-------------------------------------------------------------------------------------------'
Partial Class RImpuestos_RProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("      FROM Cuentas_Pagar, Proveedores, Vendedores    ")
            loComandoSeleccionar.AppendLine("      WHERE (Cuentas_Pagar.Cod_tip = 'Retiva' OR Cuentas_Pagar.Cod_tip = 'Riva')")
            loComandoSeleccionar.AppendLine("      					AND Proveedores.Cod_Pro = Cuentas_Pagar.Cod_Pro")
            loComandoSeleccionar.AppendLine("      					AND Vendedores.Cod_Ven = Cuentas_Pagar.Cod_Ven   ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("RImpuestos_RProveedores", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvRImpuestos_RProveedores.ReportSource = loObjetoReporte

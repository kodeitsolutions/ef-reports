<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_dGenerales.aspx.vb" Inherits="rProveedores_dGenerales" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Datos Generales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_dGenerales" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

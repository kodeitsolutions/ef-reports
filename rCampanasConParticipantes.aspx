<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCampanasConParticipantes.aspx.vb"  Inherits="rCampanasConParticipantes" %>
...
<head runat="server">
    <title>Reporte de Campañas de Marketing</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCampanasConParticipantes" runat="server" AutoDataBind="true"

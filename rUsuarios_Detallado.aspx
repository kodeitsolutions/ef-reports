<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUsuarios_Detallado.aspx.vb" Inherits="rUsuarios_Detallado" %>
...
<head runat="server">
    <title>Reporte de Listado de Usuarios Detallado</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrUsuarios_Detallado" runat="server" AutoDataBind="true"

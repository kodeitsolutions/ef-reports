...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLibro_Ventas_Venezuela"
'-------------------------------------------------------------------------------------------'
Partial Class rLibro_Ventas_Venezuela
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '*****************	Facturas de Venta anuladas (no generan CxC) *************************************  
            ...
            loComandoSeleccionar.AppendLine("			AND " & lcParametro2Hasta)
            loComandoSeleccionar.AppendLine("			AND Facturas.Cod_Suc      BETWEEN " & lcParametro3Desde)
            loComandoSeleccionar.AppendLine("			AND " & lcParametro3Hasta)
            If lcParametro5Desde = "Igual" Then
                loComandoSeleccionar.AppendLine(" 		AND Facturas.Cod_Rev BETWEEN " & lcParametro4Desde)
            Else
                loComandoSeleccionar.AppendLine(" 		AND Facturas.Cod_Rev NOT BETWEEN " & lcParametro4Desde)
            End If
            loComandoSeleccionar.AppendLine(" 			AND " & lcParametro4Hasta)
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
        ...
        '*****************	Retenciones de IVA, si aplican *************************************  
            ...
            loComandoSeleccionar.AppendLine("SELECT	Documento, Control, Fec_Ini, Nom_Cli, Rif, Cod_Tip, Doc_Ori,")
            loComandoSeleccionar.AppendLine("		Mon_Des, Mon_Rec, Por_Des, Por_Rec, Mon_Otr1, Mon_Otr2, Mon_Otr3,")
            loComandoSeleccionar.AppendLine("		Mon_Net, Mon_Bru, Mon_Exe, Cod_Imp, Por_Imp1, Mon_Imp1,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLibro_Ventas_Venezuela", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrLibro_Ventas_Venezuela.ReportSource = loObjetoReporte

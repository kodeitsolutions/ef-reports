<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rResumenCostos_ArtProd.aspx.vb" Inherits="CGS_rResumenCostos_ArtProd" %>
...
<head runat="server">
    <title>Resumen de Costos de Artículos Producidos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rResumenCostos_ArtProd" runat="server" AutoDataBind="true"

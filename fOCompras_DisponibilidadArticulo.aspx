<%@ Page Language="VB" AutoEventWireup="false" Inherits="fOCompras_DisponibilidadArticulo" CodeFile="fOCompras_DisponibilidadArticulo.aspx.vb" %>
...
<head runat="server">
    <title>Ordenes de Compras - Disponibilidad de Artículos por Artículo</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfOCompras_DisponibilidadArticulo" runat="server" AutoDataBind="true"

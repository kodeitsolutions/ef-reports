<%@ page language="VB" autoeventwireup="false" CodeFile="fCuentas_Pagar.aspx.vb" inherits="fCuentas_Pagar" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Pagar" runat="server" AutoDataBind="true"

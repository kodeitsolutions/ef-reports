<%@ page language="VB" autoeventwireup="false" inherits="CGS_fPagos_Cheque02" CodeFile="CGS_fPagos_Cheque02.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque en Pagos (CEGASA) [Mercantil]</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fPagos_Cheque02" runat="server" AutoDataBind="true"

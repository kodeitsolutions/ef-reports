<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque08" CodeFile="fOrdenes_Cheque08.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque08" runat="server" AutoDataBind="true"

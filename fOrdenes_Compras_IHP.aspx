<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Compras_IHP" CodeFile="fOrdenes_Compras_IHP.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras In Hand Provider</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Compras_IHP" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="MCL_rCRetencion_PatenteProveedores" CodeFile="MCL_rCRetencion_PatenteProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de Patente de Proveedores (MERCALUM)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrMCL_rCRetencion_PatenteProveedores" runat="server" AutoDataBind="true"

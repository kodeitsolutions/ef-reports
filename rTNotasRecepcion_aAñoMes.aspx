<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTNotasRecepcion_aAñoMes.aspx.vb" Inherits="rTNotasRecepcion_aAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Notas de Recepción por Artículo por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTNotasRecepcion_aAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

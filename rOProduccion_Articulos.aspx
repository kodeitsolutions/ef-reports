<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOProduccion_Articulos.aspx.vb" Inherits="rOProduccion_Articulos" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Producción por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOProduccion_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

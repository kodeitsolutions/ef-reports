<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEntregas_Articulos_CCSJ.aspx.vb" Inherits="rEntregas_Articulos_CCSJ" %>
...
<head runat="server">
    <title>Reporte de Entregas por Artículos (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEntregas_Articulos_CCSJ" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_vMes.aspx.vb" Inherits="rCotizaciones_vMes" %>
...
<head runat="server">
    <title>Reporte de Total de Cotizaciones por Vendedores Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_vMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rImpuestos_Municipales_Departamentos.aspx.vb" Inherits="rImpuestos_Municipales_Departamentos" %>
...
<head runat="server">
    <title>Listado de Impuestos Municipales por Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrImpuestos_Municipales_Departamentos" runat="server" AutoDataBind="true"

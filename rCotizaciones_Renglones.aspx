<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_Renglones.aspx.vb" Inherits="rCotizaciones_Renglones" %>
...
<head runat="server">
    <title>Reporte de Cotizaciones con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Renglones_iPos.aspx.vb" Inherits="rFacturas_Renglones_iPos" %>
...
<head runat="server">
    <title>Reporte de Facturas con sus Renglones iPos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Renglones_iPos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

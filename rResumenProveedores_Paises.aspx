<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumenProveedores_Paises.aspx.vb" Inherits="rResumenProveedores_Paises" %>
...
<head runat="server">
    <title>Resumen de Proveedores por Paises</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrResumenProveedores_Paises" runat="server" AutoDataBind="true"

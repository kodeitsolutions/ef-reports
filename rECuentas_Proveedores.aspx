<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rECuentas_Proveedores.aspx.vb" Inherits="rECuentas_Proveedores" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrECuentas_Proveedores" runat="server" AutoDataBind="true"

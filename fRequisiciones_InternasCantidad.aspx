<%@ page language="VB" autoeventwireup="false" inherits="fRequisiciones_InternasCantidad" CodeFile="fRequisiciones_InternasCantidad.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones de Proveedores sin Precio</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRequisiciones_InternasCantidad" runat="server" AutoDataBind="true"

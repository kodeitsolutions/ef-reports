<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rLibro_Diario.aspx.vb" Inherits="KDE_rLibro_Diario" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_rLibro_Diario" runat="server" AutoDataBind="true"

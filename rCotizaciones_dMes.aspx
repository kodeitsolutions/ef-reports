<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_dMes.aspx.vb" Inherits="rCotizaciones_dMes" %>
...
<head runat="server">
    <title>Reporte de Total de Cotizaciones por Departamentos Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_dMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_Resumen_Iva.aspx.vb"
    Inherits="CGS_Resumen_Iva" %>
...
<head runat="server">
    <title>Resumen de I.V.A. (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCGS_Resumen_Iva" runat="server" AutoDataBind="true"

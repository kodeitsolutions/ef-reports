<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTComprasProveedor_aAñoMes.aspx.vb" Inherits="rTComprasProveedor_aAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Compras a Proveedores por Artículo por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTComprasProveedor_aAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

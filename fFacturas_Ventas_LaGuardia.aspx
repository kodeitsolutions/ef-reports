.<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_LaGuardia" CodeFile="fFacturas_Ventas_LaGuardia.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_LaGuardia" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rRConciliacion_Bancaria.aspx.vb" Inherits="TRF_rRConciliacion_Bancaria" %>
...
<head runat="server">
    <title>Resumen de Conciliaíón Bancaria (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rRConciliacion_Bancaria" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

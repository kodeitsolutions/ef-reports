...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rAVencimiento_dZona"
'-------------------------------------------------------------------------------------------'
Partial Class rAVencimiento_dZona
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("  ROW_NUMBER() OVER(PARTITION BY Clientes.Cod_Zon ORDER BY Clientes.Cod_Zon, Cuentas_Cobrar.Documento, Cuentas_Cobrar.Fec_Ini, Cuentas_Cobrar.Fec_Fin) AS Fila, ")
            loComandoSeleccionar.AppendLine("  		Zonas.Cod_Zon,   ")
            ...
            loComandoSeleccionar.AppendLine("     AND Zonas.Status In (" & lcParametro13Desde & ")")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAVencimiento_dZona", laDatosReporte)
            ...
            Me.crvrAVencimiento_dZona.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS:  23/06/10: Filtro “Estatus de la Zona:”
'-------------------------------------------------------------------------------------------'
<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCuentas_Pagar.aspx.vb" Inherits="CGS_rCuentas_Pagar" %>
...
<head runat="server">
    <title>Listado de Cuentas por Pagar (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rCuentas_Pagar" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

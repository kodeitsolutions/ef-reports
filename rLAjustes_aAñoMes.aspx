<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLAjustes_aAñoMes.aspx.vb" Inherits="rLAjustes_aAñoMes" %>
...
<head runat="server">
    <title>Reporte de Ajustes por Artículos Totalizados por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLAjustes_aAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

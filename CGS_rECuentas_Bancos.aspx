<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rECuentas_Bancos.aspx.vb" Inherits="CGS_rECuentas_Bancos" %>
...
<head runat="server">
    <title>Reporte de Estado de Cuentas de Bancos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rECuentas_Bancos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gVendedores.aspx.vb" Inherits="rMargen_gVendedores" %>
...
<head runat="server">
    <title>Margen de Ganancia por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gVendedores" runat="server" AutoDataBind="true"

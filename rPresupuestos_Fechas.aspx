<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPresupuestos_Fechas.aspx.vb" Inherits="rPresupuestos_Fechas" %>
...
<head runat="server">
    <title>Reporte de Presupuestos por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPresupuestos_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="rPrecios_Almacenes_Resumido" CodeFile="rPrecios_Almacenes_Resumido.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Precios por Departamentos y Almacén (Resumido)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPrecios_Almacenes_Resumido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

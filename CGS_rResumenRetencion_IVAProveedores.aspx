<%@ page language="VB" autoeventwireup="false" inherits="CGS_rResumenRetencion_IVAProveedores" 
CodeFile="CGS_rResumenRetencion_IVAProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Retención de IVA de Proveedores (CEGASA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCGS_rResumenRetencion_IVAProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

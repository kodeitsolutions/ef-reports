<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCFormulaciones_Renglones.aspx.vb" Inherits="rCFormulaciones_Renglones" %>
...
<head runat="server">
    <title>Reporte de Control de Formulaciones con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCFormulaciones_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

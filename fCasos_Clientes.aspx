<%@ page language="VB" autoeventwireup="false" inherits="fCasos_Clientes" CodeFile="fCasos_Clientes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCasos_Clientes" runat="server" AutoDataBind="true"

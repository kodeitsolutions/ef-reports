<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rTAlmacenes_Renglones.aspx.vb" Inherits="CGS_rTAlmacenes_Renglones" %>
...
<head runat="server">
    <title>Listado de Traslados entre Almacenes con sus Renglones (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rTAlmacenes_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

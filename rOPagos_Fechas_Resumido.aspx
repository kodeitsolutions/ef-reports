<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_Fechas_Resumido.aspx.vb" Inherits="rOPagos_Fechas_Resumido" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_Fechas_Resumido" runat="server" AutoDataBind="true"

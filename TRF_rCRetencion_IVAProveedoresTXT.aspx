<%@ Page Language="VB" AutoEventWireup="false" Inherits="TRF_rCRetencion_IVAProveedoresTXT" CodeFile="TRF_rCRetencion_IVAProveedoresTXT.aspx.vb" %>
...
<head runat="server">
    <title>Archivo TXT con Retenciones de Impuesto de Proveedores (TRF)</title>

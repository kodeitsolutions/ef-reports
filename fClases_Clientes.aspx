<%@ page language="VB" autoeventwireup="false" inherits="fClases_Clientes" CodeFile="fClases_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Clases de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfClases_Clientes" runat="server" AutoDataBind="true"

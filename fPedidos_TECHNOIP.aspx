<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPedidos_TECHNOIP" CodeFile="fPedidos_TECHNOIP.aspx.vb" %>
...
<head runat="server">
    <title>Purchase Order(TECNO IP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPedidos_TECHNOIP" runat="server" AutoDataBind="true"

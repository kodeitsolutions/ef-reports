Imports System.Data
Partial Class rCCobrar_Clientes_CCSJ_Seguros
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Control, ")
            loComandoSeleccionar.AppendLine("           Tip_Doc, ")
            loComandoSeleccionar.AppendLine("           Mon_Imp1, ")
            loComandoSeleccionar.AppendLine("           Mon_Bru, ")
            loComandoSeleccionar.AppendLine("           Mon_Net, ")
            loComandoSeleccionar.AppendLine("           Mon_Sal  ")
            loComandoSeleccionar.AppendLine(" FROM      #tmpDocumentos ")
            loComandoSeleccionar.AppendLine(" WHERE     Cod_Tip <> 'ATD' AND Cod_Tip <> 'ATC' ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCCobrar_Clientes_CCSJ_Seguros", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCCobrar_Clientes_CCSJ_Seguros.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' JJD: 14/11/13: Programacion del reporte segun especificaciones de VMartinez
'-------------------------------------------------------------------------------------------'

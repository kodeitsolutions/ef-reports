<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCobros_Fechas_Ipos.aspx.vb" Inherits="rTCobros_Fechas_Ipos" %>
...
<head runat="server">
    <title>Total Cobros por Fechas iPos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCobros_Fechas_Ipos" runat="server" AutoDataBind="true"

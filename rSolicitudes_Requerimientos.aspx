<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSolicitudes_Requerimientos.aspx.vb" Inherits="rSolicitudes_Requerimientos" %>
...
<head runat="server">
    <title>Reporte de Solicitudes y Requerimientos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSolicitudes_Requerimientos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

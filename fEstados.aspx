<%@ page language="VB" autoeventwireup="false" inherits="fEstados" CodeFile="fEstados.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Estados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEstados" runat="server" AutoDataBind="true"

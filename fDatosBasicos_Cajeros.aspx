<%@ page language="VB" autoeventwireup="false" inherits="fDatosBasicos_Cajeros" CodeFile="fDatosBasicos_Cajeros.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cajeros: Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatosBasicos_Cajeros" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Articulos.aspx.vb" Inherits="rLVentas_Articulos" %>
...
<head runat="server">
    <title>Reporte de Formas Libres por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLVentas_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

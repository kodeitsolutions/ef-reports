<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fFacturas_Ventas_Presentacion" CodeFile="CSJ_fFacturas_Ventas_Presentacion.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fFacturas_Ventas_Presentacion" runat="server" AutoDataBind="true"

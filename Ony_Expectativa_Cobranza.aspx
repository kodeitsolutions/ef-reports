<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ony_Expectativa_Cobranza.aspx.vb" Inherits="Ony_Expectativa_Cobranza" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Cobrar por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvOny_Expectativa_Cobranza" runat="server" AutoDataBind="true"

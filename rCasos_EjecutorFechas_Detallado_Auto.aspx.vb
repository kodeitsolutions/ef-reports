...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCasos_EjecutorFechas_Detallado_Auto"
'-------------------------------------------------------------------------------------------'
Partial Class rCasos_EjecutorFechas_Detallado_Auto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
       ...
       'Try
            ...
            loConsulta.AppendLine("SELECT      Casos.Cod_Reg                                                               AS Cod_Reg,")
            loConsulta.AppendLine("            Clientes.Nom_Cli                                                            AS Nom_Reg,")
            loConsulta.AppendLine("            COALESCE(Renglones_Casos.Cod_Eje, Casos.Cod_Eje)                            AS Cod_Eje,")
            ...
            loConsulta.AppendLine("ORDER BY    COALESCE(Renglones_Casos.Cod_Eje, Casos.Cod_Eje) ASC,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCasos_EjecutorFechas_Detallado_Auto", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCasos_EjecutorFechas_Detallado_Auto.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' RJG: 17/05/15: Se agregó el nombre del Cliente, y se ajustó la fecha junto al ejecutor.   '
'-------------------------------------------------------------------------------------------'
' RJG: 18/05/15: Se ajustó el ordenamiento de los registros.                                '
'-------------------------------------------------------------------------------------------'

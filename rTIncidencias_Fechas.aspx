<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTIncidencias_Fechas.aspx.vb" Inherits="rTIncidencias_Fechas" %>
...
<head runat="server">
    <title>Listado Total de Incidencias por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTIncidencias_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

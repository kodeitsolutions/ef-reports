<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_Precios1.aspx.vb" Inherits="rProveedores_Precios1" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Precios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_Precios1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

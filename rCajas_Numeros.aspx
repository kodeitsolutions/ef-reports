<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCajas_Numeros.aspx.vb" Inherits="rCajas_Numeros" %>
...
<head runat="server">
    <title>Listado de Cajas por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCajas_Numeros" runat="server" AutoDataBind="true"

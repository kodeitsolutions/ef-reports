<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSeguimientos_lCotizaciones.aspx.vb" Inherits="rSeguimientos_lCotizaciones" %>
...
<head runat="server">
	<title>Reporte de Facturas por Números</title>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrSeguimientos_lCotizaciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRequisiciones_Articulos.aspx.vb" Inherits="rRequisiciones_Articulos" %>
...
<head runat="server">
    <title>Reporte  de Requisiciones por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRequisiciones_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

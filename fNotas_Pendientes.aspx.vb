...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fNotas_Pendientes"
'-------------------------------------------------------------------------------------------'
Partial Class fNotas_Pendientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Cod_Usu = '" & goUsuario.pcCodigo.ToString & "'")
            loComandoSeleccionar.AppendLine("           And Status = 'Pendiente'")
            loComandoSeleccionar.AppendLine("           ORDER BY Color, Fec_Ini")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fNotas_Pendientes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfNotas_Pendientes.ReportSource = loObjetoReporte

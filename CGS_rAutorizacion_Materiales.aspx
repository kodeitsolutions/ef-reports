<%@ page language="VB" autoeventwireup="false" inherits="CGS_rAutorizacion_Materiales" CodeFile="CGS_rAutorizacion_Materiales.aspx.vb" %>
...
<head runat="server">
    <title>Autorización de Ingreso de Materiales (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rAutorizacion_Materiales" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="CGS_fRequisiciones_Internas" CodeFile="CGS_fRequisiciones_Internas.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones Internas (CEGASA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fRequisiciones_Internas" runat="server" AutoDataBind="true"

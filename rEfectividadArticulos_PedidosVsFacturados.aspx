<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEfectividadArticulos_PedidosVsFacturados.aspx.vb" Inherits="rEfectividadArticulos_PedidosVsFacturados" %>
...
<head runat="server">
    <title>Reporte de Efectividad de Articulos Pedidos Vs Facturados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEfectividadArticulos_PedidosVsFacturados" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

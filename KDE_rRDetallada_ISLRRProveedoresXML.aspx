<%@ page language="VB" autoeventwireup="false" inherits="KDE_rRDetallada_ISLRRProveedoresXML" CodeFile="KDE_rRDetallada_ISLRRProveedoresXML.aspx.vb" %>
...
<head runat="server">
    <title>Relación Detallada de ISLR Retenido XML (KDE)</title>

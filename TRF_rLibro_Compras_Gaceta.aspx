<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLibro_Compras_Gaceta.aspx.vb"
    Inherits="TRF_rLibro_Compras_Gaceta" %>
...
<head runat="server">
    <title>Libro de Compras Gaceta N° 41.239 (TRF)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTRF_rLibro_Compras_Gaceta" runat="server" AutoDataBind="true"

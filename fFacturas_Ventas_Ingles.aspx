<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Ingles" CodeFile="fFacturas_Ventas_Ingles.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Ingles" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCompras_Proveedores.aspx.vb" Inherits="rTCompras_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Total Compras por Proveedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCompras_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

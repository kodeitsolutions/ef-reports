<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRClientes" CodeFile="rCRetencion_ISLRClientes.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Retención de ISLR de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_ISLRClientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

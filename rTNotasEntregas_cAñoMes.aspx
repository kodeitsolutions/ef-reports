<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTNotasEntregas_cAñoMes.aspx.vb" Inherits="rTNotasEntregas_cAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Notas de Entrega de Cliente por Cliente por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTNotasEntregas_cAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

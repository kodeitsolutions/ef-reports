...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "MCL_rLibro_Ventas"
'-------------------------------------------------------------------------------------------'
Partial Class MCL_rLibro_Ventas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("   SELECT  Cuentas_Cobrar.Cod_Tip 					            AS Tipo,")
            ...
            loComandoSeleccionar.AppendLine("           ND       						                    AS Mon_Exe,")
            loComandoSeleccionar.AppendLine("   		Cuentas_Cobrar.Cod_Imp								AS Cod_Imp,     ")
            loComandoSeleccionar.AppendLine("   		Cuentas_Cobrar.Por_Imp1 							AS Por_Imp1,  ")
            loComandoSeleccionar.AppendLine("   		CASE WHEN Cuentas_Cobrar.Status = 'Anulado'")
            loComandoSeleccionar.AppendLine("                THEN @lnCero")
            ...
            loComandoSeleccionar.AppendLine("                THEN Retenciones_Documentos.Num_Com")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("MCL_rLibro_Ventas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvMCL_rLibro_Ventas.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "MCL_rResumenRetencion_PATProveedores"
'-------------------------------------------------------------------------------------------'
Partial Class MCL_rResumenRetencion_PATProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		COALESCE(( SELECT Fec_Ini")
            ...
            'loComandoSeleccionar.AppendLine("       Retenciones_Documentos.Mon_Bas	AS Base_Retencion,")
            loComandoSeleccionar.AppendLine("       CASE WHEN Retenciones_Documentos.Fec_Ini < '20180820' AND Retenciones_Documentos.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("            THEN (Retenciones_Documentos.Mon_Bas/100000)")
            loComandoSeleccionar.AppendLine("            ELSE Retenciones_Documentos.Mon_Bas")
            loComandoSeleccionar.AppendLine("       END                                 AS Base_Retencion,")
            loComandoSeleccionar.AppendLine("       Retenciones_Documentos.Por_Ret	    AS Porcentaje_Retenido,")
            ...
            loComandoSeleccionar.AppendLine("       Cuentas_Pagar.Mon_Net				AS Monto_Documento,")
            'loComandoSeleccionar.AppendLine("       Cuentas_Pagar.Mon_Otr1		        AS Base_Retencion,")
            loComandoSeleccionar.AppendLine("       CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("            THEN (Cuentas_Pagar.Mon_Otr1/100000)")
            loComandoSeleccionar.AppendLine("            ELSE Cuentas_Pagar.Mon_Otr1")
            loComandoSeleccionar.AppendLine("       END                                 AS Base_Retencion,")
            loComandoSeleccionar.AppendLine("       CASE WHEN Cuentas_Pagar.Referencia = ''")
            loComandoSeleccionar.AppendLine("            THEN 0")
            loComandoSeleccionar.AppendLine("            ELSE CAST(Cuentas_Pagar.Referencia AS DECIMAL (28,2))")
            ...
            loComandoSeleccionar.AppendLine("WHERE Cuentas_Pagar.Cod_Tip = 'RETPAT'")
            loComandoSeleccionar.AppendLine("   AND	Cuentas_Pagar.Status <> 'Anulado'")
            loComandoSeleccionar.AppendLine("   AND	Cuentas_Pagar.Tip_Ori = ''")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("MCL_rResumenRetencion_PATProveedores", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrMCL_rResumenRetencion_PATProveedores.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' RJG: 09/04/15: Codigo inicial, a partir de MCL_rResumenRetencion_PATProveedores.                    '
'-------------------------------------------------------------------------------------------'

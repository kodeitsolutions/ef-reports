<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rStock_Lote.aspx.vb" Inherits="rStock_Lote" %>
...
<head runat="server">
    <title>Reporte de Stock por Lote</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrStock_Lote" runat="server" AutoDataBind="true"

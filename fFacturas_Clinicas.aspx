<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Clinicas" CodeFile="fFacturas_Clinicas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Clinicas" runat="server" AutoDataBind="true"

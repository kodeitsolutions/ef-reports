<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIndicador_Requisiciones_RecVsProc.aspx.vb" Inherits="rIndicador_Requisiciones_RecVsProc" %>
...
<head runat="server">
    <title>Indicador de Requisiciones Recibidas vs Procesadas por Comprador</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrIndicador_Requisiciones_RecVsProc" runat="server" AutoDataBind="true"

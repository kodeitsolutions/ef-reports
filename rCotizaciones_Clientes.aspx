<%@ page language="VB" autoeventwireup="false" inherits="rCotizaciones_Clientes" CodeFile="rCotizaciones_Clientes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_Clientes" runat="server" AutoDataBind="true"

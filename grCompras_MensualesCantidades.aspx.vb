...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "grCompras_MensualesCantidades"
'-------------------------------------------------------------------------------------------'
Partial Class grCompras_MensualesCantidades
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 1 THEN 'Ene' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 2 THEN 'Feb' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 3 THEN 'Mar' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 4 THEN 'Abr' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 5 THEN 'May' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 6 THEN 'Jun' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 7 THEN 'Jul' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 8 THEN 'Ago' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 9 THEN 'Sep' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 10 THEN 'Oct' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 11 THEN 'Nov' ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 12 THEN 'Dic' ")
            loComandoSeleccionar.AppendLine(" 	END AS Mes_Letras, ")
            loComandoSeleccionar.AppendLine(" 	CASE  ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 1 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 2 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 3 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 4 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 5 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 6 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 7 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 8 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 9 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 10 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 11 THEN SUM(Renglones_Compras.Can_Art1) ")
            loComandoSeleccionar.AppendLine(" 		WHEN DATEPART(MONTH, Compras.Fec_Ini) = 12 THEN SUM(Renglones_Compras.Can_Art1) ")
            ...
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 1 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Enero,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 2 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Febrero,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 3 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Marzo,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 4 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Abril,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 5 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Mayo,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 6 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Junio,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 7 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Julio,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 8 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Agosto,")
            loComandoSeleccionar.AppendLine(" CASE")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 9 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Septiembre,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 10 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Octubre,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 11 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            loComandoSeleccionar.AppendLine(" END AS Noviembre,")
            loComandoSeleccionar.AppendLine(" CASE  ")
            loComandoSeleccionar.AppendLine(" 	WHEN Mes = 12 THEN SUM(Cantidad)")
            loComandoSeleccionar.AppendLine(" 	ELSE 0")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("grCompras_MensualesCantidades", laDatosReporte)
            ...
            Me.crvgrCompras_MensualesCantidades.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFacturas_OEnvio_OnyxTD"
'-------------------------------------------------------------------------------------------'
Partial Class fFacturas_OEnvio_OnyxTD
   ...
   '         loComandoSeleccionar.AppendLine("ORDER BY Renglones_Facturas.Renglon ASC")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFacturas_OEnvio_OnyxTD", laDatosReporte)
            ...
            Me.crvfFacturas_OEnvio_OnyxTD.ReportSource = loObjetoReporte
...
' Fin del codigo																				'
'-----------------------------------------------------------------------------------------------'
' RJG: 08/06/12: Codigo inicial.																'
'-----------------------------------------------------------------------------------------------'
' RJG: 13/09/12: Se agregó el telefono de lea forma de transporte del documento de origen.		'
'-----------------------------------------------------------------------------------------------'

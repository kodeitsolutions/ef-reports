<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras.aspx.vb" Inherits="rLibro_Compras" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLibro_Compras" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Equipos.aspx.vb" Inherits="rAuditorias_Equipos" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Equipos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Equipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

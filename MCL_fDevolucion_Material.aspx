<%@ page language="VB" autoeventwireup="false" inherits="MCL_fDevolucion_Material" CodeFile="MCL_fDevolucion_Material.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Devolución de Material (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_fDevolucion_Material" runat="server" AutoDataBind="true"

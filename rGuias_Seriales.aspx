<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGuias_Seriales.aspx.vb" Inherits="rGuias_Seriales" %>
...
<head runat="server">
    <title>Listado de Seriales en Guías de Despacho</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGuias_Seriales" runat="server" AutoDataBind="true"

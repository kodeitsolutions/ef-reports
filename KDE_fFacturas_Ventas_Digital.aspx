<%@ page language="VB" autoeventwireup="false" inherits="KDE_fFacturas_Ventas_Digital" CodeFile="KDE_fFacturas_Ventas_Digital.aspx.vb" %>
...
<head runat="server">
    <title>Copia Digital de Facturas de Ventas (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_fFacturas_Ventas_Digital" runat="server" AutoDataBind="true"

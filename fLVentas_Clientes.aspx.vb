Imports System.Data
Partial Class fLVentas_Clientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fLVentas_Clientes", laDatosReporte)
						lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".",",")
            ...
            Me.crvfLVentas_Clientes.ReportSource = loObjetoReporte

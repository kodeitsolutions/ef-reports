<%@ page language="VB" autoeventwireup="false" inherits="fPromociones" CodeFile="fPromociones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Promociones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPromociones" runat="server" AutoDataBind="true"

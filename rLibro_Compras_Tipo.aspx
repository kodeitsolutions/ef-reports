<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras_Tipo.aspx.vb" Inherits="rLibro_Compras_Tipo" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLibro_Compras_Tipo" runat="server" AutoDataBind="true"

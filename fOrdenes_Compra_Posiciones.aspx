<%@ Page Language="VB" AutoEventWireup="false" Inherits="fOrdenes_Compra_Posiciones" CodeFile="fOrdenes_Compra_Posiciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compra con sus Posiciones</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfOrdenes_Compra_Posiciones" runat="server" AutoDataBind="true"

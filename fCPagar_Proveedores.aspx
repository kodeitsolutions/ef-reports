<%@ page language="VB" autoeventwireup="false" inherits="fCPagar_Proveedores" CodeFile="fCPagar_Proveedores.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCPagar_Proveedores" runat="server" AutoDataBind="true"

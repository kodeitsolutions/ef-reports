<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCBancarias_ConCC"
    CodeFile="fCBancarias_ConCC.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Cuentas Bancarias con sus Cuentas Contables</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCBancarias_ConCC" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fPropiedades_Clientes" CodeFile="fPropiedades_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Propiedades de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPropiedades_Clientes" runat="server" AutoDataBind="true"

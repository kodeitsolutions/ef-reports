...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gTipo_Precio"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gTipo_Precio
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpGanancia(	Tip_Pre		CHAR(1),			")
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpFinal(	Tip_Pre		CHAR(1),			")
            loComandoSeleccionar.AppendLine("							Can_Fac		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Can_Dev		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Base_A		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Base_B		DECIMAL(28, 10),	")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Tip_Pre, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            loComandoSeleccionar.AppendLine("SELECT		Renglones_Facturas.Tip_Pre											AS Tip_Pre,")
            ...
            loComandoSeleccionar.AppendLine("			AND Renglones_Facturas.Tip_Pre	BETWEEN " & lcParametro18Desde & " AND " & lcParametro18Hasta)
            loComandoSeleccionar.AppendLine("GROUP BY	Renglones_Facturas.Tip_Pre")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine(" 	JOIN 	Renglones_Facturas ")
            loComandoSeleccionar.AppendLine(" 		ON	Renglones_Facturas.Doc_Ori = Renglones_dClientes.Documento")
            loComandoSeleccionar.AppendLine(" 		AND	Renglones_Facturas.Ren_Ori = Renglones_dClientes.Renglon")
            loComandoSeleccionar.AppendLine(" 	JOIN 	Vendedores ")
            ...
            loComandoSeleccionar.AppendLine("			AND Renglones_dClientes.Tip_Pre 	BETWEEN " & lcParametro18Desde & " AND " & lcParametro18Hasta)
            loComandoSeleccionar.AppendLine("GROUP BY	Renglones_Facturas.Tip_Pre")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Tip_Pre, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            loComandoSeleccionar.AppendLine("SELECT	Tip_Pre				AS Tip_Pre,")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Tip_Pre")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gTipo_Precio", laDatosReporte)
            ...
            Me.crvrMargen_gTipo_Precio.ReportSource = loObjetoReporte

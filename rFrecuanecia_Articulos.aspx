<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFrecuanecia_Articulos.aspx.vb" Inherits="rFrecuanecia_Articulos" %>
...
<head runat="server">
    <title>Reporte de Frecuencia de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFrecuanecia_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLibro_Ventas_SAKAN"
'-------------------------------------------------------------------------------------------'
Partial Class rLibro_Ventas_SAKAN
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLibro_Ventas_SAKAN", laDatosReporte )
            ...
            If (Me.Request.QueryString("salida").ToLower = "xls") Then
                ...
                Dim lcFileName As String = Me.Server.MapPath("~\Administrativo\Temporales\rLibro_Ventas_SAKAN_" & Guid.NewGuid().ToString("N") & ".xls")
                ...
                Me.Response.AppendHeader("content-disposition", "attachment; filename=rLibro_Ventas_SAKAN.xls")
            ...
            Me.crvrrLibro_Ventas_SAKAN.ReportSource = loObjetoReporte

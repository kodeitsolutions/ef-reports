<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_ComprasSP" CodeFile="CGS_fOrdenes_ComprasSP.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras S/P (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOrdenes_ComprasSP" runat="server" AutoDataBind="true"

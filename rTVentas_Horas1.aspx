<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Horas1.aspx.vb" Inherits="rTVentas_Horas1" %>
...
<head runat="server">
    <title>Reporte de Total Ventas por Horas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Horas1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

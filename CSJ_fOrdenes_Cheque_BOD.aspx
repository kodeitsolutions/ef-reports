<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fOrdenes_Cheque_BOD" CodeFile="CSJ_fOrdenes_Cheque_BOD.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fOrdenes_Cheque_BOD" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fTraslados_Almacenes_Alegria" CodeFile="fTraslados_Almacenes_Alegria.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Traslados entre Almacenes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTraslados_Almacenes_Alegria" runat="server" AutoDataBind="true"

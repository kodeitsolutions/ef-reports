<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFrecuanecia_Proveedores.aspx.vb" Inherits="rFrecuanecia_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Frecuencia de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFrecuanecia_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

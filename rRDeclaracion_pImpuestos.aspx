<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRDeclaracion_pImpuestos.aspx.vb" Inherits="rRDeclaracion_pImpuestos" %>
...
<head runat="server">
    <title>Resumen para la Declaración de Impuestos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRDeclaracion_pImpuestos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

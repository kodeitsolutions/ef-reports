...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCPagar_Proveedores"
'-------------------------------------------------------------------------------------------'
Partial Class rCPagar_Proveedores
	...
	Try
            ...
            loComandoSeleccionar.AppendLine("               WHEN Cuentas_Pagar.Status = 'Anulado' THEN 0")
            loComandoSeleccionar.AppendLine("               WHEN Tip_Doc = 'Credito' THEN Cuentas_Pagar.Mon_Bru *(-1)")
            ...
            loComandoSeleccionar.AppendLine("           (CASE ")
            loComandoSeleccionar.AppendLine("               WHEN Cuentas_Pagar.Status = 'Anulado' THEN 0")
            loComandoSeleccionar.AppendLine("               WHEN Tip_Doc = 'Credito' THEN Cuentas_Pagar.Mon_Net *(-1)")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rCPagar_Proveedores", laDatosReporte)       

            Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCPagar_Proveedores.ReportSource =	 loObjetoReporte	

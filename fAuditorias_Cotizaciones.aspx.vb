...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fAuditorias_Cotizaciones"
'-------------------------------------------------------------------------------------------'
Partial Class fAuditorias_Cotizaciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" FROM Auditorias,Cotizaciones ")
            loComandoSeleccionar.AppendLine(" WHERE     " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Documento=	Cotizaciones.Documento ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tabla	=	'Cotizaciones' ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tipo		=	'Datos' ")
            loComandoSeleccionar.AppendLine("			AND	(Auditorias.Opcion	=	'Cotizaciones' OR Auditorias.Opcion	=	'Sin opción' OR Auditorias.Opcion	=	'ListarCotizacionesCRM')  ")
           ...
           '--------------------------------------------------'
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fAuditorias_Cotizaciones", laDatosReporte)

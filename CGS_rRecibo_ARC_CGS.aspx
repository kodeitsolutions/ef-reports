<%@ Page Language="VB" AutoEventWireup="false" Inherits="CGS_rRecibo_ARC_CGS" CodeFile="CGS_rRecibo_ARC_CGS.aspx.vb" %>
...
<head runat="server">
	<title>Formatos de Recibos de ARC (incluye liquidados) (CGS)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvCGS_rRecibo_ARC_CGS" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False"  />

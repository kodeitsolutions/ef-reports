<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEfectividadArticulos2.aspx.vb" Inherits="rEfectividadArticulos2" %>
...
<head runat="server">
    <title>Listado de Efectividad por Articulos II</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEfectividadArticulos2" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPresupuestos_Numeros.aspx.vb" Inherits="rPresupuestos_Numeros" %>
...
<head runat="server">
    <title>Reporte de Presupuestos por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPresupuestos_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

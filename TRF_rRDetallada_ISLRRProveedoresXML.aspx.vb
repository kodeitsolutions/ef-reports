...
Partial Class TRF_rRDetallada_ISLRRProveedoresXML
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("         CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini > '20180731'")
            loConsulta.AppendLine("              THEN (Campos_Extras.Doble1/100000)")
            loConsulta.AppendLine("              ELSE Campos_Extras.Doble1")
            loConsulta.AppendLine("         END                                         AS Base_Retencion,")
            ...
            loConsulta.AppendLine("         CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini > '20180731'")
            loConsulta.AppendLine("              THEN (Cuentas_Pagar.Mon_Net/100000)")

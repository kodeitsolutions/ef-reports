<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras_SAKAN.aspx.vb"
    Inherits="rLibro_Compras_SAKAN" %>
...
<head runat="server">
    <title>Libro de Compras SAKAN</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrrLibro_Compras_SAKAN" runat="server" AutoDataBind="true"

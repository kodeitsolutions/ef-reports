<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSeguimientos_lFacturas.aspx.vb" Inherits="rSeguimientos_lFacturas" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrSeguimientos_lFacturas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

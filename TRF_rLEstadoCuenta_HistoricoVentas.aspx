<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLEstadoCuenta_HistoricoVentas.aspx.vb" Inherits="TRF_rLEstadoCuenta_HistoricoVentas" %>
...
<head runat="server">
    <title>Analítico de Clientes (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rLEstadoCuenta_HistoricoVentas" runat="server" AutoDataBind="true"

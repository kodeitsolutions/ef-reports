<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fPagos_Cheque_BOD" CodeFile="CSJ_fPagos_Cheque_BOD.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fPagos_Cheque_BOD" runat="server" AutoDataBind="true"

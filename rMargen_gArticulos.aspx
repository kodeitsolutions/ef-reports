<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gArticulos.aspx.vb" Inherits="rMargen_gArticulos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gArticulos" runat="server" AutoDataBind="true"

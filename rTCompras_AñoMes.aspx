<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCompras_AñoMes.aspx.vb" Inherits="rTCompras_AñoMes" %>
...
<head runat="server">
    <title>Reporte de Total de Compras por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCompras_AñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

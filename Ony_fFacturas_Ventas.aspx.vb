Imports System.Data
Partial Class Ony_fFacturas_Ventas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("Ony_fFacturas_Ventas", laDatosReporte)
            lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".", ",")
            ...
            Me.crvOny_fFacturas_Ventas.ReportSource = loObjetoReporte

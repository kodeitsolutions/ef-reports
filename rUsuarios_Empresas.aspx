<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUsuarios_Empresas.aspx.vb" Inherits="rUsuarios_Empresas" %>
...
<head runat="server">
    <title>Reporte de Usuarios con sus Empresas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrUsuarios_Empresas" runat="server" AutoDataBind="true"

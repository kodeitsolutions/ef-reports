<%@ page language="VB" autoeventwireup="false" inherits="CGS_fPedidos" CodeFile="CGS_fPedidos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Pedido (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fPedidos" runat="server" AutoDataBind="true"

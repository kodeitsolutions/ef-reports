<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rVentas_Articulos.aspx.vb" Inherits="CGS_rVentas_Articulos" %>
...
<head runat="server">
    <title>Listado Contable de Ventas por Artículos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rVentas_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

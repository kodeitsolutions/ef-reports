<%@ page language="VB" autoeventwireup="false" inherits="fProposiciones_Prospectos" CodeFile="fProposiciones_Prospectos.aspx.vb" %>
...
<head runat="server">
    <title>Proposiciones a Prospectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfProposiciones_Prospectos" runat="server" AutoDataBind="true"

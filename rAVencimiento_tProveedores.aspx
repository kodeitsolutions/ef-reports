<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAVencimiento_tProveedores.aspx.vb" Inherits="rAVencimiento_tProveedores" %>
...
<head runat="server">
    <title>Análisis del Vencimiento Totalizado por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAVencimiento_tProveedores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grUltimas_30SMontos.aspx.vb" Inherits="grUltimas_30SMontos" %>
...
<head runat="server">
    <title>Gráfico de Ventas de Últimas 30 Semanas en Montos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrUltimas_30SMontos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="CGS_fActaServicio_RI" CodeFile="CGS_fActaServicio_RI.aspx.vb" %>
...
<head runat="server">
    <title>Acta de Servicio para Requisiciones Internas (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fActaServicio_RI" runat="server" AutoDataBind="true"

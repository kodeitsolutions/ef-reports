<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque_BOD" CodeFile="fPagos_Cheque_BOD.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque_BOD" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_KCR" CodeFile="fFacturas_Ventas_KCR.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas KCR</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_KCR" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gZona.aspx.vb" Inherits="rMargen_gZona" %>
...
<head runat="server">
    <title>Margen de Ganancia por Zonas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gZona" runat="server" AutoDataBind="true"

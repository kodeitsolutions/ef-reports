<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Horas.aspx.vb" Inherits="rAuditorias_Horas" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Hora</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Horas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

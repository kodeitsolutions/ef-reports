<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grCompras_MensualesCantidades.aspx.vb" Inherits="grCompras_MensualesCantidades" %>
...
<head runat="server">
    <title>Gráfico de Compras Mensuales en Cantidades</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrCompras_MensualesCantidades" runat="server" AutoDataBind="true"

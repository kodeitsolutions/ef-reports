...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fAuditorias_Vendedores"
'-------------------------------------------------------------------------------------------'
Partial Class fAuditorias_Vendedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			loComandoSeleccionar.AppendLine(" SELECT    Auditorias.Codigo, ")
            ...
            loComandoSeleccionar.AppendLine(" FROM Auditorias,Vendedores ")
            loComandoSeleccionar.AppendLine(" WHERE     " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Codigo	=	Vendedores.Cod_Ven ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tabla	=	'Vendedores' ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tipo		=	'Datos' ")
            loComandoSeleccionar.AppendLine("			AND	(Auditorias.Opcion	=	'Vendedores' OR Auditorias.Opcion	=	'Sin opción' OR Auditorias.Opcion	=	'ListarVendedoresCRM')  ")
           ...
           '--------------------------------------------------'
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fAuditorias_Vendedores", laDatosReporte)
            
            Me.mTraducirReporte(loObjetoReporte)
            
            Me.mFormatearCamposReporte(loObjetoReporte)
            
            Me.crvfAuditorias_Vendedores.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Compras_Tire" CodeFile="fOrdenes_Compras_Tire.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras Tire Solutions</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Compras_Tire" runat="server" AutoDataBind="true"

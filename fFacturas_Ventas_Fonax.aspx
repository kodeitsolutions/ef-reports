<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Fonax" CodeFile="fFacturas_Ventas_Fonax.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Fonax" runat="server" AutoDataBind="true"

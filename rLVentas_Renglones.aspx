<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Renglones.aspx.vb" Inherits="rLVentas_Renglones" %>
...
<head runat="server">
    <title>Reporte de Formas Libres con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLVentas_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

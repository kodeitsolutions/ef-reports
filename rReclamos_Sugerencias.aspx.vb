...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rReclamos_Sugerencias"
'-------------------------------------------------------------------------------------------'
Partial Class rReclamos_Sugerencias
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" 		Reclamos.Cod_Cli, ")
            loComandoSeleccionar.AppendLine(" 		SUBSTRING(Clientes.Nom_Cli,1,51) AS Nom_Cli, ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rReclamos_Sugerencias", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrReclamos_Sugerencias.ReportSource = loObjetoReporte

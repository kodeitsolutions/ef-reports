<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNotas.aspx.vb" Inherits="rNotas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNotas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

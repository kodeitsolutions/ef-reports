...
Partial Class rTNotasRecepcion_pAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" recepciones, renglones_recepciones, proveedores, articulos" )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTNotasRecepcion_pAñoMes", laDatosReporte)
            ...
            Me.crvrTNotasRecepcion_pAñoMes.ReportSource = loObjetoReporte

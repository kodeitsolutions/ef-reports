<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gVendedorArticulos_Resumido.aspx.vb" Inherits="rMargen_gVendedorArticulos_Resumido" %>
...
<head runat="server">
    <title>Margen de Ganancia por Vendedor por Artículo Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gVendedorArticulos_Resumido" runat="server" AutoDataBind="true"

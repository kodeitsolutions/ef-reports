<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Fecha.aspx.vb" Inherits="rTotal_Casos_Fecha" %>
...
<head runat="server">
    <title>Total Casos por Fecha</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Fecha" runat="server" AutoDataBind="true"

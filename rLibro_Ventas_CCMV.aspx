<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Ventas_CCMV.aspx.vb" Inherits="rLibro_Ventas_CCMV" %>
...
<head runat="server">
    <title>Libro de Ventas CCMV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLibro_Ventas_CCMV" runat="server" AutoDataBind="true"

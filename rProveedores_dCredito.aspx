<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_dCredito.aspx.vb" Inherits="rProveedores_dCredito" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Datos de Crédito</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_dCredito" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Fechas.aspx.vb" Inherits="rPedidos_Fechas" %>
...
<head runat="server">
    <title>Reporte de Pedidos por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

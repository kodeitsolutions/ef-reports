<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_DiaSemana1.aspx.vb" Inherits="rTVentas_DiaSemana1" %>
...
<head runat="server">
    <title>Reporte de Total Ventas por Dia de la Semana</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_DiaSemana1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

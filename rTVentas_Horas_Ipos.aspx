<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Horas_Ipos.aspx.vb" Inherits="rTVentas_Horas_Ipos" %>
...
<head runat="server">
    <title>Reporte de Total Ventas por Horas Ipos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Horas_Ipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="CGS_rResumenRetencion_PATProveedores" 
CodeFile="CGS_rResumenRetencion_PATProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Retención de Patente Municipal de Proveedores (CEGASA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCGS_rResumenRetencion_PATProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

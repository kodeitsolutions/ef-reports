<%@ page language="VB" autoeventwireup="false" inherits="fSeguimiento_Proveedores" CodeFile="fSeguimiento_Proveedores.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Seguimiento en Proveedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeguimiento_Proveedores" runat="server" AutoDataBind="true"

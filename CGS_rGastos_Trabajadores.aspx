<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rGastos_Trabajadores.aspx.vb" Inherits="CGS_rGastos_Trabajadores" %>
...
<head runat="server">
    <title>Gastos de Trabajadores (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rGastos_Trabajadores" runat="server" AutoDataBind="true"

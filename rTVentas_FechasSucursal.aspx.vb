...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTVentas_FechasSucursal"
'-------------------------------------------------------------------------------------------'
Partial Class rTVentas_FechasSucursal
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
			...
			loComandoSeleccionar.AppendLine("DECLARE	@Sucursales		NVARCHAR(MAX)	")
			loComandoSeleccionar.AppendLine("DECLARE	@SucursalesAux	NVARCHAR(MAX)	")
			loComandoSeleccionar.AppendLine("DECLARE	@SucursalesAux2	NVARCHAR(MAX)	")
			loComandoSeleccionar.AppendLine("DECLARE	@SubConsulta	NVARCHAR(MAX)	")
			loComandoSeleccionar.AppendLine("DECLARE	@Numero			INT				")
			loComandoSeleccionar.AppendLine("DECLARE	@Numero2		INT				")
			loComandoSeleccionar.AppendLine("")
			...
			loComandoSeleccionar.AppendLine("			SET @SucursalesAux	=	@SucursalesAux + 'SUM(ISNULL([' + RTrim(@tmpSucursales) + '],0)) AS Columna' + CAST(@Numero AS NVARCHAR) + ',' ")
			loComandoSeleccionar.AppendLine("			SET @SucursalesAux2	=	@SucursalesAux2 + 'SUM(ISNULL([' + RTrim(@tmpSucursales) + '],0)) AS Columna' + CAST(@Numero2 AS NVARCHAR) + ',' ")
			...
			loComandoSeleccionar.AppendLine("			CONVERT(NCHAR(10), Facturas.Fec_Ini, 102)	AS	Fec_Ini2, ")
			...
			loComandoSeleccionar.AppendLine("GROUP BY	CONVERT(NCHAR(10), Facturas.Fec_Ini, 103), CONVERT(NCHAR(10), Facturas.Fec_Ini, 102), Facturas.Cod_Suc, LTRIM(Sucursales.Nom_Suc)")
			loComandoSeleccionar.AppendLine("")
			
			'-------------------------------------------------------------------------------------------'
			' Ejecucion del PIVOT    
			'-------------------------------------------------------------------------------------------'
			loComandoSeleccionar.AppendLine("SELECT Fec_Ini, Fec_Ini2, ' + @SucursalesAux + ' ")
			loComandoSeleccionar.AppendLine("INTO #Temp")
			loComandoSeleccionar.AppendLine("FROM   ")
			loComandoSeleccionar.AppendLine("		(SELECT Can_Art, Mon_Net, Fec_Ini, Fec_Ini2, Nom_Suc  FROM #curTemporal) AS SourceTable")
			...
			loComandoSeleccionar.AppendLine("SELECT Fec_Ini, Fec_Ini2, ' + @SucursalesAux2 + ' ")
			loComandoSeleccionar.AppendLine("INTO #Temp2")
			loComandoSeleccionar.AppendLine("FROM	( ")
			loComandoSeleccionar.AppendLine("			SELECT Can_Art, Mon_Net, Fec_Ini, Fec_Ini2, Nom_Suc")
            ...
            loComandoSeleccionar.AppendLine("	JOIN #Temp2 ON #Temp.Fec_Ini = #Temp2.Fec_Ini ")
			...
			loComandoSeleccionar.AppendLine("SELECT TOP " & lcParametro14Desde & "")
			loComandoSeleccionar.AppendLine("		RTRIM(Nom_Suc) AS Nom_Suc, ")
			loComandoSeleccionar.AppendLine("		RTRIM(Cod_Suc) AS Cod_Suc ")
			loComandoSeleccionar.AppendLine("FROM	Sucursales    ")
			If lcParametro15Desde <> "" Then
                loComandoSeleccionar.AppendLine("WHERE	Cod_Suc IN ('" & lcParametro15Desde & "')   ")
			End If
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTVentas_FechasSucursal", laDatosReporte)
			...
			Me.crvrTVentas_FechasSucursal.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS: 03/08/09: Metodo de ordenamiento
'-------------------------------------------------------------------------------------------'

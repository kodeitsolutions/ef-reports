<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Renglones.aspx.vb" Inherits="rFacturas_Renglones" %>
...
<head runat="server">
    <title>Reporte de Facturas con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLAjustes_dAñoMes.aspx.vb" Inherits="rLAjustes_dAñoMes" %>
...
<head runat="server">
    <title>Reporte de Ajustes por Departamento Totalizados por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLAjustes_dAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Marcas_Ipos.aspx.vb" Inherits="rTVentas_Marcas_Ipos" %>
...
<head runat="server">
    <title>Ventas del Día por Marcas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Marcas_Ipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="KDE_fFacturas_Ventas" CodeFile="KDE_fFacturas_Ventas.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_fFacturas_Ventas" runat="server" AutoDataBind="true"

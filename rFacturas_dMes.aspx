<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_dMes.aspx.vb" Inherits="rFacturas_dMes" %>
...
<head runat="server">
    <title>Reporte de Total de Facturas por Departamentos Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_dMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

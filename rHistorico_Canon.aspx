<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rHistorico_Canon.aspx.vb" Inherits="rHistorico_Canon" %>
...
<head runat="server">
    <title>Histórico de Canon</title>
...
<body>
    ...
    <div >
         <CR:CrystalReportViewer ID="crvrHistorico_Canon" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"
            EnableParameterPrompt="False" HasCrystalLogo="False" Height="50px" Width="350px"
            HasPrintButton="False" DisplayGroupTree="false" />

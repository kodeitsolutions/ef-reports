<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCotizaciones_TECHNOIP" CodeFile="fCotizaciones_TECHNOIP.aspx.vb" %>
...
<head runat="server">
    <title>Quotation(TECHNOIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCotizaciones_TECHNOIP" runat="server" AutoDataBind="true"

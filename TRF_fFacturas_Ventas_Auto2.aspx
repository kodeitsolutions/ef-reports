<%@ page language="VB" autoeventwireup="false" inherits="TRF_fFacturas_Ventas_Auto2" CodeFile="TRF_fFacturas_Ventas_Auto2.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas Automático(TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_fFacturas_Ventas_Auto2" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rPagos_Proveedores.aspx.vb" Inherits="CGS_rPagos_Proveedores" %>
...
<head runat="server">
    <title>Listado de Pagos a Proveedores (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rPagos_Proveedores" runat="server" AutoDataBind="true"

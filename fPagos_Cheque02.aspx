<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque02" CodeFile="fPagos_Cheque02.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque02" runat="server" AutoDataBind="true"

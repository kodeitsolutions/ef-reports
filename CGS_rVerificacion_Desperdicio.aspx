<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rVerificacion_Desperdicio.aspx.vb" Inherits="CGS_rVerificacion_Desperdicio" %>
...
<head runat="server">
    <title>Reporte de verificación de desperdicio por lote (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rVerificacion_Desperdicio" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

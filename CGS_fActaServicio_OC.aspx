<%@ page language="VB" autoeventwireup="false" inherits="CGS_fActaServicio_OC" CodeFile="CGS_fActaServicio_OC.aspx.vb" %>
...
<head runat="server">
    <title>Acta de Servicio para Órdenes de Compras (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fActaServicio_OC" runat="server" AutoDataBind="true"

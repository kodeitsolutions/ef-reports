<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Ventas.aspx.vb" Inherits="rLibro_Ventas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLibro_Ventas" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCuentas_CobrarProForma" CodeFile="fCuentas_CobrarProForma.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cuentas por Cobrar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_CobrarProForma" runat="server" AutoDataBind="true"

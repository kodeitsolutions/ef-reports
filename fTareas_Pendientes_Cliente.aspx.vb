...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fTareas_Pendientes_Cliente"
'-------------------------------------------------------------------------------------------'
Partial Class fTareas_Pendientes_Cliente
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			loComandoSeleccionar.AppendLine ("declare @lcCliente char(30)")
			loComandoSeleccionar.AppendLine("set @lcCliente = (select top 1 cod_reg from tareas where " & cusAplicacion.goFormatos.pcCondicionPrincipal & ")")
			loComandoSeleccionar.AppendLine(" ")
			loComandoSeleccionar.AppendLine(" select ")
			loComandoSeleccionar.AppendLine(" 		Tareas.Origen,")
			loComandoSeleccionar.AppendLine(" 		Tareas.Cod_Reg,")
			loComandoSeleccionar.AppendLine(" 		Clientes.Cod_Cli Nombre,")
            ...
            loComandoSeleccionar.AppendLine("	 AND Tareas.Origen = 'Clientes'")
            loComandoSeleccionar.AppendLine("	 AND Tareas.Cod_Reg = @lcCliente" )
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fTareas_Pendientes_Cliente", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfTareas_Pendientes_Cliente.ReportSource = loObjetoReporte

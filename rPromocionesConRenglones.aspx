<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPromocionesConRenglones.aspx.vb"  Inherits="rPromocionesConRenglones" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrPromocionesConRenglones" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fOrdenes_Pagos_IKP.aspx.vb"
    Inherits="fOrdenes_Pagos_IKP" %>
...
<head runat="server">
    <title>Formato de Ordenes de Pagos (IKP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfOrdenes_Pagos_IKP" runat="server" AutoDataBind="true"

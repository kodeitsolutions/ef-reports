<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_sAlmacenConsolidado.aspx.vb" Inherits="rArticulos_sAlmacenConsolidado" %>
...
<head runat="server">
    <title>Reporte de Artículos con su Stock por Almacén Consolidado</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_sAlmacenConsolidado" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

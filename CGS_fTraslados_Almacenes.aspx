<%@ page language="VB" autoeventwireup="false" inherits="CGS_fTraslados_Almacenes" CodeFile="CGS_fTraslados_Almacenes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Traslados entre Almacenes (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fTraslados_Almacenes" runat="server" AutoDataBind="true"

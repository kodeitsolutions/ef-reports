<%@ page language="VB" autoeventwireup="false" inherits="TRF_fRequisiciones_Internas" CodeFile="TRF_fRequisiciones_Internas.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones Internas (TRF)</title>

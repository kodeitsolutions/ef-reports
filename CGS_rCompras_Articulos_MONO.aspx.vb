...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_rCompras_Articulos_MONO"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_rCompras_Articulos_MONO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("   JOIN Almacenes ON Renglones_Compras.Cod_Alm = Almacenes.Cod_Alm")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("CGS_rCompras_Articulos_MONO", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvCGS_rCompras_Articulos_MONO.ReportSource = loObjetoReporte

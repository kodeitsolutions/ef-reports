<%@ page language="VB" autoeventwireup="false" inherits="fDatosBasicos_Parlamentos" CodeFile="fDatosBasicos_Parlamentos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Parlamentos: Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatosBasicos_Parlamentos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" CodeFile="fCuentas_Cobrar_Russo.aspx.vb" inherits="fCuentas_Cobrar_Russo" %>
...
<head runat="server">
    <title>Formato de Documento de Cuentas Por Cobrar(Russo)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Cobrar_Russo" runat="server" AutoDataBind="true"

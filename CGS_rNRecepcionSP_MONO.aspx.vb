Imports System.Data
Partial Class CGS_rNRecepcionSP_MONO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("		CONCAT(COALESCE(RTRIM(Renglones_Ajustes.Cod_Tip),''),' - ', COALESCE(Tipos_Ajustes.Nom_Tip,''))	AS Tipo_Ajuste,")
            lcComandoSeleccionar.AppendLine("		CONCAT(COALESCE(RTRIM(Renglones_Ajustes.Cod_Alm),''),' - ',COALESCE(Almacenes.Nom_Alm,''))	    AS Nom_Alm,		")
            ...
            lcComandoSeleccionar.AppendLine("       @lcDocOri                       AS Orden_Compra")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("CGS_rNRecepcionSP_MONO", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvCGS_rNRecepcionSP_MONO.ReportSource = loObjetoReporte

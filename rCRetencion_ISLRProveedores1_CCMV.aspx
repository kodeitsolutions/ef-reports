<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores1_CCMV" CodeFile="rCRetencion_ISLRProveedores1_CCMV.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Retención de ISLR de Proveedores (Multicentro Inversiones)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_ISLRProveedores1_CCMV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

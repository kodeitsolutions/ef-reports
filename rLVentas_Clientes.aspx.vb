Imports System.Data
Partial Class rLVentas_Clientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Libres_Ventas.Cod_Mon, ")
            loComandoSeleccionar.AppendLine("           Libres_Ventas.Control, ")
            ...
            loComandoSeleccionar.AppendLine("           Libres_Ventas.Mon_Sal  ")
            loComandoSeleccionar.AppendLine(" FROM      Clientes, ")
            loComandoSeleccionar.AppendLine("           Libres_Ventas, ")
            loComandoSeleccionar.AppendLine("           Vendedores, ")
            loComandoSeleccionar.AppendLine("           Transportes, ")
            loComandoSeleccionar.AppendLine("           Monedas ")
            loComandoSeleccionar.AppendLine(" WHERE     Libres_Ventas.Cod_Cli        = Clientes.Cod_Cli ")
            ...
            loComandoSeleccionar.AppendLine("           And Libres_Ventas.Cod_Mon    = Monedas.Cod_Mon ")
            ...
            loComandoSeleccionar.AppendLine("           And Libres_Ventas.Status     IN (" & lcParametro4Desde & ")")
            loComandoSeleccionar.AppendLine("           And Libres_Ventas.Cod_Tra    Between " & lcParametro5Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro5Hasta)
            loComandoSeleccionar.AppendLine("           And Libres_Ventas.Cod_Mon    Between " & lcParametro6Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro6Hasta)
            'loComandoSeleccionar.AppendLine(" ORDER BY  Libres_Ventas.Cod_Cli, Libres_Ventas.Fec_Ini, Libres_Ventas.Fec_Fin, Libres_Ventas.Cod_Ven ")
            loComandoSeleccionar.AppendLine("ORDER BY   Libres_Ventas.Cod_Cli, " & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLVentas_Clientes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrLVentas_Clientes.ReportSource = loObjetoReporte

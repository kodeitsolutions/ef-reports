<%@ Page Language="VB" AutoEventWireup="false" Inherits="rCobros_Renglones_CCMV"
    CodeFile="rCobros_Renglones_CCMV.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Cobros con sus Renglones CCMV</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCobros_Renglones_CCMV" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPagos_Vendedores.aspx.vb" Inherits="rPagos_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Pagos por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPagos_Vendedores" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rToCompra_vAñoMes"
'-------------------------------------------------------------------------------------------'
Partial Class rToCompra_vAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine(" ordenes_compras, renglones_oCompras, vendedores, articulos")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rToCompra_vAñoMes", laDatosReporte)
            ...
            Me.crvrToCompra_vAñoMes.ReportSource = loObjetoReporte

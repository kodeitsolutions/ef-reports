<%@ page language="VB" autoeventwireup="false" inherits="fImpuestos_Bancarios" CodeFile="fImpuestos_Bancarios.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfImpuestos_Bancarios" runat="server" AutoDataBind="true"

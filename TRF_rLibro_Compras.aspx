<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLibro_Compras.aspx.vb"
    Inherits="TRF_rLibro_Compras" %>
...
<head runat="server">
    <title>Libro de Compras (TRF)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTRF_rLibro_Compras" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="CGS_rEntrada_Inventario_Auto" CodeFile="CGS_rEntrada_Inventario_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Entrada de Inventario Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rEntrada_Inventario_Auto" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rSaldos_DGarantias_CCMV" CodeFile="rSaldos_DGarantias_CCMV.aspx.vb" %>
...
<head runat="server">
    <title>Saldos de Depósitos en Garantía</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSaldos_DGarantias_CCMV" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPresupuestos_Requisitos" CodeFile="fPresupuestos_Requisitos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Presupuestos con sus Requisitos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPresupuestos_Requisitos" runat="server" AutoDataBind="true"

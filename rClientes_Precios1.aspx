<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_Precios1.aspx.vb" Inherits="rClientes_Precios1" %>
...
<head runat="server">
    <title>Reporte de Clientes con sus Precios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_Precios1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

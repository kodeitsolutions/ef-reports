<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReportes.aspx.vb" Inherits="rReportes" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReportes" runat="server" AutoDataBind="true"

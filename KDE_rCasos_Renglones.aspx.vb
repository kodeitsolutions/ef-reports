...
Partial Class KDE_rCasos_Renglones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("               THEN(RTRIM(Casos.Cod_Coo) + ' - ' + COALESCE(Coord.Nom_Ven,'[No Válido]') ) ")
            loConsulta.AppendLine("               ELSE '[No Asignado]'")
            loConsulta.AppendLine("         END                                            AS Nom_Coo,")
            loConsulta.AppendLine("         CASE WHEN Casos.Cod_Eje<>''")
            loConsulta.AppendLine("              THEN(RTRIM(Casos.Cod_Eje) + ' - ' + COALESCE(Ejec.Nom_Ven,'[No Válido]') ) ")
            loConsulta.AppendLine("              ELSE '[No Asignado]'")

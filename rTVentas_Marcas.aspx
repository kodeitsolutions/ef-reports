<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Marcas.aspx.vb" Inherits="rTVentas_Marcas" %>
...
<head runat="server">
    <title>Total Ventas por Marcas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Marcas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fExistencias_ActualesCotizacion"
'-------------------------------------------------------------------------------------------'
Partial Class fExistencias_ActualesCotizacion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("			Renglones_Cotizaciones.Cod_Alm				AS  Cod_Alm, ")
            loComandoSeleccionar.AppendLine("			ISNULL(Renglones_Almacenes.Exi_Act1, 0)     AS  Exi_Actual_Almacen, ")
            loComandoSeleccionar.AppendLine("			ISNULL(Renglones_Almacenes.Exi_Act1 - Renglones_Almacenes.Exi_Ped1, 0)     AS  Exi_Disponible_Almacen, ")
            loComandoSeleccionar.AppendLine("			ISNULL(Renglones_Almacenes.Exi_Por1, 0)	    AS  Por_Llegar_Almacen ")
            ...
            loComandoSeleccionar.AppendLine(" 		ON	(Renglones_Almacenes.Cod_Alm	=   Renglones_Cotizaciones.Cod_Alm)")
            loComandoSeleccionar.AppendLine(" 		AND (Renglones_Almacenes.Cod_Art	=   Renglones_Cotizaciones.Cod_Art)")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fExistencias_ActualesCotizacion", laDatosReporte)
            ...
            Me.crvfExistencias_ActualesCotizacion.ReportSource = loObjetoReporte

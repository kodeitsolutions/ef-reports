<%@ Page Language="VB" AutoEventWireup="false" Inherits="fAuditorias_Requisiciones" CodeFile="fAuditorias_Requisiciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Requisiciones Internas</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfAuditorias_Requisiciones" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" CodeFile="fComprobante_ISLR.aspx.vb" inherits="fComprobante_ISLR" %>
...
<head runat="server">
    <title>Comprobante de ISLR</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfComprobante_ISLR" runat="server" AutoDataBind="true"

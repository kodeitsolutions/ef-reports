...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fCajas_ConCC"
'-------------------------------------------------------------------------------------------'
Partial Class fCajas_ConCC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT  Cod_Caj, ")
            loConsulta.AppendLine("        Nom_Caj,")
            ...
            loConsulta.AppendLine("FROM    Cajas")
            loConsulta.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCajas_ConCC", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfCajas_ConCC.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grPedidos_MensualesMonto.aspx.vb" Inherits="grPedidos_MensualesMonto" %>
...
<head runat="server">
    <title>Gráfico de Pedidos Mensuales en Montos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrPedidos_MensualesMonto" runat="server" AutoDataBind="true"

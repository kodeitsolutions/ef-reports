<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque02" CodeFile="fOrdenes_Cheque02.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque BANESCO</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque02" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCotdArtVC_SLFR.aspx.vb" Inherits="rTCotdArtVC_SLFR" %>
...
<head runat="server">
    <title>Total Cotizaciones de Artículos por Vendedor por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCotdArtVC_SLFR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

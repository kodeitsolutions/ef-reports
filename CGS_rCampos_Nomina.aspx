<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCampos_Nomina.aspx.vb" Inherits="CGS_rCampos_Nomina" %>
...
<head runat="server">
    <title>Listado de Campos de Nómina con su valor (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvCGS_rCampos_Nomina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

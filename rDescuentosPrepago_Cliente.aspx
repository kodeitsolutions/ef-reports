<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDescuentosPrepago_Cliente.aspx.vb" Inherits="rDescuentosPrepago_Cliente" %>
...
<head runat="server">
    <title>Listado de Descuentos Comerciales por Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDescuentosPrepago_Cliente" runat="server" AutoDataBind="true"

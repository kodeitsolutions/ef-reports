<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_Comprados.aspx.vb" Inherits="rArticulos_Comprados" %>
...
<head runat="server">
    <title>Reporte de Artículos más Comprados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Comprados" runat="server" AutoDataBind="true"

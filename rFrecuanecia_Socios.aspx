<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFrecuanecia_Socios.aspx.vb" Inherits="rFrecuanecia_Socios" %>
...
<head runat="server">
    <title>Reporte de Frecuencia de Socios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFrecuanecia_Socios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

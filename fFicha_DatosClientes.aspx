<%@ page language="VB" autoeventwireup="false" inherits="fFicha_DatosClientes" CodeFile="fFicha_DatosClientes.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_DatosClientes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumenProspectos_Paises.aspx.vb" Inherits="rResumenProspectos_Paises" %>
...
<head runat="server">
    <title>Resumen de Prospectos por Paises</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrResumenProspectos_Paises" runat="server" AutoDataBind="true"

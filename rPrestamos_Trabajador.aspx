<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPrestamos_Trabajador.aspx.vb" Inherits="rPrestamos_Trabajador" %>
...
<head runat="server">
	<title>Listado de Reposos por Trabajador</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrPrestamos_Trabajador" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

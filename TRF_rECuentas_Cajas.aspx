<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rECuentas_Cajas.aspx.vb" Inherits="TRF_rECuentas_Cajas" %>
...
<head runat="server">
    <title>Reporte de Estado de Cuenta de Caja (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rECuentas_Cajas" runat="server" AutoDataBind="true"

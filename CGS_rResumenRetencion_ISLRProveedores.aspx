<%@ page language="VB" autoeventwireup="false" inherits="CGS_rResumenRetencion_ISLRProveedores" 
CodeFile="CGS_rResumenRetencion_ISLRProveedores.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCGS_rResumenRetencion_ISLRProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

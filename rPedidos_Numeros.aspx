<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Numeros.aspx.vb" Inherits="rPedidos_Numeros" %>
...
<head runat="server">
    <title>Reporte de Pedidos por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

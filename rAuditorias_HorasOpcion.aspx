<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_HorasOpcion.aspx.vb" Inherits="rAuditorias_HorasOpcion" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Opcion y Hora</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_HorasOpcion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

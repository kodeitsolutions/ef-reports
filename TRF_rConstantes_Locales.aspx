<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rConstantes_Locales.aspx.vb" Inherits="TRF_rConstantes_Locales" %>
...
<head runat="server">
    <title>Listado de Constantes Locales (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvTRF_rConstantes_Locales" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

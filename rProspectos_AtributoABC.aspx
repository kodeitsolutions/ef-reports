<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProspectos_AtributoABC.aspx.vb" Inherits="rProspectos_AtributoABC" %>
...
<head runat="server">
    <title>Resumen de Prospectos por Atributo y ABC</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrProspectos_AtributoABC" runat="server" AutoDataBind="true"

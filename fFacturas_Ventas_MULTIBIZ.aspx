<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_MULTIBIZ" CodeFile="fFacturas_Ventas_MULTIBIZ.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas MULTIBIZ</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_MULTIBIZ" runat="server" AutoDataBind="true"
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <vis3Controles:pnlVentanaModal ID="PnlVentanaModalPrincipal" runat="server" pcEstiloBotonCerrar="BotonCerrarVentanaModal"
                        pcEstiloFondo="FondoVentanaModal" pcEstiloMarco="MarcoVentanaModal" />

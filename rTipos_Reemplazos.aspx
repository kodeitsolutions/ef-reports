<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Reemplazos.aspx.vb" Inherits="rTipos_Reemplazos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Reemplazos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Reemplazos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

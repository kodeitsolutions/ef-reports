<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOCompras_cRenglones.aspx.vb" Inherits="rOCompras_cRenglones" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Compras con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOCompras_cRenglones" runat="server" AutoDataBind="true"

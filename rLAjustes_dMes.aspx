<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLAjustes_dMes.aspx.vb" Inherits="rLAjustes_dMes" %>
...
<head runat="server">
    <title>Reporte de Ajustes por Departamentos Totalizados Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLAjustes_dMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Resumido_75.aspx.vb" Inherits="rLVentas_Resumido_75" %>
...
<head runat="server">
    <title>Libro de Ventas Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLVentas_Resumido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="IGE_MUL_fNota_Entrega" CodeFile="IGE_MUL_fNota_Entrega.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvIGE_MUL_fNota_Entrega" runat="server" AutoDataBind="true"

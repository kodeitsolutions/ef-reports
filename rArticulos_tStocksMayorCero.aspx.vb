...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rArticulos_tStocksMayorCero"
'-------------------------------------------------------------------------------------------'
Partial Class rArticulos_tStocksMayorCero
   Inherits vis2Formularios.frmReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("           SUBSTRING(Articulos.Nom_Art,1,40) As Nom_Art, ")
			...
			loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rArticulos_tStocksMayorCero", laDatosReporte)
			
            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)
	
            Me.crvrArticulos_tStocksMayorCero.ReportSource = loObjetoReporte

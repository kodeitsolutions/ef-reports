<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_ConCC.aspx.vb" Inherits="rProveedores_ConCC" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Cuentas Contables</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_ConCC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

Imports System.Data
Partial Class rClases_Proveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		loComandoSeleccionar.AppendLine("		Case When Status = 'A' Then 'Activo' Else 'Inactivo' End as Status_Clases_Proveedores " )
		...
		loComandoSeleccionar.AppendLine("ORDER BY      " & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rClases_Proveedores", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)
			
			Me.crvrClases_Proveedores.ReportSource =  loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' YJP:  22/04/09: Estandarizacion de codigo,agregar combo estatus y colocar en español.
'-------------------------------------------------------------------------------------------'

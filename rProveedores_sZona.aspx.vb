Imports System.Data
Partial Class rProveedores_sZona 
	...
	Try
		...
		Dim lcParametro0Desde As String = goServicios.mObtenerCampoFormatoSQL(cusAplicacion.goReportes.paParametrosIniciales(0))
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rProveedores_sZona", laDatosReporte)
            
			Me.mTraducirReporte(loObjetoReporte)
			            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrProveedores_sZona.ReportSource =	 loObjetoReporte	

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rProveedores.aspx.vb" Inherits="CGS_rProveedores" %>
...
<head runat="server">
    <title>Listado de Proveedores (CGS) </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rpedidos_dMes.aspx.vb" Inherits="rPedidos_dMes" %>
...
<head runat="server">
    <title>Reporte de Total de Pedidos por Departamentos Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_dMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

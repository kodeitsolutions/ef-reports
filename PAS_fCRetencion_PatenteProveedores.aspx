<%@ Page Language="VB" AutoEventWireup="false" Inherits="PAS_fCRetencion_PatenteProveedores" CodeFile="PAS_fCRetencion_PatenteProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención Municipal de Proveedores (PAS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrPAS_fCRetencion_PatenteProveedores" runat="server" AutoDataBind="true"

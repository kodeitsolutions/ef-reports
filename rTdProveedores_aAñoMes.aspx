<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTdProveedores_aAñoMes.aspx.vb" Inherits="rTdProveedores_aAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Devoluciones de Proveedores por Artículos por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTdProveedores_aAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class CGS_fRecepciones_Proveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("       COALESCE(Renglones_Ajustes.Cod_Tip,'')	AS Tipo_Ajuste")
            ...
            loComandoSeleccionar.AppendLine("	LEFT JOIN Ajustes ON Ajustes.Doc_Ori = Recepciones.Documento")
            loComandoSeleccionar.AppendLine("		AND Ajustes.Tip_Ori = 'Recepciones'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("WITH Sumatorias (Cod_Art, Lote, Cantidad, Cantidad_Lote) AS")
            loComandoSeleccionar.AppendLine("(")
            loComandoSeleccionar.AppendLine("   SELECT Cod_Art, Lote,SUM(Cantidad) AS Cantidad, SUM(Cantidad_Lote) AS Cantidad_Lote")

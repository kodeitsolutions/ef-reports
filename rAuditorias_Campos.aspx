<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Campos.aspx.vb" Inherits="rAuditorias_Campos" %>
...
<head runat="server">
    <title>Listado de Auditorías por Campos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrAuditorias_Campos" runat="server" AutoDataBind="true"

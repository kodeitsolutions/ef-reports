<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Containers" CodeFile="fTipos_Containers.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Containerss</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Containers" runat="server" AutoDataBind="true"

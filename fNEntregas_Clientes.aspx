<%@ page language="VB" autoeventwireup="false" inherits="fNEntregas_Clientes" CodeFile="fNEntregas_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Notas de Entregas a Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfNEntregas_Clientes" runat="server" AutoDataBind="true"

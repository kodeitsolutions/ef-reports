<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Ajustes.aspx.vb" Inherits="rTipos_Ajustes" %>
...
<head runat="server">
    <title>Reporte de Tipos de Ajustes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Ajustes" runat="server" AutoDataBind="true"

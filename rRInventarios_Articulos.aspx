<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRInventarios_Articulos.aspx.vb" Inherits="rRInventarios_Articulos" %>
...
<head runat="server">
    <title>Reporte Resumen de Inventario por Articulos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRInventarios_Articulos" runat="server" AutoDataBind="true"

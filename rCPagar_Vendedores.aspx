<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Vendedores.aspx.vb" Inherits="rCPagar_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Pagar por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Vendedores" runat="server" AutoDataBind="true"

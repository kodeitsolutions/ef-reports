<%@ page language="VB" autoeventwireup="false" inherits="Ony_fFacturas_Ventas" CodeFile="Ony_fFacturas_Ventas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvOny_fFacturas_Ventas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTdProveedores_vAñoMes.aspx.vb" Inherits="rTdProveedores_vAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Devoluciones de proveedores por Vendedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTdProveedores_vAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

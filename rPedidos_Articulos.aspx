<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Articulos.aspx.vb" Inherits="rPedidos_Articulos" %>
...
<head runat="server">
    <title>Reporte de Pedidos por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

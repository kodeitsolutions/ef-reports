<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rECuentas_Bancos.aspx.vb" Inherits="rECuentas_Bancos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrECuentas_Bancos" runat="server" AutoDataBind="true"

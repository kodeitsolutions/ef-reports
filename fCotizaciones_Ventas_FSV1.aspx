<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Ventas_FSV1" CodeFile="fCotizaciones_Ventas_FSV1.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Propuesta FSV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Ventas_FSV1" runat="server" AutoDataBind="true"

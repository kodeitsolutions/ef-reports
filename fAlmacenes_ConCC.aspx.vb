...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fAlmacenes_ConCC"
'-------------------------------------------------------------------------------------------'
Partial Class fAlmacenes_ConCC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT  Cod_Alm, ")
            loConsulta.AppendLine("        Nom_Alm,")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fAlmacenes_ConCC", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfAlmacenes_ConCC.ReportSource = loObjetoReporte

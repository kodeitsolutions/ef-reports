<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCobros_Fechas_CCMV.aspx.vb" Inherits="rCobros_Fechas_CCMV" %>
...
<head runat="server">
    <title>Reporte de Cobros por Fechas CCMV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCobros_Fechas_CCMV" runat="server" AutoDataBind="true"

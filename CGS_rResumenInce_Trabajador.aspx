<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rResumenInce_Trabajador.aspx.vb" Inherits="CGS_rResumenInce_Trabajador" %>
...
<head runat="server">
	<title>Resumen de Pago de INCE por Trabajador (CGS)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvCGS_rResumenInce_Trabajador" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False"  HasPrintButton="False" />

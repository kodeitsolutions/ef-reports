<%@ page language="VB" autoeventwireup="false" inherits="rPrecios_MarcasII" CodeFile="rPrecios_MarcasII.aspx.vb"  %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPrecios_MarcasII" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

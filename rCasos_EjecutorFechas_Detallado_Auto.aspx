<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCasos_EjecutorFechas_Detallado_Auto.aspx.vb" Inherits="rCasos_EjecutorFechas_Detallado_Auto" %>
...
<head runat="server">
    <title>Casos por Ejecutor y Fecha Detallado (Auto)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCasos_EjecutorFechas_Detallado_Auto" runat="server" AutoDataBind="true"

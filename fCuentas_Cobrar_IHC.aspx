<%@ page language="VB" autoeventwireup="false" inherits="fCuentas_Cobrar_IHC" CodeFile="fCuentas_Cobrar_IHC.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cuentas por Cobrar In Hand Customer</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Cobrar1" runat="server" AutoDataBind="true"

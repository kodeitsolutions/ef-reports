<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_AnuladasPFechas.aspx.vb" Inherits="rCCobrar_AnuladasPFechas" %>
...
<head runat="server">
    <title>Listado de Documentos de Cuentas por Cobrar Anuladas por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_AnuladasPFechas" runat="server" AutoDataBind="true"

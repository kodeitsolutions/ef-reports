...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gPais"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gPais
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpGanancia(	Cod_Pai		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Pai		CHAR(100),			")
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpFinal(	Cod_Pai		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Pai		CHAR(100),			")
            loComandoSeleccionar.AppendLine("							Can_Fac		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Can_Dev		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Base_A		DECIMAL(28, 10),	")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Pai, Nom_Pai, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            loComandoSeleccionar.AppendLine("SELECT		Paises.Cod_Pai														AS Cod_Pai,")
            loComandoSeleccionar.AppendLine("			Paises.Nom_Pai														AS Nom_Pai,")
            ...
            loComandoSeleccionar.AppendLine(" 	JOIN	Paises ")
            loComandoSeleccionar.AppendLine(" 		ON	Paises.Cod_Pai = Clientes.Cod_Pai")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Paises.Cod_Pai, Paises.Nom_Pai")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Pai, Nom_Pai, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            loComandoSeleccionar.AppendLine("SELECT	Cod_Pai				AS Cod_Pai,")
            loComandoSeleccionar.AppendLine("		Nom_Pai				AS Nom_Pai,")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Cod_Pai, Nom_Pai")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gPais", laDatosReporte)
            ...
            Me.crvrMargen_gPais.ReportSource = loObjetoReporte

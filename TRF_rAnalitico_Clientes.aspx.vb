    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If (laDatosReporte.Tables(0).Rows.Count <= 0) Then
                ...
                loComandoSeleccionar1.AppendLine("		Cod_Cli											AS Cod_Cli")
                ...
                loComandoSeleccionar1.AppendLine("	AND Cod_Cli BETWEEN @sp_CodCli_Desde AND @sp_CodCli_Hasta")
                loComandoSeleccionar1.AppendLine("	AND Fec_Ini BETWEEN @sp_FecIni AND @sp_FecFin")
                loComandoSeleccionar1.AppendLine("GROUP BY Cod_Cli")
                loComandoSeleccionar1.AppendLine("")
                ...
                loComandoSeleccionar1.AppendLine("      ISNULL((SELECT Pendientes FROM #tmpMovPendientes WHERE Cod_Cli = A.Cod_Cli),0) AS Pendientes")
                ...
                loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("TRF_rAnalitico_Clientes", laDatosReporte1)

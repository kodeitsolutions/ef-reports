<%@ Page Language="VB" AutoEventWireup="false" CodeFile="RAL_rLibro_Compras_Gaceta.aspx.vb"
    Inherits="RAL_rLibro_Compras_Gaceta" %>
...
<head runat="server">
    <title>Libro de Compras Gaceta N° 41.239 (RAL)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrRAL_rLibro_Compras_Gaceta" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_AñoMes.aspx.vb" Inherits="rAuditorias_AñoMes" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_AñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

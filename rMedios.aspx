<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMedios.aspx.vb" Inherits="rMedios" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMedios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

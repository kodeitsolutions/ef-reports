...
Partial Class rLibro_Ventas_CCMV
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            If (Me.Request.QueryString("salida").ToLower = "xsl") Then
                ' Ruta donde se creara temporalmente el archivo
                Dim lcFileName As String = Server.MapPath("~\Administrativo\Complementos\rLibro_Ventas_CCMV.xls")
...
''' <remarks></remarks>
    Private Sub modificar_excel(ByVal loFileName As String, ByVal loDatosReporte As DataSet)
        ...
        Try
            ...
            ' Nombre del modulo
            lcHojaExcel.Cells(2, 1).Value = cusAplicacion.goAplicacion.pcModuloActual
            ' Titulo del reporte
            ...
            For lcFila = 0 To lcTotalFilas - 1
                ...
                'bloque 3
                If (Trim(lcDatosFila("Cod_Rev")) = "01" And Not (lcDatosFila("Nom_Cli").ToString().Trim().ToLower() = "cond." Or lcDatosFila("Nom_Cli").ToString.ToLower = "mica")) Then
                ...
                ' bloque 4
                If (Trim(lcDatosFila("Cod_Rev")) = "01" And (lcDatosFila("Nom_Cli").ToString().Trim().ToLower() = "cond." Or lcDatosFila("Nom_Cli").ToString.ToLower = "mica")) Then
            ...
            lcRango = lcHojaExcel.Range("B6:AD" & CStr(lcNumFila))
            lcRango.Select()
    ...
    Private Sub NAR(ByVal objeto As Object)
        Try
...
'-------------------------------------------------------------------------------------------'
' DLC: 07/08/2010: Se agrego el formate de la salida por excel.
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLCompras_Renglones.aspx.vb" Inherits="rLCompras_Renglones" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Compras con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLCompras_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

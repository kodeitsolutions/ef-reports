<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_Fechas.aspx.vb" Inherits="rCotizaciones_Fechas" %>
...
<head runat="server">
    <title>Reporte de Cotizaciones por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="gInventarios_MontosMeses.aspx.vb" Inherits="gInventarios_MontosMeses" %>
...
<head runat="server">
    <title>Gráfico de Inventario por Meses en Montos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgInventarios_MontosMeses" runat="server" AutoDataBind="true"

...
Partial Class rLAjustesAlmacenes_AñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine("SELECT		")
			lcComandoSeleccionar.AppendLine("			ROW_NUMBER() OVER(PARTITION BY cod_alm ORDER BY " & lcOrdenamiento & ") AS 'Renglon', ")
			lcComandoSeleccionar.AppendLine("			cod_Alm, nom_alm, AÑO, num_mes, mes, ")
			...
			lcComandoSeleccionar.AppendLine("GROUP BY	 cod_alm, nom_alm, AÑO, num_mes, mes ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLAjustesAlmacenes_AñoMes", laDatosReporte)
            ...
            Me.crvrLAjustesAlmacenes_AñoMes.ReportSource = loObjetoReporte

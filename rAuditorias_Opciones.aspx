<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Opciones.aspx.vb" Inherits="rAuditorias_Opciones" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Opciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Opciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCotizaciones_LIRIO_EIP" CodeFile="fCotizaciones_LIRIO_EIP.aspx.vb" %>
...
<head runat="server">
    <title>Quotation (LIRIO/EverythingIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCotizaciones_LIRIO_EIP" runat="server" AutoDataBind="true"

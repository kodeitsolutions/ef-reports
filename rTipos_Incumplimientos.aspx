<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Incumplimientos.aspx.vb" Inherits="rTipos_Incumplimientos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Incumplimientos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Incumplimientos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fVendedoresUltimas_20Facturas" CodeFile="fVendedoresUltimas_20Facturas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfVendedoresUltimas_20Facturas" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fPagos_Check_Format"
'-------------------------------------------------------------------------------------------'
Partial Class fPagos_Check_Format
...
'me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fPagos_Check_Format", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfPagos_Check_Format.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fInvoice" CodeFile="fInvoice.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfInvoice" runat="server" AutoDataBind="true"

Imports System.Data
Partial Class fFacturas_VentasFiscal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Facturas.Fiscal1, ")
            loComandoSeleccionar.AppendLine("           Facturas.Fiscal2, ")
   ...
   '         lcPorcentajesImpueto = lcPorcentajesImpueto.Replace("(,", "(")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFacturas_VentasFiscal", laDatosReporte)
			'lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".",",")
   '         CType(loObjetoReporte.ReportDefinition.ReportObjects("Text1"), CrystalDecisions.CrystalReports.Engine.TextObject).Text = lcPorcentajesImpueto.ToString
            ...
            Me.crvfFacturas_VentasFiscal.ReportSource = loObjetoReporte

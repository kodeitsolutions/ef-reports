<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLAjustes_aMes.aspx.vb" Inherits="rLAjustes_aMes" %>
...
<head runat="server">
    <title>Reporte de Ajustes por Artículos Totalizados Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLAjustes_aMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

Imports System.Data
Partial Class CGS_fRecepciones_Produccion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT Pedidos.Cod_Cli                         AS Cod_Cli, ")
            ...
            loComandoSeleccionar.AppendLine("	    Ajustes.Referencia			            AS Doc_Ori,")
            ...
            loComandoSeleccionar.AppendLine("   JOIN Pedidos ON Ajustes.Referencia = Pedidos.Documento")
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("CGS_fRecepciones_Produccion", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvCGS_fRecepciones_Produccion.ReportSource = loObjetoReporte

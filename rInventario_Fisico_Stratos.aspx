<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rInventario_Fisico_Stratos.aspx.vb" Inherits="rInventario_Fisico_Stratos" %>
...
<head runat="server">
    <title>Reporte de Toma de Inventario Físico (Stratos)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrInventario_Fisico_Stratos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

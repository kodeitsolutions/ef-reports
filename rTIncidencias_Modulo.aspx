<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTIncidencias_Modulo.aspx.vb" Inherits="rTIncidencias_Modulo" %>
...
<head runat="server">
    <title>Listado Total de Incidencias por Modulo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTIncidencias_Modulo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

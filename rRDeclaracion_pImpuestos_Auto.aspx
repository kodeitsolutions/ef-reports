<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRDeclaracion_pImpuestos_Auto.aspx.vb" Inherits="rRDeclaracion_pImpuestos_Auto" %>
...
<head runat="server">
    <title>Resumen para la Declaración de Impuestos (Auto)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRDeclaracion_pImpuestos_Auto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

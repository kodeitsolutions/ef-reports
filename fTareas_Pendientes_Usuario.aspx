<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fTareas_Pendientes_Usuario.aspx.vb" Inherits="fTareas_Pendientes_Usuario" %>
...
<head runat="server">
    <title>Formato de Tareas Pendientes del Usuario</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfTareas_Pendientes_Usuario" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

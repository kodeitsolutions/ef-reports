...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rReportes_Chequeos"
'-------------------------------------------------------------------------------------------'
Partial Class rReportes_Chequeos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			loComandoSeleccionar.AppendLine(" 	AND		(Cod_Rep like '%" & lcParametro5Desde.Trim & "%' OR Nom_Rep like '%" & lcParametro5Desde.trim & "%')")
...
'me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            Dim laDatosReporte As DataSet = loServicios.mObtenerTodosSinEsquema(loComandoSeleccionar.ToString, "curReportes_Chequeos")

            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rReportes_Chequeos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrReportes_Chequeos.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' CMS: 12/06/10 se agrego el filtro para buscar un reporte dado una subcadena
'-------------------------------------------------------------------------------------------'

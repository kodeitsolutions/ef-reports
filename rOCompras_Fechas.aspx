<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOCompras_Fechas.aspx.vb" Inherits="rOCompras_Fechas" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Compras por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOCompras_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

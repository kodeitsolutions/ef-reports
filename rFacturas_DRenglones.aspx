<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_DRenglones.aspx.vb" Inherits="rFacturas_DRenglones" %>
...
<head runat="server">
    <title>Listado de Facturas con Detalle de Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_DRenglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

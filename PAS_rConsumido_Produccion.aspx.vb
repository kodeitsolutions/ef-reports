Imports System.Data
Partial Class PAS_rConsumido_Produccion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("   AND Ajustes.Status IN ( " & lcParametro6Desde & ")")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("PAS_rConsumido_Produccion", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvPAS_rConsumido_Produccion.ReportSource = loObjetoReporte

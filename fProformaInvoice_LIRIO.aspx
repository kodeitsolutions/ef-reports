<%@ Page Language="VB" AutoEventWireup="false" Inherits="fProformaInvoice_LIRIO" CodeFile="fProformaInvoice_LIRIO.aspx.vb" %>
...
<head runat="server">
    <title>Proforma Invoice (LIRIO)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfProformaInvoice_LIRIO" runat="server" AutoDataBind="true"

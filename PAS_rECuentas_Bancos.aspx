<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_rECuentas_Bancos.aspx.vb" Inherits="PAS_rECuentas_Bancos" %>
...
<head runat="server">
    <title>Reporte de Estado de Cuentas de Bancos (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_rECuentas_Bancos" runat="server" AutoDataBind="true"

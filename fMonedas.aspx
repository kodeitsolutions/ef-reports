<%@ page language="VB" autoeventwireup="false" inherits="fMonedas" CodeFile="fMonedas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Monedas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfMonedas" runat="server" AutoDataBind="true"

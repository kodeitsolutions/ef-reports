...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFrecuanecia_Competencia"
'-------------------------------------------------------------------------------------------'
Partial Class rFrecuanecia_Competencia
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" 			Competencia.Status			")
            loComandoSeleccionar.AppendLine(" FROM	Frecuencias ")
            loComandoSeleccionar.AppendLine(" JOIN Competencia ON (Competencia.Cod_Com = Frecuencias.Cod_Reg) AND ('Competencia' = Frecuencias.Origen)")
            loComandoSeleccionar.AppendLine(" WHERE     Competencia.Cod_Com	Between " & lcParametro0Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro0Hasta)
            loComandoSeleccionar.AppendLine("           And Competencia.Status IN (" & lcParametro1Desde & ")")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFrecuanecia_Competencia", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFrecuanecia_Competencia.ReportSource = loObjetoReporte

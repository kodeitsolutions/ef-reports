<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCheques_Postfechados.aspx.vb" Inherits="rCheques_Postfechados" %>
...
<head runat="server">
    <title>Listado de Cheques PosFechados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCheques_Postfechados" runat="server" AutoDataBind="true"

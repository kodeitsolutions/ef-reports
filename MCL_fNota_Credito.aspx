<%@ page language="VB" autoeventwireup="false" inherits="MCL_fNota_Credito" CodeFile="MCL_fNota_Credito.aspx.vb" %>
...
<head runat="server">
    <title>Nota de Crédito (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_fNota_Credito" runat="server" AutoDataBind="true"

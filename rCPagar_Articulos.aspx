<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Articulos.aspx.vb" Inherits="rCPagar_Articulos" %>
...
<head runat="server">
    <title>Reporte de Cuentas por Pagar con Renglones por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

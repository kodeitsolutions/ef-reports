...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFaltantes_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class rFaltantes_Articulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" ORDER BY Renglones_Faltantes.Cod_Art," & lcOrdenamiento)
...
'me.mEscribirConsulta(loComandoSeleccionar.ToString())
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFaltantes_Articulos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFaltantes_Articulos.ReportSource = loObjetoReporte

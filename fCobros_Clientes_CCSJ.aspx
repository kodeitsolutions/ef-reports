<%@ page language="VB" autoeventwireup="false" inherits="fCobros_Clientes_CCSJ" CodeFile="fCobros_Clientes_CCSJ.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cobros a Clientes CCSJ</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCobros_Clientes_CCSJ" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTPedidos_AñoMes"
'-------------------------------------------------------------------------------------------'

Partial Class rTPedidos_AñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("   		pedidos.Documento, ")
            ...
            lcComandoSeleccionar.AppendLine(" pedidos, renglones_pedidos, articulos, departamentos")
            ...
            Else
                lcComandoSeleccionar.AppendLine(" 				AND pedidos.cod_rev  NOT between " & lcParametro7Desde)
            End If
...
'me.mEscribirConsulta(lcComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTPedidos_AñoMes", laDatosReporte)
            ...
            Me.crvrTPedidos_AñoMes.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRequisiciones_PendientesAntiguedad.aspx.vb" Inherits="rRequisiciones_PendientesAntiguedad" %>
...
<head runat="server">
    <title>Requisiciones por Procresar con su Antigüedad</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrRequisiciones_PendientesAntiguedad" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fOrden_Produccion" CodeFile="fOrden_Produccion.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Producción</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrden_Produccion" runat="server" AutoDataBind="true"

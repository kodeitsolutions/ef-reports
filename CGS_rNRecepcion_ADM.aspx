<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rNRecepcion_ADM.aspx.vb" Inherits="CGS_rNRecepcion_ADM" %>
...
<head runat="server">
    <title>Reporte Administrativo de Notas de Recepción (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rNRecepcion_ADM" runat="server" AutoDataBind="true"

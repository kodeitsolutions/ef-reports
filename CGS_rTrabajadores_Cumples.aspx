<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rTrabajadores_Cumples.aspx.vb" Inherits="CGS_rTrabajadores_Cumples" %>
...
<head runat="server">
    <title>Listado de Cumpleaños (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvCGS_rTrabajadores_Cumples" runat="server" AutoDataBind="true"

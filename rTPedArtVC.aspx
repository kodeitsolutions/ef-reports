<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTPedArtVC.aspx.vb" Inherits="rTPedArtVC" %>
...
<head runat="server">
    <title>Total de Pedidos de Artículos por Vendedor por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTPedArtVC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

Imports System.Data
Partial Class rConceptos_Movimientos
	...
	Try	
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rConceptos_Movimientos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrConceptos_Movimientos.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' GCR:  27/02/09: Estandarizacion de codigo
'-------------------------------------------------------------------------------------------'
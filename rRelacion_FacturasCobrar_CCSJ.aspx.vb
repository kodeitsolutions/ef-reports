...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRelacion_FacturasCobrar_CCSJ"
'-------------------------------------------------------------------------------------------'
Partial Class rRelacion_FacturasCobrar_CCSJ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loSeleccion.AppendLine("")
            loSeleccion.AppendLine("INSERT INTO #tmpFacturas(   Numero, Seguro_Codigo, Seguro_Nombre,")
            ...
            loSeleccion.AppendLine("ORDER BY    cuentas_cobrar.fec_ini ASC, cuentas_cobrar.documento ASC")
            loSeleccion.AppendLine("")
            loSeleccion.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRelacion_FacturasCobrar_CCSJ", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRelacion_FacturasCobrar_CCSJ.ReportSource = loObjetoReporte
...
' Bitacora de cambios.                                                                      '
'-------------------------------------------------------------------------------------------'
' RJG: 10/03/14: Programacion inicial.                                                      '
'-------------------------------------------------------------------------------------------'

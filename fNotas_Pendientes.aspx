<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fNotas_Pendientes.aspx.vb" Inherits="fNotas_Pendientes" %>
...
<head runat="server">
    <title>Formato de Notas Pendientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfNotas_Pendientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOCompras_Articulos.aspx.vb" Inherits="rOCompras_Articulos" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Compras por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOCompras_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

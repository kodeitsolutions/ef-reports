<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Proveedores_Retenciones" CodeFile="fPagos_Proveedores_Retenciones.aspx.vb" %>
...
<head runat="server">
    <title>Retenciones Aplicadas en el Pago</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Proveedores_Retenciones" runat="server" AutoDataBind="true"

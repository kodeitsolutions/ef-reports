<%@ page language="VB" autoeventwireup="false"  CodeFile="rVariables.aspx.vb" Inherits="rVariables" %>
...
<head runat="server">
    <title>Reporte de Variables</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVariables" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Fechas_CCSJ.aspx.vb" Inherits="rCPagar_Fechas_CCSJ" %>
...
<head runat="server">
    <title>* Reporte de Documentos de Cuentas por Pagar por Fechas (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Fechas_CCSJ" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Tire" CodeFile="fCotizaciones_Tire.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cotizaciones Tire Solutions</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Tire" runat="server" AutoDataBind="true"

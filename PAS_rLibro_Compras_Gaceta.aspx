<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_rLibro_Compras_Gaceta.aspx.vb"
    Inherits="PAS_rLibro_Compras_Gaceta" %>
...
<head runat="server">
    <title>Libro de Compras Gaceta N° 41.239 (PAS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrPAS_rLibro_Compras_Gaceta" runat="server" AutoDataBind="true"

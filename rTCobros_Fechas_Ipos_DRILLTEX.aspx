<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCobros_Fechas_Ipos_DRILLTEX.aspx.vb"
    Inherits="rTCobros_Fechas_Ipos_DRILLTEX" %>
...
<head runat="server">
    <title>Total Cobros por Fechas iPos (DRILLTEX)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTCobros_Fechas_Ipos_DRILLTEX" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fPreguntas_Frecuentes" CodeFile="fPreguntas_Frecuentes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Preguntas Frecuentes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPreguntas_Frecuentes" runat="server" AutoDataBind="true"

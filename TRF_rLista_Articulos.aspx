<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLista_Articulos.aspx.vb" Inherits="TRF_rLista_Articulos" %>
...
<head runat="server">
    <title>Listado de Artículos (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rLista_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

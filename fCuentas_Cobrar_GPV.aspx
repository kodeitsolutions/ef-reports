<%@ page language="VB" autoeventwireup="false" inherits="fCuentas_Cobrar_GPV" CodeFile="fCuentas_Cobrar_GPV.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Cobrar_GPV" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rImpuestos_Municipales.aspx.vb" Inherits="rImpuestos_Municipales" %>
...
<head runat="server">
    <title>Reporte de Impuestos Municipales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrImpuestos_Municipales" runat="server" AutoDataBind="true"

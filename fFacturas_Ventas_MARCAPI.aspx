<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Ventas_MARCAPI" CodeFile="fFacturas_Ventas_MARCAPI.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Factura MARCAPI</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Ventas_MARCAPI" runat="server" AutoDataBind="true"

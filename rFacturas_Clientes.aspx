<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Clientes.aspx.vb" Inherits="rFacturas_Clientes" %>
...
<head runat="server">
    <title>Reporte de Facturas por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRCompras_MensualesVendedores.aspx.vb" Inherits="rRCompras_MensualesVendedores" %>
...
<head runat="server">
    <title>Reporte Resumen de Compras Mensuales por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRCompras_MensualesVendedores" runat="server" AutoDataBind="true"

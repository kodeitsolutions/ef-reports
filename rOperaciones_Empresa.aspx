<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOperaciones_Empresa.aspx.vb" Inherits="rOperaciones_Empresa" %>
...
<head runat="server">
    <title>Reporte de Reglas de Integración por Modificacion</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOperaciones_Empresa" runat="server" AutoDataBind="true"

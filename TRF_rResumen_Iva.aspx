<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rResumen_Iva.aspx.vb"
    Inherits="TRF_rResumen_Iva" %>
...
<head runat="server">
    <title>Resumen de I.V.A. (TRF)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTRF_rResumen_Iva" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCobros_VendedoresSucursales.aspx.vb" Inherits="rTCobros_VendedoresSucursales" %>
...
<head runat="server">
    <title>Reporte Total Cobros por Vendedores y Sucursal</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCobros_VendedoresSucursales" runat="server" AutoDataBind="true"

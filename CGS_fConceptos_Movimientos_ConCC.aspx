<%@ Page Language="VB" AutoEventWireup="false" Inherits="CGS_fConceptos_Movimientos_ConCC"
    CodeFile="CGS_fConceptos_Movimientos_ConCC.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Conceptos de Movimientos con sus Cuentas Contables (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvCGS_fConceptos_Movimientos_ConCC" runat="server" AutoDataBind="true"

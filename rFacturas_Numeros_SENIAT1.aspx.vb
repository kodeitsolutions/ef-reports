...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFacturas_Numeros_SENIAT1"
'-------------------------------------------------------------------------------------------'
Partial Class rFacturas_Numeros_SENIAT1 
	...
	Try
            ...
            loConsulta.AppendLine(" 			Facturas.Cod_Tra            AS Cod_Tra, ")
            loConsulta.AppendLine(" 			Facturas.Mon_Imp1           AS Mon_Imp1, ")
            loConsulta.AppendLine(" 			Vendedores.Status           AS Status, ")
            loConsulta.AppendLine(" 			Facturas.Control            AS Control, ")
            loConsulta.AppendLine(" 			Facturas.Mon_Net            AS Mon_Net, ")
            loConsulta.AppendLine(" 			Facturas.Mon_Sal            AS Mon_Sal,")
            loConsulta.AppendLine(" 			Facturas.Mon_bru            AS Mon_bru, ")
            loConsulta.AppendLine(" 			Facturas.Mon_Des1           AS Mon_Des1, ")
            loConsulta.AppendLine(" 			Facturas.Por_Des1           AS Por_Des1, ")
            loConsulta.AppendLine(" 			CAST( Facturas.Mon_bru")
            loConsulta.AppendLine(" 			    - Facturas.Mon_Exe ")
            loConsulta.AppendLine(" 			    - Facturas.Mon_Des1 ")
            loConsulta.AppendLine(" 			    AS DECIMAL(28,10))      AS Monto_Base")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rFacturas_Numeros_SENIAT1", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrFacturas_Numeros_SENIAT1.ReportSource =	 loObjetoReporte	
...
'-------------------------------------------------------------------------------------------'
' RJG: 31/10/13: Se agregaron los descuentos y monto base al SELECT y al reporte.           '
'-------------------------------------------------------------------------------------------'

...
Partial Class rDAuditorias_UResumido
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           And       Accion        Between " & lcParametro7Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rDAuditorias_UResumido", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrDAuditorias_UResumido.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Proveedores_CCSJ.aspx.vb" Inherits="rCPagar_Proveedores_CCSJ" %>
...
<head runat="server">
    <title>* Estado de Cuenta de Honorarios Médicos (Pendientes por Pagar) (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Proveedores_CCSJ" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFormulas_Renglones.aspx.vb" Inherits="rFormulas_Renglones" %>
...
<head runat="server">
    <title>Listado de las Fórmulas con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFormulas_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

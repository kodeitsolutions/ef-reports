<%@ Page Language="VB" AutoEventWireup="false" Inherits="CGS_rRecibo_Liquidacion" CodeFile="CGS_rRecibo_Liquidacion.aspx.vb" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvCGS_rRecibo_Liquidacion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False"   />

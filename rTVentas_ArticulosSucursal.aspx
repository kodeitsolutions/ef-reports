<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_ArticulosSucursal.aspx.vb" Inherits="rTVentas_ArticulosSucursal" %>
...
<head runat="server">
    <title>Total Ventas por Artículos y Sucursales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_ArticulosSucursal" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="KDE_rResumenRetencion_ISLRProveedores" 
CodeFile="KDE_rResumenRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Retención de ISLR (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrKDE_rResumenRetencion_ISLRProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Vendedores.aspx.vb" Inherits="rPedidos_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Pedidos por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEventos.aspx.vb" Inherits="rEventos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEventos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="rPagos_Detalles" CodeFile="rPagos_Detalles.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Pagos con sus Detalles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPagos_Detalles" runat="server" AutoDataBind="true"

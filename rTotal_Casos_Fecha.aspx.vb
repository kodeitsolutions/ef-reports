...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Casos_Fecha"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Casos_Fecha
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT      CAST(COALESCE(Renglones_Casos.Fec_Ini, Casos.Fec_Ini) AS DATE)    AS Fecha,")
            ...
            loConsulta.AppendLine("            SUM(CASE  WHEN Renglones_Casos.facturable = 1 ")
            loConsulta.AppendLine("                        THEN Renglones_Casos.duracion")
            loConsulta.AppendLine("                        ELSE 0 END)                                     AS Horas_Fact_Dia")
            ...
            loConsulta.AppendLine("GROUP BY    CAST(COALESCE(Renglones_Casos.Fec_Ini, Casos.Fec_Ini) AS DATE)")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Casos_Fecha", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Casos_Fecha.ReportSource = loObjetoReporte
...
'                Se ajustó el calculo de horas promedio (ya no aplica).                                    '
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Vendedores.aspx.vb" Inherits="rFacturas_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Facturas por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

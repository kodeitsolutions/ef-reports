<%@ page language="VB" autoeventwireup="false" inherits="fFaltantes" CodeFile="fFaltantes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Faltantes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFaltantes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCotdArtVC.aspx.vb" Inherits="rTCotdArtVC" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCotdArtVC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

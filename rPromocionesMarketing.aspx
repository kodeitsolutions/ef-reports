<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPromocionesMarketing.aspx.vb"  Inherits="rPromocionesMarketing" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrPromocionesMarketing" runat="server" AutoDataBind="true"

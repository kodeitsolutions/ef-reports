<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Paises.aspx.vb" Inherits="rFacturas_Paises" %>
...
<head runat="server">
    <title>Reporte de Facturas por Paises</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Paises" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOCompras_Proveedores.aspx.vb" Inherits="rOCompras_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Compras por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOCompras_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

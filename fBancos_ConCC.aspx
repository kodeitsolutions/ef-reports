<%@ Page Language="VB" AutoEventWireup="false" Inherits="fBancos_ConCC"
    CodeFile="fBancos_ConCC.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Bancos con sus Cuentas Contables</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfBancos_ConCC" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gProveedores.aspx.vb" Inherits="rMargen_gProveedores" %>
...
<head runat="server">
    <title>Margen de Ganancia por Proveedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gProveedores" runat="server" AutoDataBind="true"

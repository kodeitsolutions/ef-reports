<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rBalance_Comprobacion.aspx.vb" Inherits="CGS_rBalance_Comprobacion" %>
...
<head runat="server">
    <title>Balance de Comprobación (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rBalance_Comprobacion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

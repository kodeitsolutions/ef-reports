<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rEGanancias_Perdidas.aspx.vb" Inherits="CGS_rEGanancias_Perdidas" %>
...
<head runat="server">
    <title>Estado de Ganancias y Pérdidas (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rEGanancias_Perdidas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

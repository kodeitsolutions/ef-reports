<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_Familiares.aspx.vb" Inherits="rTrabajadores_Familiares" %>
...
<head runat="server">
	<title>Listado de Trabajadores con sus Familiares</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTrabajadores_Familiares" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ page language="VB" autoeventwireup="false" inherits="fFormulas" CodeFile="fFormulas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Fórmulas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFormulas" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="PAS_fPagos_Proveedores_Retenciones" CodeFile="PAS_fPagos_Proveedores_Retenciones.aspx.vb" %>
...
<head runat="server">
    <title>Retenciones Aplicadas en el Pago (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fPagos_Proveedores_Retenciones" runat="server" AutoDataBind="true"

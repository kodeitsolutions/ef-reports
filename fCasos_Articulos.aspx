<%@ page language="VB" autoeventwireup="false" inherits="fCasos_Articulos" CodeFile="fCasos_Articulos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCasos_Articulos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fQuotation" CodeFile="fQuotation.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfQuotation" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCobros_Clientes_Retenciones" CodeFile="fCobros_Clientes_Retenciones.aspx.vb" %>
...
<head runat="server">
    <title>Retenciones Aplicadas en el Cobro</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCobros_Clientes_Retenciones" runat="server" AutoDataBind="true"

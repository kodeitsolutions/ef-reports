<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_Cheque02" CodeFile="CGS_fOrdenes_Cheque02.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque (CEGASA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOrdenes_Cheque02" runat="server" AutoDataBind="true"

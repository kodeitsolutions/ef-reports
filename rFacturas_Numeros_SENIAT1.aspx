<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Numeros_SENIAT1.aspx.vb" Inherits="rFacturas_Numeros_SENIAT1" %>
...
<head runat="server">
    <title>Reporte de Facturas por Números (SENIAT 1)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrFacturas_Numeros_SENIAT1" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" CodeFile="fUsuarios_Opciones.aspx.vb" inherits="fUsuarios_Opciones" %>
...
<head runat="server">
    <title>Usuario con sus Opciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfUsuarios_Opciones" runat="server" AutoDataBind="true"

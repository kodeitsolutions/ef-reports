<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOrdenes_CompraProcesada_PorComprador.aspx.vb" Inherits="rOrdenes_CompraProcesada_PorComprador" %>
...
<head runat="server">
    <title>Órdenes de Compra Procesadas (Cantidad y Monto) por Comprador</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrOrdenes_CompraProcesada_PorComprador" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumenProspectos_Pais_AtributoB.aspx.vb" Inherits="rResumenProspectos_Pais_AtributoB" %>
...
<head runat="server">
    <title>Resumen de Prospectos por Pais AtributoB</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrResumenProspectos_Pais_AtributoB" runat="server" AutoDataBind="true"

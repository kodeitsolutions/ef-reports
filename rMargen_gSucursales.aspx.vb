...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gSucursales"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gSucursales
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim lcParametro17Desde As String = cusAplicacion.goReportes.paParametrosIniciales(17)
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpGanancia(	Cod_Suc		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Suc		CHAR(100),			")
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpFinal(	Cod_Suc		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Suc		CHAR(100),			")
            loComandoSeleccionar.AppendLine("							Can_Fac		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Can_Dev		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Base_A		DECIMAL(28, 10),	")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Suc, Nom_Suc, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            ...
            loComandoSeleccionar.AppendLine(" 		ON	Sucursales.Cod_Suc = Facturas.Cod_Suc")
            ...
            If lcParametro17Desde = "Igual" Then
				loComandoSeleccionar.AppendLine("			AND Facturas.Cod_Rev 	BETWEEN " & lcParametro16Desde & " AND " & lcParametro16Hasta)
            Else
				loComandoSeleccionar.AppendLine("			AND Facturas.Cod_Rev NOT BETWEEN " & lcParametro16Desde & " AND " & lcParametro16Hasta)
            End If
            loComandoSeleccionar.AppendLine("			AND Facturas.Cod_Suc 	BETWEEN " & lcParametro18Desde & " AND " & lcParametro18Hasta)
            loComandoSeleccionar.AppendLine("GROUP BY	Sucursales.Cod_Suc, Sucursales.Nom_Suc")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine(" 	JOIN	Sucursales ")
            loComandoSeleccionar.AppendLine(" 		ON	Sucursales.Cod_Suc = Devoluciones_Clientes.Cod_Suc")
            ...
            Else
				loComandoSeleccionar.AppendLine("			AND Devoluciones_Clientes.Cod_Rev NOT BETWEEN " & lcParametro16Desde & " AND " & lcParametro16Hasta)
            End If
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Suc, Nom_Suc, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            loComandoSeleccionar.AppendLine("SELECT	Cod_Suc				AS Cod_Suc,")
            loComandoSeleccionar.AppendLine("		Nom_Suc				AS Nom_Suc,")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Cod_Suc, Nom_Suc")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gSucursales", laDatosReporte)
            ...
            Me.crvrMargen_gSucursales.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' CMS: 30/06/10: Programacion inicial
'-------------------------------------------------------------------------------------------'

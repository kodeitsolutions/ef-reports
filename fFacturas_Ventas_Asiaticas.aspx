<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Asiaticas" CodeFile="fFacturas_Ventas_Asiaticas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Factura Asiaticas</title>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Asiaticas" runat="server" AutoDataBind="true"

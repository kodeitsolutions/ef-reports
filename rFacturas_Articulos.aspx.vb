...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFacturas_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class rFacturas_Articulos 
	...
	Try
          ...
          Dim laDatosReporte As DataSet = loServicios.mObtenerTodos(loComandoSeleccionar.ToString, "curReportes")
			...
			loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rFacturas_Articulos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
          
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrFacturas_Articulos.ReportSource =	 loObjetoReporte	

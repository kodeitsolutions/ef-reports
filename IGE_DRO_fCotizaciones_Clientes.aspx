<%@ page language="VB" autoeventwireup="false" inherits="IGE_DRO_fCotizaciones_Clientes" CodeFile="IGE_DRO_fCotizaciones_Clientes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvIGE_DRO_fCotizaciones_Clientes" runat="server" AutoDataBind="true"

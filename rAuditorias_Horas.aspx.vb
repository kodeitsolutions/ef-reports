...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rAuditorias_Horas"
'-------------------------------------------------------------------------------------------'
Partial Class rAuditorias_Horas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" ORDER BY  Hora ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAuditorias_Horas", laDatosReporte)
            ...
            Me.crvrAuditorias_Horas.ReportSource = loObjetoReporte

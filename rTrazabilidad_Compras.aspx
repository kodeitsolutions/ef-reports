<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrazabilidad_Compras.aspx.vb" Inherits="rTrazabilidad_Compras" %>
...
<head runat="server">
    <title>Trazabilidad de Compras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTrazabilidad_Compras" runat="server" AutoDataBind="true"
            EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMCuentas_Fechas.aspx.vb" Inherits="rMCuentas_Fechas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMCuentas_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

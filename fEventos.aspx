<%@ page language="VB" autoeventwireup="false" inherits="fEventos" CodeFile="fEventos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEventos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gFacturasAVC.aspx.vb" Inherits="rMargen_gFacturasAVC" %>
...
<html>
<head runat="server">
    <title>Margen de Ganancia por Factura, Artículo, Vendedor y Cliente</title>
    <link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrMargen_gFacturasAVC" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Fechas.aspx.vb" Inherits="rLVentas_Fechas" %>
...
<head runat="server">
    <title>Reporte de Formas Libres por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLVentas_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

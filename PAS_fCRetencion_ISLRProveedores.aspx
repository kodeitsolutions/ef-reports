<%@ Page Language="VB" AutoEventWireup="false" Inherits="PAS_fCRetencion_ISLRProveedores" CodeFile="PAS_fCRetencion_ISLRProveedores.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrPAS_fCRetencion_ISLRProveedores" runat="server" AutoDataBind="true"

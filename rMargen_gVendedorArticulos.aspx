<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gVendedorArticulos.aspx.vb" Inherits="rMargen_gVendedorArticulos" %>
...
<head runat="server">
    <title>Margen de Ganancia por Vendedor y Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gVendedorArticulos" runat="server" AutoDataBind="true"

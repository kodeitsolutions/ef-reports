<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDProveedores_Proveedores.aspx.vb" Inherits="rDProveedores_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Devoluciones por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDProveedores_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

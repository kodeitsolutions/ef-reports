<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDepositos_Numeros.aspx.vb" Inherits="rDepositos_Numeros" %>
...
<head runat="server">
    <title>Reporte de Depósitos Bancarios por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDepositos_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

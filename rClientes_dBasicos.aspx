<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_dBasicos.aspx.vb" Inherits="rClientes_dBasicos" %>
...
<head runat="server">
    <title>Reporte de Clientes con sus Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_dBasicos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

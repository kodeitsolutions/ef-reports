<%@ page language="VB" autoeventwireup="false" inherits="CGS_rOrdenes_Compras" CodeFile="CGS_rOrdenes_Compras.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Órdenes de Compras en lotes (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOrdenes_Compras" runat="server" AutoDataBind="true"

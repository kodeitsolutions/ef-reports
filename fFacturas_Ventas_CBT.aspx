<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_CBT" CodeFile="fFacturas_Ventas_CBT.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_CBT" runat="server" AutoDataBind="true"

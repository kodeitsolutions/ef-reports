<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Vendedor_Ipos.aspx.vb" Inherits="rTVentas_Vendedor_Ipos" %>
...
<head runat="server">
    <title>Ventas del Día por Vendedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Vendedor_Ipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

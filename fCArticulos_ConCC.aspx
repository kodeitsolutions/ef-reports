<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCArticulos_ConCC"
    CodeFile="fCArticulos_ConCC.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Clases de Articulos con sus Cuentas Contables</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCArticulos_ConCC" runat="server" AutoDataBind="true"

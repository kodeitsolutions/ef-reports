<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Usuarios_Auto.aspx.vb" Inherits="rAuditorias_Usuarios_Auto" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Usuarios (Auto)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Usuarios_Auto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

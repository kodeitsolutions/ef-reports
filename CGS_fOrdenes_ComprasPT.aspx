<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_ComprasPT" CodeFile="CGS_fOrdenes_ComprasPT.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compras, Precio Total</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOrdenes_ComprasPT" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAranceles.aspx.vb" Inherits="rAranceles" %>
...
<head runat="server">
    <title>Reporte de Listado de Aranceles </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAranceles" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

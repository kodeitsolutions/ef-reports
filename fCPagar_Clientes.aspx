<%@ page language="VB" autoeventwireup="false" inherits="fCPagar_Clientes" CodeFile="fCPagar_Clientes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCPagar_Clientes" runat="server" AutoDataBind="true"

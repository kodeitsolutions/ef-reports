<%@ page language="VB" autoeventwireup="false" inherits="TRF_fNotas_Credito" CodeFile="TRF_fNotas_Credito.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Nota de Crédito (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_fNotas_Credito" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_rMCuentas_Cuentas"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_rMCuentas_Cuentas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT	Movimientos_Cuentas.Cod_Tip, ")
            ...
            loComandoSeleccionar.AppendLine("       JOIN Tipos_Movimientos")
            loComandoSeleccionar.AppendLine("           ON Movimientos_Cuentas.Cod_Tip = Tipos_Movimientos.Cod_Tip")
            loComandoSeleccionar.AppendLine("       JOIN Cuentas_Bancarias")
            loComandoSeleccionar.AppendLine("           ON  Movimientos_Cuentas.Cod_Cue = Cuentas_Bancarias.Cod_Cue")
            loComandoSeleccionar.AppendLine(" WHERE     Movimientos_Cuentas.Fec_Ini     BETWEEN " & lcParametro0Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("CGS_rMCuentas_Cuentas", laDatosReporte)

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rGarantia_PrestacionesTrabajadores.aspx.vb" Inherits="TRF_rGarantia_PrestacionesTrabajadores" %>
...
<head runat="server">
    <title>Garantía de Prestaciones de Trabajadores (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvTRF_rGarantia_PrestacionesTrabajadores" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCRetencion_ISLR_PagoProveedores_RASA" CodeFile="fCRetencion_ISLR_PagoProveedores_RASA.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque Bancaribe GPV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCRetencion_ISLR_PagoProveedores_RASA" runat="server" AutoDataBind="true"

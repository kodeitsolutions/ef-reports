<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Compras_IHP" CodeFile="fFacturas_Compras_IHP.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Facturas de Compras In Hand Provider</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Compras_IHP" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="PAS_rResumenRetencion_ISLRProveedores" 
CodeFile="PAS_rResumenRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Retención de ISLR (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPAS_rResumenRetencion_ISLRProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

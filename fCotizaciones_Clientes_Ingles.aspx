<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Clientes_Ingles" CodeFile="fCotizaciones_Clientes_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Cotizaciones a Clientes en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Clientes_Ingles" runat="server" AutoDataBind="true"

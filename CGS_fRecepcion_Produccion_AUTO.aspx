<%@ page language="VB" autoeventwireup="false" inherits="CGS_fRecepcion_Produccion_AUTO" CodeFile="CGS_fRecepcion_Produccion_AUTO.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Recepción de Producción AUTO (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fRecepcion_Produccion_AUTO" runat="server" AutoDataBind="true"

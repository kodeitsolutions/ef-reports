<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores.aspx.vb" Inherits="rProveedores" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores" runat="server" AutoDataBind="true"

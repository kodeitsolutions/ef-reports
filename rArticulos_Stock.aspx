<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_Stock" CodeFile="rArticulos_Stock.aspx.vb"  %>
...
<head runat="server">
    <title>Reporte de Artículos con su Stock</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Stock" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

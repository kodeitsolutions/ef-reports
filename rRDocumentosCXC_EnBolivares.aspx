<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRDocumentosCXC_EnBolivares.aspx.vb" Inherits="rRDocumentosCXC_EnBolivares" %>
...
<head runat="server">
    <title>Resumen de Documentos de Cuentas por Cobrar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRDocumentosCXC_EnBolivares" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_fRequerimientos.aspx.vb" Inherits="KDE_fRequerimientos" %>
...
<head runat="server">
    <title>Formato de Requerimientos (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_fRequerimientos" runat="server" AutoDataBind="true"

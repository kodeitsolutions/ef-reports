<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCobros_Vendedores.aspx.vb" Inherits="rCobros_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Cobros por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCobros_Vendedores" runat="server" AutoDataBind="true"

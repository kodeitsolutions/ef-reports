<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_sProveedor.aspx.vb" Inherits="rArticulos_sProveedor" %>
...
<head runat="server">
    <title>Reporte de Artículos con su Stock por Almacén</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_sProveedor" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

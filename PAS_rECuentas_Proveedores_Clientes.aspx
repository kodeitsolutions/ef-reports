<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_rECuentas_Proveedores_Clientes.aspx.vb" Inherits="PAS_rECuentas_Proveedores_Clientes" %>
...
<head runat="server">
    <title>Reporte de Estado de Cuentas de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_rECuentas_Proveedores_Clientes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLMontosAjustes_tMes.aspx.vb" Inherits="rLMontosAjustes_tMes" %>
...
<head runat="server">
    <title>Reporte de Montos de Ajustes por Tipo de Ajuste Totalizados Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLMontosAjustes_tMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

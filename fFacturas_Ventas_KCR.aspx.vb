...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFacturas_Ventas_KCR"
'-------------------------------------------------------------------------------------------'
Partial Class fFacturas_Ventas_KCR
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFacturas_Ventas_KCR", laDatosReporte)
			lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".",",")
            ...
            for i as integer = 0 to doctoprint.PrinterSettings.PaperSizes.Count - 1
                Dim p as System.Drawing.Printing.PaperSize = doctoprint.PrinterSettings.PaperSizes(i)
                if (p.PaperName = "8.5x5.5") Then

                
                    rawKind = Convert.ToInt32(p.GetType().GetField("kind", System.Reflection.BindingFlags.Instance _
                        OR System.Reflection.BindingFlags.NonPublic).GetValue(p))
            ...
            loObjetoReporte.PrintOptions.PaperSize = DirectCast(rawKind, CrystalDecisions.Shared.PaperSize)

            Me.crvfFacturas_Ventas_KCR.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSMS_AñoMes.aspx.vb" Inherits="rSMS_AñoMes" %>
...
<head runat="server">
    <title>Reporte de SMS por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSMS_AñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_DepartamentosVendedores.aspx.vb" Inherits="rTVentas_DepartamentosVendedores" %>
...
<head runat="server">
    <title>Total Ventas por Departamentos y Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_DepartamentosVendedores" runat="server" AutoDataBind="true"

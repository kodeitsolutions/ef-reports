Imports System.Data
Partial Class rFacturas_Clientes 
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" ORDER BY    Facturas.Cod_Cli, " & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFacturas_Clientes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrFacturas_Clientes.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Dacron.aspx.vb" Inherits="rLVentas_Dacron" %>
...
<head runat="server">
    <title>Libro de Ventas Dacron</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrLVentas_Resumido" runat="server" AutoDataBind="true"

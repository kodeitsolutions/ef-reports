<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Vendedores.aspx.vb" Inherits="rTipos_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Tipos de Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Vendedores" runat="server" AutoDataBind="true"

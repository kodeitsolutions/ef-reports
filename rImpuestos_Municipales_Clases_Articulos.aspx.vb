...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rImpuestos_Municipales_Clases_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class rImpuestos_Municipales_Clases_Articulos
   Inherits vis2Formularios.frmReporte
	...
	Try	
			...
			Dim loComandoSeleccionar As New StringBuilder() 	
				...
				loComandoSeleccionar.AppendLine(" SELECT	CAST(Clases_Articulos.imp_mun as XML) AS impuesto,")
				loComandoSeleccionar.AppendLine(" 			Clases_Articulos.Cod_Cla AS Cod_Cla")
				loComandoSeleccionar.AppendLine(" INTO	#tmpImpuesto")
				loComandoSeleccionar.AppendLine(" FROM	Clases_Articulos ")
				loComandoSeleccionar.AppendLine("")
				
				loComandoSeleccionar.AppendLine(" SELECT	#tmpImpuesto.Cod_Cla,")
				...
				loComandoSeleccionar.AppendLine(" ORDER BY Cod_Cla ASC")
				loComandoSeleccionar.AppendLine("")
				...
				loComandoSeleccionar.AppendLine(" GROUP BY #tmpTemporal1.Cod_Cla,#tmpTemporal1.codigo, #tmpTemporal1.nombre,#tmpTemporal1.impuesto,Impuestos_Municipales.Nom_Imp,Impuestos_Municipales.Por_Imp")
				loComandoSeleccionar.AppendLine("")
				...
				loComandoSeleccionar.AppendLine("			Clases_Articulos.Cod_Cla As Cod_Cla,")
				loComandoSeleccionar.AppendLine("			Clases_Articulos.Nom_Cla  As Nom_Cla,")
				...
				loComandoSeleccionar.AppendLine(" JOIN Clases_Articulos ON (Clases_Articulos.Cod_Cla = Articulos.Cod_Cla AND Clases_Articulos.Cod_Cla = #tmpTemporal2.Cod_Cla)")
			...
			End If
				...
				loComandoSeleccionar.AppendLine(" GROUP BY Facturas.Cod_Suc,Clases_Articulos.Cod_Cla,Clases_Articulos.Nom_Cla,#tmpTemporal2.nombre,#tmpTemporal2.impuesto,#tmpTemporal2.Nom_Impuesto,#tmpTemporal2.Por_Imp")
				loComandoSeleccionar.AppendLine("")
			...
			End If
				...
				loComandoSeleccionar.AppendLine("		AND" & lcParametro14Hasta)
				loComandoSeleccionar.AppendLine(" GROUP BY devoluciones_clientes.Cod_Suc,Clases_Articulos.Cod_Cla,#tmpTemporal2.nombre,#tmpTemporal2.impuesto,#tmpTemporal2.Nom_Impuesto,#tmpTemporal2.Por_Imp")
				loComandoSeleccionar.AppendLine("")
				
				
				loComandoSeleccionar.AppendLine(" SELECT ")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Cod_Suc As Cod_Suc,")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Cod_Cla As Cod_Cla,")
				loComandoSeleccionar.AppendLine("		#tmpVentas.Nom_Cla As Nom_Cla,")
				...
				loComandoSeleccionar.AppendLine("			AND #tmpDevoluciones.Cod_Cla = #tmpVentas.Cod_Cla")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rImpuestos_Municipales_Clases_Articulos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
			            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrImpuestos_Municipales_Clases_Articulos.ReportSource = loObjetoReporte

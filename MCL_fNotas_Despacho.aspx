<%@ page language="VB" autoeventwireup="false" inherits="MCL_fNotas_Despacho" CodeFile="MCL_fNotas_Despacho.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Notas de Despacho (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_fNotas_Despacho" runat="server" AutoDataBind="true"

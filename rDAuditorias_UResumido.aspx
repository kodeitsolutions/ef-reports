<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDAuditorias_UResumido.aspx.vb" Inherits="rDAuditorias_UResumido" %>
...
<head runat="server">
    <title>Reporte de Detalle de Auditorias por Usuarios Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDAuditorias_UResumido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

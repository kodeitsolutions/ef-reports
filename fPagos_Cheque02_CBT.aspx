<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque02_CBT" CodeFile="fPagos_Cheque02_CBT.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque02_CBT" runat="server" AutoDataBind="true"

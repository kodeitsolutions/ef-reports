<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rEGanancias_Perdidas_Mensual.aspx.vb" Inherits="TRF_rEGanancias_Perdidas_Mensual" %>
...
<head runat="server">
    <title>Estado de Ganancias y Pérdidas por Meses (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rEGanancias_Perdidas_Mensual" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

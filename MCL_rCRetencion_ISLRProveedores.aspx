<%@ Page Language="VB" AutoEventWireup="false" Inherits="MCL_rCRetencion_ISLRProveedores" CodeFile="MCL_rCRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (MERCALUM)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrMCL_rCRetencion_ISLRProveedores" runat="server" AutoDataBind="true"

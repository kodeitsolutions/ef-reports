<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompetencia.aspx.vb" Inherits="rCompetencia" %>
...
<head runat="server">
    <title>Reporte de Competencia</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompetencia" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

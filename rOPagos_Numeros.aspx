<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_Numeros.aspx.vb" Inherits="rOPagos_Numeros" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_Numeros" runat="server" AutoDataBind="true"

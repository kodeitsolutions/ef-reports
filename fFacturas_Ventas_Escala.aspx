<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Escala" CodeFile="fFacturas_Ventas_Escala.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Escala" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false"  CodeFile="rAlmacenes.aspx.vb" Inherits="rAlmacenes" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAlmacenes" runat="server" AutoDataBind="true"

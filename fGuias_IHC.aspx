<%@ page language="VB" autoeventwireup="false" inherits="fGuias_IHC" CodeFile="fGuias_IHC.aspx.vb" %>
...
<head runat="server">
    <title>Guías In Hand Customer</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfGuias_Clientes" runat="server" AutoDataBind="true"

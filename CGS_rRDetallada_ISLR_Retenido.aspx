<%@ page language="VB" autoeventwireup="false" inherits="CGS_rRDetallada_ISLR_Retenido" CodeFile="CGS_rRDetallada_ISLR_Retenido.aspx.vb" %>
...
<head runat="server">
    <title>Relación Detallada de ISLR Retenido (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCGS_rRDetallada_ISLR_Retenido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fAuditoriasTraza_Requisiciones" CodeFile="fAuditoriasTraza_Requisiciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Traza y Auditoría de Requisiciones Internas</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfAuditoriasTraza_Requisiciones" runat="server" AutoDataBind="true"

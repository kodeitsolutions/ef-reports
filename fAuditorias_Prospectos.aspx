<%@ page language="VB" autoeventwireup="false" inherits="fAuditorias_Prospectos" CodeFile="fAuditorias_Prospectos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Prospectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAuditorias_Prospectos" runat="server" AutoDataBind="true"

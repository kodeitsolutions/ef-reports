<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_USA" CodeFile="fCotizaciones_USA.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_USA" runat="server" AutoDataBind="true"

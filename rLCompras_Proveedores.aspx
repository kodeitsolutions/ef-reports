<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLCompras_Proveedores.aspx.vb" Inherits="rLCompras_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Compras por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLCompras_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

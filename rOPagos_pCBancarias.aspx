<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_pCBancarias.aspx.vb" Inherits="rOPagos_pCBancarias" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos por Cuenta Bancaria</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_pCBancarias" runat="server" AutoDataBind="true"

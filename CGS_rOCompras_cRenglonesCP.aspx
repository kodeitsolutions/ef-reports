<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rOCompras_cRenglonesCP.aspx.vb" Inherits="CGS_rOCompras_cRenglonesCP" %>
...
<head runat="server">
    <title>Reporte Administrativo de Órdenes de Compras (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOCompras_cRenglonesCP" runat="server" AutoDataBind="true"

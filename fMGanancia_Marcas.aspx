<%@ page language="VB" autoeventwireup="false" inherits="fMGanancia_Marcas" CodeFile="fMGanancia_Marcas.aspx.vb" %>
...
<head runat="server">
    <title>Márgenes de Ganancia por Marca</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfMGanancia_Marcas" runat="server" AutoDataBind="true"

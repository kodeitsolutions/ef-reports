<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCotizaciones_ArticulosFechasVendedores.aspx.vb" Inherits="rTCotizaciones_ArticulosFechasVendedores" %>
...
<head runat="server">
    <title>Reporte de Total de Cotizaciones por Artículos por Fechas y Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCotizaciones_ArticulosFechasVendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"
            EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

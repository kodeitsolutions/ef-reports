<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLInventarios_Renglones.aspx.vb" Inherits="rLInventarios_Renglones" %>
...
<head runat="server">
    <title>Listado de Formas Líbres de Inventarios con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLInventarios_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

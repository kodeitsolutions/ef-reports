<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUbicaciones_Articulos.aspx.vb" Inherits="rUbicaciones_Articulos" %>
...
<head runat="server">
    <title>Reporte de Ubicaciones de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrUbicaciones_Articulos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_Renglones.aspx.vb" Inherits="rCompras_Renglones" %>
...
<head runat="server">
    <title>Reporte de Compras con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

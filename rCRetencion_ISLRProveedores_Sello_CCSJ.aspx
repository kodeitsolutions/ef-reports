<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores_Sello_CCSJ" CodeFile="rCRetencion_ISLRProveedores_Sello_CCSJ.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores Sellado (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCRetencion_ISLRProveedores_Sello_CCSJ" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"
            EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <vis3Controles:pnlVentanaModal ID="PnlVentanaModalPrincipal" runat="server" pcEstiloBotonCerrar="BotonCerrarVentanaModal"
                        ...
                        plMostrarBotonCerrar="false" poAlto="520px" poAncho="550px" Style="left: -16px; top: 50px" />

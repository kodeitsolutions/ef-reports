...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTIncidencias_AnnoMes"
'-------------------------------------------------------------------------------------------'
Partial Class rTIncidencias_AnnoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    DATEPART(YEAR,Registro)              AS  Anno, ")
            ...
            loComandoSeleccionar.AppendLine(" SELECT    Anno                    AS  Anno, ")
            ...
            loComandoSeleccionar.AppendLine(" INTO      #curTemporal03 ")
            loComandoSeleccionar.AppendLine(" FROM      #curTemporal02 ")
            loComandoSeleccionar.AppendLine(" ORDER BY  " & lcOrdenamiento)

            loComandoSeleccionar.AppendLine(" SELECT    CAST(Anno AS VARCHAR) + '/' + " & "CAST(Mes AS VARCHAR)    AS  AnnoMes, ")
            loComandoSeleccionar.AppendLine("           Can_Opc, ")
            loComandoSeleccionar.AppendLine("           Can_Err, ")
            loComandoSeleccionar.AppendLine("           Promedio ")
            loComandoSeleccionar.AppendLine(" FROM      #curTemporal03 ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTIncidencias_AnnoMes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTIncidencias_AnnoMes.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Articulos" CodeFile="fTipos_Articulos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Articulos" runat="server" AutoDataBind="true"

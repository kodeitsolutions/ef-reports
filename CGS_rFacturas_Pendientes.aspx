<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rFacturas_Pendientes.aspx.vb" Inherits="CGS_rFacturas_Pendientes" %>
...
<head runat="server">
    <title>Listado de Facturas de Compras Pendientes (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rFacturas_Pendientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

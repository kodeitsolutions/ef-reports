<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Renglones.aspx.vb" Inherits="rPedidos_Renglones" %>
...
<head runat="server">
    <title>Reporte de Pedidos con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

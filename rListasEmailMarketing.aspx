<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rListasEmailMarketing.aspx.vb"  Inherits="rListasEmailMarketing" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrListasEmailMarketing" runat="server" AutoDataBind="true"

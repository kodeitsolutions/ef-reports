<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_Contactos.aspx.vb" Inherits="rProveedores_Contactos" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Contactos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_Contactos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_IHC" CodeFile="fFacturas_IHC.aspx.vb" %>
...
<head runat="server">
    <title>Facturas In Hand Customer</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDetalle_Condominio002_CCMV.aspx.vb" Inherits="rDetalle_Condominio002_CCMV" %>
...
<head runat="server">
    <title>Aviso de Cobro Arrendatarios Con Reservas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDetalle_Condominio002_CCMV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fOrdenes_Cheque_Provincial" CodeFile="CSJ_fOrdenes_Cheque_Provincial.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Orden de Pago Moore</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fOrdenes_Cheque_Provincial" runat="server" AutoDataBind="true"

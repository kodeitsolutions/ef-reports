<%@ page language="VB" autoeventwireup="false" inherits="fProveedoresUltimas_20Facturas" CodeFile="fProveedoresUltimas_20Facturas.aspx.vb" %>
...
<head runat="server">
    <title>Ultimas 20 Facturas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfProveedoresUltimas_20Facturas" runat="server" AutoDataBind="true"

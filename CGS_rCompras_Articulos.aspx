<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCompras_Articulos.aspx.vb" Inherits="CGS_rCompras_Articulos" %>
...
<head runat="server">
    <title>Reporte de Compras por Artículos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rCompras_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

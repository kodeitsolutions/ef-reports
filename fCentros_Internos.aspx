<%@ page language="VB" autoeventwireup="false" inherits="fCentros_Internos" CodeFile="fCentros_Internos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Centros Internos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCentros_Internos" runat="server" AutoDataBind="true"

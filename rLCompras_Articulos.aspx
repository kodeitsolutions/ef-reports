<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLCompras_Articulos.aspx.vb" Inherits="rLCompras_Articulos" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Compras por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLCompras_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

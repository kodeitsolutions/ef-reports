...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLibro_Ventas_2013"
'-------------------------------------------------------------------------------------------'
Partial Class rLibro_Ventas_2013
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        '*****************	Retenciones de IVA, si aplican *************************************  
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLibro_Ventas_2013", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrLibro_Ventas_2013.ReportSource = loObjetoReporte

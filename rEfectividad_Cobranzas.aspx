<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEfectividad_Cobranzas.aspx.vb" Inherits="rEfectividad_Cobranzas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEfectividad_Cobranzas" runat="server" AutoDataBind="true"

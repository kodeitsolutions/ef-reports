<%@ page language="VB" autoeventwireup="false" inherits="CGS_fResumen_Produccion" CodeFile="CGS_fResumen_Produccion.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Producción del día</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fResumen_Produccion" runat="server" AutoDataBind="true"

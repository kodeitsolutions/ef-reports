<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Revision.aspx.vb" Inherits="rTotal_Casos_Revision" %>
...
<head runat="server">
    <title>Total Casos por Revisión</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Revision" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fImpuestos_Nacionales" CodeFile="fImpuestos_Nacionales.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Revisiones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfImpuestos_Nacionales" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="TRF_rRDetallada_ISLR_Retenido" CodeFile="TRF_rRDetallada_ISLR_Retenido.aspx.vb" %>
...
<head runat="server">
    <title>Relación Detallada de ISLR Retenido (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTRF_rRDetallada_ISLR_Retenido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Articulos_FSV2.aspx.vb" Inherits="rPedidos_Articulos_FSV2" %>
...
<head runat="server">
    <title>Historico de Precios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Articulos_FSV2" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Numeros_SENIAT2.aspx.vb" Inherits="rFacturas_Numeros_SENIAT2" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrFacturas_Numeros_SENIAT2" runat="server" AutoDataBind="true"

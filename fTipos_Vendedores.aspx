<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Vendedores" CodeFile="fTipos_Vendedores.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Vendedores" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Proveedores_CCSJ" CodeFile="fPagos_Proveedores_CCSJ.aspx.vb" %>
...
<head runat="server">
    <title>* Pagos a Proveedores (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Proveedores_CCSJ" runat="server" AutoDataBind="true"

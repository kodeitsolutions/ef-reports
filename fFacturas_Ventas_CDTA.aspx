<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Ventas_CDTA" CodeFile="fFacturas_Ventas_CDTA.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas CDTA</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Ventas_CDTA" runat="server" AutoDataBind="true"

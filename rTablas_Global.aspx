<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTablas_Global.aspx.vb" Inherits="rTablas_Global" %>
...
<head runat="server">
    <title>Estado de Tablas en Factory Global</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTablas_Global" runat="server" AutoDataBind="true"

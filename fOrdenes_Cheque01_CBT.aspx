<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque01_CBT" CodeFile="fOrdenes_Cheque01_CBT.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque01_CBT" runat="server" AutoDataBind="true"

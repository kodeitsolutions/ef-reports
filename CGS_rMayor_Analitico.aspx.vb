...
Partial Class CGS_rMayor_Analitico
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("DECLARE	@sp_Documento_Desde	AS VARCHAR(10)")
            loComandoSeleccionar.AppendLine("DECLARE	@sp_Documento_Hasta	AS VARCHAR(10)")
            ...
            loComandoSeleccionar.AppendLine("SET    @sp_Documento_Desde = " & lcParametro2Desde)
            loComandoSeleccionar.AppendLine("SET    @sp_Documento_Hasta = " & lcParametro2Hasta)
            loComandoSeleccionar.AppendLine("SET    @sp_Auxiliar_Desde = " & lcParametro3Desde)
            loComandoSeleccionar.AppendLine("SET    @sp_Auxiliar_Hasta = " & lcParametro3Hasta)
            loComandoSeleccionar.AppendLine("")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY Renglones_Comprobantes.Cod_Cue, Renglones_Comprobantes.Nom_Cue")
            loComandoSeleccionar.AppendLine("")
            ...
            loComandoSeleccionar.AppendLine("		Saldo_Inicial = Mov.Saldo_Inicial")
            ...
            loComandoSeleccionar.AppendLine("			CASE WHEN #tmpMovimientos.Categoria IN ('Capital','Ingresos', 'Pasivos')")
            loComandoSeleccionar.AppendLine("				THEN ISNULL(Saldo_Ini.Saldo_Haber,0)")
            loComandoSeleccionar.AppendLine("				ELSE ISNULL(Saldo_Ini.Saldo_Debe,0)")
            loComandoSeleccionar.AppendLine("			END	AS Saldo_Inicial,")
            ...
            loComandoSeleccionar.AppendLine("			LEFT JOIN (SELECT Cod_Cuenta, SUM(Saldo_Debe) AS Saldo_Debe, SUM(Saldo_Haber) AS Saldo_Haber FROM #tmpSaldos_Iniciales GROUP BY Cod_Cuenta) AS Saldo_Ini")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLista_Cheques.aspx.vb" Inherits="TRF_rLista_Cheques" %>
...
<head runat="server">
    <title>Listado de cheques emitidos (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rLista_Cheques" runat="server" AutoDataBind="true"

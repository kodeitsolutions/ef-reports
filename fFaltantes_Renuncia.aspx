<%@ page language="VB" autoeventwireup="false" inherits="fFaltantes_Renuncia" CodeFile="fFaltantes_Renuncia.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Renuncia de Faltantes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFaltantes_Renuncia" runat="server" AutoDataBind="true"

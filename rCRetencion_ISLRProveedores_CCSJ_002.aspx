<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores_CCSJ_002" CodeFile="rCRetencion_ISLRProveedores_CCSJ_002.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (CCSJ C/# Control)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCRetencion_ISLRProveedores_CCSJ_002" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

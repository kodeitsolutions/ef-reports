Imports System.Data
Partial Class PAS_MCL_rNRecepcion_ProduccionSP
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'lcComandoSeleccionar.AppendLine("		CONCAT(@lcDcto_Desde,' - ', @lcDcto_Hasta)	AS Docs,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("PAS_MCL_rNRecepcion_ProduccionSP", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvPAS_MCL_rNRecepcion_ProduccionSP.ReportSource = loObjetoReporte

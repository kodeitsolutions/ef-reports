<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVideos.aspx.vb" Inherits="rVideos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVideos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

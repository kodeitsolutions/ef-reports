<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_ComprasSP_AUTO" CodeFile="CGS_fOrdenes_ComprasSP_AUTO.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compras S/P Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOrdenes_ComprasSP_AUTO" runat="server" AutoDataBind="true"

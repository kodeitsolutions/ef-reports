<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEfectividadVendedores_CotizadosVsFacturados.aspx.vb" Inherits="rEfectividadVendedores_CotizadosVsFacturados" %>
...
<head runat="server">
    <title>Efectividad Cotizaciones Vs Facturaciones por Vendedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEfectividadVendedores_CotizadosVsFacturados" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

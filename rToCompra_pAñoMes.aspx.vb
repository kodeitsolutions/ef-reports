...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rToCompra_pAñoMes"
'-------------------------------------------------------------------------------------------'
Partial Class rToCompra_pAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("   		renglones_oCompras.can_art1 as cant,  ")
            lcComandoSeleccionar.AppendLine("   		renglones_oCompras.mon_net as monto	  ")
            lcComandoSeleccionar.AppendLine("INTO #temporal	 ")
            lcComandoSeleccionar.AppendLine("FROM ")
            lcComandoSeleccionar.AppendLine(" ordenes_compras, renglones_oCompras, proveedores, articulos")
            lcComandoSeleccionar.AppendLine(" WHERE	")
            lcComandoSeleccionar.AppendLine("					ordenes_compras.documento   =  renglones_oCompras.documento ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rToCompra_pAñoMes", laDatosReporte)
            ...
            Me.crvrToCompra_pAñoMes.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque_MiBanco_GPV" CodeFile="fOrdenes_Cheque_MiBanco_GPV.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque Mi Banco GPV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque_MiBanco_GPV" runat="server" AutoDataBind="true"

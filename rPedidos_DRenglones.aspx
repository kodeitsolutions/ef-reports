<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_DRenglones.aspx.vb" Inherits="rPedidos_DRenglones" %>
...
<head runat="server">
    <title>Listado de Pedidos con Detalle de Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_DRenglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

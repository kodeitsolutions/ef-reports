<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDocumentos_RMA.aspx.vb" Inherits="rDocumentos_RMA" %>
...
<head runat="server">
    <title>Reporte de Documentos de RMA</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDocumentos_RMA" runat="server" AutoDataBind="true"

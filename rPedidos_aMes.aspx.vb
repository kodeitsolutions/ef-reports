...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rPedidos_aMes"
'-------------------------------------------------------------------------------------------'
Partial Class rPedidos_aMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine(" SELECT	articulos.nom_art, ")
            ...
            lcComandoSeleccionar.AppendLine("from renglones_pedidos, pedidos, articulos, departamentos ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rPedidos_aMes", laDatosReporte)
            ...
            Me.crvrPedidos_aMes.ReportSource = loObjetoReporte

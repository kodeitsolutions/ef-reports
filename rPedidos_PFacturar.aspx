<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_PFacturar.aspx.vb" Inherits="rPedidos_PFacturar" %>
...
<head runat="server">
    <title>Reporte de Pedidos Pendientes por Facturar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_PFacturar" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

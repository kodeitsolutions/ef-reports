<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Clientes" CodeFile="fTipos_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Clientes" runat="server" AutoDataBind="true"

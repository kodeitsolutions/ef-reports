<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_Articulos_SLFR.aspx.vb" Inherits="rCotizaciones_Articulos_SLFR" %>
...
<head runat="server">
    <title>Reporte de Cotizaciones por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_Articulos_SLFR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

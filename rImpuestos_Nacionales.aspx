<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rImpuestos_Nacionales.aspx.vb" Inherits="rImpuestos_Nacionales" %>
...
<head runat="server">
    <title>Reporte de Impuestos Nacionales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrImpuestos_Nacionales" runat="server" AutoDataBind="true"

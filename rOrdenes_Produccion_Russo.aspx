<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOrdenes_Produccion_Russo.aspx.vb" Inherits="rOrdenes_Produccion_Russo" %>
...
<head runat="server">
    <title>Listado de Ordenes de Producción</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOrdenes_Produccion_Russo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_Valor" CodeFile="rArticulos_Valor.aspx.vb"  %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Valor" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTPedidos_aAñoMes.aspx.vb" Inherits="rTPedidos_aAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total de Pedidos por Artículos por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTPedidos_aAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

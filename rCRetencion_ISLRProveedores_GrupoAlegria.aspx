<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores_GrupoAlegria" CodeFile="rCRetencion_ISLRProveedores_GrupoAlegria.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_ISLRProveedores_GrupoAlegria" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

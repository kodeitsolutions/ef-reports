<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fSolicitudes_Requerimientos.aspx.vb" Inherits="fSolicitudes_Requerimientos" %>
...
<head runat="server">
    <title>Formato de Solicitudes y Requerimientos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSolicitudes_Requerimientos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fFallas" CodeFile="fFallas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFallas" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fBeneficiarios" CodeFile="fBeneficiarios.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Beneficiarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfBeneficiarios" runat="server" AutoDataBind="true"

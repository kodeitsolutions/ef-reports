<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque01" CodeFile="fOrdenes_Cheque01.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque01" runat="server" AutoDataBind="true"

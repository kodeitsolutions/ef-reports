<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNRecepcion_Numeros.aspx.vb" Inherits="rNRecepcion_Numeros" %>
...
<head runat="server">
    <title>Reporte de Notas de Recepción por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNRecepcion_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

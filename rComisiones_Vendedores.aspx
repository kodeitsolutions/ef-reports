<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rComisiones_Vendedores.aspx.vb" Inherits="rComisiones_Vendedores" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrComisiones_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

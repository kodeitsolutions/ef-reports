<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rMaquila.aspx.vb" Inherits="MCL_rMaquila" %>
...
<head runat="server">
    <title>Listado de Maquila [reducido] (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rMaquila" runat="server" AutoDataBind="true"

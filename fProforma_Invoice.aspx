<%@ page language="VB" autoeventwireup="false" inherits="fProforma_Invoice" CodeFile="fProforma_Invoice.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfProforma_Invoice" runat="server" AutoDataBind="true"

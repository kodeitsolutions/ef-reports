<%@ page language="VB" autoeventwireup="false" inherits="fDatos_Llamada" CodeFile="fDatos_Llamada.aspx.vb" %>
...
<head runat="server">
    <title>Formato de CallCenter: Datos de Llamada</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatos_Llamada" runat="server" AutoDataBind="true"

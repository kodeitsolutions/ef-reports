<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBcotizaciones_Totalizadas.aspx.vb" Inherits="rBcotizaciones_Totalizadas" %>
...
<head runat="server">
    <title>Reporte de Bolsa de Cotizaciones Resumidas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBcotizaciones_Totalizadas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFrecuanecia_Competencia.aspx.vb" Inherits="rFrecuanecia_Competencia" %>
...
<head runat="server">
    <title>Reporte de Frecuencia de Competencias</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFrecuanecia_Competencia" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPresupuestos_Proveedores.aspx.vb" Inherits="rPresupuestos_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Presupuestos por Proveedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPresupuestos_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

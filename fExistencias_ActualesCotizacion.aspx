<%@ page language="VB" autoeventwireup="false" inherits="fExistencias_ActualesCotizacion" CodeFile="fExistencias_ActualesCotizacion.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cotización (USA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfExistencias_ActualesCotizacion" runat="server" AutoDataBind="true"

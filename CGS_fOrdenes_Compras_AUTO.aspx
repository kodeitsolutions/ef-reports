<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_Compras_AUTO" CodeFile="CGS_fOrdenes_Compras_AUTO.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compras Automático (CGS)</title>

<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Tire" CodeFile="fFacturas_Ventas_Tire.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas Tire Solutions</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Tire" runat="server" AutoDataBind="true"

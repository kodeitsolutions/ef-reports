<%@ page language="VB" autoeventwireup="false" inherits="rCotizaciones_USA" CodeFile="rCotizaciones_USA.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_USA" runat="server" AutoDataBind="true"

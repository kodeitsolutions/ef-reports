...
Partial Class rAuditorias_Sucursales
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    (CASE WHEN Cod_Suc = ''	THEN 'Vacio' ELSE Cod_Suc END)                                                  As  Cod_Suc, ")
            ...
            loComandoSeleccionar.AppendLine("           And Cod_Suc     Between " & lcParametro2Desde)
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY  Auditorias.Cod_Suc ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAuditorias_Sucursales", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrAuditorias_Sucursales.ReportSource = loObjetoReporte

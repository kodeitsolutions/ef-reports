<%@ page language="VB" autoeventwireup="false" inherits="IGE_DRO_fFacturas_Ventas" CodeFile="IGE_DRO_fFacturas_Ventas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvIGE_DRO_fFacturas_Ventas" runat="server" AutoDataBind="true"

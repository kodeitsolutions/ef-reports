<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rProveedores_dBasicos.aspx.vb" Inherits="TRF_rProveedores_dBasicos" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Datos Básicos (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rProveedores_dBasicos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Articulos_CCSJ.aspx.vb" Inherits="rFacturas_Articulos_CCSJ" %>
...
<head runat="server">
    <title>Reporte de Facturas por Artículos (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Articulos_CCSJ" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_Montos.aspx.vb" Inherits="rRVentas_Montos" %>
...
<head id="Head1" runat="server">
    <title>Reporte de Resumen de Ventas por Montos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_Montos" runat="server" AutoDataBind="true"

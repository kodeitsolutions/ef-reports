<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rComprobante_Diario.aspx.vb" Inherits="CGS_rComprobante_Diario" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Diario (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rComprobante_Diario" runat="server" AutoDataBind="true"

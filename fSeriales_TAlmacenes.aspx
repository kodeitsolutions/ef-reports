<%@ page language="VB" autoeventwireup="false" inherits="fSeriales_TAlmacenes" CodeFile="fSeriales_TAlmacenes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeriales_TAlmacenes" runat="server" AutoDataBind="true"

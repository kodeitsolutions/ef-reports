<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fOrdenes_Cheque_BanCaribe" CodeFile="CSJ_fOrdenes_Cheque_BanCaribe.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fOrdenes_Cheque_BanCaribe" runat="server" AutoDataBind="true"

...
Partial Class rTFacturas_vAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" facturas, vendedores,renglones_facturas, articulos, departamentos" )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTFacturas_vAñoMes", laDatosReporte)
            ...
            Me.crvrTFacturas_vAñoMes.ReportSource = loObjetoReporte

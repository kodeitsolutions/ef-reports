...
Partial Class CGS_rMovimientosBancos_TCuenta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("					AND Movimientos_Cuentas.Fec_Ini BETWEEN DATEADD(DAY, 1, DATEDIFF(DAY,-1,Cuentas_Bancarias.Fec_Cil)-1) ")
            loComandoSeleccionar.AppendLine("						AND DATEADD(SECOND, -1, DATEADD(DAY, DATEDIFF(DAY, 0, @Fecha)-0, 0))")

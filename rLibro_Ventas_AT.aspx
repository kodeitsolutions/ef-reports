<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Ventas_AT.aspx.vb"
    Inherits="rLibro_Ventas_AT" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrrLibro_Ventas_AT" runat="server" AutoDataBind="true"

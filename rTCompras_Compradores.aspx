<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCompras_Compradores.aspx.vb" Inherits="rTCompras_Compradores" %>
...
<head runat="server">
    <title>Reporte de Total Compras por Comprador</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTCompras_Compradores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLProduccion_Renglones.aspx.vb" Inherits="rLProduccion_Renglones" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Producción con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLProduccion_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class CGS_rCRetencion_IVAProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("				''									AS Cod_Ter,")
            loComandoSeleccionar.AppendLine("				''									AS Nom_Ter,")
            loComandoSeleccionar.AppendLine("				''									AS Rif_Ter,")
            loComandoSeleccionar.AppendLine("				''									AS Nit_Ter,")
            loComandoSeleccionar.AppendLine("				''									AS Direccion_Ter")
            ...
            loComandoSeleccionar.AppendLine("				" & lcAño & "						AS Anio,")
            loComandoSeleccionar.AppendLine("				" & lcMes & "						AS Mes,")
            loComandoSeleccionar.AppendLine("				ISNULL((SELECT Cod_Ter")
            loComandoSeleccionar.AppendLine("				FROM Retenciones_Renglones")
            loComandoSeleccionar.AppendLine("				WHERE Doc_Des = Cuentas_Pagar.Documento	")
            loComandoSeleccionar.AppendLine("					AND Doc_Ori = Cuentas_Pagar.Doc_Ori")
            loComandoSeleccionar.AppendLine("				),'')									AS Cod_Ter, ")
            loComandoSeleccionar.AppendLine("				ISNULL((SELECT Nom_Pro")
            loComandoSeleccionar.AppendLine("				FROM Retenciones_Renglones")
            loComandoSeleccionar.AppendLine("					JOIN Proveedores ON Proveedores.Cod_Pro = Retenciones_Renglones.Cod_Ter")
            loComandoSeleccionar.AppendLine("				WHERE Doc_Des = Cuentas_Pagar.Documento	")
            loComandoSeleccionar.AppendLine("					AND Doc_Ori = Cuentas_Pagar.Doc_Ori")
            loComandoSeleccionar.AppendLine("				),'')									AS Nom_Ter,")
            loComandoSeleccionar.AppendLine("				ISNULL((SELECT Rif")
            loComandoSeleccionar.AppendLine("				FROM Retenciones_Renglones")
            loComandoSeleccionar.AppendLine("					JOIN Proveedores ON Proveedores.Cod_Pro = Retenciones_Renglones.Cod_Ter")
            loComandoSeleccionar.AppendLine("				WHERE Doc_Des = Cuentas_Pagar.Documento	")
            loComandoSeleccionar.AppendLine("					AND Doc_Ori = Cuentas_Pagar.Doc_Ori")
            loComandoSeleccionar.AppendLine("				),'')									AS Rif_Ter,  ")
            loComandoSeleccionar.AppendLine("				ISNULL((SELECT Nit")
            loComandoSeleccionar.AppendLine("				FROM Retenciones_Renglones")
            loComandoSeleccionar.AppendLine("					JOIN Proveedores ON Proveedores.Cod_Pro = Retenciones_Renglones.Cod_Ter")
            loComandoSeleccionar.AppendLine("				WHERE Doc_Des = Cuentas_Pagar.Documento	")
            loComandoSeleccionar.AppendLine("					AND Doc_Ori = Cuentas_Pagar.Doc_Ori")
            loComandoSeleccionar.AppendLine("				),'')									AS Nit_Ter, ")
            loComandoSeleccionar.AppendLine("				ISNULL((SELECT Dir_Fis")
            loComandoSeleccionar.AppendLine("				FROM Retenciones_Renglones")
            loComandoSeleccionar.AppendLine("					JOIN Proveedores ON Proveedores.Cod_Pro = Retenciones_Renglones.Cod_Ter")
            loComandoSeleccionar.AppendLine("				WHERE Doc_Des = Cuentas_Pagar.Documento	")
            loComandoSeleccionar.AppendLine("					AND Doc_Ori = Cuentas_Pagar.Doc_Ori")

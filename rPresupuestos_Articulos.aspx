<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPresupuestos_Articulos.aspx.vb" Inherits="rPresupuestos_Articulos" %>
...
<head runat="server">
    <title>Reporte de Presupuestos por Articulos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPresupuestos_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class CGS_rResumenRetencion_IVAProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN #tabRetenciones.Fecha_Doc < '20180820' AND #tabRetenciones.Fecha_Doc >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("		REPLACE(#tabRetenciones.Rif,'-','') AS Rif,")

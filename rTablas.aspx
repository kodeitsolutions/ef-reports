<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTablas.aspx.vb" Inherits="rTablas" %>
...
<head runat="server">
    <title>Estado de Tablas con sus Estadísticas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTablas" runat="server" AutoDataBind="true"

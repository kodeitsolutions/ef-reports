<%@ page language="VB" autoeventwireup="false" inherits="CGS_rArticulos_Stock" CodeFile="CGS_rArticulos_Stock.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Artículos con Stock (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rArticulos_Stock" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

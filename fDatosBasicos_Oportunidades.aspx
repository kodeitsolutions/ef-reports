<%@ page language="VB" autoeventwireup="false" inherits="fDatosBasicos_Oportunidades" CodeFile="fDatosBasicos_Oportunidades.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Oportunidades: Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatosBasicos_Oportunidades" runat="server" AutoDataBind="true"

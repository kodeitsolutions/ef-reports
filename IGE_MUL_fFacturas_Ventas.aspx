<%@ page language="VB" autoeventwireup="false" inherits="IGE_MUL_fFacturas_Ventas" CodeFile="IGE_MUL_fFacturas_Ventas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvIGE_MUL_fFacturas_Ventas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIIMargen_gMarcas.aspx.vb" Inherits="rMargen_gMarcas" %>
...
<head runat="server">
    <title>Margen de Ganancia por Marca II</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gMarcas" runat="server" AutoDataBind="true"

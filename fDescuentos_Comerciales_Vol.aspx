<%@ page language="VB" autoeventwireup="false" inherits="fDescuentos_Comerciales_Vol" CodeFile="fDescuentos_Comerciales_Vol.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Descuentos Comerciales por Volumen</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDescuentos_Comerciales_Vol" runat="server" AutoDataBind="true"

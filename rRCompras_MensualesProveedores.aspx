<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRCompras_MensualesProveedores.aspx.vb" Inherits="rRCompras_MensualesProveedores" %>
...
<head runat="server">
    <title>Reporte Resumen de Compras Mensuales por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRCompras_MensualesProveedores" runat="server" AutoDataBind="true"

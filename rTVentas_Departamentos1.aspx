<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Departamentos1.aspx.vb" Inherits="rTVentas_Departamentos1" %>
...
<head runat="server">
    <title>Total Ventas por Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Departamentos1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

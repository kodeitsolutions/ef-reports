<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Articulos1.aspx.vb" Inherits="rTVentas_Articulos1" %>
...
<head runat="server">
    <title>Reporte de Total Ventas de Articulos por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Articulos1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gABC"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gABC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpGanancia(	Abc			CHAR(10), ")
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpFinal(	Abc			CHAR(10), ")
            loComandoSeleccionar.AppendLine("							Can_Fac		DECIMAL(28, 10),")
            loComandoSeleccionar.AppendLine("							Can_Dev		DECIMAL(28, 10),")
            loComandoSeleccionar.AppendLine("							Base_A		DECIMAL(28, 10),")
            loComandoSeleccionar.AppendLine("							Base_B		DECIMAL(28, 10),")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Abc, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            loComandoSeleccionar.AppendLine("SELECT		Clientes.Abc														AS Abc,")
            ...
            loComandoSeleccionar.AppendLine("			AND Clientes.ABC				BETWEEN " & lcParametro18Desde & " AND " & lcParametro18Hasta)
            loComandoSeleccionar.AppendLine("GROUP BY	Clientes.Abc")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Abc, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            loComandoSeleccionar.AppendLine("SELECT	Abc					AS Abc,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gABC", laDatosReporte)
            ...
            Me.crvrMargen_gABC.ReportSource = loObjetoReporte

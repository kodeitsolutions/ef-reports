<%@ page language="VB" autoeventwireup="false" inherits="MCL_rRequisiciones_Pendientes_AUTO" CodeFile="MCL_rRequisiciones_Pendientes_AUTO.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Requisiciones Internas Pendientes Automático (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rRequisiciones_Pendientes_AUTO" runat="server" AutoDataBind="true"

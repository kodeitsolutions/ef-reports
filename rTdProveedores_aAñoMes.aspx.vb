...
Partial Class rTdProveedores_aAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" devoluciones_proveedores, renglones_dproveedores, transportes, monedas, articulos, proveedores, departamentos" )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTdProveedores_aAñoMes", laDatosReporte)
            ...
            Me.crvrTdProveedores_aAñoMes.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fMGanancia_Proveedores" CodeFile="fMGanancia_Proveedores.aspx.vb" %>
...
<head runat="server">
    <title>Márgenes de Ganancia por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfMGanancia_Proveedores" runat="server" AutoDataBind="true"

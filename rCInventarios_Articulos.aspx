<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCInventarios_Articulos.aspx.vb" Inherits="rCInventarios_Articulos" %>
...
<head runat="server">
    <title>Reporte de Cortes de Inventarios por Articulos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCInventarios_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

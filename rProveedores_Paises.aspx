<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_Paises.aspx.vb" Inherits="rProveedores_Paises" %>
...
<head runat="server">
    <title>Listado de Proveedores por Paises</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrProveedores_Paises" runat="server" AutoDataBind="true"

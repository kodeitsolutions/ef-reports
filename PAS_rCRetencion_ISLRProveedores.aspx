<%@ Page Language="VB" AutoEventWireup="false" Inherits="PAS_rCRetencion_ISLRProveedores" CodeFile="PAS_rCRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (PAS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrPAS_rCRetencion_ISLRProveedores" runat="server" AutoDataBind="true"

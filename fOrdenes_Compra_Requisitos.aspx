<%@ Page Language="VB" AutoEventWireup="false" Inherits="fOrdenes_Compra_Requisitos" CodeFile="fOrdenes_Compra_Requisitos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compra con sus Requisitos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfOrdenes_Compra_Requisitos" runat="server" AutoDataBind="true"

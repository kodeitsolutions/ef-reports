...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFrecuanecia_Socios"
'-------------------------------------------------------------------------------------------'
Partial Class rFrecuanecia_Socios
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" JOIN Prospectos ON (Prospectos.Cod_Pro = Frecuencias.Cod_Reg) AND ('Prospectos' = Frecuencias.origen) AND (Frecuencias.Adicional = 'Socios') AND (Prospectos.origen = 'Socios') ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFrecuanecia_Socios", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFrecuanecia_Socios.ReportSource = loObjetoReporte

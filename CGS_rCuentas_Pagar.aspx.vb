...
Partial Class CGS_rCuentas_Pagar
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		Ordenes_Compras.Mon_Bru * CONVERT(NUMERIC(18,2), Proveedores.Atributo_A) AS Ret_Pat,")
            ...
            loComandoSeleccionar.AppendLine("       - (Ordenes_Compras.Mon_Bru * CONVERT(NUMERIC(18,2), Proveedores.Atributo_A))")
            ...
            loComandoSeleccionar.AppendLine("	JOIN Proveedores ON Proveedores.Cod_Pro = Ordenes_Compras.Cod_Pro")
            loComandoSeleccionar.AppendLine("WHERE Ordenes_Compras.Status <> 'Pendiente'")
            loComandoSeleccionar.AppendLine("	AND (Ordenes_Compras.Documento IN (SELECT Doc_Ori FROM Renglones_Compras WHERE Tip_Ori = 'ordenes_compras')")
            ...
            loComandoSeleccionar.AppendLine("ORDER BY Tipo, Cod_Pro")
            loComandoSeleccionar.AppendLine("")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Containers.aspx.vb" Inherits="rTipos_Containers" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Containers" runat="server" AutoDataBind="true"

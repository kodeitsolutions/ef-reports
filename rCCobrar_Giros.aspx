<%@ page language="VB" autoeventwireup="false" inherits="rCCobrar_Giros" CodeFile="rCCobrar_Giros.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Giros Formato Continúo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Giros" runat="server" AutoDataBind="true"

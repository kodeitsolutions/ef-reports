<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAVencimiento_dCliente.aspx.vb" Inherits="rAVencimiento_dCliente" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAVencimiento_dCliente" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" CodeFile="fAjustes_Precios_Ingles.aspx.vb" inherits="fAjustes_Precios_Ingles" %>
...
<head runat="server">
    <title>Formato de Ajustes de Precios en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAjustes_Precios_Ingles" runat="server" AutoDataBind="true"

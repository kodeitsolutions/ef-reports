<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMovimientosBancos_TCuenta.aspx.vb" Inherits="rMovimientosBancos_TCuenta" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Cuentas Totalizados por Cuenta</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMovimientosBancos_TCuenta" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

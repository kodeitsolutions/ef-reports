...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fOCompras_DisponibilidadProveedor"
'-------------------------------------------------------------------------------------------'
Partial Class fOCompras_DisponibilidadProveedor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("ORDER BY    COALESCE(Proveedores_Disponibles.Cod_Pro, '') ASC, Renglon ASC")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fOCompras_DisponibilidadProveedor", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfOCompras_DisponibilidadProveedor.ReportSource = loObjetoReporte

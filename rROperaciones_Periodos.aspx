<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rROperaciones_Periodos.aspx.vb" Inherits="rROperaciones_Periodos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrROperaciones_Periodos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSegmentos.aspx.vb" Inherits="rSegmentos" %>
...
<head runat="server">
    <title>Listado de Segmentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSegmentos" runat="server" AutoDataBind="true"

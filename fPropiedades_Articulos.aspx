<%@ page language="VB" autoeventwireup="false" inherits="fPropiedades_Articulos" CodeFile="fPropiedades_Articulos.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Propiedades de Articulos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPropiedades_Articulos" runat="server" AutoDataBind="true"

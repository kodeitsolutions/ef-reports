<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grPedidos_MensualesCantidades.aspx.vb" Inherits="grPedidos_MensualesCantidades" %>
...
<head runat="server">
    <title>Gráfico de Pedidos Mensuales en Cantidades</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrPedidos_MensualesCantidades" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Clientes_StockMarket" CodeFile="fCotizaciones_Clientes_StockMarket.aspx.vb" %>
...
<head runat="server">
    <title>Cotizaciones a Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Clientes_StockMarket" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rAStock_UMultiples" CodeFile="rAStock_UMultiples.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Artículos con su Stock en Unidades Múltiples</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAStock_UMultiples" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

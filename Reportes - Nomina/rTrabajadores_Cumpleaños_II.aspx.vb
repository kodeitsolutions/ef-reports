...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTrabajadores_Cumpleaños_II"
'-------------------------------------------------------------------------------------------'
Partial Class rTrabajadores_Cumpleaños_II
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		'Cumpleañeros del Mes de '+ ")
            ...
            loConsulta.AppendLine("		CASE DATEPART(WEEKDAY,DATEADD(YEAR,YEAR(GETDATE())-YEAR(fec_nac),fec_nac)) ")
            ...
            loConsulta.AppendLine("		END + CAST(DAY(fec_nac) AS CHAR(2)) AS dia, ")
            ...
            loConsulta.AppendLine("ORDER BY      MONTH(fec_nac),Day(fec_nac)," & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTrabajadores_Cumpleaños_II", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTrabajadores_Cumpleaños_II.ReportSource = loObjetoReporte

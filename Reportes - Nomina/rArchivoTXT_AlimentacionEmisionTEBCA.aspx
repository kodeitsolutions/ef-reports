<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_AlimentacionEmisionTEBCA.aspx.vb" Inherits="rArchivoTXT_AlimentacionEmisionTEBCA" %>
...
<head runat="server">
    <title>Bono de Alimentación TEBCA/SERVITECA - Solicitud (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_AlimentacionEmisionTEBCA" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

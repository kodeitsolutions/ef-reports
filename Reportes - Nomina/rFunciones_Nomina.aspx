<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFunciones_Nomina.aspx.vb" Inherits="rFunciones_Nomina" %>
...
<head runat="server">
	<title>Listado de Funciones de Nómina</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrFunciones_Nomina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

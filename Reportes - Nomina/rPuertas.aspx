<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPuertas.aspx.vb" Inherits="rPuertas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPuertas" runat="server" AutoDataBind="true"

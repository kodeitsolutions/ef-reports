<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_NominaBBVA.aspx.vb" Inherits="rArchivoTXT_NominaBBVA" %>
...
<head runat="server">
    <title>Pago de Nómina BBVA (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_NominaBBVA" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

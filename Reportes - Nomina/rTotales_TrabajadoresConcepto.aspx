<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_TrabajadoresConcepto.aspx.vb" Inherits="rTotales_TrabajadoresConcepto" %>
...
<head runat="server">
	<title>Listado de Totales por Trabajador y por Concepto</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_TrabajadoresConcepto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rInasistencias_Acceso.aspx.vb"
    Inherits="rInasistencias_Acceso" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrInasistencias_Acceso" runat="server" AutoDataBind="true"

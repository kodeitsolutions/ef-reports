<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_Departamentos.aspx.vb" Inherits="rTrabajadores_Departamentos" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTrabajadores_Departamentos" runat="server" AutoDataBind="true"

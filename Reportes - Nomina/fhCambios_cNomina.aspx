<%@ Page Language="VB" AutoEventWireup="false" Inherits="fhCambios_cNomina" CodeFile="fhCambios_cNomina.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfhCambios_cNomina" runat="server" AutoDataBind="true"

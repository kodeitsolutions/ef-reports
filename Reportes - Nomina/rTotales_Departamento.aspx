<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_Departamento.aspx.vb" Inherits="rTotales_Departamento" %>
...
<head runat="server">
	<title>Listado de Totales por Departamento</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_Departamento" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

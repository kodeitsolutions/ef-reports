...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTrabajadores_CumpleañosIII"
'-------------------------------------------------------------------------------------------'
Partial Class rTrabajadores_CumpleañosIII
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		RIGHT('00'+RTRIM(CAST(DAY(fec_nac) AS CHAR(2))),2)+ ' de '+ ")
            ...
            loConsulta.AppendLine("		END							AS fecha, ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTrabajadores_CumpleañosIII", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTrabajadores_CumpleañosIII.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="fTrabajadores" CodeFile="fTrabajadores.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTrabajadores" runat="server" AutoDataBind="true"

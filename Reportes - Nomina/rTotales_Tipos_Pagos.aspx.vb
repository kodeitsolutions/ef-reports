...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Tipos_Pagos"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Tipos_Pagos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT     Trabajadores.Tip_Pag,")
            ...
            loComandoSeleccionar.AppendLine("        AND Trabajadores.tip_pag <> ''")
            loComandoSeleccionar.AppendLine("GROUP BY    Trabajadores.Tip_Pag")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Tipos_Pagos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Tipos_Pagos.ReportSource = loObjetoReporte

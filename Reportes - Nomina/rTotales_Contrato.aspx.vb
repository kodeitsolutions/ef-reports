...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Contrato"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Contrato
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("    JOIN    Contratos ")
            loComandoSeleccionar.AppendLine("        ON  Contratos.Cod_Con = Recibos.Cod_Con ")
            ...
            loComandoSeleccionar.AppendLine("        AND Contratos.Cod_Con BETWEEN " & lcParametro3Desde & " AND " & lcParametro3Hasta)
            ...
            loComandoSeleccionar.AppendLine("GROUP BY    Contratos.Cod_Con,")
            loComandoSeleccionar.AppendLine("            Contratos.Nom_Con")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Contrato", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Contrato.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 15/05/13: Codigo inicial																'
'-------------------------------------------------------------------------------------------'
' RJG: 16/05/13: Se agregó la columna Nº de trabajadores.   								'
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Trabajadores_Grado_Instruccion.aspx.vb" Inherits="rTotal_Trabajadores_Grado_Instruccion" %>
...
<head runat="server">
    <title>Total de Trabajadores por Grado de Instrucción</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrTotal_Trabajadores_Grado_Instruccion" runat="server" AutoDataBind="true"

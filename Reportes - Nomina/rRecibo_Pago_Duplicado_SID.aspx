<%@ Page Language="VB" AutoEventWireup="false" Inherits="rRecibo_Pago_Duplicado_SID" CodeFile="rRecibo_Pago_Duplicado_SID.aspx.vb" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrRecibo_Pago_Duplicado_SID" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

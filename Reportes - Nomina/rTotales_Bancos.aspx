<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_Bancos.aspx.vb" Inherits="rTotales_Bancos" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_Bancos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

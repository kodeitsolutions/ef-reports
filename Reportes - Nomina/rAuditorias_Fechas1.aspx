<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Fechas1.aspx.vb" Inherits="rAuditorias_Fechas1" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Fechas1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Trabajadores_Contratos.aspx.vb" Inherits="rTotal_Trabajadores_Contratos" %>
...
<head runat="server">
    <title>Total de Trabajadores por Contrato</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrTotal_Trabajadores_Contratos" runat="server" AutoDataBind="true"

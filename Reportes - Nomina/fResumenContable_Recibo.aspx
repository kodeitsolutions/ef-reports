<%@ Page Language="VB" AutoEventWireup="false" Inherits="fResumenContable_Recibo" CodeFile="fResumenContable_Recibo.aspx.vb" %>
...
<head runat="server">
	<title>Listado de Resumen Contable de Recibos</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvfResumenContable_Recibo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

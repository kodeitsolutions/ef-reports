<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_Nomina_100BANCO.aspx.vb" Inherits="rArchivoTXT_Nomina_100BANCO" %>
...
<head runat="server">
    <title>Pago de Nómina 100% BANCO (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_Nomina_100BANCO" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

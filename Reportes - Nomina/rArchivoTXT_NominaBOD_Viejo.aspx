<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_NominaBOD_Viejo.aspx.vb" Inherits="rArchivoTXT_NominaBOD_Viejo" %>
...
<head runat="server">
    <title>Pago de Nómina BOD (TXT) - Formato 2014</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_NominaBOD_Viejo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fReposos.aspx.vb" Inherits="fReposos" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfReposos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Grado_Instruccion"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Grado_Instruccion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT      Grados_Instruccion.cod_gra,")
            loComandoSeleccionar.AppendLine("            Grados_Instruccion.nom_gra,")
            ...
            loComandoSeleccionar.AppendLine("    JOIN    Grados_Instruccion ")
            loComandoSeleccionar.AppendLine("        ON  Grados_Instruccion.Cod_gra = Trabajadores.Cod_gra ")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY    Grados_Instruccion.cod_gra,")
            loComandoSeleccionar.AppendLine("            Grados_Instruccion.nom_gra")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Grado_Instruccion", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Grado_Instruccion.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rConstancias_tLiquidados"
'-------------------------------------------------------------------------------------------'
Partial Class rConstancias_tLiquidados
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim lcParametro9Desde As String = goServicios.mObtenerCampoFormatoSQL(cusAplicacion.goReportes.paParametrosIniciales(9))  'condicion de contrato
        ...
        Try
            ...
            loConsulta.AppendLine("        COALESCE(Usuarios.Telefonos, '')                AS Telefonos_Firma,")
            ...
            loConsulta.AppendLine("        " & lcParametro9Desde & "                       AS Cond_Contrato")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rConstancias_tLiquidados", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrConstancias_tLiquidados.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLiquidaciones.aspx.vb" Inherits="rLiquidaciones" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrLiquidaciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

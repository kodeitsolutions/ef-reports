<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReposos_Trabajador.aspx.vb" Inherits="rReposos_Trabajador" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrReposos_Trabajador" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Trabajadores_Sucursales.aspx.vb" Inherits="rTotal_Trabajadores_Sucursales" %>
...
<head runat="server">
    <title>Total de Trabajadores por Sucursales</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrTotal_Trabajadores_Sucursales" runat="server" AutoDataBind="true"

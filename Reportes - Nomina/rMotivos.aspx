<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMotivos.aspx.vb" Inherits="rMotivos" %>
...
<head runat="server">
    <title>Reporte de Motivos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMotivos" runat="server" AutoDataBind="true"

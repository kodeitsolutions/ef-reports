Imports System.Data
Partial Class rConstantes_Locales
	...
	Try	
		lcComandoSelect = "SELECT	Cod_Con, " _
								 & "Nom_Con, " _
								 & "Status, " _
								 & "(Case When Status = 'A' Then 'Activo' Else 'Inactivo' End) as Status_Constantes_Locales " _
						& "FROM	 Constantes_Locales " _
           ...
           loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rConstantes_Locales", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrConstantes_Locales.ReportSource = loObjetoReporte

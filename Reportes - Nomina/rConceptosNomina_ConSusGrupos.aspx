<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConceptosNomina_ConSusGrupos.aspx.vb"
    Inherits="rConceptosNomina_ConSusGrupos" %>
...
<head runat="server">
    <title>Conceptos de Nómina con sus Grupos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrConceptosNomina_ConSusGrupos" runat="server" AutoDataBind="true"

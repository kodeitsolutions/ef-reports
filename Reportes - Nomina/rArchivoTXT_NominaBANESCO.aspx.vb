...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rArchivoTXT_NominaBANESCO"
'-------------------------------------------------------------------------------------------'
Partial Class rArchivoTXT_NominaBANESCO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Dim lcParametro4Desde As String = goServicios.mObtenerCampoFormatoSQL(cusAplicacion.goReportes.paParametrosIniciales(4), goServicios.enuOpcionesRedondeo.KN_FechaSinHoras)
        ...
        Try
            ...
            loConsulta.AppendLine("            CAST( " & lcParametro4Desde & " AS DATE)AS Emision,")
            loConsulta.AppendLine("            CAST( " & lcParametro5Desde & " AS VARCHAR(8))AS Codigo_Descripcion_Pago,")
            loConsulta.AppendLine("            CAST( " & lcParametro6Desde & " AS VARCHAR(8))AS Referencia_Debito,")
            loConsulta.AppendLine("            CAST( " & lcParametro7Desde & " AS VARCHAR(8))AS Numero_Orden_Pago")
            loConsulta.AppendLine("FROM        Trabajadores")
            loConsulta.AppendLine("    JOIN    Cuentas_Bancarias ON Cuentas_Bancarias.Cod_Cue = Trabajadores.Cod_Cue")
            ...
            loConsulta.AppendLine("    AND Trabajadores.Cod_Cue = " & lcParametro3Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rArchivoTXT_NominaBANESCO", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrArchivoTXT_NominaBANESCO.ReportSource = loObjetoReporte

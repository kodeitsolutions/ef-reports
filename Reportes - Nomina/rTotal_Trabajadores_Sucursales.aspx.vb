...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Trabajadores_Sucursales"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Trabajadores_Sucursales
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		Sucursales.cod_suc,")
            ...
            loConsulta.AppendLine("	JOIN Sucursales ON Sucursales.cod_suc = Trabajadores.cod_suc")
            ...
            loConsulta.AppendLine("Group by Sucursales.cod_suc,Sucursales.nom_suc")
            loConsulta.AppendLine("ORDER BY Sucursales.cod_suc")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Trabajadores_Sucursales", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Trabajadores_Sucursales.ReportSource = loObjetoReporte

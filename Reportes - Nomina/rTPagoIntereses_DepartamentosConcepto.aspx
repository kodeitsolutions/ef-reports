<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTPagoIntereses_DepartamentosConcepto.aspx.vb" Inherits="rTPagoIntereses_DepartamentosConcepto" %>
...
<head runat="server">
	<title>Listado de Totales de Pago de Intereses de Prestaciones por Departamento y por Concepto</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTPagoIntereses_DepartamentosConcepto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

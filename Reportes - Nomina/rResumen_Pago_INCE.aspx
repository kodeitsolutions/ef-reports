<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumen_Pago_INCE.aspx.vb" Inherits="rResumen_Pago_INCE" %>
...
<head runat="server">
	<title>Resumen del Pago del INCE</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrResumen_Pago_INCE" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

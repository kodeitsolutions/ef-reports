<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTurnos_Accesos.aspx.vb" Inherits="rTurnos_Accesos" %>
...
<head runat="server">
    <title>Reporte de Turnos de Accesos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTurnos_Accesos" runat="server" AutoDataBind="true"

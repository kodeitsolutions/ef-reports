...
Partial Class rMotivos
	...
	Try	
		lcComandoSelect = "SELECT	Cod_Mot, " _
						          & "Nom_Mot, " _
								  & "Status, " _
								  & "(Case When Status = 'A' Then 'Activo' Else 'Inactivo' End) as Status_Motivos " _
						& "FROM	 Motivos " _
						& "WHERE Cod_Mot between '" & cusAplicacion.goReportes.paParametrosIniciales(0) & "'" _
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMotivos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrMotivos.ReportSource = loObjetoReporte

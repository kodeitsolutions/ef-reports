<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConceptosNomina_Origen.aspx.vb" Inherits="rConceptosNomina_Origen" %>
...
<head runat="server">
    <title>Listado de Conceptos de Nómina</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrConceptosNomina_Origen" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

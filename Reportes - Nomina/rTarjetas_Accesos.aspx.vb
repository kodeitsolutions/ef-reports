Imports System.Data
Partial Class rTarjetas_Accesos
   Inherits vis2Formularios.frmReporte
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
        lcComandoSelect = "SELECT	Cod_Tar, " _
						         & "Nom_Tar, " _
						         & "Status, " _
							     & "Case When Status = 'A' Then 'Activo' Else 'Inactivo' End as Status_Tarjetas_Accesos " _
					     & "FROM	 Tarjetas_Accesos " _
				         & "WHERE Cod_Tar between '" & cusAplicacion.goReportes.paParametrosIniciales(0) & "'" _
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTarjetas_Accesos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
			            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrTarjetas_Accesos.ReportSource =   loObjetoReporte

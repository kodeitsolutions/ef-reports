<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_Conceptos.aspx.vb" Inherits="rTotales_Conceptos" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_Conceptos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRecibo_Pago_BonoAlimentacionCGS"
'-------------------------------------------------------------------------------------------'
Partial Class rRecibo_Pago_BonoAlimentacionCGS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		AND Contratos.Cod_Con IN ('95')")
            End If
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRecibo_Pago_BonoAlimentacionCGS", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRecibo_Pago_BonoAlimentacionCGS.ReportSource = loObjetoReporte

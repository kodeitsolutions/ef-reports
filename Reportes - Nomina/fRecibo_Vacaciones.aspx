<%@ Page Language="VB" AutoEventWireup="false" Inherits="fRecibo_Vacaciones" CodeFile="fRecibo_Vacaciones.aspx.vb" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvfRecibo_Vacaciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

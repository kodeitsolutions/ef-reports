<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fListas_Desplegables.aspx.vb" Inherits="fListas_Desplegables" %>
...
<head runat="server">
    <title>Formato de Usuarios Globales</title>
...
<body>
    <form id="form1" runat="server">
        <div><asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <CR:CrystalReportViewer ID="crvfListas_Desplegables" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

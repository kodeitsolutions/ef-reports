<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGConceptos_Detallado.aspx.vb" Inherits="rGConceptos_Detallado" %>
...
<head runat="server">
	<title>Listado de Grupos de Conceptos</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrGConceptos_Detallado" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fRecibo_Utilidades" CodeFile="fRecibo_Utilidades.aspx.vb" %>
...
<head runat="server">
	<title>Recivo de Pago</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvfRecibo_Utilidades" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fRecibo_Pago" CodeFile="fRecibo_Pago.aspx.vb" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvfRecibo_Pago" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

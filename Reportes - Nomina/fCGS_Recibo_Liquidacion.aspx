<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCGS_Recibo_Liquidacion" CodeFile="fCGS_Recibo_Liquidacion.aspx.vb" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvfCGS_Recibo_Liquidacion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

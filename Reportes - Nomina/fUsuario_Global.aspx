<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fUsuario_Global.aspx.vb" Inherits="fUsuario_Global" %>
...
<body>
    <form id="form1" runat="server">
        <div><asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <CR:CrystalReportViewer ID="crvfUsuario_Global" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

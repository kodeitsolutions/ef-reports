<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCNomina_Trabajador.aspx.vb" Inherits="rCNomina_Trabajador" %>
...
<head runat="server">
	<title>Listado de Campos de Nómina por Trabajador</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrCNomina_Trabajador" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

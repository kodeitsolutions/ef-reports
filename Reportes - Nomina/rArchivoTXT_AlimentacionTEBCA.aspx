<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_AlimentacionTEBCA.aspx.vb" Inherits="rArchivoTXT_AlimentacionTEBCA" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_AlimentacionTEBCA" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

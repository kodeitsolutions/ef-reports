<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rContratos_Detallados.aspx.vb" Inherits="rContratos_Detallados" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrContratos_Detallados" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

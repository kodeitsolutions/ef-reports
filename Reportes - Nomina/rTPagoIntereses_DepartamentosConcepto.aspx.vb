...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTPagoIntereses_DepartamentosConcepto"
'-------------------------------------------------------------------------------------------'
Partial Class rTPagoIntereses_DepartamentosConcepto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("        AND Recibos.Cod_Con IN ('89') ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTPagoIntereses_DepartamentosConcepto", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTPagoIntereses_DepartamentosConcepto.ReportSource = loObjetoReporte

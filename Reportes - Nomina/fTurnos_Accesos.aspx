<%@ page language="VB" autoeventwireup="false" inherits="fTurnos_Accesos" CodeFile="fTurnos_Accesos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTurnos_Accesos" runat="server" AutoDataBind="true"

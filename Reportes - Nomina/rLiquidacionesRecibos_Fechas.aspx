<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLiquidacionesRecibos_Fechas.aspx.vb" 
    Inherits="rLiquidacionesRecibos_Fechas" %>
...
<head runat="server">
	<title>Listado de Liquidaciones por Fecha</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrLiquidacionesRecibos_Fechas" runat="server" AutoDataBind="true" 
			    EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" 

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rElegibles.aspx.vb" Inherits="rElegibles" %>
...
<head runat="server">
    <title>Reporte de Elegibles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrElegibles" runat="server" AutoDataBind="true"

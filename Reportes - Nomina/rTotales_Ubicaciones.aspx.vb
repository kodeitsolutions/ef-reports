...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Ubicaciones"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Ubicaciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT     Ubicaciones_Nomina.nom_ubi,")
            loComandoSeleccionar.AppendLine("			Ubicaciones_Nomina.cod_ubi,")
            ...
            loComandoSeleccionar.AppendLine("    JOIN    Ubicaciones_Nomina ")
            loComandoSeleccionar.AppendLine("        ON  Ubicaciones_Nomina.Cod_Ubi = Trabajadores.Cod_Ubi ")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY    Ubicaciones_Nomina.cod_ubi,")
            loComandoSeleccionar.AppendLine("            Ubicaciones_Nomina.nom_ubi")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Ubicaciones", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Ubicaciones.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_NominaProvincial.aspx.vb" Inherits="rArchivoTXT_NominaProvincial" %>
...
<head runat="server">
    <title>Pago de Nómina Provincial (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_NominaProvincial" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

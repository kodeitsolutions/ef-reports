<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Documentacion.aspx.vb" Inherits="rTipos_Documentacion" %>
...
<head runat="server">
	<title>Listado Tipos de Documentacion</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTipos_Documentacion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

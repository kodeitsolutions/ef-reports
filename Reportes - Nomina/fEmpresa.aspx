<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fEmpresa.aspx.vb" Inherits="fEmpresa" %>
...
<body>
    <form id="form1" runat="server">
        <div><asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <CR:CrystalReportViewer ID="crvfEmpresa" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_ConceptosTrabajador.aspx.vb" Inherits="rTotales_ConceptosTrabajador" %>
...
<head runat="server">
	<title>Listado de Totales por Concepto por Trabajador</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_ConceptosTrabajador" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

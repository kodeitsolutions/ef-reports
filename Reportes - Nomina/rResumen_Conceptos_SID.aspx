<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumen_Conceptos_SID.aspx.vb" Inherits="rResumen_Conceptos_SID" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrResumen_Conceptos_SID" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

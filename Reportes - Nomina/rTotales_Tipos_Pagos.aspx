<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_Tipos_Pagos.aspx.vb" Inherits="rTotales_Tipos_Pagos" %>
...
<head runat="server">
	<title>Listado de Total Movimientos por Cargo</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_Tipos_Pagos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRecibo_Pago_BonoAlimentacion_SID"
'-------------------------------------------------------------------------------------------'
Partial Class rRecibo_Pago_BonoAlimentacion_SID
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("WHERE	Renglones_Recibos.Cod_Con IN ('A011', 'A013')")
            ...
            loConsulta.AppendLine("")
            loConsulta.AppendLine("SELECT   *, Sueldos.Monto_Periodo")
            ...
            loConsulta.AppendLine("        FROM    #tmpRecibos")
            loConsulta.AppendLine("        WHERE   Tipo <> 'Otro'")
            ...
            loConsulta.AppendLine("			(CASE Tipo ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRecibo_Pago_BonoAlimentacion_SID", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRecibo_Pago_BonoAlimentacion_SID.ReportSource = loObjetoReporte

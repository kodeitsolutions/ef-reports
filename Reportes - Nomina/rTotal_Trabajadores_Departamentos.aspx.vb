...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Trabajadores_Departamentos"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Trabajadores_Departamentos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("Group by Departamentos_Nomina.cod_dep,Departamentos_Nomina.nom_dep")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Trabajadores_Departamentos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Trabajadores_Departamentos.ReportSource = loObjetoReporte

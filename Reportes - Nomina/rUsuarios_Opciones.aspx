<%@ page language="VB" autoeventwireup="false" CodeFile="rUsuarios_Opciones.aspx.vb" inherits="rUsuarios_Opciones" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrUsuarios_Opciones" runat="server" AutoDataBind="true"

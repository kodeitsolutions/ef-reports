<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEstados_Civiles.aspx.vb" Inherits="rEstados_Civiles" %>
...
<head runat="server">
    <title>Reporte de Estados Civiles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEstados_Civiles" runat="server" AutoDataBind="true"

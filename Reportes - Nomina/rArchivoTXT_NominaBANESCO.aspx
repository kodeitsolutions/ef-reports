<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_NominaBANESCO.aspx.vb" Inherits="rArchivoTXT_NominaBANESCO" %>
...
<head runat="server">
    <title>Pago de Nómina BANESCO (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_NominaBANESCO" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

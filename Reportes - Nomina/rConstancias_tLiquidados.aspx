<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConstancias_tLiquidados.aspx.vb" Inherits="rConstancias_tLiquidados" %>
...
<head runat="server">
    <title>Listado de Constancias de Trabajadores Liquidados</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrConstancias_tLiquidados" runat="server" AutoDataBind="true"

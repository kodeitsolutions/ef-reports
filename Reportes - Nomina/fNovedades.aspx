<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fNovedades.aspx.vb" Inherits="fNovedades" %>
...
<head runat="server">
    <title>Formato de Novedades</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfNovedades" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

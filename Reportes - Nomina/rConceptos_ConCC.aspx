<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConceptos_ConCC.aspx.vb" Inherits="rConceptos_ConCC" %>
...
<head runat="server">
    <title>Listado de Conceptos con sus Cuentas Contables</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrConceptos_ConCC" runat="server" AutoDataBind="true"

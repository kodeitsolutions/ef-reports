<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNacionalidades.aspx.vb" Inherits="rNacionalidades" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNacionalidades" runat="server" AutoDataBind="true"

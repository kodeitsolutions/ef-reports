<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConceptos_Nomina.aspx.vb" Inherits="rConceptos_Nomina" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrConceptos_Nomina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

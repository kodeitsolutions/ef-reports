...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Conceptos"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Conceptos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("ORDER BY    (CASE Conceptos_Nomina.tipo")
            ...
            loComandoSeleccionar.AppendLine("                ELSE 2 END) ASC, cod_con ASC")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Conceptos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Conceptos.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Bancos"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Bancos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("			Bancos.cod_ban,")
            ...
            loComandoSeleccionar.AppendLine("        ON  Bancos.Cod_ban = Trabajadores.Cod_ban ")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY    Bancos.cod_ban,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Bancos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Bancos.ReportSource = loObjetoReporte

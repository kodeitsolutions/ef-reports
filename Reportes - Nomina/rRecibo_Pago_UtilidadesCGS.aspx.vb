...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRecibo_Pago_UtilidadesCGS"
'-------------------------------------------------------------------------------------------'
Partial Class rRecibo_Pago_UtilidadesCGS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		AND Contratos.Cod_Con IN ('90')")
            End If
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRecibo_Pago_UtilidadesCGS", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRecibo_Pago_UtilidadesCGS.ReportSource = loObjetoReporte

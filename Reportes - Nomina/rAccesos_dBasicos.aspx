<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAccesos_dBasicos.aspx.vb" Inherits="rAccesos_dBasicos" %>
...
<head runat="server">
    <title>Reporte de Accesos con sus Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAccesos_dBasicos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Trabajadores_Departamentos.aspx.vb" Inherits="rTotal_Trabajadores_Departamentos" %>
...
<head runat="server">
    <title>Total de Trabajadores por Departamentos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrTotal_Trabajadores_Departamentos" runat="server" AutoDataBind="true"

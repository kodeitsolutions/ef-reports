<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReportes_Chequeos.aspx.vb" Inherits="rReportes_Chequeos" %>
...
<head runat="server">
    <title>Listado de Reportes para Chequeos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReportes_Chequeos" runat="server" AutoDataBind="true"

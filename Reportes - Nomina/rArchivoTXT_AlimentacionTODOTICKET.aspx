<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_AlimentacionTODOTICKET.aspx.vb" Inherits="rArchivoTXT_AlimentacionTODOTICKET" %>
...
<head runat="server">
    <title>Bono de Alimentación TodoTicket (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_AlimentacionTODOTICKET" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPrestamos_Numeros.aspx.vb" Inherits="rPrestamos_Numeros" %>
...
<head runat="server">
    <title>Reporte de Préstamos por Números</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrPrestamos_Numeros" runat="server" AutoDataBind="true"

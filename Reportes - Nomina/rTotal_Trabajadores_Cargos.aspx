<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Trabajadores_Cargos.aspx.vb" Inherits="rTotal_Trabajadores_Cargos" %>
...
<head runat="server">
    <title>Total de Trabajadores por Cargos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrTotal_Trabajadores_Cargos" runat="server" AutoDataBind="true"

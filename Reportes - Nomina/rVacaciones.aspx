<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVacaciones.aspx.vb" Inherits="rVacaciones" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrVacaciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

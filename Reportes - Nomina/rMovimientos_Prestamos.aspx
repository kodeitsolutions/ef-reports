<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMovimientos_Prestamos.aspx.vb" Inherits="rMovimientos_Prestamos" %>
...
<head runat="server">
	<title>Listado de Movimientos de Préstamos</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrMovimientos_Prestamos" runat="server" AutoDataBind="true" 

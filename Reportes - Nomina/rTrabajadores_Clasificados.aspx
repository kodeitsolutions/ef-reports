<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_Clasificados.aspx.vb" Inherits="rTrabajadores_Clasificados" %>
...
<head runat="server">
    <title>Listado de Trabajadores Clasificados</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTrabajadores_Clasificados" runat="server" AutoDataBind="true"

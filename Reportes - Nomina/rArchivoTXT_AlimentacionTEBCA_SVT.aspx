<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_AlimentacionTEBCA_SVT.aspx.vb" Inherits="rArchivoTXT_AlimentacionTEBCA_SVT" %>
...
<head runat="server">
    <title>Bono de Alimentación TEBCA/SERVITECA (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrArchivoTXT_AlimentacionTEBCA_SVT" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

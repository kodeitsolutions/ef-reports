...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rUsuarios_Opciones"
'-------------------------------------------------------------------------------------------'
Partial Class rUsuarios_Opciones
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			Dim lcClienteGlobal	As String = goServicios.mObtenerCampoFormatoSQL(goCliente.pcCodigo)
            ...
            loComandoSeleccionar.AppendLine("WHERE		U.Cod_Usu BETWEEN " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine("				AND " & lcParametro0Hasta)
            loComandoSeleccionar.AppendLine("		AND	U.Status IN (" & lcParametro1Desde & ")")
            loComandoSeleccionar.AppendLine("		AND	U.Cod_Cli = " & lcClienteGlobal)
            loComandoSeleccionar.AppendLine("")
			loComandoSeleccionar.AppendLine("")
            ...
            loComandoSeleccionar.AppendLine("ORDER BY " & lcOrdenamiento & ", O.Cod_Opc ASC")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rUsuarios_Opciones", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrUsuarios_Opciones.ReportSource = loObjetoReporte

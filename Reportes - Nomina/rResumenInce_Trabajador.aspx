<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumenInce_Trabajador.aspx.vb" Inherits="rResumenInce_Trabajador" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrResumenInce_Trabajador" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

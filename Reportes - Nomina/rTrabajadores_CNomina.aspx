<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_CNomina.aspx.vb" Inherits="rTrabajadores_CNomina" %>
...
<head runat="server">
	<title>Listado de Trabajadores con sus Campos de Nómina</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTrabajadores_CNomina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

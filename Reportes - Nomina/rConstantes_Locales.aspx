<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConstantes_Locales.aspx.vb" Inherits="rConstantes_Locales" %>
...
<head runat="server">
    <title>Reporte de Constantes Locales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrConstantes_Locales" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_SSO_RPE.aspx.vb" Inherits="rTotales_SSO_RPE" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_SSO_RPE" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

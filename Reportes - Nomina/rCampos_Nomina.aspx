<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCampos_Nomina.aspx.vb" Inherits="rCampos_Nomina" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrCampos_Nomina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

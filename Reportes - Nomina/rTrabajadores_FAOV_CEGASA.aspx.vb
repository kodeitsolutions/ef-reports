...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTrabajadores_FAOV_CEGASA"
'-------------------------------------------------------------------------------------------'
Partial Class rTrabajadores_FAOV_CEGASA
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        lcConceptosDevengadoFAOV2 = String.Join(",", laConceptosDevengadoFAOV2.ToArray(GetType(String)))
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTrabajadores_FAOV_CEGASA", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTrabajadores_FAOV_CEGASA.ReportSource = loObjetoReporte

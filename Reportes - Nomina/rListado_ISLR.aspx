<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rListado_ISLR.aspx.vb" Inherits="rListado_ISLR" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrListado_ISLR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVacacionesRecibos_Fechas.aspx.vb" 
    Inherits="rVacacionesRecibos_Fechas" %>
...
<head runat="server">
	<title>Listado de Vacaciones por Fecha</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrVacacionesRecibos_Fechas" runat="server" AutoDataBind="true" 

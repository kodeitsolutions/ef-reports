<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_Cumpleaños_Ampliado.aspx.vb" Inherits="rTrabajadores_Cumpleaños_Ampliado" %>
...
<head runat="server">
    <title>Listado de Cumpleaños Ampliado</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrTrabajadores_Cumpleaños_Ampliado" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCNomina_Trabajador"
'-------------------------------------------------------------------------------------------'
Partial Class rCNomina_Trabajador
Inherits vis2formularios.frmReporte
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
			...
			loComandoSeleccionar.AppendLine("WHERE	Campos_Nomina.Cod_Cam BETWEEN " & lcParametro0Desde)
			loComandoSeleccionar.AppendLine("		AND	" & lcParametro0Hasta)
			loComandoSeleccionar.AppendLine("		AND	Campos_Nomina.Status IN (" & lcParametro1Desde & ")")
			loComandoSeleccionar.AppendLine("		AND	Campos_Nomina.Tipo IN (" & lcParametro2Desde & ")")
			loComandoSeleccionar.AppendLine("		AND	Campos_Nomina.Uso IN (" & lcParametro3Desde & ")")
			loComandoSeleccionar.AppendLine("		AND	Trabajadores.cod_tra BETWEEN " & lcParametro4Desde)
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCNomina_Trabajador", laDatosReporte)

			Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrCNomina_Trabajador.ReportSource = loObjetoReporte

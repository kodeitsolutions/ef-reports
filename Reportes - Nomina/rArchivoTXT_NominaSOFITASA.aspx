<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_NominaSOFITASA.aspx.vb" Inherits="rArchivoTXT_NominaSOFITASA" %>
...
<head runat="server">
    <title>Pago de Nómina SOFITASA (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_NominaSOFITASA" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Movimientos_AnoMes.aspx.vb" Inherits="rTotal_Movimientos_AnoMes" %>
...
<head runat="server">
	<title>Total Movimientos por Año y Mes</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotal_Movimientos_AnoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

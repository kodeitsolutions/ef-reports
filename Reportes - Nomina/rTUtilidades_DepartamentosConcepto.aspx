<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTUtilidades_DepartamentosConcepto.aspx.vb" Inherits="rTUtilidades_DepartamentosConcepto" %>
...
<head runat="server">
	<title>Listado de Totales de Utilidades por Departamento y por Concepto</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTUtilidades_DepartamentosConcepto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

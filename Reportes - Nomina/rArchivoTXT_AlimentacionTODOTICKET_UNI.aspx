<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_AlimentacionTODOTICKET_UNI.aspx.vb" Inherits="rArchivoTXT_AlimentacionTODOTICKET_UNI" %>
...
<head runat="server">
    <title>Bono de Alimentación TodoTicket (TXT) (UNIALI)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_AlimentacionTODOTICKET_UNI" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

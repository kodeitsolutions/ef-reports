<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUbicaciones_Nomina.aspx.vb" Inherits="rUbicaciones_Nomina" %>
...
<head runat="server">
    <title>Ubicaciones de Nómina</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrUbicaciones_Nomina" runat="server" AutoDataBind="true"

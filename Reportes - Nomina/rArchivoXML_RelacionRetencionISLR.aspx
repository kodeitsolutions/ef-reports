<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoXML_RelacionRetencionISLR.aspx.vb" Inherits="rArchivoXML_RelacionRetencionISLR" %>
...
<head runat="server">
    <title>Relación de Retenciones de ISLR (XML)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoXML_RelacionRetencionISLR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

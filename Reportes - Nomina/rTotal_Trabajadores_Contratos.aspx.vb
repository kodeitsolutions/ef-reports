...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Trabajadores_Contratos"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Trabajadores_Contratos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		Contratos.cod_con,")
            loConsulta.AppendLine("		Contratos.nom_con,")
            ...
            loConsulta.AppendLine("	JOIN Contratos ON Contratos.cod_con = Trabajadores.cod_con")
            ...
            loConsulta.AppendLine("Group by Contratos.cod_con,Contratos.nom_con")
            loConsulta.AppendLine("ORDER BY Contratos.cod_con")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Trabajadores_Contratos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Trabajadores_Contratos.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNominas.aspx.vb" Inherits="rNominas" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrNominas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rContratos.aspx.vb" Inherits="rContratos" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrContratos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_Informacion_Pago.aspx.vb" Inherits="rTrabajadores_Informacion_Pago" %>
...
<head runat="server">
    <title>Listado de Trabajadores con Información de Pago</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTrabajadores_Informacion_Pago" runat="server" AutoDataBind="true"

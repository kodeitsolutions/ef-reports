<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_NominaBOD.aspx.vb" Inherits="rArchivoTXT_NominaBOD" %>
...
<head runat="server">
    <title>Pago de Nómina BOD (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_NominaBOD" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

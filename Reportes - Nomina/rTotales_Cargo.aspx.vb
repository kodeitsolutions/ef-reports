...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Cargo"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Cargo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT      Cargos.cod_car,")
            loComandoSeleccionar.AppendLine("            Cargos.nom_car,")
            ...
            loComandoSeleccionar.AppendLine("    JOIN    Cargos ")
            loComandoSeleccionar.AppendLine("        ON  Cargos.Cod_car = Trabajadores.Cod_car ")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY    Cargos.cod_car,")
            loComandoSeleccionar.AppendLine("            Cargos.nom_car")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Cargo", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Cargo.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConstancias_Trabajadores.aspx.vb" Inherits="rConstancias_Trabajadores" %>
...
<head runat="server">
    <title>Listado de Constancias de Trabajadores</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrConstancias_Trabajadores" runat="server" AutoDataBind="true"

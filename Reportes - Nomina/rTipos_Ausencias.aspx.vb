Imports System.Data
Partial Class rTipos_Ausencias
	...
	Try	
		 lcComandoSelect = "SELECT	Cod_Tip, " _
						          & "Nom_Tip, " _
								  & "Status, " _
								  & "(Case When Status = 'A' Then 'Activo' Else 'Inactivo' End) as Status_Tipos_Ausencias " _
						& "FROM	 Tipos_Ausencias " _
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTipos_Ausencias", laDatosReporte)
	   
			 Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

			 Me.crvrTipos_Ausencias.ReportSource = loObjetoReporte

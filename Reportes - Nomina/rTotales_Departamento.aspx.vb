...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Departamento"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Departamento
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT      Departamentos_Nomina.Cod_Dep                   AS Cod_Dep,")
            loComandoSeleccionar.AppendLine("            Departamentos_Nomina.Nom_Dep                   AS Nom_Dep,")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY    Departamentos_Nomina.Cod_Dep,")
            loComandoSeleccionar.AppendLine("            Departamentos_Nomina.Nom_Dep")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Departamento", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Departamento.ReportSource = loObjetoReporte

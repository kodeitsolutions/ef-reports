<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumenContable_Recibos.aspx.vb" Inherits="rResumenContable_Recibos" %>
...
<head runat="server">
	<title>Listado de Resumen Contable de Recibos de Nómina</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrResumenContable_Recibos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

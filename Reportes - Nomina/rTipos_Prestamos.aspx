<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Prestamos.aspx.vb" Inherits="rTipos_Prestamos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Prestamos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Prestamos" runat="server" AutoDataBind="true"

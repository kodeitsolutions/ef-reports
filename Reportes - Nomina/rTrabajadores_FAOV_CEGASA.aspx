<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_FAOV_CEGASA.aspx.vb" Inherits="rTrabajadores_FAOV_CEGASA" %>
...
<head runat="server">
    <title>FAOV Retenido a Trabajadores (GECASA)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTrabajadores_FAOV_CEGASA" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Ausencias.aspx.vb" Inherits="rTipos_Ausencias" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Ausencias" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotales_Sucursal"
'-------------------------------------------------------------------------------------------'
Partial Class rTotales_Sucursal
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("GROUP BY    Sucursales.Cod_Suc,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotales_Sucursal", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotales_Sucursal.ReportSource = loObjetoReporte

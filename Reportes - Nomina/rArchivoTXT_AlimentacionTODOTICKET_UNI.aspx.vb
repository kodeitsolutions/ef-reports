...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rArchivoTXT_AlimentacionTODOTICKET_UNI"
'-------------------------------------------------------------------------------------------'
Partial Class rArchivoTXT_AlimentacionTODOTICKET_UNI
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rArchivoTXT_AlimentacionTODOTICKET_UNI", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrArchivoTXT_AlimentacionTODOTICKET_UNI.ReportSource = loObjetoReporte
    ...
    Private Sub mGenerarArchivoTxt(laDatosReporte As DataSet)
        ...
        For n As Integer = 0 To lnCantidad - 1
            ...
            If (lcTipo <> "V" AndAlso lcTipo <> "E")
                lcTipo = "V" 'Esto es para que produzca error al tratar de cargarlo: solo se permite V o E
            End If
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' RJG: 27/07/15: Código Inicial, a partir de rArchivoTXT_AlimentacionTODOTICKET.            '
'-------------------------------------------------------------------------------------------'

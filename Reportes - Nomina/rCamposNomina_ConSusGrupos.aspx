<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCamposNomina_ConSusGrupos.aspx.vb" Inherits="rCamposNomina_ConSusGrupos" %>
...
<head runat="server">
    <title>Campos de Nómina con sus Grupos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCamposNomina_ConSusGrupos" runat="server" AutoDataBind="true"
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <vis3Controles:pnlVentanaModal ID="PnlVentanaModalPrincipal" runat="server" pcEstiloBotonCerrar="BotonCerrarVentanaModal"
                        ...
                        plMostrarBotonCerrar="false" poAlto="520px" poAncho="550px" Style="left: -24px; top: 61px" />
                    <vis3Controles:pnlMensajeModal ID="PnlMensajeModal" runat="server" pcEstiloContenido="ContenidoMensajeModal"
                        ...
                        poAlto="400px" poAncho="750px" poArriba="20%" poIzquierda="30%" Style="left: -24px; top: 61px" />

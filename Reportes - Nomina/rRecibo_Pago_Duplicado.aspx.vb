...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRecibo_Pago_Duplicado"
'-------------------------------------------------------------------------------------------'
Partial Class rRecibo_Pago_Duplicado
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            Dim lcNombreEmpresaSQL As String = goServicios.mObtenerCampoFormatoSQL(goEmpresa.pcNombre)
            Dim lcRifEmpresaSQL As String = goServicios.mObtenerCampoFormatoSQL(goEmpresa.pcRifEmpresa)
            Dim lcDireccionEmpresaSQL As String = goServicios.mObtenerCampoFormatoSQL(goEmpresa.pcDireccionEmpresa)
            Dim lcTelefonoEmpresaSQL As String = goServicios.mObtenerCampoFormatoSQL(goEmpresa.pcTelefonoEmpresa)
            ...
            loConsulta.AppendLine("         " & lcNombreEmpresaSQL    & "                           AS Nombre_Empresa_Cliente,")
            loConsulta.AppendLine("         " & lcRifEmpresaSQL       & "                           AS Rif_Empresa_Cliente,")
            loConsulta.AppendLine("         " & lcDireccionEmpresaSQL & "                           AS Direccion_Empresa_Cliente,")
            loConsulta.AppendLine("         " & lcTelefonoEmpresaSQL & "                           AS Telefono_Empresa_Cliente")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRecibo_Pago_Duplicado", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRecibo_Pago_Duplicado.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 13/08/15: Codigo inicial.															'
'-------------------------------------------------------------------------------------------'
' RJG: 14/08/15: Se quitaron los conceptos "De la empresa" y se agregó la firma al final.   '
'-------------------------------------------------------------------------------------------'
' RJG: 28/08/15: Se quitó el filtro del bono de alimentación.                               '
'-------------------------------------------------------------------------------------------'

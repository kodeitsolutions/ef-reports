<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGarantia_PrestacionesTrabajadores.aspx.vb" Inherits="rGarantia_PrestacionesTrabajadores" %>
...
<head runat="server">
    <title>Garantía de Prestaciones de Trabajadores</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrGarantia_PrestacionesTrabajadores" runat="server" AutoDataBind="true"

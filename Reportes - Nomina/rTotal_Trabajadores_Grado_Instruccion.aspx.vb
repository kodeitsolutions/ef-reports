...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Trabajadores_Grado_Instruccion"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Trabajadores_Grado_Instruccion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("				THEN 'hoooooo'	")
            ...
            loConsulta.AppendLine("Group by Grados_Instruccion.cod_gra,Grados_Instruccion.nom_gra")
            loConsulta.AppendLine("ORDER BY Grados_Instruccion.cod_gra")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Trabajadores_Grado_Instruccion", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Trabajadores_Grado_Instruccion.ReportSource = loObjetoReporte

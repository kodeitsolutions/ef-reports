<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSegmentacion_Sueldo_Grado_Instruccion.aspx.vb" Inherits="rSegmentacion_Sueldo_Grado_Instruccion" %>
...
<head runat="server">
    <title>Listado de Trabajadores Ampliado</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrSegmentacion_Sueldo_Grado_Instruccion" runat="server" AutoDataBind="true"

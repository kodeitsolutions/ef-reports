...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTVacaciones_DepartamentosConcepto"
'-------------------------------------------------------------------------------------------'
Partial Class rTVacaciones_DepartamentosConcepto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("        AND Recibos.Cod_Con IN ('91') ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTVacaciones_DepartamentosConcepto", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTVacaciones_DepartamentosConcepto.ReportSource = loObjetoReporte

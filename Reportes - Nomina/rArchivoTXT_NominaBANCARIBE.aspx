<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_NominaBANCARIBE.aspx.vb" Inherits="rArchivoTXT_NominaBANCARIBE" %>
...
<head runat="server">
    <title>Pago de Nómina Bancaribe (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_NominaBANCARIBE" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="rRecibo_Pago_MediaPagina" CodeFile="rRecibo_Pago_MediaPagina.aspx.vb" %>
...
<head runat="server">
	<title>Listado de Recibos de Pago en Lote (Media Carta)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrRecibo_Pago_MediaPagina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

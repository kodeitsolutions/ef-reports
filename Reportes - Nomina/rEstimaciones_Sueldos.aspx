<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEstimaciones_Sueldos.aspx.vb" Inherits="rEstimaciones_Sueldos" %>
...
<head runat="server">
    <title>Estimación de Sueldos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrEstimaciones_Sueldos" runat="server" AutoDataBind="true"

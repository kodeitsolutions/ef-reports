<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumenInce_Trabajador_CGS.aspx.vb" Inherits="rResumenInce_Trabajador_CGS" %>
...
<head runat="server">
	<title>Resumen de Pago de INCE por Trabajador</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrResumenInce_Trabajador_CGS" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

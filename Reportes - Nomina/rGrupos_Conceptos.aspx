<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGrupos_Conceptos.aspx.vb" Inherits="rGrupos_Conceptos" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrGrupos_Conceptos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

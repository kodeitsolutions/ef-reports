<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGrados_Instruccion.aspx.vb" Inherits="rGrados_Instruccion" %>
...
<head runat="server">
    <title>Reporte de Grados de Instrucción</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGrados_Instruccion" runat="server" AutoDataBind="true"

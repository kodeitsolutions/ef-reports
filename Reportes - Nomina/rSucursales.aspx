<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSucursales.aspx.vb" Inherits="rSucursales" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSucursales" runat="server" AutoDataBind="true"

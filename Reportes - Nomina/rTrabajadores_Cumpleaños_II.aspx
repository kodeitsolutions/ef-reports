<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores_Cumpleaños_II.aspx.vb" Inherits="rTrabajadores_Cumpleaños_II" %>
...
<head runat="server">
    <title>Listado de Cumpleaños II</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <CR:CrystalReportViewer ID="crvrTrabajadores_Cumpleaños_II" runat="server" AutoDataBind="true"

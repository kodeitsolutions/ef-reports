<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotales_Ubicaciones.aspx.vb" Inherits="rTotales_Ubicaciones" %>
...
<head runat="server">
	<title>Listado de Total Movimientos por Ubicación</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrTotales_Ubicaciones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

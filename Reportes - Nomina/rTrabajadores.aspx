<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrabajadores.aspx.vb" Inherits="rTrabajadores" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTrabajadores" runat="server" AutoDataBind="true"

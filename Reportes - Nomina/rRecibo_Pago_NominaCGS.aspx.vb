...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRecibo_Pago_NominaCGS"
'-------------------------------------------------------------------------------------------'
Partial Class rRecibo_Pago_NominaCGS
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'loConsulta.AppendLine("		AND Contratos.Cod_Con IN ('01','02','03','04','06')")
            End If
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRecibo_Pago_NominaCGS", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRecibo_Pago_NominaCGS.ReportSource = loObjetoReporte

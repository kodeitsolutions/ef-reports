<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReporte_General_Pago_SID.aspx.vb" Inherits="rReporte_General_Pago_SID" %>
...
<head runat="server">
	<title>Resumen de Concepto</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrReporte_General_Pago_SID" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

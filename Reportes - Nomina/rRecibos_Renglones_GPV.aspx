<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRecibos_Renglones_GPV.aspx.vb" Inherits="rRecibos_Renglones_GPV" %>
...
<head runat="server">
	<title>Listado de Recibos de Nómina con sus Renglones (GPV/RASA)</title>
	<link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrRecibos_Renglones_GPV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

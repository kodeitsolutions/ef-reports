<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fVentas_Compras_uAños.aspx.vb" Inherits="fVentas_Compras_uAños" %>
...
<head runat="server">
    <title>Histórico de los Ultimos 3 Años</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfVentas_Compras_uAños" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

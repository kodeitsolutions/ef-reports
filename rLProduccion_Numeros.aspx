<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLProduccion_Numeros.aspx.vb" Inherits="rLProduccion_Numeros" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Producción por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLProduccion_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

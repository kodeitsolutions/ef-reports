<%@ page language="VB" autoeventwireup="false" inherits="rLlamadas_Usuario" CodeFile="rLlamadas_Usuario.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Llamadas por Usuario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLlamadas_Usuario" runat="server" AutoDataBind="true"

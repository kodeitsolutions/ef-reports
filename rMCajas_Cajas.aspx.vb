...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMCajas_Cajas"
'-------------------------------------------------------------------------------------------'
Partial Class rMCajas_Cajas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'loComandoSeleccionar.AppendLine(" ORDER BY  Movimientos_Cajas.Cod_Caj, Movimientos_Cajas.Documento ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMCajas_Cajas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrMCajas_Cajas.ReportSource = loObjetoReporte

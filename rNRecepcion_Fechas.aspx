<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNRecepcion_Fechas.aspx.vb" Inherits="rNRecepcion_Fechas" %>
...
<head runat="server">
    <title>Reporte de Notas de Recepción por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNRecepcion_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

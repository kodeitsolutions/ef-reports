<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rFacturas_Morosas.aspx.vb"
    Inherits="KDE_rFacturas_Morosas" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvKDE_rFacturas_Morosas" runat="server" AutoDataBind="true"

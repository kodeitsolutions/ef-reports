<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras_SID.aspx.vb"
    Inherits="rLibro_Compras_SID" %>
...
<head runat="server">
    <title>Libro de Compras SID</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrLibro_Compras_SID" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEstados.aspx.vb" Inherits="rEstados" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEstados" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRetenciones_Clientes.aspx.vb" Inherits="rRetenciones_Clientes" %>
...
<head runat="server">
    <title>Total Retenciones por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRetenciones_Clientes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumenClientes_Paises.aspx.vb" Inherits="rResumenClientes_Paises" %>
...
<head runat="server">
    <title>Resumen de Clientes por Paises</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrResumenClientes_Paises" runat="server" AutoDataBind="true"

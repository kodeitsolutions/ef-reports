<%@ page language="VB" autoeventwireup="false" inherits="IGE_MIT_fFacturas_Ventas" CodeFile="IGE_MIT_fFacturas_Ventas.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvIGE_MIT_fFacturas_Ventas" runat="server" AutoDataBind="true"

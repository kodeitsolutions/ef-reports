<%@ Page Language="VB" AutoEventWireup="false" Inherits="fAuditorias_oCompra" CodeFile="fAuditorias_oCompra.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Órdenes de Compra</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfAuditorias_oCompra" runat="server" AutoDataBind="true"

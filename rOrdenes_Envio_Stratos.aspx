<%@ page language="VB" autoeventwireup="false" inherits="rOrdenes_Envio_Stratos" CodeFile="rOrdenes_Envio_Stratos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOrdenes_Envio_Stratos" runat="server" AutoDataBind="true"

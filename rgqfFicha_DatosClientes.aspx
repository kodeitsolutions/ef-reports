<%@ page language="VB" autoeventwireup="false" inherits="rgqfFicha_DatosClientes" CodeFile="rgqfFicha_DatosClientes.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Cliente pruebargq</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrgqfFicha_DatosClientes" runat="server" AutoDataBind="true"

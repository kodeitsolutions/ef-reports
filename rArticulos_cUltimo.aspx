<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_cUltimo.aspx.vb" Inherits="rArticulos_cUltimo" %>
...
<head runat="server">
    <title>Reporte de Artículos con su Costo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_cUltimo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fCorte_Cuenta_Entrega_CCSJ" CodeFile="fCorte_Cuenta_Entrega_CCSJ.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCorte_Cuenta_Entrega_CCSJ" runat="server" AutoDataBind="true"

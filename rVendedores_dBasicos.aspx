<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVendedores_dBasicos.aspx.vb" Inherits="rVendedores_dBasicos" %>
...
<head runat="server">
    <title>Reporte de Vendedores con sus Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVendedores_dBasicos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

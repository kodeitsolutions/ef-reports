<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_TiposProveedores.aspx.vb" Inherits="rCPagar_TiposProveedores" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Pagar por Proveedor (USA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_TiposProveedores" runat="server" AutoDataBind="true"

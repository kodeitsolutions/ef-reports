<%@ page language="VB" autoeventwireup="false" CodeFile="MHL_StodisF.aspx.vb" inherits="MHL_StodisF" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMHL_StodisF" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

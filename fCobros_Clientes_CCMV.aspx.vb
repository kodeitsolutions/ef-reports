Imports System.Data
Partial Class fCobros_Clientes_CCMV
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Cuentas_Cobrar.Comentario   AS  Com_Doc, ")
            ...
            loComandoSeleccionar.AppendLine("           Renglones_Cobros.Doc_Ori    =   Cuentas_Cobrar.Documento    AND ")
            loComandoSeleccionar.AppendLine("           Renglones_Cobros.Cod_Tip    =   Cuentas_Cobrar.Cod_Tip      AND ")
            ...
            loComandoSeleccionar.AppendLine("           Clientes.Fax, ")
            loComandoSeleccionar.AppendLine("           Cobros.Documento, ")
            loComandoSeleccionar.AppendLine("           ''                          AS  Com_Doc, ")
            loComandoSeleccionar.AppendLine("           Cobros.Fec_Ini, ")
            loComandoSeleccionar.AppendLine("           Cobros.Fec_Fin, ")
            loComandoSeleccionar.AppendLine("           CAST('' AS CHAR(400))       AS  Mon_Let, ")
            loComandoSeleccionar.AppendLine("           Cobros.Mon_Bru, ")
        ...
        '-------------------------------------------------------------------------------------------------------
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCobros_Clientes_CCMV", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfCobros_Clientes_CCMV.ReportSource = loObjetoReporte

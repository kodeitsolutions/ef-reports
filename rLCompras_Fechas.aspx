<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLCompras_Fechas.aspx.vb" Inherits="rLCOmpras_Fechas" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Compras por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLCOmpras_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

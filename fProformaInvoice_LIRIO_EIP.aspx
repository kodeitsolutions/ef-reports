<%@ Page Language="VB" AutoEventWireup="false" Inherits="fProformaInvoice_LIRIO_EIP" CodeFile="fProformaInvoice_LIRIO_EIP.aspx.vb" %>
...
<head runat="server">
    <title>Proforma Invoice (LIRIO/EverythingIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfProformaInvoice_LIRIO_EIP" runat="server" AutoDataBind="true"

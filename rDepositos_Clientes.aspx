<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDepositos_Clientes.aspx.vb" Inherits="rDepositos_Clientes" %>
...
<head runat="server">
    <title>Reporte de Depósitos Bancarios por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDepositos_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

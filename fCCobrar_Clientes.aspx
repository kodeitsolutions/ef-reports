<%@ page language="VB" autoeventwireup="false" inherits="fCCobrar_Clientes" CodeFile="fCCobrar_Clientes.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCCobrar_Clientes" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rECuentas_Proveedores_Ingles"
'-------------------------------------------------------------------------------------------'
Partial Class rECuentas_Proveedores_Ingles
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("     	 AND Cuentas_Pagar.Cod_Suc BETWEEN " & lcParametro7Desde)
            ...
            Else
                loComandoSeleccionar.AppendLine(" 				AND Cuentas_Pagar.Cod_Rev NOT between " & lcParametro8Desde)
            End If
            ...
            'loComandoSeleccionar.AppendLine("ORDER BY #tempMOVIMIENTO.Cod_Pro    ")
            ...
            If laDatosReporte.Tables(0).Rows.Count <> 0 Then
                ...
                loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rECuentas_Proveedores_Ingles", loDatosReporteFinal)
            Else
                ...
                loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rECuentas_Proveedores_Ingles", laDatosReporte)
            End If

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrECuentas_Proveedores_Ingles.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Numeros.aspx.vb"
    Inherits="rFacturas_Numeros" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrFacturas_Numeros" runat="server" AutoDataBind="true"

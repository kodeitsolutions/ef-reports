<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rFacturas.aspx.vb"
    Inherits="KDE_rFacturas" %>
...
<head runat="server">
    <title>Listado de Facturas (KDE)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvKDE_rFacturas" runat="server" AutoDataBind="true"

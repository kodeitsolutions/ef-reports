<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_Vendedores.aspx.vb" Inherits="rCompras_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Compras por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

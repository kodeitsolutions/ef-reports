...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gDepartamentos"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gDepartamentos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Dep, Nom_Dep, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Dep, Nom_Dep, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gDepartamentos", laDatosReporte)
            ...
            Me.crvrMargen_gDepartamentos.ReportSource = loObjetoReporte

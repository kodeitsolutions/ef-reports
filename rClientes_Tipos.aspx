<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_Tipos.aspx.vb" Inherits="rClientes_Tipos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_Tipos" runat="server" AutoDataBind="true"

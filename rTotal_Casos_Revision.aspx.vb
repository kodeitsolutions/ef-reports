...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTotal_Casos_Revision"
'-------------------------------------------------------------------------------------------'
Partial Class rTotal_Casos_Revision
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("SELECT      COALESCE( Revisiones.Cod_Rev, '[SIN REV.]')              AS Cod_Reg,")
            loConsulta.AppendLine("            COALESCE(  Revisiones.Nom_Rev , '[SIN REVISIÓN]')            AS Nombre,")
            ...
            loConsulta.AppendLine("    LEFT JOIN    Revisiones")
            loConsulta.AppendLine("        ON  Revisiones.Cod_Rev = Casos.Cod_Rev")
            ...
            loConsulta.AppendLine("GROUP BY    Revisiones.Cod_Rev,  Revisiones.Nom_Rev")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTotal_Casos_Revision", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTotal_Casos_Revision.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMovimientosCajas_tTipos"
'-------------------------------------------------------------------------------------------'
Partial Class rMovimientosCajas_tTipos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("  			COUNT(Documento) AS Num_Trans,    ")
            loComandoSeleccionar.AppendLine("  			SUM(Mon_Deb) AS Mon_Deb,          ")
            loComandoSeleccionar.AppendLine("  			SUM(Mon_Hab) AS Mon_Hab,          ")
            loComandoSeleccionar.AppendLine("  			SUM	(Mon_Deb - Mon_Hab) As Diferenc     ")
            ...
            loComandoSeleccionar.AppendLine(" 				AND Cod_Caj between " & lcParametro1Desde)
            loComandoSeleccionar.AppendLine(" 				AND " & lcParametro1Hasta)
            loComandoSeleccionar.AppendLine(" 				AND Cod_Mon between " & lcParametro2Desde)
            ...
            Else
                loComandoSeleccionar.AppendLine(" 				AND Cod_Rev NOT between " & lcParametro4Desde)
            End If

            loComandoSeleccionar.AppendLine(" 				AND " & lcParametro4Hasta)
            loComandoSeleccionar.AppendLine("  GROUP BY	Tipo")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMovimientosCajas_tTipos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrMovimientosCajas_tTipos.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDProveedores_Renglones.aspx.vb" Inherits="rDProveedores_Renglones" %>
...
<head runat="server">
    <title>Reporte de Devoluciones con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDProveedores_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

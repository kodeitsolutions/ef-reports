<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLSolicitudes_Requerimientos_Vendedor.aspx.vb" Inherits="rLSolicitudes_Requerimientos_Vendedor" %>
...
<head runat="server">
    <title>Reporte de Solicitudes y Requerimientos por Vendedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLSolicitudes_Requerimientos_Vendedor" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

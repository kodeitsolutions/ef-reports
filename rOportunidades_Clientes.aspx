<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOportunidades_Clientes.aspx.vb" Inherits="rOportunidades_Clientes" %>
...
<head runat="server">
    <title>Listado de Oportunidades por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOportunidades_Clientes" runat="server" AutoDataBind="true"

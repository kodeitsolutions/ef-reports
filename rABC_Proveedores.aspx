<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rABC_Proveedores.aspx.vb" Inherits="rABC_Proveedores" %>
...
<head runat="server">
    <title>ABC de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrABC_Proveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

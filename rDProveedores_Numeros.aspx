<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDProveedores_Numeros.aspx.vb" Inherits="rDProveedores_Numeros" %>
...
<head runat="server">
    <title>Reporte de Devoluciones por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDProveedores_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fNotaGarantia_FacturaVenta_IKP" CodeFile="fNotaGarantia_FacturaVenta_IKP.aspx.vb" %>
...
<head runat="server">
    <title>Nota de Garantía (de Factura de Venta) (IKP)</title>

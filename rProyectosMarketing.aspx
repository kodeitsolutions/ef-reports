<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProyectosMarketing.aspx.vb"  Inherits="rProyectosMarketing" %>
...
<head runat="server">
    <title>Reporte de Proyectos de Marketing</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrProyectosMarketing" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLInventarios_Numeros.aspx.vb" Inherits="rLInventarios_Numeros" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Inventarios por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLInventarios_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

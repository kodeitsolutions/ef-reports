<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rLibro_Compras_Gaceta.aspx.vb"
    Inherits="KDE_rLibro_Compras_Gaceta" %>
...
<head runat="server">
    <title>Libro de Compras Gaceta N° 41.239 (KDE)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrKDE_rLibro_Compras_Gaceta" runat="server" AutoDataBind="true"

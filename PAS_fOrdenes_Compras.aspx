<%@ page language="VB" autoeventwireup="false" inherits="PAS_fOrdenes_Compras" CodeFile="PAS_fOrdenes_Compras.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compras (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fOrdenes_Compras" runat="server" AutoDataBind="true"

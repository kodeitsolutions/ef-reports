<%@ page language="VB" autoeventwireup="false" inherits="fConceptos_Retenciones" CodeFile="fConceptos_Retenciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Conceptos de Retenciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfConceptos_Retenciones" runat="server" AutoDataBind="true"

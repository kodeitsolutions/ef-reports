<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_OMS" CodeFile="fFacturas_Ventas_OMS.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas OMS</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_OMS" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fAuditorias_Vendedores" CodeFile="fAuditorias_Vendedores.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAuditorias_Vendedores" runat="server" AutoDataBind="true"

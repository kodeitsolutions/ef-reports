<%@ page language="VB" autoeventwireup="false" inherits="fClases_Proveedores" CodeFile="fClases_Proveedores.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Clases de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfClases_Proveedores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTIncidencias_Usuario.aspx.vb" Inherits="rTIncidencias_Usuario" %>
...
<head runat="server">
    <title>Listado Total de Incidencias por Usuario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTIncidencias_Usuario" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

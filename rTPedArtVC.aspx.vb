...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTPedArtVC"
'-------------------------------------------------------------------------------------------'
Partial Class rTPedArtVC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" 				AND SUBSTRING(Renglones_Pedidos.Cod_Art,1,4) <>	'VIA-' ")
            loComandoSeleccionar.AppendLine(" 				AND SUBSTRING(Renglones_Pedidos.Cod_Art,1,4) <> 'GEN-' ")
            loComandoSeleccionar.AppendLine(" 				AND SUBSTRING(Renglones_Pedidos.Cod_Art,1,5) <> 'NOTAS' ")
            loComandoSeleccionar.AppendLine(" 				AND SUBSTRING(Renglones_Pedidos.Cod_Art,1,7) <> 'SES-CAN' ")
            loComandoSeleccionar.AppendLine(" 				AND SUBSTRING(Renglones_Pedidos.Cod_Art,1,7) <> 'INC-CAN' ")
            loComandoSeleccionar.AppendLine(" 				AND SUBSTRING(Renglones_Pedidos.Cod_Art,1,7) <> 'INC-PER' ")
            loComandoSeleccionar.AppendLine(" 				AND SUBSTRING(Renglones_Pedidos.Cod_Art,1,4) <> 'REQ-' ")
            ...
            loComandoSeleccionar.AppendLine("               AND pedidos.Cod_Rev between " & lcParametro10Desde)
            loComandoSeleccionar.AppendLine("    	        AND " & lcParametro10Hasta)
            loComandoSeleccionar.AppendLine(" GROUP BY		Pedidos.Cod_Ven, Pedidos.Cod_Cli, Renglones_Pedidos.Cod_Art,  Articulos.Nom_Art, ")
            loComandoSeleccionar.AppendLine("               Renglones_Pedidos.Cod_Uni, Vendedores.Nom_Ven, Clientes.Nom_Cli ")
            'loComandoSeleccionar.AppendLine(" ORDER BY		Pedidos.Cod_Ven, Pedidos.Cod_Cli, Renglones_Pedidos.Cod_Art ")
            loComandoSeleccionar.AppendLine("ORDER BY       Pedidos.Cod_Ven, Pedidos.Cod_Cli, " & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTPedArtVC", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrTPedArtVC.ReportSource = loObjetoReporte

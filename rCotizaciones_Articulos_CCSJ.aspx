<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_Articulos_CCSJ.aspx.vb" Inherits="rCotizaciones_Articulos_CCSJ" %>
...
<head runat="server">
    <title>Reporte de Cotizaciones por Artículos (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_Articulos_CCSJ" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

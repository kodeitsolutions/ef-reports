<%@ page language="VB" autoeventwireup="false" inherits="fRequerimientos" CodeFile="fRequerimientos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRequerimientos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_dCredito.aspx.vb" Inherits="rClientes_dCredito" %>
...
<head runat="server">
    <title>Reporte de Clientes con sus Datos de Crédito</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_dCredito" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCRetencion_ISLRProveedores_GrupoAlegria"
'-------------------------------------------------------------------------------------------'
Partial Class rCRetencion_ISLRProveedores_GrupoAlegria
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("				Renglones_Pagos.Factura				AS Factura_Origen,")
            loComandoSeleccionar.AppendLine("				Renglones_Pagos.Control				AS Control_Origen,")
            ...
            loComandoSeleccionar.AppendLine("				Ordenes_Pagos.Factura				AS Factura_Origen,")
            loComandoSeleccionar.AppendLine("				Ordenes_Pagos.Control				AS Control_Origen,")
            ...
            loComandoSeleccionar.AppendLine("				Cuentas_Pagar.Fec_Ini				AS Fecha_Retencion,")
            loComandoSeleccionar.AppendLine("				''									AS Numero_Pago,")
            loComandoSeleccionar.AppendLine("				Documentos.Factura					AS Factura_Origen,")
            loComandoSeleccionar.AppendLine("				Documentos.Control					AS Control_Origen,")
            loComandoSeleccionar.AppendLine("				Retenciones_Documentos.Cod_Tip		AS Tipo_Documento,")
            loComandoSeleccionar.AppendLine("				Retenciones_Documentos.Doc_Ori		AS Numero_Documento,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCRetencion_ISLRProveedores_GrupoAlegria", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrrCRetencion_ISLRProveedores_GrupoAlegria.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 12/07/11: Codigo inicial (a partir de rCRetenciones_ISLRProveedores)					'
'-------------------------------------------------------------------------------------------'

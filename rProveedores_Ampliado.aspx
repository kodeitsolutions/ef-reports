<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_Ampliado.aspx.vb" Inherits="rProveedores_Ampliado" %>
...
<head runat="server">
    <title>Reporte Ampliado de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_Ampliado" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

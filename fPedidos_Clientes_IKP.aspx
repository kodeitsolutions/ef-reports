<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPedidos_Clientes_IKP" CodeFile="fPedidos_Clientes_IKP.aspx.vb" %>
...
<head runat="server">
    <title>Pedidos de Clientes (IKP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPedidos_Clientes_IKP" runat="server" AutoDataBind="true"

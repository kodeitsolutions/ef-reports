<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRDocumentosVentas_Mensuales.aspx.vb" Inherits="rRDocumentosVentas_Mensuales" %>
...
<head runat="server">
    <title>Resumen de Documentos de Ventas Mensuales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRDocumentosVentas_Mensuales" runat="server" AutoDataBind="true"

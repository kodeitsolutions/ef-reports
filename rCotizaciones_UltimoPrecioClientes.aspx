<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_UltimoPrecioClientes.aspx.vb" Inherits="rCotizaciones_UltimoPrecioClientes" %>
...
<head runat="server">
    <title>Reporte de Últimos Precios por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_UltimoPrecioClientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rResumen_Iva.aspx.vb"
    Inherits="KDE_rResumen_Iva" %>
...
<head runat="server">
    <title>Resumen de I.V.A. (KDE)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrKDE_rResumen_Iva" runat="server" AutoDataBind="true"

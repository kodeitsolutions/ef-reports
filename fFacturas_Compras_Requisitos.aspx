<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Compras_Requisitos" CodeFile="fFacturas_Compras_Requisitos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Facturas de Compras con sus Requisitos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Compras_Requisitos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_tPrecios.aspx.vb" Inherits="rArticulos_tPrecios" %>
...
<head runat="server">
    <title>Reporte de Artículos con Todos sus Precios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_tPrecios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLVentas_Dacron2"
'-------------------------------------------------------------------------------------------'
Partial Class rLVentas_Dacron2
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLVentas_Dacron2", laDatosReporte)
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 24/10/13: Codigo inicial (A partir de rLVentas_Dracon2).							    '
'-------------------------------------------------------------------------------------------'
' RJG: 31/10/13: Ajustes menores de la interfaz: líneas, alineación, ancho de columnas...   '
'-------------------------------------------------------------------------------------------'
' RJG: 05/11/13: Ajustes menores de la interfaz: líneas, numero de página en Español.       '
'                Ajuste en la representación de las retenciones: ahora se muestra cada una  '
'                en un renglon separado, con la fecha de registro y recepción de la misma.  '
'-------------------------------------------------------------------------------------------'
' RJG: 19/11/13: Ajuste en clientes contribuyentes especiales: se ajustó una condición para '
'                evitar que se agrupen los clientes especiales.                             '
'-------------------------------------------------------------------------------------------'
' RJG: 20/12/13: Ajuste en clientes NO contribuyentes: se ajustó para que no agrupe las N/CR'
'                de estos clientes y que no muestre el campo Hasta cuando sea solo una N/CR '
'                o Factura.                                                                 '
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Clientes1.aspx.vb" Inherits="rTVentas_Clientes1" %>
...
<head runat="server">
    <title>Reporte de Total Ventas por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Clientes1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

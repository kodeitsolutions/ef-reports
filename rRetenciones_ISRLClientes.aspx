<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRetenciones_ISRLClientes.aspx.vb" Inherits="rRetenciones_ISRLClientes" %>
...
<head runat="server">
    <title>Reporte de Retenciones de ISRL a Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRetenciones_ISRLClientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

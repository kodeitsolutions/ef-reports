<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_Margen.aspx.vb" Inherits="rArticulos_Margen" %>
...
<head runat="server">
    <title>Reporte de Artículos con su Margen de Ganancia</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Margen" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

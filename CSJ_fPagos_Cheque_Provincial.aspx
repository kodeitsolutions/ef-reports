<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fPagos_Cheque_Provincial" CodeFile="CSJ_fPagos_Cheque_Provincial.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque MOORE</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fPagos_Cheque_Provincial" runat="server" AutoDataBind="true"

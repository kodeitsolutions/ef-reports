<%@ page language="VB" autoeventwireup="false" inherits="fOrden_Servicio_FSV2" CodeFile="fOrden_Servicio_FSV2.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrden_Servicio_FSV2" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gClienteArticulos.aspx.vb" Inherits="rMargen_gClienteArticulos" %>
...
<head runat="server">
    <title>Margen de Ganancia por Cliente y Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gClienteArticulos" runat="server" AutoDataBind="true"

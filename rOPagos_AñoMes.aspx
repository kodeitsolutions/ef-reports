<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_AñoMes.aspx.vb" Inherits="rOPagos_AñoMes" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_AñoMes" runat="server" AutoDataBind="true"

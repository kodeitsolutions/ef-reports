...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRVentas_CBancariasHoyAdministrativo"
'-------------------------------------------------------------------------------------------'
Partial Class rRVentas_CBancariasHoyAdministrativo
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Dim lcParametro0Desde	As  String = goServicios.mObtenerCampoFormatoSQL(Date.Now(), goServicios.enuOpcionesRedondeo.KN_FechaInicioDelDia)
		Dim lcParametro0Hasta	As  String = goServicios.mObtenerCampoFormatoSQL(Date.Now(), goServicios.enuOpcionesRedondeo.KN_FechaFinDelDia)

		cusAplicacion.goReportes.pcModuloReporte = "IPOS"
	...
	Try
		...
		Dim loComandoSeleccionar As New StringBuilder()
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rRVentas_CBancariasHoyAdministrativo", laDatosReporte)
...
'-------------------------------------------------------------------------------------------'
' CMS: 18/03/10: Se aplico el metodo de verificación de registro cero.						'
'-------------------------------------------------------------------------------------------'
' RJG: 29/01/13: Se agregó el módulo del reporte, que estaba "fijo" en el formulario de		'
'				 complementos. NOTA: El reporte no tenía comentarios, y la bitacora anterior'
'				 a este comentario puede haber sido copiada del reporte original.			'
'-------------------------------------------------------------------------------------------'

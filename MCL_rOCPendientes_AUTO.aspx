<%@ page language="VB" autoeventwireup="false" inherits="MCL_rOCPendientes_AUTO" CodeFile="MCL_rOCPendientes_AUTO.aspx.vb" %>
...
<head runat="server">
    <title>Órdenes de Compras Pendientes Automático (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rOCPendientes_AUTO" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_IVAProveedores_GPV" 
CodeFile="rCRetencion_IVAProveedores_GPV.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobante de Retención de IVA de Proveedores (GPV)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_IVAProveedores_GPV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

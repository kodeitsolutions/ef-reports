<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Proveedores" CodeFile="fPagos_Proveedores.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Proveedores" runat="server" AutoDataBind="true"

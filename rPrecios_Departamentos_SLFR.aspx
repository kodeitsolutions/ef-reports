<%@ page language="VB" autoeventwireup="false" inherits="rPrecios_Departamentos_SLFR" CodeFile="rPrecios_Departamentos_SLFR.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Precios por Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPrecios_Departamentos_SLFR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

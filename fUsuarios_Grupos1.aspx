<%@ page language="VB" autoeventwireup="false" CodeFile="fUsuarios_Grupos1.aspx.vb" inherits="fUsuarios_Grupos1" %>
...
<head runat="server">
    <title>Distribución por Grupos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfUsuarios_Grupos1" runat="server" AutoDataBind="true"

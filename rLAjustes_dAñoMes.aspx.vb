...
Partial Class rLAjustes_dAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine("SELECT		")
			lcComandoSeleccionar.AppendLine("			ROW_NUMBER() OVER(PARTITION BY cod_dep ORDER BY " & lcOrdenamiento & ") AS 'Renglon', ")
			lcComandoSeleccionar.AppendLine("			cod_dep, nom_dep, AÑO, num_mes, mes, ")
			...
			lcComandoSeleccionar.AppendLine("GROUP BY	 cod_dep, nom_dep, AÑO, num_mes, mes ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLAjustes_dAñoMes", laDatosReporte)
            ...
            Me.crvrLAjustes_dAñoMes.ReportSource = loObjetoReporte

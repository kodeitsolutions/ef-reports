<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fSucursales.aspx.vb" Inherits="fSucursales" %>
...
<head runat="server">
    <title>Formato de Empresa</title>
...
<body>
    <form id="form1" runat="server">
        <div><asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <CR:CrystalReportViewer ID="crvfSucursales" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProspectos_dBasicos.aspx.vb" Inherits="rProspectos_dBasicos" %>
...
<head runat="server">
    <title>Reporte de Prospectos con sus Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProspectos_dBasicos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

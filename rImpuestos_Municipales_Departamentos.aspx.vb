...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rImpuestos_Municipales_Departamentos"
'-------------------------------------------------------------------------------------------'
Partial Class rImpuestos_Municipales_Departamentos
   Inherits vis2Formularios.frmReporte
	...
	Try	
			...
			Dim loComandoSeleccionar As New StringBuilder() 	
				...
				loComandoSeleccionar.AppendLine(" SELECT	CAST(Departamentos.imp_mun as XML) AS impuesto,")
				...
				loComandoSeleccionar.AppendLine(" ORDER BY Cod_dep ASC")
				loComandoSeleccionar.AppendLine("")
				...
				loComandoSeleccionar.AppendLine(" GROUP BY #tmpTemporal1.cod_dep,#tmpTemporal1.codigo, #tmpTemporal1.nombre,#tmpTemporal1.impuesto,Impuestos_Municipales.Nom_Imp,Impuestos_Municipales.Por_Imp")
				loComandoSeleccionar.AppendLine("")
				...
				loComandoSeleccionar.AppendLine(" JOIN Departamentos ON (Departamentos.Cod_Dep = Articulos.Cod_Dep AND Departamentos.Cod_Dep = #tmpTemporal2.Cod_Dep)")
			...
			End If
				...
				loComandoSeleccionar.AppendLine(" GROUP BY Facturas.Cod_Suc,Departamentos.Cod_Dep,Departamentos.Nom_Dep,#tmpTemporal2.nombre,#tmpTemporal2.impuesto,#tmpTemporal2.Nom_Impuesto,#tmpTemporal2.Por_Imp")
				loComandoSeleccionar.AppendLine("")
			...
			End If
				...
				loComandoSeleccionar.AppendLine("		AND" & lcParametro14Hasta)
				loComandoSeleccionar.AppendLine(" GROUP BY devoluciones_clientes.Cod_Suc,Departamentos.Cod_Dep,#tmpTemporal2.nombre,#tmpTemporal2.impuesto,#tmpTemporal2.Nom_Impuesto,#tmpTemporal2.Por_Imp")
				loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rImpuestos_Municipales_Departamentos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
			            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrImpuestos_Municipales_Departamentos.ReportSource = loObjetoReporte

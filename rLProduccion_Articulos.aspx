<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLProduccion_Articulos.aspx.vb" Inherits="rLProduccion_Articulos" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Produccion por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLProduccion_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "grUnidades_UAnio"
'-------------------------------------------------------------------------------------------'
Partial Class grUnidades_UAnio
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT 1 AS Mes,CASE WHEN DATEPART(MONTH,GETDATE())>=1 THEN DATEPART(YEAR,GETDATE()) ELSE DATEPART(YEAR,GETDATE())-1 END AS Anio, 0 As Unidades INTO #temp_unifac")
            ...
            loComandoSeleccionar.AppendLine(" 		DATEPART(YEAR,Facturas.Fec_Ini) AS Anio,")
            loComandoSeleccionar.AppendLine(" 		Renglones_Facturas.Can_Art1 AS Unidades")
            ...
            loComandoSeleccionar.AppendLine(" 		DATEDIFF(MONTH,Facturas.Fec_Ini,GETDATE()) < 12")
            loComandoSeleccionar.AppendLine("       AND " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 	    #temp_unifac.Mes,")
            loComandoSeleccionar.AppendLine(" 	    #temp_unifac.Anio,")
            loComandoSeleccionar.AppendLine(" 	    SUM(#temp_unifac.Unidades) AS Unidades,")
            loComandoSeleccionar.AppendLine(" 	    ROW_NUMBER() OVER(ORDER BY #temp_unifac.Anio ASC, #temp_unifac.Mes ASC) AS Row")
            loComandoSeleccionar.AppendLine(" INTO #temp_totfac")
            loComandoSeleccionar.AppendLine(" FROM #temp_unifac")
            loComandoSeleccionar.AppendLine(" GROUP BY Mes, Anio")
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SET @sum_Ey = (SELECT SUM(#temp_totfac.Unidades) FROM #temp_totfac)/12")
            loComandoSeleccionar.AppendLine(" SET @sum_Ex = 6.5")
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 		((#temp_totfac.Row-@sum_Ex)*(#temp_totfac.Unidades-@sum_Ey)) AS xEx_yEy,")
            loComandoSeleccionar.AppendLine(" 		((#temp_totfac.Row-@sum_Ex)*(#temp_totfac.Row-@sum_Ex)) AS xEx_xEx")
            loComandoSeleccionar.AppendLine(" INTO #temp_tenfac")
            loComandoSeleccionar.AppendLine(" FROM #temp_totfac")
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SET @sum_fac_xEx_yEy = (SELECT SUM(#temp_tenfac.xEx_yEy) FROM #temp_tenfac)")
            loComandoSeleccionar.AppendLine(" SET @sum_fac_xEx_xEx = (SELECT SUM(#temp_tenfac.xEx_xEx) FROM #temp_tenfac)")
            loComandoSeleccionar.AppendLine(" ")
            ...
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 	    #temp_totfac.Mes,")
            loComandoSeleccionar.AppendLine(" 	    #temp_totfac.Anio,")
            loComandoSeleccionar.AppendLine(" 	    #temp_totfac.Unidades,")
            loComandoSeleccionar.AppendLine(" 	    ((@valor_a*#temp_totfac.Row)+@valor_b) AS Tendencia")
            loComandoSeleccionar.AppendLine(" INTO #temp_ttenfac")
            loComandoSeleccionar.AppendLine(" FROM #temp_totfac")
            loComandoSeleccionar.AppendLine(" ")
            ...
            loComandoSeleccionar.AppendLine(" 		DATEPART(YEAR,Devoluciones_Clientes.Fec_Ini) AS Anio,")
            loComandoSeleccionar.AppendLine(" 		Renglones_DClientes.Can_Art1 AS Unidades")
            loComandoSeleccionar.AppendLine(" FROM Clientes")
            loComandoSeleccionar.AppendLine(" JOIN Devoluciones_Clientes ON Clientes.Cod_Cli = Devoluciones_clientes.Cod_Cli")
            ...
            loComandoSeleccionar.AppendLine(" WHERE ")
            loComandoSeleccionar.AppendLine(" 		DATEDIFF(MONTH,Devoluciones_Clientes.Fec_Ini,GETDATE()) < 12")
            loComandoSeleccionar.AppendLine("       AND " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SELECT")
            ...
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SET @sum_fac_xEx_yEy = (SELECT SUM(#temp_tendev.xEx_yEy) FROM #temp_tendev)")
            loComandoSeleccionar.AppendLine(" SET @sum_fac_xEx_xEx = (SELECT SUM(#temp_tendev.xEx_xEx) FROM #temp_tendev)")
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine(" SET @valor_a = (@sum_fac_xEx_yEy / @sum_fac_xEx_xEx)")
            loComandoSeleccionar.AppendLine(" SET @valor_b = (@sum_Ey-(@valor_a*@sum_Ex))")
            loComandoSeleccionar.AppendLine(" ")
            ...
            loComandoSeleccionar.AppendLine(" 	    #temp_ttenfac.Mes AS Num_Mes,")
            loComandoSeleccionar.AppendLine(" 	    CASE")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 1 THEN 'Ene'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 2 THEN 'Feb'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 3 THEN 'Mar'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 4 THEN 'Abr'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 5 THEN 'May'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 6 THEN 'Jun'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 7 THEN 'Jul'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 8 THEN 'Ago'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 9 THEN 'Sep'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 10 THEN 'Oct'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 11 THEN 'Nov'")
            loComandoSeleccionar.AppendLine(" 		    WHEN #temp_ttenfac.Mes = 12 THEN 'Dic'")
            loComandoSeleccionar.AppendLine(" 	    END AS Str_Mes,")
            loComandoSeleccionar.AppendLine(" 	    #temp_ttenfac.Anio AS Anio,")
            loComandoSeleccionar.AppendLine(" 	    #temp_ttenfac.Unidades AS Facturas,")
            loComandoSeleccionar.AppendLine(" 	    #temp_ttenfac.Tendencia AS TendenciaFacturas,")
            ...
            loComandoSeleccionar.AppendLine(" FROM #temp_ttenfac,#temp_ttendev, Clientes")
            loComandoSeleccionar.AppendLine(" WHERE	")
            loComandoSeleccionar.AppendLine(" 	    #temp_ttenfac.Mes = #temp_ttendev.Mes")
            loComandoSeleccionar.AppendLine("       AND " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("grUnidades_UAnio", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvgrUnidades_UAnio.ReportSource = loObjetoReporte

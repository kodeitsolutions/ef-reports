<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_SalesT" CodeFile="fCotizaciones_SalesT.aspx.vb" %>
...
<head runat="server">
    <title>Cotizaciones Sales T</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_SalesT" runat="server" AutoDataBind="true"

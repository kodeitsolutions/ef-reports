<%@ page language="VB" autoeventwireup="false" inherits="fDepositos_Bancarios_Ingles" CodeFile="fDepositos_Bancarios_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Depósitos Bancarios en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDepositos_Bancarios_Ingles" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Ventas_LIRIO_EIP" CodeFile="fFacturas_Ventas_LIRIO_EIP.aspx.vb" %>
...
<head runat="server">
    <title>Invoice (LIRIO/EverythingIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Ventas_LIRIO_EIP" runat="server" AutoDataBind="true"

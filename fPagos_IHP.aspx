<%@ page language="VB" autoeventwireup="false" inherits="fPagos_IHP" CodeFile="fPagos_IHP.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Pagos In Hand Provider</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_IHP" runat="server" AutoDataBind="true"

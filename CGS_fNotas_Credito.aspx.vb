...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_fNotas_Credito"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_fNotas_Credito
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("     Cuentas_Cobrar.Fec_Fin              AS Fec_Fin, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("CGS_fNotas_Credito", laDatosReporte)
            'lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".", ",")
            ...
            Me.crvCGS_fNotas_Credito.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Modelos.aspx.vb" Inherits="rFacturas_Modelos" %>
...
<head runat="server">
    <title>Reporte de Facturas por Modelos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Modelos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class CGS_rLibro_Compras
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("SELECT	ROW_NUMBER() OVER (ORDER BY Registros.Fecha_Doc) AS Num," & Empresa & " AS Empresa,*")
            loComandoSeleccionar.AppendLine("INTO #tmpLibroCompra")
            loComandoSeleccionar.AppendLine("FROM(")
            loComandoSeleccionar.AppendLine("       SELECT  CASE WHEN Cuentas_Pagar.Cod_Mon = 'VEB'")
            loComandoSeleccionar.AppendLine("                    THEN Cuentas_Pagar.Cod_Tip")
            ...
            loComandoSeleccionar.AppendLine("		#tmpLibroCompra.Empresa,")

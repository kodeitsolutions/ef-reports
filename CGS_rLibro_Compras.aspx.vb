...
Partial Class CGS_rLibro_Compras
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'loComandoSeleccionar.AppendLine("DECLARE @date as DATE; ")
            'loComandoSeleccionar.AppendLine("SET @date = cast('2000-01-01 00:00:00' as datetime);")
            ...
            'loComandoSeleccionar.AppendLine("				@date               					AS Fecha_Comp,")
            ...
            loComandoSeleccionar.AppendLine("				CONCAT('" & lcAño & "' , '" & lcMes & "' , Retenciones_Documentos.Num_Com) AS Num_Comprobante,")
            loComandoSeleccionar.AppendLine("				Documentos.Factura					    AS Factura_Afect,")
            loComandoSeleccionar.AppendLine("				Renglones_Pagos.Mon_Net				    AS Total_Doc,")
            ...
            'loComandoSeleccionar.AppendLine("				Documentos.Fec_Ini					    AS Fecha_Comp,")
            loComandoSeleccionar.AppendLine("               CAST(" & lcParametro0Desde & " AS DATE) AS Fecha_De,")
            loComandoSeleccionar.AppendLine("               CAST(" & lcParametro0Hasta & " AS DATE) AS Fecha_Hasta")
            loComandoSeleccionar.AppendLine("		FROM Cuentas_Pagar")
            ...
            loComandoSeleccionar.AppendLine("				Retenciones_Documentos.Mon_Ret		    AS Monto_Ret,")
            'loComandoSeleccionar.AppendLine("				Documentos.fec_ini					    AS Fecha_Comp,")
            loComandoSeleccionar.AppendLine("               CAST(" & lcParametro0Desde & " AS DATETIME) AS Fecha_De,")
            loComandoSeleccionar.AppendLine("               CAST(" & lcParametro0Hasta & " AS DATETIME) AS Fecha_Hasta")
            loComandoSeleccionar.AppendLine("		FROM	Cuentas_Pagar")

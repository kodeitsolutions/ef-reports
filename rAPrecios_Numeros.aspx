<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAPrecios_Numeros.aspx.vb" Inherits="rAPrecios_Numeros" %>
...
<head runat="server">
    <title>Reporte de Ajustes de Precios por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAPrecios_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

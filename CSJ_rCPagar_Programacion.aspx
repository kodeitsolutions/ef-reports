<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CSJ_rCPagar_Programacion.aspx.vb" Inherits="CSJ_rCPagar_Programacion" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Pagar por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_rCPagar_Programacion" runat="server" AutoDataBind="true"

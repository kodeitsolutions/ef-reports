<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grIncidencias_Fechas.aspx.vb" Inherits="grIncidencias_Fechas" %>
...
<head runat="server">
    <title>Gráfico de Incidencias por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrIncidencias_Fechas" runat="server" AutoDataBind="true"

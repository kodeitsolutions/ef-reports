<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rVerificacionContable.aspx.vb" Inherits="TRF_rVerificacionContable" %>
...
<head runat="server">
    <title>Reporte para Verificación Contable (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rVerificacionContable" runat="server" AutoDataBind="true"

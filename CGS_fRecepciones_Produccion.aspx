<%@ page language="VB" autoeventwireup="false" inherits="CGS_fRecepciones_Produccion" CodeFile="CGS_fRecepciones_Produccion.aspx.vb" %>
...
<head runat="server">
    <title>Recepción de producción para Terceros (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fRecepciones_Produccion" runat="server" AutoDataBind="true"

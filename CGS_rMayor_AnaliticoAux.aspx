<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rMayor_AnaliticoAux.aspx.vb" Inherits="CGS_rMayor_AnaliticoAux" %>
...
<head runat="server">
    <title>Mayor Analítico de Auxiliares(CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rMayor_AnaliticoAux" runat="server" AutoDataBind="true"

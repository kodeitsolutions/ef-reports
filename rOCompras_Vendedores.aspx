<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOCompras_Vendedores.aspx.vb" Inherits="rOCompras_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Compras por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOCompras_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

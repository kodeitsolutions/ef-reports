...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rDetalle_Condominio002_CCMV_3_2014"
'-------------------------------------------------------------------------------------------'
Partial Class rDetalle_Condominio002_CCMV_3_2014
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT @lnMontoNeto = (SELECT ROUND(SUM(Mon_Net),2) FROM #tmpDatosAdministrativos WHERE cod_art = @lcClienteBase);")
            ...
            If (lcParametro6Desde.ToUpper() = "SI") Then
                loComandoSeleccionar.AppendLine("WHERE Detalles.Canon > 0")
            ElseIf (lcParametro7Desde.ToUpper() = "SI") Then
                loComandoSeleccionar.AppendLine("WHERE Detalles.Canon <= 0")
            End If
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rDetalle_Condominio002_CCMV_3_2014", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrDetalle_Condominio002_CCMV_3_2014.ReportSource = loObjetoReporte

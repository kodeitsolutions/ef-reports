<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Compras_Europos.aspx.vb"
    Inherits="rLibro_Compras_Venezuela" %>
...
<head runat="server">
    <title>Libro de Compras Europos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrLibro_Compras_Europos" runat="server" AutoDataBind="true"

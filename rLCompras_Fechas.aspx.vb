...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLCOmpras_Fechas"
'-------------------------------------------------------------------------------------------'
Partial Class rLCOmpras_Fechas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" ORDER BY  CONVERT(nchar(30), Libres_Compras.Fec_Ini,112), " & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLCompras_Fechas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrLCOmpras_Fechas.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS: 20/08/09: Ajuste al metodo orden de los registros

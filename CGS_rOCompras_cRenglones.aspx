<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rOCompras_cRenglones.aspx.vb" Inherits="CGS_rOCompras_cRenglones" %>
...
<head runat="server">
    <title>Reporte de Órdenes de Compras con sus Renglones (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOCompras_cRenglones" runat="server" AutoDataBind="true"

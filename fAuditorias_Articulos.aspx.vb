...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fAuditorias_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class fAuditorias_Articulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" FROM Auditorias,Articulos ")
            loComandoSeleccionar.AppendLine(" WHERE     " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Codigo	=	Articulos.Cod_Art ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tabla	=	'Articulos' ")
            loComandoSeleccionar.AppendLine("			AND	Auditorias.Tipo		=	'Datos' ")
            loComandoSeleccionar.AppendLine("			AND	(Auditorias.Opcion	=	'Articulos' OR Auditorias.Opcion	=	'Sin opción' OR Auditorias.Opcion	=	'ListarArticulos')  ")
           ...
           '--------------------------------------------------'
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fAuditorias_Articulos", laDatosReporte)
            
            Me.mTraducirReporte(loObjetoReporte)
            
            Me.mFormatearCamposReporte(loObjetoReporte)
            
            Me.crvfAuditorias_Articulos.ReportSource = loObjetoReporte

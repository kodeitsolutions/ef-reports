<%@ page language="VB" autoeventwireup="false" inherits="fReclamos_SugerenciasCRM" CodeFile="fReclamos_SugerenciasCRM.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Reclamos y Sugerencias</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfReclamos_SugerenciasCRM" runat="server" AutoDataBind="true"

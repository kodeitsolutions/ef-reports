<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_Cheque01" CodeFile="CGS_fOrdenes_Cheque01.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOrdenes_Cheque01" runat="server" AutoDataBind="true"

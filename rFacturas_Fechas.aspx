<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Fechas.aspx.vb"
    Inherits="rFacturas_Fechas" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrFacturas_Fechas" runat="server" AutoDataBind="true"

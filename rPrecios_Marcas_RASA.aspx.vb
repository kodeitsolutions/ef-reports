...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rPrecios_Marcas_RASA"
'-------------------------------------------------------------------------------------------'
Partial Class rPrecios_Marcas_RASA
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            End If
            loComandoSeleccionar.AppendLine("ORDER BY   CASE Marcas.cod_mar	 ")
            loComandoSeleccionar.AppendLine("				WHEN 'DAEWOO' then 1 ")
            loComandoSeleccionar.AppendLine("				WHEN 'HYUN' THEN 2 ")
            loComandoSeleccionar.AppendLine("				WHEN 'KIA' THEN 3 ")
            loComandoSeleccionar.AppendLine("				ELSE 4 ")
            loComandoSeleccionar.AppendLine("		   END asc,Marcas.cod_mar ASC,  Marcas.nom_mar, Articulos.nom_art ASC ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rPrecios_Marcas_RASA", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrPrecios_Marcas_RASA.ReportSource = loObjetoReporte

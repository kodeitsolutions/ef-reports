<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rBalance_Comprobacion.aspx.vb" Inherits="TRF_rBalance_Comprobacion" %>
...
<head runat="server">
    <title>Balance de Comprobación (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rBalance_Comprobacion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

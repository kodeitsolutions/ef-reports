<%@ page language="VB" autoeventwireup="false" inherits="TRF_rCRetencion_IVAProveedores" 
CodeFile="TRF_rCRetencion_IVAProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Retención de IVA de Proveedores (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTRF_rCRetencion_IVAProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

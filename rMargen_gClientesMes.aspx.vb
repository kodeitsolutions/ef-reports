...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gClientesMes"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gClientesMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Cli, Nom_Cli, Año, Mes, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Clientes.Cod_Cli, Clientes.Nom_Cli, MONTH(Facturas.Fec_Ini), YEAR(Facturas.Fec_Ini)")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Clientes.Cod_Cli, Clientes.Nom_Cli, MONTH(Devoluciones_Clientes.Fec_Ini), YEAR(Devoluciones_Clientes.Fec_Ini)")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("/* Cálculo de ganancia								 										*/ ")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Cli, Nom_Cli, Año, Mes, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Cod_Cli, Nom_Cli, Año, Mes")
            loComandoSeleccionar.AppendLine("")
            ...
            End Select
            loComandoSeleccionar.AppendLine("ORDER BY      Cod_Cli, " & lcOrdenamiento & ", Mes ASC")
        	loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gClientesMes", laDatosReporte)
            ...
            Me.crvrMargen_gClientesMes.ReportSource = loObjetoReporte

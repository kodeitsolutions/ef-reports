<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores_TUR" CodeFile="rCRetencion_ISLRProveedores_TUR.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (AT)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCRetencion_ISLRProveedores_TUR" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

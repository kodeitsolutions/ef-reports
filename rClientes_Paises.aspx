<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_Paises.aspx.vb" Inherits="rClientes_Paises" %>
...
<head runat="server">
    <title>Listado de Clientes por Paises</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrClientes_Paises" runat="server" AutoDataBind="true"

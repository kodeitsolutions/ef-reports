<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTPedidos_ArticulosFechasVendedores.aspx.vb" Inherits="rTPedidos_ArticulosFechasVendedores" %>
...
<head runat="server">
    <title>Reporte de Total de Pedidos por Artículos por Fechas y Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTPedidos_ArticulosFechasVendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

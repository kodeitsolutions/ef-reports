<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSeguimientos_Proveedores.aspx.vb" Inherits="rSeguimientos_Proveedores" %>
...
<head runat="server">
    <title>Listado de Seguimientos de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSeguimientos_Proveedores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Cliente_Ipos.aspx.vb" Inherits="rTVentas_Cliente_Ipos" %>
...
<head runat="server">
    <title>Ventas del Día por Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Cliente_Ipos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

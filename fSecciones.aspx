<%@ page language="VB" autoeventwireup="false" inherits="fSecciones" CodeFile="fSecciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Secciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSecciones" runat="server" AutoDataBind="true"

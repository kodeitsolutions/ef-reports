<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConsumos_Pacientes_CCSJ.aspx.vb" Inherits="rConsumos_Pacientes_CCSJ" %>
...
<head runat="server">
    <title>Notas de Consumo por Pacientes (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrConsumos_Pacientes_CCSJ" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

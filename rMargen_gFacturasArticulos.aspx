<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gFacturasArticulos.aspx.vb" Inherits="rMargen_gFacturasArticulos" %>
...
<html>
<head runat="server">
    <title>Margen de Ganancia por Factura y Artículo</title>
    <link href="/aspnet_client/System_Web/2_0_50727/CrystalReportWebFormViewer3/css/default.css" rel="stylesheet" type="text/css" />
</head>
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrMargen_gFacturasArticulos" runat="server" AutoDataBind="true"

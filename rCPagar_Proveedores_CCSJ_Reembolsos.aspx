<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCPagar_Proveedores_CCSJ_Reembolsos.aspx.vb" Inherits="rCPagar_Proveedores_CCSJ_Reembolsos" %>
...
<head runat="server">
    <title>* Estado de Cuenta de Honorarios Médicos (Solo Reembolsos) (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCPagar_Proveedores_CCSJ_Reembolsos" runat="server" AutoDataBind="true"

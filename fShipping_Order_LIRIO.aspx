<%@ Page Language="VB" AutoEventWireup="false" Inherits="fShipping_Order_LIRIO" CodeFile="fShipping_Order_LIRIO.aspx.vb" %>
...
<head runat="server">
    <title>Shipping Order (LIRIO)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfShipping_Order_LIRIO" runat="server" AutoDataBind="true"

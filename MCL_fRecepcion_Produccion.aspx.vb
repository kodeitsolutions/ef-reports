Imports System.Data
Partial Class MCL_fRecepcion_Produccion
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("                                                               AND Auditorias.Accion = 'Agregar' ORDER BY Auditorias.Registro DESC)) COLLATE DATABASE_DEFAULT")
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("MCL_fRecepcion_Produccion", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvMCL_fRecepcion_Produccion.ReportSource = loObjetoReporte

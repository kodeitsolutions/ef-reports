<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFrecuanecia_Clientes.aspx.vb" Inherits="rFrecuanecia_Clientes" %>
...
<head runat="server">
    <title>Reporte de Frecuencia de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFrecuanecia_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

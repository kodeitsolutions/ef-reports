<%@ page language="VB" autoeventwireup="false" inherits="rFacturas_Ventas_Onyx_Ingles" CodeFile="rFacturas_Ventas_Onyx_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Ventas_Onyx_Ingles" runat="server" AutoDataBind="true"

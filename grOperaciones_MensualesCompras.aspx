<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grOperaciones_MensualesCompras.aspx.vb" Inherits="grOperaciones_MensualesCompras" %>
...
<head runat="server">
    <title>Gráfico de Operaciones Mensuales</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvgrOperaciones_MensualesCompras" runat="server" AutoDataBind="true"

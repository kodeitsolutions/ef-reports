<%@ page language="VB" autoeventwireup="false" inherits="fTransacciones_Financieras" CodeFile="fTransacciones_Financieras.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Transacciones Financieras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTransacciones_Financieras" runat="server" AutoDataBind="true"

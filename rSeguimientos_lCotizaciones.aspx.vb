...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rSeguimientos_lCotizaciones"
'-------------------------------------------------------------------------------------------'
Partial Class rSeguimientos_lCotizaciones 
	...
	Try
            ...
            loComandoSeleccionar.AppendLine("-- *********************************************************")
            loComandoSeleccionar.AppendLine("SELECT		Cotizaciones.Documento				AS Documento,	")
            ...
            loComandoSeleccionar.AppendLine("			Cotizaciones.Cod_Cli				AS Cod_Cli,		")
            loComandoSeleccionar.AppendLine("			CASE WHEN (Cotizaciones.Nom_Cli>'')					")
            loComandoSeleccionar.AppendLine("				THEN	Cotizaciones.Nom_Cli					")
            loComandoSeleccionar.AppendLine("				ELSE	Clientes.Nom_Cli					")
            loComandoSeleccionar.AppendLine("			END 							AS Nom_Cli,		")
            loComandoSeleccionar.AppendLine("			Cotizaciones.Status					AS Status,		")
            loComandoSeleccionar.AppendLine("			Cotizaciones.Mon_Net				AS Mon_Net, 	")
            loComandoSeleccionar.AppendLine("			Cotizaciones.For_Env				AS For_Env, 	")
            loComandoSeleccionar.AppendLine("			Cotizaciones.Tip_Env				AS Tip_Env, 	")
            loComandoSeleccionar.AppendLine("			Cotizaciones.Dir_Ent				AS Dir_Ent, 	")
            loComandoSeleccionar.AppendLine("			CAST(Cotizaciones.Tie_Log AS XML)	AS Tie_Log, 	")
            loComandoSeleccionar.AppendLine("			CAST(Cotizaciones.Embalaje AS XML)	AS Embalaje,	")
            loComandoSeleccionar.AppendLine("			CAST(Cotizaciones.Tra_Adi AS XML)	AS Tra_Adi, 	")
            loComandoSeleccionar.AppendLine("			CAST(Cotizaciones.Seg_Log AS XML)	AS Seg_Log  	")
            ...
            loComandoSeleccionar.AppendLine("		AND Cotizaciones.Cod_For	BETWEEN " & lcParametro7Desde)
            ...
            loComandoSeleccionar.AppendLine("SELECT	#tmpCotizaciones.Documento								AS Documento,")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Fec_Ini								AS Fec_Ini,")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Fec_Fin								AS Fec_Fin,")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Cod_Cli								AS Cod_Cli,")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Nom_Cli								AS Nom_Cli,")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Status									AS Status,")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Mon_Net								AS Mon_Net, ")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.For_Env								AS For_Env, ")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Tip_Env								AS Tip_Env, ")
            loComandoSeleccionar.AppendLine("		#tmpCotizaciones.Dir_Ent								AS Dir_Ent,")
            ...
            loComandoSeleccionar.AppendLine("			PARTITION BY #tmpCotizaciones.Documento							")
            ...
            loComandoSeleccionar.AppendLine("		ON	Documentacion.Cod_Reg = #tmpCotizaciones.Documento")
            loComandoSeleccionar.AppendLine("		AND	Documentacion.Origen = 'Cotizaciones'")		   
            loComandoSeleccionar.AppendLine("ORDER BY	#tmpCotizaciones.Documento, Documentacion.Nom_Doc")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("-- *********************************************************")
            loComandoSeleccionar.AppendLine("-- Resto de las Cotizaciones (las que no tienen Detalle XML de Logística)")
            loComandoSeleccionar.AppendLine("-- *********************************************************")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(	Documento, Fec_Ini, Fec_Fin, Cod_Cli, Nom_Cli, Status,")
            ...
            loComandoSeleccionar.AppendLine("			#tmpCotizaciones.Dir_Ent						AS Dir_Ent")
            loComandoSeleccionar.AppendLine("FROM		#tmpCotizaciones")
            loComandoSeleccionar.AppendLine("WHERE NOT EXISTS(SELECT * FROM #tmpFinal WHERE #tmpFinal.Documento = #tmpCotizaciones.Documento)")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rSeguimientos_lCotizaciones", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrSeguimientos_lCotizaciones.ReportSource =	 loObjetoReporte	

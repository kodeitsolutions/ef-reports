<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_AnoMes.aspx.vb" Inherits="rTotal_Casos_AnoMes" %>
...
<head runat="server">
    <title>Total Casos por Años y Meses</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_AnoMes" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFTrasladoAlmacenes_eDymo_IKP"
'-------------------------------------------------------------------------------------------'
Partial Class fFTrasladoAlmacenes_eDymo_IKP
...
#End Region
    ...
    '*****************************************************************************
        ...
        loConsulta.AppendLine("            SELECT   Renglones_Traslados.documento    AS Documento,")
        loConsulta.AppendLine("                     Renglones_Traslados.Renglon      AS Renglon,")
        loConsulta.AppendLine("                     Traslados.Fec_Ini                AS Fec_Ini,")
        loConsulta.AppendLine("                     Renglones_Traslados.Cod_Art      AS Cod_Art,")
        loConsulta.AppendLine("                     Renglones_Traslados.Notas        AS Nom_Art, ")
        loConsulta.AppendLine("                     Renglones_Traslados.Can_Art1     AS Can_Art1")
        ...
        loConsulta.AppendLine("LEFT JOIN seriales ON seriales.cod_art = A.Cod_Art")
        loConsulta.AppendLine("    AND seriales.Ult_Tip = 'Traslados' ")
        loConsulta.AppendLine("    AND Ult_Doc = A.Documento")
    ...
    '*****************************************************************************
        ...
        Dim lcArchivo As String =  "fFTrasladoAlmacenes_eDymo_IKP_" & lcFechaDoc 
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 12/08/13: Creación de la clase														'
'-------------------------------------------------------------------------------------------'

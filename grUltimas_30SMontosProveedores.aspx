<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grUltimas_30SMontosProveedores.aspx.vb" Inherits="grUltimas_30SMontosProveedores" %>
...
<head runat="server">
    <title>Gráfico de Compras de Últimas 30 Semanas en Montos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrUltimas_30SMontosProveedores" runat="server" AutoDataBind="true"

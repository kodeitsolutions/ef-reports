<%@ page language="VB" autoeventwireup="false" CodeFile="fCuentas_PagarProForma.aspx.vb" inherits="fCuentas_PagarProForma" %>
...
<head runat="server">
    <title>Formato de Cuentas por Pagar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_PagarProForma" runat="server" AutoDataBind="true"

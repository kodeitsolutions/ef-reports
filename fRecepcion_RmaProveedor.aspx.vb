...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fRecepcion_RmaProveedor"
'-------------------------------------------------------------------------------------------'
Partial Class fRecepcion_RmaProveedor
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fRecepcion_RmaProveedor", laDatosReporte)
			lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".",",")
            ...
            Me.crvfRecepcion_RmaProveedor.ReportSource = loObjetoReporte

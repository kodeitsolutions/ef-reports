<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_Renglones.aspx.vb" Inherits="rOPagos_Renglones" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_Renglones" runat="server" AutoDataBind="true"

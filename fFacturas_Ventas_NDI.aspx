<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_NDI" CodeFile="fFacturas_Ventas_NDI.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Facturas NDI</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_NDI" runat="server" AutoDataBind="true"

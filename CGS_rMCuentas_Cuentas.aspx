<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rMCuentas_Cuentas.aspx.vb" Inherits="CGS_rMCuentas_Cuentas" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Cuentas Bancarias por Cuentas (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMCuentas_Cuentas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

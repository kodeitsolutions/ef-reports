...
Partial Class rTNotasRecepcion_aAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" recepciones, renglones_recepciones, proveedores, articulos, departamentos" )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTNotasRecepcion_aAñoMes", laDatosReporte)
            ...
            Me.crvrTNotasRecepcion_aAñoMes.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="rRVentas_Articulos_Ampliada" CodeFile="rRVentas_Articulos_Ampliada.aspx.vb"  %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_Articulos_Ampliada" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

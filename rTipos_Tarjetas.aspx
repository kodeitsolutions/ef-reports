<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Tarjetas.aspx.vb" Inherits="rTipos_Tarjetas" %>
...
<head runat="server">
    <title>Reporte de Tipos de Tarjetas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Tarjetas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="CGS_rCRetencion_ISLRProveedores" CodeFile="CGS_rCRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (CEGASA)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCGS_rCRetencion_ISLRProveedores" runat="server" AutoDataBind="true"

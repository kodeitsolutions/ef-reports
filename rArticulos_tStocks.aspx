<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_tStocks.aspx.vb" Inherits="rArticulos_tStocks" %>
...
<head runat="server">
    <title>Reporte de Artículos con Todos sus Stocks</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_tStocks" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

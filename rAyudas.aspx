<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAyudas.aspx.vb" Inherits="rAyudas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAyudas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

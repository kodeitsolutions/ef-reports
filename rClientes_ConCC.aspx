<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_ConCC.aspx.vb" Inherits="rClientes_ConCC" %>
...
<head runat="server">
    <title>Reporte de Clientes con sus Cuentas Contables</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_ConCC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

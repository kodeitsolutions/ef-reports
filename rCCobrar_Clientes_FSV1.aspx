<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Clientes_FSV1.aspx.vb" Inherits="rCCobrar_Clientes_FSV1" %>
...
<head runat="server">
    <title>Saldos de Cuentas por Cobrar por Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Clientes_FSV1" runat="server" AutoDataBind="true"

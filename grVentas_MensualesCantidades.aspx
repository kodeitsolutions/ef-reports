<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grVentas_MensualesCantidades.aspx.vb" Inherits="grVentas_MensualesCantidades" %>
...
<head runat="server">
    <title>Gráfico de Ventas Mensuales en Cantidades</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrVentas_MensualesCantidades" runat="server" AutoDataBind="true"

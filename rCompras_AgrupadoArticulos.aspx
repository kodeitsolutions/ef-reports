<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_AgrupadoArticulos.aspx.vb" Inherits="rCompras_AgrupadoArticulos" %>
...
<head runat="server">
    <title>Reporte de Compras Agrupado por Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_AgrupadoArticulos" runat="server" AutoDataBind="true"

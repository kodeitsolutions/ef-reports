...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fCasos_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class fCasos_Articulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		COALESCE(Renglones_Casos.cod_art,'')				AS cod_art,")
            loConsulta.AppendLine("		COALESCE(Renglones_Casos.nom_art,'')				AS nom_art,")
            loConsulta.AppendLine("		COALESCE(Renglones_Casos.can_art,0)					AS can_art")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCasos_Articulos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfCasos_Articulos.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGrupos_Usuarios.aspx.vb" Inherits="rGrupos_Usuarios" %>
...
<head runat="server">
    <title>Reporte de Grupos de Usuarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGrupos_Usuarios" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCiudades.aspx.vb" Inherits="rCiudades" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCiudades" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

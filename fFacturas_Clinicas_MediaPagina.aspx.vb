...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFacturas_Clinicas_MediaPagina"
'-------------------------------------------------------------------------------------------'
Partial Class fFacturas_Clinicas_MediaPagina
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fFacturas_Clinicas_MediaPagina", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfFacturas_Clinicas_MediaPagina.ReportSource = loObjetoReporte

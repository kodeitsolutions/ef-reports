<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Articulos.aspx.vb" Inherits="rTipos_Articulos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Articulos" runat="server" AutoDataBind="true"

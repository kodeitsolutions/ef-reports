<%@ page language="VB" autoeventwireup="false" inherits="fDepartamentos" CodeFile="fDepartamentos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDepartamentos" runat="server" AutoDataBind="true"

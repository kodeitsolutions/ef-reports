<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCostos_ArtProd.aspx.vb" Inherits="CGS_rCostos_ArtProd" %>
...
<head runat="server">
    <title>Costos de Artículos Producidos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rCostos_ArtProd" runat="server" AutoDataBind="true"

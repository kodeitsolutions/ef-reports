...
Partial Class rTNotasEntregas_aAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" entregas, renglones_entregas, clientes, articulos, departamentos" )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTNotasEntregas_aAñoMes", laDatosReporte)
            ...
            Me.crvrTNotasEntregas_aAñoMes.ReportSource = loObjetoReporte

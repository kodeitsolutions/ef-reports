<%@ page language="VB" autoeventwireup="false" inherits="rPrecios_Unidades" CodeFile="rPrecios_Unidades.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Precios de MultiUnidad</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPrecios_Unidades" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

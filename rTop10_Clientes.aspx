<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTop10_Clientes.aspx.vb" Inherits="rTop10_Clientes" %>
...
<head runat="server">
    <title>Reporte de Top 10 Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTop10_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="TRF_rResumenRetencion_ISLRProveedores" 
CodeFile="TRF_rResumenRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Retención de ISLR (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTRF_rResumenRetencion_ISLRProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

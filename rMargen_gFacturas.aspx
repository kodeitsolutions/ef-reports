<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gFacturas.aspx.vb" Inherits="rMargen_gFacturas" %>
...
<head runat="server">
    <title>Margen de Ganancia por Facturas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gFacturas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_Sucursal.aspx.vb" Inherits="rRVentas_Sucursal" %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas por Sucursal</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_Sucursal" runat="server" AutoDataBind="true"

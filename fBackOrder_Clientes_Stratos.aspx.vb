...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fBackOrder_Clientes_Stratos"
'-------------------------------------------------------------------------------------------'
Partial Class fBackOrder_Clientes_Stratos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Renglones_Pedidos.Can_Pen1, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fBackOrder_Clientes_Stratos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfBackOrder_Clientes_Stratos.ReportSource = loObjetoReporte

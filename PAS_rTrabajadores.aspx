<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_rTrabajadores.aspx.vb" Inherits="PAS_rTrabajadores" %>
...
<head runat="server">
    <title>Listado de Trabajadores (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_rTrabajadores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_aArticuloProveedorMensual.aspx.vb" Inherits="rCompras_aArticuloProveedorMensual" %>
...
<head runat="server">
    <title>Reporte de Compras Agrupadas por Artículos y Proveedores Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_aArticuloProveedorMensual" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

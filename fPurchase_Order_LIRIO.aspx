<%@ Page Language="VB" AutoEventWireup="false" Inherits="fPurchase_Order_LIRIO" CodeFile="fPurchase_Order_LIRIO.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfPurchase_Order_LIRIO" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_fComprobante_Diario.aspx.vb" Inherits="CGS_fComprobante_Diario" %>
...
<head runat="server">
    <title>Comprobante Diario (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fComprobante_Diario" runat="server" AutoDataBind="true"

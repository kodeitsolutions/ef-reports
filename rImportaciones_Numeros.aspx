<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rImportaciones_Numeros.aspx.vb" Inherits="rImportaciones_Numeros" %>
...
<head runat="server">
    <title>Reporte de Importaciones por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrImportaciones_Numeros" runat="server" AutoDataBind="true"

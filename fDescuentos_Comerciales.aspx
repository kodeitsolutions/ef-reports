<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fDescuentos_Comerciales.aspx.vb" Inherits="fDescuentos_Comerciales" %>
...
<head runat="server">
    <title>Descuentos Comerciales del Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDescuentos_Comerciales" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTComprasProveedor_vAñoMes.aspx.vb" Inherits="rTComprasProveedor_vAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Compras a Proveedores por Vendedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTComprasProveedor_vAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

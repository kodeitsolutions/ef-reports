<%@ page language="VB" autoeventwireup="false" inherits="fVariables" CodeFile="fVariables.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfVariables" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRetenciones_Proveedores.aspx.vb" Inherits="rRetenciones_Proveedores" %>
...
<head runat="server">
    <title>Total Retenciones por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRetenciones_Proveedores" runat="server" AutoDataBind="true"

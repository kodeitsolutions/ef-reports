<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rNRecepcionSP_MONO.aspx.vb" Inherits="CGS_rNRecepcionSP_MONO" %>
...
<head runat="server">
    <title>Listado de Notas de Recepción [reducido] (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rNRecepcionSP_MONO" runat="server" AutoDataBind="true"

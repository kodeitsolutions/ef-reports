<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_IVAProveedores" 
CodeFile="rCRetencion_IVAProveedores.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrCRetencion_IVAProveedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

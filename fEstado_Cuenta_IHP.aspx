<%@ page language="VB" autoeventwireup="false" inherits="fEstado_Cuenta_IHP" CodeFile="fEstado_Cuenta_IHP.aspx.vb" %>
...
<head runat="server">
    <title>Estado de Cuenta In hand Provider</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfEstado_Cuenta_IHP" runat="server" AutoDataBind="true"

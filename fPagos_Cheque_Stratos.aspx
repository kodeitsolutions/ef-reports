<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque_Stratos" CodeFile="fPagos_Cheque_Stratos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque_Stratos" runat="server" AutoDataBind="true"

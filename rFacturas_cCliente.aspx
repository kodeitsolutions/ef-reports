<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_cCliente.aspx.vb" Inherits="rFacturas_cCliente" %>
...
<head runat="server">
    <title>Reporte de Facturas de Ventas Cobradas a un Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_cCliente" runat="server" AutoDataBind="true"

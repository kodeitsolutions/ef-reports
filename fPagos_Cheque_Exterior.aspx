<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque_Exterior" CodeFile="fPagos_Cheque_Exterior.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque_Exterior" runat="server" AutoDataBind="true"

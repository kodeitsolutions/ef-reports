<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAPrecios_Renglones.aspx.vb" Inherits="rAPrecios_Renglones" %>
...
<head runat="server">
    <title>Listado de Ajustes de Precios con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAPrecios_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

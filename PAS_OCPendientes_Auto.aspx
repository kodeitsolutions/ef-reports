<%@ page language="VB" autoeventwireup="false" inherits="PAS_OCPendientes_Auto" CodeFile="PAS_OCPendientes_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Órdenes de Compras pendientes Automático (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_OCPendientes_Auto" runat="server" AutoDataBind="true"

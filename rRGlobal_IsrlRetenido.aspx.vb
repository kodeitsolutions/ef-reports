...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRGlobal_IsrlRetenido"
'-------------------------------------------------------------------------------------------'
Partial Class rRGlobal_IsrlRetenido
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		'-------------------------------------------------------------------------------------------'
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRGlobal_IsrlRetenido", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRGlobal_IsrlRetenido.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS: 29/07/09: Se Renombro de Relación Global de ISLR Relativo a Relación Global de ISLR 
'                Retenido
'-------------------------------------------------------------------------------------------'

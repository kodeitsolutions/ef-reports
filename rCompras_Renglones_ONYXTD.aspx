<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_Renglones_ONYXTD.aspx.vb" Inherits="rCompras_Renglones_ONYXTD" %>
...
<head runat="server">
    <title>Reporte de Compras con sus Renglones (ONYXTD)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_Renglones_ONYXTD" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

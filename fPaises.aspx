<%@ page language="VB" autoeventwireup="false" inherits="fPaises" CodeFile="fPaises.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPaises" runat="server" AutoDataBind="true"

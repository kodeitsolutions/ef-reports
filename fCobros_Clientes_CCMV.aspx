<%@ page language="VB" autoeventwireup="false" inherits="fCobros_Clientes_CCMV" CodeFile="fCobros_Clientes_CCMV.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cobros a Clientes CCMV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCobros_Clientes_CCMV" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLMontosAjustes_AlmacenMes.aspx.vb" Inherits="rLMontosAjustes_AlmacenMes" %>
...
<head runat="server">
    <title>Reporte de Monto de Ajustes por Almacén Totalizados Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLMontosAjustes_AlmacenMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

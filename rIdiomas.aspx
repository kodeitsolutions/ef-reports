<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIdiomas.aspx.vb" Inherits="rIdiomas" %>
...
<head runat="server">
    <title>Reporte de Idiomas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrIdiomas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

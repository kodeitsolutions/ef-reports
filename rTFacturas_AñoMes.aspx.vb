...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTFacturas_AñoMes"
'-------------------------------------------------------------------------------------------'

Partial Class rTFacturas_AñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            lcComandoSeleccionar.AppendLine("   		Facturas.Documento, ")
            ...
            lcComandoSeleccionar.AppendLine(" Facturas, renglones_Facturas, articulos, departamentos")
            ...
            Else
                lcComandoSeleccionar.AppendLine(" 				AND Facturas.cod_rev  NOT between " & lcParametro7Desde)
            End If
...
'me.mEscribirConsulta(lcComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTFacturas_AñoMes", laDatosReporte)
            ...
            Me.crvrTFacturas_AñoMes.ReportSource = loObjetoReporte

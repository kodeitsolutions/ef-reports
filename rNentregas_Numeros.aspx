<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNentregas_Numeros.aspx.vb" Inherits="rNentregas_Numeros" %>
...
<head runat="server">
    <title>Reporte de las Notas de Entregas por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNentregas_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

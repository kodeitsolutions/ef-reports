Imports System.Data
Partial Class rLibro_Compras_Tipo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("			Proveedores.Cod_Tip AS Tipo_Proveedor,")
            loComandoSeleccionar.AppendLine("			Tipos_Proveedores.Nom_Tip AS Nom_Tip, ")
            ...
            loComandoSeleccionar.AppendLine("FROM		Cuentas_Pagar, Proveedores, Tipos_Proveedores ")
            loComandoSeleccionar.AppendLine("WHERE		Cuentas_Pagar.Cod_Pro = Proveedores.Cod_Pro ")
            loComandoSeleccionar.AppendLine(" 			And Tipos_Proveedores.Cod_Tip = Proveedores.Cod_Tip ")
            ...
            loComandoSeleccionar.AppendLine(" 			And Proveedores.Cod_Tip BETWEEN " & lcParametro8Desde)
            ...
            loComandoSeleccionar.AppendLine("FROM		Ordenes_Pagos, Proveedores, Tipos_Proveedores ")
            ...
            If lcParametro6Desde.ToUpper = "SI" Then
                ...
                loComandoSeleccionar.AppendLine("ORDER BY   Cod_Tip, Tipo_Proveedor,  " & lcOrdenamiento.Replace("Cuentas_Pagar.", " "))
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLibro_Compras_Tipo", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrLibro_Compras_Tipo.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' CMS:  03/04/10: Se ajusto para tomar los siguientes documentos GIRO, ISRL, N/CR, N/DB, RETIVA
'-------------------------------------------------------------------------------------------'
...
'-------------------------------------------------------------------------------------------'
' JFP:  06/09/12: Adecuacion al tipo de proveedor
'-------------------------------------------------------------------------------------------'

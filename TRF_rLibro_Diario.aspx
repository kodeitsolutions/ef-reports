<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLibro_Diario.aspx.vb" Inherits="TRF_rLibro_Diario" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rLibro_Diario" runat="server" AutoDataBind="true"

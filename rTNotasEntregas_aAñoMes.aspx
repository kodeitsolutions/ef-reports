<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTNotasEntregas_aAñoMes.aspx.vb" Inherits="rTNotasEntregas_aAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Notas de Entrega de Cliente por Artículo por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTNotasEntregas_aAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fFicha_DatosVendedores" CodeFile="fFicha_DatosVendedores.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Vendedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_DatosVendedores" runat="server" AutoDataBind="true"

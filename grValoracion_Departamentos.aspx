<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grValoracion_Departamentos.aspx.vb" Inherits="grValoracion_Departamentos" %>
...
<head runat="server">
    <title>Gráfico de Valoración por Departamento</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrValoracion_Departamentos" runat="server" AutoDataBind="true"

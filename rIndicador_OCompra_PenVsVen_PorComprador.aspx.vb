...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rIndicador_OCompra_PenVsVen_PorComprador"
'-------------------------------------------------------------------------------------------'
Partial Class rIndicador_OCompra_PenVsVen_PorComprador
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("        SUM(CASE WHEN DATEDIFF(DAY, Ordenes_Compras.Fec_Fin, GETDATE())>0")
            loConsulta.AppendLine("            THEN 1 ELSE 0")
            loConsulta.AppendLine("        END)                                                            AS Vencidas,")
            loConsulta.AppendLine("        CAST(SUM(CASE WHEN DATEDIFF(DAY, Ordenes_Compras.Fec_Fin, GETDATE())>0")
            loConsulta.AppendLine("            THEN 1 ELSE 0")
            loConsulta.AppendLine("        END) AS DECIMAL(28,10))*100/CAST(COUNT(*) AS DECIMAL(28,10))    AS Porcentaje")
            ...
            loConsulta.AppendLine("WHERE   Ordenes_Compras.Status IN ('Confirmado' , 'Afectado')")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rIndicador_OCompra_PenVsVen_PorComprador", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrIndicador_OCompra_PenVsVen_PorComprador.ReportSource = loObjetoReporte

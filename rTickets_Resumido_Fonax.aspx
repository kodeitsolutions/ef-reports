<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTickets_Resumido_Fonax.aspx.vb" Inherits="rTickets_Resumido_Fonax" %>
...
<head runat="server">
    <title>Listado de tickets Resumido Fonax</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTickets_Resumido_Fonax" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

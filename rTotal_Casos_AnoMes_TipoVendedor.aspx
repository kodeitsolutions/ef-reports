<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_AnoMes_TipoVendedor.aspx.vb" Inherits="rTotal_Casos_AnoMes_TipoVendedor" %>
...
<head runat="server">
    <title>Total Casos por Años y Meses por Tipo de Ejecutor</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_AnoMes_TipoVendedor" runat="server" AutoDataBind="true"

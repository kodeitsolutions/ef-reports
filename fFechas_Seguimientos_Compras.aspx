<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fFechas_Seguimientos_Compras.aspx.vb" Inherits="fFechas_Seguimientos_Compras" %>
...
<head runat="server">
    <title>Formato de Fechas y Seguimientos de Compras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFechas_Seguimientos_Compras" runat="server" AutoDataBind="true"

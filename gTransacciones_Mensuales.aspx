<%@ Page Language="VB" AutoEventWireup="false" CodeFile="gTransacciones_Mensuales.aspx.vb" Inherits="gTransacciones_Mensuales" %>
...
<head runat="server">
    <title>Gráfico de Transacciones Mensuales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgTransacciones_Mensuales" runat="server" AutoDataBind="true"

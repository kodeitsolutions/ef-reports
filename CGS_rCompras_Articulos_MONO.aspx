<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCompras_Articulos_MONO.aspx.vb" Inherits="CGS_rCompras_Articulos_MONO" %>
...
<head runat="server">
    <title>Listado Contable de Compras por Artículos [MONOESPACIO] (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rCompras_Articulos_MONO" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

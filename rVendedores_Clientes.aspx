<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVendedores_Clientes.aspx.vb" Inherits="rVendedores_Clientes" %>
...
<head runat="server">
    <title>Reporte de Vendedores con sus Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVendedores_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEstimacion_Pagos.aspx.vb" Inherits="rEstimacion_Pagos" %>
...
<head runat="server">
    <title>Estimación de Pagos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEstimacion_Pagos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

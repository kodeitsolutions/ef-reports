<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rABC_Clientes.aspx.vb" Inherits="rABC_Clientes" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrABC_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gSucursalDepartamentos.aspx.vb" Inherits="rMargen_gSucursalDepartamentos" %>
...
<head runat="server">
    <title>Margen de Ganancia por Sucursal y Departamento</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gSucursalDepartamentos" runat="server" AutoDataBind="true"

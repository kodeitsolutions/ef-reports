<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCortes_Numeros.aspx.vb" Inherits="rCortes_Numeros" %>
...
<head runat="server">
    <title>Reporte de Cortes de Inventarios por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCortes_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_dBasicos.aspx.vb" Inherits="rProveedores_dBasicos" %>
...
<head runat="server">
    <title>Reporte de Proveedores con sus Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_dBasicos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

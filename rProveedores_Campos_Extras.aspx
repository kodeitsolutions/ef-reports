<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_Campos_Extras.aspx.vb" Inherits="rProveedores_Campos_Extras" %>
...
<head runat="server">
    <title>Listado de Proveedores con sus Campos Extras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_Campos_Extras" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

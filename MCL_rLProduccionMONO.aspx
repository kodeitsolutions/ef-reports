<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rLProduccionMONO.aspx.vb" Inherits="MCL_rLProduccionMONO" %>
...
<head runat="server">
    <title>Listado de Órdenes de Producción por lote agrupado (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rLProduccionMONO" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

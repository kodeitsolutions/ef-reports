...
Partial Class rTNotasEntregas_vAñoMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" entregas, renglones_entregas, vendedores, clientes, articulos  " )
			...
			'lcComandoSeleccionar.AppendLine("			AND		entregas.cod_tra			=	transportes.cod_tra ")
			'lcComandoSeleccionar.AppendLine("			AND		entregas.cod_mon			=	monedas.cod_mon ")
			...
			'lcComandoSeleccionar.AppendLine("ORDER BY   cod_ven, nom_ven, AÑO, num_mes")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTNotasEntregas_vAñoMes", laDatosReporte)
            ...
            Me.crvrTNotasEntregas_vAñoMes.ReportSource = loObjetoReporte

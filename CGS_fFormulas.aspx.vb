...
Partial Class CGS_fFormulas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Formulas.Cos_Otr1                                           AS Costo_Act,")
            loComandoSeleccionar.AppendLine("           Formulas.Cos_Otr2                                           AS Costo_Std,")
            loComandoSeleccionar.AppendLine("           Formulas.Caracter1                                          AS Lote,")
            loComandoSeleccionar.AppendLine("           Formulas.Numerico1                                          AS Total_Act,")
            loComandoSeleccionar.AppendLine("           Formulas.Numerico2                                          AS Total_Est,")
            loComandoSeleccionar.AppendLine("           Formulas.Can_Ren                                            AS Obtenido,")
            ...
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Can_Art1                                 AS Cant_Act,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Can_Art2                                 AS Cant_Std,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Cod_Uni                                  AS Unidad,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Cos_Ult1                                 AS RengCosto_Act,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Cos_Ult2                                 AS RengCosto_Std,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Notas                                    AS Notas,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Por_Des                                  AS Desperdicio,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Precio1                                  AS Unitario_Act,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Precio2                                  AS Unitario_Std,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Numerico1                                AS Monto_Act,")
            loComandoSeleccionar.AppendLine("           Renglones_Formulas.Numerico2                                AS Monto_Std,")

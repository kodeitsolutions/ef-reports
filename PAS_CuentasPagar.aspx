<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_CuentasPagar.aspx.vb" Inherits="PAS_CuentasPagar" %>
...
<head runat="server">
    <title>Listado de Cuentas por Pagar (PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_CuentasPagar" runat="server" AutoDataBind="true"

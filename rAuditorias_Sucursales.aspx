<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_Sucursales.aspx.vb" Inherits="rAuditorias_Sucursales" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Sucursales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_Sucursales" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

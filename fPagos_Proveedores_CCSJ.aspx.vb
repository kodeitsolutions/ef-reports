...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fPagos_Proveedores_CCSJ"
'-------------------------------------------------------------------------------------------'
Partial Class fPagos_Proveedores_CCSJ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT	TOP 1 Proveedores.Cod_Pro,")
            ...
            loComandoSeleccionar.AppendLine(" INTO      #tmpBancos ")
            loComandoSeleccionar.AppendLine(" FROM      Pagos, ")
            loComandoSeleccionar.AppendLine("           Bancos, ")
            loComandoSeleccionar.AppendLine("           Proveedores, ")
            loComandoSeleccionar.AppendLine("           Cuentas_Clientes ")
            loComandoSeleccionar.AppendLine(" WHERE     Proveedores.Cod_Pro =   Cuentas_Clientes.Cod_Reg ")
            loComandoSeleccionar.AppendLine("           AND Bancos.Cod_Ban	=   Cuentas_Clientes.Cod_Ban  ")
            loComandoSeleccionar.AppendLine("           AND Pagos.Cod_Pro   =   Proveedores.Cod_Pro AND " & cusAplicacion.goFormatos.pcCondicionPrincipal)
            ...
            loComandoSeleccionar.AppendLine("         	#tmpBancos.Tip_Cue, ")
            loComandoSeleccionar.AppendLine("         	#tmpBancos.Num_Cue, ")
            ...
            loComandoSeleccionar.AppendLine("           #tmpBancos.Cod_Ban_Pro      AS  Cod_Ban_Pro, ")
            ...
            loComandoSeleccionar.AppendLine("           #tmpBancos.Nom_Ban_Pro      AS  Nom_Ban_Pro, ")
            ...
            loComandoSeleccionar.AppendLine("           Proveedores LEFT JOIN #tmpBancos ")
            loComandoSeleccionar.AppendLine("           ON #tmpBancos.Cod_Pro      =   Proveedores.Cod_Pro ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fPagos_Proveedores_CCSJ", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfPagos_Proveedores_CCSJ.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rNRecepcionProveedor_MONO.aspx.vb" Inherits="CGS_rNRecepcionProveedor_MONO" %>
...
<head runat="server">
    <title>Listado de Notas de Recepción para Proveedores [reducido] (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rNRecepcionProveedor_MONO" runat="server" AutoDataBind="true"

Imports System.Data
Partial Class rCompras_Numeros
	...
	Try
            ...
            loComandoSeleccionar.AppendLine("ORDER BY      " & lcOrdenamiento & ", CONVERT(nchar(30), Compras.Fec_Ini,112)")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rCompras_Numeros", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCompras_Numeros.ReportSource =	 loObjetoReporte	

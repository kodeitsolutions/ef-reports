...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gVendedorArticulos"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gVendedorArticulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Ven, Nom_Ven, Cod_Art, Nom_Art, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Ven, Nom_Ven, Cod_Art, Nom_Art, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gVendedorArticulos", laDatosReporte)
            ...
            Me.crvrMargen_gVendedorArticulos.ReportSource = loObjetoReporte

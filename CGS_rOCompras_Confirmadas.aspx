<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rOCompras_Confirmadas.aspx.vb" Inherits="CGS_rOCompras_Confirmadas" %>
...
<head runat="server">
    <title>Listado de Órdenes de Compras Confirmadas (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOCompras_Confirmadas" runat="server" AutoDataBind="true"

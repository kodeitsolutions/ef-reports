<%@ page language="VB" autoeventwireup="false" CodeFile="rCronograma_Requerimientos.aspx.vb" inherits="rCronograma_Requerimientos" %>
...
<head runat="server">
    <title>Cronograma de Requerimientos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCronograma_Requerimientos" runat="server" AutoDataBind="true"

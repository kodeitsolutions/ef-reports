<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_Facturados.aspx.vb" Inherits="rArticulos_Facturados" %>
...
<head runat="server">
    <title>Reporte de Artículos Facturados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Facturados" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

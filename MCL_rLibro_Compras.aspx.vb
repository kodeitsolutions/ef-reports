...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "MCL_rLibro_Compras"
'-------------------------------------------------------------------------------------------'
Partial Class MCL_rLibro_Compras
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("               Cuentas_Pagar.Fec_Reg			        AS Fecha_Reg,")
            ...
            loComandoSeleccionar.AppendLine("               CASE WHEN Cuentas_Pagar.Cod_Mon = 'VEB'")
            ...
            loComandoSeleccionar.AppendLine("               CAST(ISNULL(CAST(Cuentas_Pagar.Dis_Imp AS XML).value('(/impuestos/impuesto/base)[1]', 'VARCHAR(MAX)'),0)AS DECIMAL (28,10)) AS Base_Imponible,")
            loComandoSeleccionar.AppendLine("				CAST(ISNULL(CAST(Cuentas_Pagar.Dis_Imp AS XML).value('(/impuestos/impuesto/porcentaje)[1]', 'VARCHAR(MAX)'),0)AS DECIMAL (28,10))	AS Impuesto,")
            loComandoSeleccionar.AppendLine("               CAST(ISNULL(CAST(Cuentas_Pagar.Dis_Imp AS XML).value('(/impuestos/impuesto/monto)[1]', 'VARCHAR(MAX)'),0)AS DECIMAL (28,10)) AS Monto_Imp,")
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN #tmpLibroCompra.Fecha_Doc < '20180820' AND #tmpLibroCompra.Fecha_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (#tmpLibroCompra.Total_Doc/100000)")
            loComandoSeleccionar.AppendLine("            ELSE #tmpLibroCompra.Total_Doc")
            loComandoSeleccionar.AppendLine("       END AS Total_Doc,")
            'loComandoSeleccionar.AppendLine("		#tmpLibroCompra.Total_Doc,")
            loComandoSeleccionar.AppendLine("       CASE WHEN #tmpLibroCompra.Fecha_Doc < '20180820' AND #tmpLibroCompra.Fecha_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (#tmpLibroCompra.Monto_Exento/100000)")
            loComandoSeleccionar.AppendLine("            ELSE #tmpLibroCompra.Monto_Exento")
            loComandoSeleccionar.AppendLine("       END AS Monto_Exento,")
            'loComandoSeleccionar.AppendLine("		#tmpLibroCompra.Monto_Exento,")
            loComandoSeleccionar.AppendLine("       CASE WHEN #tmpLibroCompra.Fecha_Doc < '20180820' AND #tmpLibroCompra.Fecha_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (#tmpLibroCompra.Base_Imponible/100000)")
            loComandoSeleccionar.AppendLine("            ELSE #tmpLibroCompra.Base_Imponible")
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN #tmpLibroCompra.Fecha_Doc < '20180820' AND #tmpLibroCompra.Fecha_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (#tmpLibroCompra.Monto_Imp/100000)")
            loComandoSeleccionar.AppendLine("            ELSE #tmpLibroCompra.Monto_Imp")
            loComandoSeleccionar.AppendLine("       END AS Monto_Imp,")
            'loComandoSeleccionar.AppendLine("		#tmpLibroCompra.Monto_Imp,")
            loComandoSeleccionar.AppendLine("       CASE WHEN #tmpLibroCompra.Fecha_Doc < '20180820' AND #tmpLibroCompra.Fecha_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (#tmpLibroCompra.Base_Imponible2/100000)")
            loComandoSeleccionar.AppendLine("            ELSE #tmpLibroCompra.Base_Imponible2")
            loComandoSeleccionar.AppendLine("       END AS Base_Imponible2,")
            'loComandoSeleccionar.AppendLine("		#tmpLibroCompra.Base_Imponible2,")
            loComandoSeleccionar.AppendLine("		#tmpLibroCompra.Impuesto2,")
            loComandoSeleccionar.AppendLine("       CASE WHEN #tmpLibroCompra.Fecha_Doc < '20180820' AND #tmpLibroCompra.Fecha_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (#tmpLibroCompra.Monto_Imp2/100000)")
            loComandoSeleccionar.AppendLine("            ELSE #tmpLibroCompra.Monto_Imp2")
            loComandoSeleccionar.AppendLine("       END AS Monto_Imp2,")
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN #tmpLibroCompra.Fecha_Doc < '20180820' AND #tmpLibroCompra.Fecha_Reg >= '20180801'")
            loComandoSeleccionar.AppendLine("            THEN (#tmpLibroCompra.Monto_Ret/100000)")
            loComandoSeleccionar.AppendLine("            ELSE #tmpLibroCompra.Monto_Ret")
            loComandoSeleccionar.AppendLine("       END AS Monto_Ret,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("MCL_rLibro_Compras", laDatosReporte)
            ...
            '    Dim lcFileName As String = Me.Server.MapPath("~\Administrativo\Temporales\MCL_rLibro_Compras_" & Guid.NewGuid().ToString("N") & ".xls")
            ...
            '    Me.Response.AppendHeader("content-disposition", "attachment; filename=MCL_rLibro_Compras.xls")
            ...
            Me.crvrMCL_rLibro_Compras.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rCampos_Nomina.aspx.vb" Inherits="TRF_rCampos_Nomina" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvTRF_rCampos_Nomina" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

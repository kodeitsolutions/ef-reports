<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rECuentas_Cajas_Stratos.aspx.vb" Inherits="rECuentas_Cajas_Stratos" %>
...
<head runat="server">
    <title>Reporte de Estado de Cuentas de Cajas (USA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrECuentas_Cajas_Stratos" runat="server" AutoDataBind="true"

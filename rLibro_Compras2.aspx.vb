...
Partial Class rLibro_Compras2
	...
	Try	
			...
			loComandoSeleccionar.AppendLine("			CASE  " )
			loComandoSeleccionar.AppendLine("				WHEN Cuentas_Pagar.Tip_Doc = 'Credito' THEN " )
			loComandoSeleccionar.AppendLine("					Cuentas_Pagar.Mon_Des * -1 " )
			loComandoSeleccionar.AppendLine("				ELSE  " )
			loComandoSeleccionar.AppendLine("					Cuentas_Pagar.Mon_Des " )
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLibro_Compras2", laDatosReporte2)
            
            Me.mTraducirReporte(loObjetoReporte)
            
            Me.mFormatearCamposReporte(loObjetoReporte)
	   
			Me.crvrLibro_Compras2.ReportSource = loObjetoReporte

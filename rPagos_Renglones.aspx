<%@ page language="VB" autoeventwireup="false" inherits="rPagos_Renglones" CodeFile="rPagos_Renglones.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Pagos con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPagos_Renglones" runat="server" AutoDataBind="true"

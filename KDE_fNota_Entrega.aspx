<%@ page language="VB" autoeventwireup="false" inherits="KDE_fNota_Entrega" CodeFile="KDE_fNota_Entrega.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Nota de Entrega (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_fNota_Entrega" runat="server" AutoDataBind="true"

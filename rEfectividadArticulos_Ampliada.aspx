<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEfectividadArticulos_Ampliada.aspx.vb" Inherits="rEfectividadArticulos_Ampliada" %>
...
<head runat="server">
    <title>Efectividad por Articulos Ampliada</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEfectividadArticulos_Ampliada" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

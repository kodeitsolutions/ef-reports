...
Partial Class CGS_rStock_LoteAlmacen
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		(CASE WHEN Renglones_Ajustes.Tipo = 'Salida' THEN Operaciones_Lotes.Cantidad ELSE @lnCero END)		AS	CanLte_Sal, ")
            loComandoSeleccionar.AppendLine("		(CASE WHEN Renglones_Ajustes.Tipo = 'Entrada'  THEN Operaciones_Lotes.Cantidad ELSE @lnCero END)	AS	CanLte_Ent, ")
            ...
            loComandoSeleccionar.AppendLine("		CASE WHEN #curTemporal.Lote <> '' ")
            loComandoSeleccionar.AppendLine("			 THEN 'LOTE' ELSE 'NO LOTE' END	        AS Tabla,")
            ...
            loComandoSeleccionar.AppendLine("WHERE Lotes.Exi_Act1 > 0")

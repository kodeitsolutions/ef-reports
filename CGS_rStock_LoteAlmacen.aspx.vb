...
Partial Class CGS_rStock_LoteAlmacen
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("						AND Piezas.Cod_Var  IN ('AINV-NPIEZ', 'NREC-NPIEZ', 'TA-NPIEZ','OTRA-NPIEZ','CPRO-NPIEZ')")
            ...
            loComandoSeleccionar.AppendLine("			 THEN (SELECT Nom_Sec FROM Secciones WHERE Cod_Sec = @lcSec_Desde AND Cod_Dep = @lcDep_Desde)")
            loComandoSeleccionar.AppendLine("			 ELSE '' END				AS Sec_Desde,")
            loComandoSeleccionar.AppendLine("		CASE WHEN @lcSec_Hasta <> 'zzzzzzz'")
            loComandoSeleccionar.AppendLine("			 THEN (SELECT Nom_Sec FROM Secciones WHERE Cod_Sec = @lcSec_Hasta AND Cod_Dep = @lcDep_Hasta)")

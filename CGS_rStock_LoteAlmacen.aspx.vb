...
Partial Class CGS_rStock_LoteAlmacen
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("       AND Renglones_Lotes.Cod_Lot <> ''")
            loComandoSeleccionar.AppendLine("       AND Renglones_Lotes.Cod_Alm = #curTemporal.Cod_Alm)")
            loComandoSeleccionar.AppendLine("   OR (Renglones_Almacenes.Exi_Act1 > 0")
            loComandoSeleccionar.AppendLine("       AND #curTemporal.Lote = ''")
            loComandoSeleccionar.AppendLine("       AND Renglones_Almacenes.Cod_Alm = #curTemporal.Cod_Alm)")
            loComandoSeleccionar.AppendLine("ORDER BY Cod_Alm ASC, Cod_Art ASC, Lote ASC")
            loComandoSeleccionar.AppendLine("")

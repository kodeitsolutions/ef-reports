<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rNRecepcionSP.aspx.vb" Inherits="CGS_rNRecepcionSP" %>
...
<head runat="server">
    <title>Listado de Notas de Recepción (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rNRecepcionSP" runat="server" AutoDataBind="true"

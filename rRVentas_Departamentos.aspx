<%@ page language="VB" autoeventwireup="false" inherits="rRVentas_Departamentos" CodeFile="rRVentas_Departamentos.aspx.vb"  %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas por Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_Departamentos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

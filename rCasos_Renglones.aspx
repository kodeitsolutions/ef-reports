<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCasos_Renglones.aspx.vb" Inherits="rCasos_Renglones" %>
...
<head runat="server">
    <title>Reporte de Casos con sus Renglones</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCasos_Renglones" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_Numeros.aspx.vb" Inherits="rCompras_Numeros" %>
...
<head runat="server">
    <title>Reporte de Compras por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

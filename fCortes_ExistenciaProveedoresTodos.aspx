<%@ page language="VB" autoeventwireup="false" inherits="fCortes_ExistenciaProveedoresTodos" CodeFile="fCortes_ExistenciaProveedoresTodos.aspx.vb" %>
...
<head runat="server">
    <title>Cortes de Existencias por Proveedores de Todos los Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCortes_ExistenciaProveedoresTodos" runat="server" AutoDataBind="true"

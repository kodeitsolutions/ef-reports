<%@ Page Language="VB" AutoEventWireup="false" CodeFile="Ony_rMargen_gClientes.aspx.vb" Inherits="Ony_rMargen_gClientes" %>
...
<head runat="server">
    <title>Margen de Ganancia por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvOny_rMargen_gClientes" runat="server" AutoDataBind="true"

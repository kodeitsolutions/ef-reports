...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFacturas_Numeros"
'-------------------------------------------------------------------------------------------'
Partial Class rFacturas_Numeros 
	...
	Try
            ...
            loConsulta.AppendLine("                THEN 0 ELSE Facturas.Mon_Imp1")
            loConsulta.AppendLine("             END) AS Mon_Imp1, ")
            loConsulta.AppendLine("             (CASE WHEN Facturas.Status = 'Anulado' ")
            loConsulta.AppendLine("                THEN 0 ELSE Facturas.Mon_Net")
            loConsulta.AppendLine("             END) AS Mon_Bru, ")
            loConsulta.AppendLine("             (CASE WHEN Facturas.Status = 'Anulado' ")
            loConsulta.AppendLine("                THEN 0 ELSE Facturas.Mon_Net")
            loConsulta.AppendLine("             END) AS Mon_Net, ")
            loConsulta.AppendLine("             (CASE WHEN Facturas.Status = 'Anulado' ")
            loConsulta.AppendLine("                THEN 0 ELSE Facturas.Mon_Sal")
            ...
            loObjetoReporte	=  cusAplicacion.goReportes.mCargarReporte("rFacturas_Numeros", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrFacturas_Numeros.ReportSource =	 loObjetoReporte	
...
'-------------------------------------------------------------------------------------------'
' RJG: 07/10/13: Se ajustó el layout y se eliminaron tablas redundantes.                    '
'-------------------------------------------------------------------------------------------'

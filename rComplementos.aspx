<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rComplementos.aspx.vb" Inherits="rComplementos" %>
...
<head runat="server">
    <title>Reporte de Complementos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrComplementos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

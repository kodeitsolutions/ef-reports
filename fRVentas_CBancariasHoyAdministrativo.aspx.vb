...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fRVentas_CBancariasHoyAdministrativo"
'-------------------------------------------------------------------------------------------'

Partial Class fRVentas_CBancariasHoyAdministrativo
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Dim lcParametro0Desde	As  String = goServicios.mObtenerCampoFormatoSQL(Now(), goServicios.enuOpcionesRedondeo.KN_FechaInicioDelDia)
		Dim lcParametro0Hasta	As  String = goServicios.mObtenerCampoFormatoSQL(Now(), goServicios.enuOpcionesRedondeo.KN_FechaFinDelDia)
...
'me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            loObjetoReporte	=  cusAplicacion.goFormatos.mCargarInforme("fRVentas_CBancariasHoyAdministrativo", laDatosReporte)
 
            Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfRVentas_CBancariasHoyAdministrativo.ReportSource =	 loObjetoReporte	

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Proveedores.aspx.vb" Inherits="rTipos_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Tipos de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Proveedores" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fReclamos_Sugerecias" CodeFile="fReclamos_Sugerecias.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfReclamos_Sugerecias" runat="server" AutoDataBind="true"

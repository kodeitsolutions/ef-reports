<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Ventas_SID.aspx.vb" Inherits="rLibro_Ventas_SID" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrLibro_Ventas_SID" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ page language="VB" autoeventwireup="false" inherits="rPlanilla_ArcVPagos" CodeFile="rPlanilla_ArcvPagos.aspx.vb" %>
...
<head runat="server">
    <title>Planilla ARCV (Pagos a Proveedores)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrPlanilla_ArcVPagos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

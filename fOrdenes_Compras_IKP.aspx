<%@ Page Language="VB" AutoEventWireup="false" Inherits="fOrdenes_Compras_IKP" CodeFile="fOrdenes_Compras_IKP.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras IKP</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfOrdenes_Compras_IKP" runat="server" AutoDataBind="true"

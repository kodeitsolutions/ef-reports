<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rObtenido_Produccion.aspx.vb" Inherits="MCL_rObtenido_Produccion" %>
...
<head runat="server">
    <title>Listado de Obtenido en Producción [reducido] (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rObtenido_Produccion" runat="server" AutoDataBind="true"

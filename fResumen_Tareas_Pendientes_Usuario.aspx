<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fResumen_Tareas_Pendientes_Usuario.aspx.vb" Inherits="fResumen_Tareas_Pendientes_Usuario" %>
...
<head runat="server">
    <title>Formato de Resumen Tareas Pendientes del Usuario</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfResumen_Tareas_Pendientes_Usuario" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"
                EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False"

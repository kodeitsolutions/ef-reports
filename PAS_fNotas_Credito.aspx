<%@ page language="VB" autoeventwireup="false" inherits="PAS_fNotas_Credito" CodeFile="PAS_fNotas_Credito.aspx.vb" %>
...
<head runat="server">
    <title>Notas de Crédito(PAS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_fNotas_Credito" runat="server" AutoDataBind="true"

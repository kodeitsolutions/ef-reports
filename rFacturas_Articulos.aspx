<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Articulos.aspx.vb" Inherits="rFacturas_Articulos" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Compras_Ingles" CodeFile="fFacturas_Compras_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Facturas de Compras en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Compras_Ingles" runat="server" AutoDataBind="true"

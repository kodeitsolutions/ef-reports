<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRDocumentos_CXP.aspx.vb" Inherits="rRDocumentos_CXP" %>
...
<head runat="server">
    <title>Resumen de Documentos de Cuentas por Pagar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRDocumentos_CXP" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rStock_LoteAlmacen.aspx.vb" Inherits="CGS_rStock_LoteAlmacen" %>
...
<head runat="server">
    <title>Reporte de Stock de Artículos por Almacén (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rStock_LoteAlmacen" runat="server" AutoDataBind="true"

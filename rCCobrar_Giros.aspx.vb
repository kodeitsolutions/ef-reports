...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCCobrar_Giros"
'-------------------------------------------------------------------------------------------'
Partial Class rCCobrar_Giros
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
			...
			loComandoSeleccionar.AppendLine("           AND Cuentas_Cobrar.Cod_Tip		=   'GIRO' ")
			...
			loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("rCCobrar_Giros", laDatosReporte)
			...
			Me.crvrCCobrar_Giros.ReportSource = loObjetoReporte

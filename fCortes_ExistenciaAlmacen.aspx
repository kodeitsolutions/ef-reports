<%@ page language="VB" autoeventwireup="false" inherits="fCortes_ExistenciaAlmacen" CodeFile="fCortes_ExistenciaAlmacen.aspx.vb" %>
...
<head runat="server">
    <title>Corte de Existencias por Almacén Artículo Actual</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCortes_ExistenciaAlmacen" runat="server" AutoDataBind="true"

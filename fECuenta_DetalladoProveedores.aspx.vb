...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fECuenta_DetalladoProveedores"
'-------------------------------------------------------------------------------------------'
Partial Class fECuenta_DetalladoProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           And Proveedores.Cod_Pro = (SELECT Cod_Pro FROM " & cusAplicacion.goFormatos.pcCondicionPrincipal.Split(".")(0).Replace("(", "") & " WHERE " & cusAplicacion.goFormatos.pcCondicionPrincipal & ")")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fECuenta_DetalladoProveedores", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfECuenta_DetalladoProveedores.ReportSource = loObjetoReporte

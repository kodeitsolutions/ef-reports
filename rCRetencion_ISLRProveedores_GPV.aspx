<%@ page language="VB" autoeventwireup="false" inherits="rCRetencion_ISLRProveedores_GPV" CodeFile="rCRetencion_ISLRProveedores_GPV.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCRetencion_ISLRProveedores_GPV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

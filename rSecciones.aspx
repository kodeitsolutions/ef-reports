<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rSecciones.aspx.vb" Inherits="rSecciones" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrSecciones" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="RAL_rCRetencion_ISLRProveedores" CodeFile="RAL_rCRetencion_ISLRProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de ISLR de Proveedores (RAL)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrRAL_rCRetencion_ISLRProveedores" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rGuias_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class rGuias_Articulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" WHERE     Articulos.Cod_Art           =   Renglones_Guias.Cod_Art ")
            loComandoSeleccionar.AppendLine("           AND Guias.Documento         =   Renglones_Guias.Documento ")
            ...
            loComandoSeleccionar.AppendLine("           AND Almacenes.Cod_Alm       =   Renglones_Guias.Cod_Alm ")
            loComandoSeleccionar.AppendLine("           AND Renglones_Guias.Cod_Art BETWEEN " & lcParametro0Desde)
            ...
            loComandoSeleccionar.AppendLine("           AND Guias.Status            In ( " & lcParametro5Desde & " ) ")
            loComandoSeleccionar.AppendLine("           AND Renglones_Guias.Cod_Alm BETWEEN " & lcParametro6Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rGuias_Articulos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrGuias_Articulos.ReportSource = loObjetoReporte

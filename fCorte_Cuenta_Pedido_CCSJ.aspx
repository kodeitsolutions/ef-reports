<%@ page language="VB" autoeventwireup="false" inherits="fCorte_Cuenta_Pedido_CCSJ" CodeFile="fCorte_Cuenta_Pedido_CCSJ.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCorte_Cuenta_Pedido_CCSJ" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="MCL_rProduccion.aspx.vb" Inherits="MCL_rProduccion" %>
...
<head runat="server">
    <title>Listado de Producción [reducido] (MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_rProduccion" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Proveedores_Ingles" CodeFile="fPagos_Proveedores_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Pagos a Proveedores en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Proveedores_Ingles" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReportes_Fecha_Creacion.aspx.vb" Inherits="rReportes_Fecha_Creacion" %>
...
<head runat="server">
    <title>Total Reportes por Fecha de Creación</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReportes_Fecha_Creacion" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rMayor_AnaliticoAux.aspx.vb" Inherits="TRF_rMayor_AnaliticoAux" %>
...
<head runat="server">
    <title>Mayor Analítico de Auxiliares(TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rMayor_AnaliticoAux" runat="server" AutoDataBind="true"

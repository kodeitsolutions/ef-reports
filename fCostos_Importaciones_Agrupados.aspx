<%@ page language="VB" autoeventwireup="false" inherits="fCostos_Importaciones_Agrupados" CodeFile="fCostos_Importaciones_Agrupados.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Costos de Importaciones Agrupados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCostos_Importaciones_Agrupados" runat="server" AutoDataBind="true"

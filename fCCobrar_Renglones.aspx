<%@ page language="VB" autoeventwireup="false" inherits="fCCobrar_Renglones" CodeFile="fCCobrar_Renglones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cuentas por Cobrar con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCCobrar_Renglones" runat="server" AutoDataBind="true"

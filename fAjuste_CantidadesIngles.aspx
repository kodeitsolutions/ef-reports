<%@ page language="VB"  Debug="true" autoeventwireup="false" inherits="fAjuste_CantidadesIngles" CodeFile="fAjuste_CantidadesIngles.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ajuste de Inventario en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAjuste_CantidadesIngles" runat="server" AutoDataBind="true"

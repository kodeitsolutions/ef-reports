<%@ Page Language="VB" AutoEventWireup="false" CodeFile="GCodigo.aspx.vb" Inherits="GCodigo" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvGCodigo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

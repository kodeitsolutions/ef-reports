<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGarantias.aspx.vb" Inherits="rGarantias" %>
...
<head runat="server">
    <title>Reporte de Listado de Garantias  </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGarantias" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

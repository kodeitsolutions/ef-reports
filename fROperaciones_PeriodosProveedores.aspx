<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fROperaciones_PeriodosProveedores.aspx.vb" Inherits="fROperaciones_PeriodosProveedores" %>
...
<head id="Head1" runat="server">
    <title>Reporte de Resumen de Operaciones por Periodos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfROperaciones_PeriodosProveedores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grEstado_CXC.aspx.vb" Inherits="grEstado_CXC" %>
...
<head runat="server">
    <title>Gráfico de Estado de Cuentas por Cobrar</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvgrEstado_CXC" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque01" CodeFile="fPagos_Cheque01.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque01" runat="server" AutoDataBind="true"

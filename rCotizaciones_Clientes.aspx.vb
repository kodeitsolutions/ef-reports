...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCotizaciones_Clientes"
'-------------------------------------------------------------------------------------------'
Partial Class rCotizaciones_Clientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Articulos.Cod_Art       =   Renglones_Cotizaciones.Cod_Art ")
            loComandoSeleccionar.AppendLine("       AND Cotizaciones.Documento	= " & lcParametro0Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCotizaciones_Clientes", laDatosReporte)

            loObjetoReporte.SetParameterValue("Telefono_Empresa_Cliente", goEmpresa.pcTelefonoEmpresa)
            loObjetoReporte.SetParameterValue("Direccion_Empresa_Cliente", goEmpresa.pcDireccionEmpresa)
            loObjetoReporte.SetParameterValue("Rif_Empresa_Cliente", goEmpresa.pcRifEmpresa)
            loObjetoReporte.SetParameterValue("Etiqueta_Nombre_Impuesto", goOpciones.mObtener("TXFNOMIMP", "C"))
            
            loObjetoReporte.SetParameterValue("Pie_Pagina", "www.factorysoft.com.ve          eFactory Administrativo  :  " & _
													goEmpresa.pcCodigo & "  :  " & goUsuario.pcCodigo & "  :  rCotizaciones_Clientes.aspx")
            ...
            Me.crvrCotizaciones_Clientes.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 25/01/13: Codigo inicial, a partir de rCotizaciones_Clientes.						'
'-------------------------------------------------------------------------------------------'

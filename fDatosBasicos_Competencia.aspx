<%@ page language="VB" autoeventwireup="false" inherits="fDatosBasicos_Competencia" CodeFile="fDatosBasicos_Competencia.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Competencia: Datos Básicos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDatosBasicos_Competencia" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_sAlmacen_OnyxTD.aspx.vb" Inherits="rArticulos_sAlmacen_OnyxTD" %>
...
<head runat="server">
    <title>Reporte de Artículos con su Stock por Almacén (OnyxTD)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArticulos_sAlmacen_OnyxTD" runat="server" AutoDataBind="true"

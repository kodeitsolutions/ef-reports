<%@ Page Language="VB" AutoEventWireup="false" Inherits="TRF_fPagos_Cheque" CodeFile="TRF_fPagos_Cheque.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque en Pagos (TRF)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvTRF_fPagos_Cheque" runat="server" AutoDataBind="true"

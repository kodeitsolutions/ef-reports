<%@ page language="VB" autoeventwireup="false" inherits="MCL_fOrdenes_Cheque01" CodeFile="MCL_fOrdenes_Cheque01.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cheque (MERCALUM)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvMCL_fOrdenes_Cheque01" runat="server" AutoDataBind="true"

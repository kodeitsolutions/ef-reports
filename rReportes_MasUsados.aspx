<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReportes_MasUsados.aspx.vb" Inherits="rReportes_MasUsados" %>
...
<head runat="server">
    <title>Listado de Reportes Mas Usados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReportes_MasUsados" runat="server" AutoDataBind="true"

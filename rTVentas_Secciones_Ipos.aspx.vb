...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTVentas_Secciones_Ipos"
'-------------------------------------------------------------------------------------------'
Partial Class rTVentas_Secciones_Ipos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("JOIN   Secciones ON Secciones.Cod_Dep		=   Departamentos.Cod_Dep")
            ...
            loComandoSeleccionar.AppendLine("				  Cod_Sec, ")
            loComandoSeleccionar.AppendLine("                 Nom_Sec, ")
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY Cod_Dep,Cod_Sec, Nom_Sec ")
          ...
          ' Me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTVentas_Secciones_Ipos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTVentas_Secciones_Ipos.ReportSource = loObjetoReporte

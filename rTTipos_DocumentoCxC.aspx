<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTTipos_DocumentoCxC.aspx.vb" Inherits="rTTipos_DocumentoCxC" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTTipos_DocumentoCxC" runat="server" AutoDataBind="true"

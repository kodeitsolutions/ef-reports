<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fOrdenes_Cheque_Mercantil" CodeFile="CSJ_fOrdenes_Cheque_Mercantil.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fOrdenes_Cheque_Mercantil" runat="server" AutoDataBind="true"

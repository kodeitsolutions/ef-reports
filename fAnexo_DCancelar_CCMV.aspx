<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fAnexo_DCancelar_CCMV.aspx.vb" Inherits="fAnexo_DCancelar_CCMV" %>
...
<head runat="server">
    <title>Anexo para Después de Cancelar CCMV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAnexo_DCancelar_CCMV" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fPedidos_Clientes_GPV" CodeFile="fPedidos_Clientes_GPV.aspx.vb" %>
...
<head runat="server">
    <title>Pedidos de Clientes (GPV)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPedidos_Clientes_GPV" runat="server" AutoDataBind="true"

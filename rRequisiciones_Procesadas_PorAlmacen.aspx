<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRequisiciones_Procesadas_PorAlmacen.aspx.vb" Inherits="rRequisiciones_Procesadas_PorAlmacen" %>
...
<head runat="server">
    <title>Número de Requisiciones Procesadas por Almacén</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrRequisiciones_Procesadas_PorAlmacen" runat="server" AutoDataBind="true"

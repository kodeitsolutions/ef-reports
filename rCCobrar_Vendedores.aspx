<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Vendedores.aspx.vb" Inherits="rCCobrar_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Cobrar por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Vendedores" runat="server" AutoDataBind="true"

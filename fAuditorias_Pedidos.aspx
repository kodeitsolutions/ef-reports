<%@ Page Language="VB" AutoEventWireup="false" Inherits="fAuditorias_Pedidos" CodeFile="fAuditorias_Pedidos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Pedidos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfAuditorias_Pedidos" runat="server" AutoDataBind="true"

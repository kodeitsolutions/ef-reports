<%@ page language="VB" autoeventwireup="false" inherits="fMGanancia_Departamentos" CodeFile="fMGanancia_Departamentos.aspx.vb" %>
...
<head runat="server">
    <title>Márgenes de Ganancia por Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfMGanancia_Departamentos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCRetencion_ISLR_PagoProveedores_GPV" CodeFile="fCRetencion_ISLR_PagoProveedores_GPV.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCRetencion_ISLR_PagoProveedores_GPV" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" Inherits="fShipping_Order_TECHNOIP" CodeFile="fShipping_Order_TECHNOIP.aspx.vb" %>
...
<head runat="server">
    <title>Shipping Order (TECHNOIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfShipping_Order_TECHNOIP" runat="server" AutoDataBind="true"

...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fShipping_Order_LIRIO"
'-------------------------------------------------------------------------------------------'
Partial Class fShipping_Order_LIRIO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("           Transportes.Telefonos     AS Tel_Tra, ")
            loConsulta.AppendLine("           Transportes.Contacto      AS Con_Tra, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fShipping_Order_LIRIO", laDatosReporte)
           
            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvfShipping_Order_LIRIO.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' RJG: 08/07/14: Ajustes visuales varios en la interfaz.                                    '
'-------------------------------------------------------------------------------------------'
' RJG: 09/07/14: Ajuste en presentación del código de barras. Se cambió el nombre del       '
'                vendedor por el código, y el código del cliente por nombre en 3 página.    '
'-------------------------------------------------------------------------------------------'
' RJG: 18/07/14: Se eliminó el fondo gris en los cuadros para escritura a mano de la página ' 
'                2 (PickingList).                                                           '
'-------------------------------------------------------------------------------------------'

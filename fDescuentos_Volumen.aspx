<%@ page language="VB" autoeventwireup="false" CodeFile="fDescuentos_Volumen.aspx.vb" inherits="fDescuentos_Volumen" %>
...
<head runat="server">
    <title>Formato de Descuentos por Volumen</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDescuentos_Volumen" runat="server" AutoDataBind="true"

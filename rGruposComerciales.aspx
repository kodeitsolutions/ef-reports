<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGruposComerciales.aspx.vb" Inherits="rGruposComerciales" %>
...
<head runat="server">
    <title>Grupos Comerciales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGruposComerciales" runat="server" AutoDataBind="true"

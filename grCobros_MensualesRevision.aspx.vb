...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "grCobros_MensualesRevision"
'-------------------------------------------------------------------------------------------'
Partial Class grCobros_MensualesRevision
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            ' Tabla base con todas las revisiones, incluyendo la una 'Sin Revisión'
            loComandoSeleccionar.AppendLine("SELECT")
            loComandoSeleccionar.AppendLine("		'' AS Cod_Rev,")
            loComandoSeleccionar.AppendLine("		'Sin Revisión' AS Nom_Rev")
            loComandoSeleccionar.AppendLine("INTO	#tablaRevisiones")
            loComandoSeleccionar.AppendLine("UNION ALL")
            loComandoSeleccionar.AppendLine("SELECT	")
            ...
            ' Tabla base con todas las revisiones y los meses del año
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine("       #tablaRevisiones.Cod_Rev,")
            loComandoSeleccionar.AppendLine(" 		#tablaRevisiones.Nom_Rev,")
            ...
            loComandoSeleccionar.AppendLine(" FROM	#tablaRevisiones")
            loComandoSeleccionar.AppendLine(" CROSS JOIN #tablaFechas")
            loComandoSeleccionar.AppendLine(" ")

            ' Tabla resultado con la informacion de los cobros mensuales por revision (vertical)
            loComandoSeleccionar.AppendLine("SELECT")
            loComandoSeleccionar.AppendLine("		#tablaRevisiones.Cod_Rev,")
            loComandoSeleccionar.AppendLine("		#tablaRevisiones.Nom_Rev,")
            ...
            loComandoSeleccionar.AppendLine("JOIN	#tablaRevisiones ON #tablaRevisiones.Cod_Rev = Cuentas_Cobrar.Cod_Rev")
            ...
            loComandoSeleccionar.AppendLine(" 		AND Cuentas_Cobrar.Cod_Rev BETWEEN " & lcParametro5Desde & " AND " & lcParametro5Hasta)
            loComandoSeleccionar.AppendLine(" 		AND Cobros.Cod_Suc BETWEEN " & lcParametro6Desde & " AND " & lcParametro6Hasta)
            loComandoSeleccionar.AppendLine("GROUP BY #tablaRevisiones.Cod_Rev, #tablaRevisiones.Nom_Rev, DATEPART(YEAR, Cobros.fec_ini), DATEPART(MONTH, Cobros.fec_ini)")
            loComandoSeleccionar.AppendLine(" ")

            ' Tabla resultado con la informacion de los cobros mensuales por sucursal (vertical)
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 		#tablaResVerBase1.Cod_Rev,")
            loComandoSeleccionar.AppendLine(" 		#tablaResVerBase1.Nom_Rev,")
            ...
            loComandoSeleccionar.AppendLine(" UNION ALL")
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 		#tablaResVerBase2.Cod_Rev,")
            loComandoSeleccionar.AppendLine(" 		#tablaResVerBase2.Nom_Rev,")
            loComandoSeleccionar.AppendLine("       CASE")
			...
			loComandoSeleccionar.AppendLine("				CASE  Renglones_Cobros.Tip_Doc")
			loComandoSeleccionar.AppendLine("				WHEN 'Credito' THEN -1")
			loComandoSeleccionar.AppendLine("				WHEN 'Debito' THEN 1")
            ...
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 		#tablaResHorBase1.Cod_Rev,")
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY #tablaResHorBase1.Cod_Rev")
            loComandoSeleccionar.AppendLine(" ")

            ' Tabla resultado final con los montos de los cobros mensuales por sucursal
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine("       CASE WHEN #tablaResVer.Cod_Rev='' THEN 'SIN_REV' ELSE #tablaResVer.Cod_Rev END AS Cod_Rev,")
            loComandoSeleccionar.AppendLine(" 		#tablaResVer.Nom_Rev,")
            ...
            loComandoSeleccionar.AppendLine(" LEFT OUTER JOIN #tablaResHor ON #tablaResVer.Cod_Rev = #tablaResHor.Cod_Rev")
            loComandoSeleccionar.AppendLine(" GROUP BY #tablaResVer.Cod_Rev, #tablaResVer.Nom_Rev, #tablaResVer.Str_Mes, #tablaResVer.Mes, #tablaResVer.Año,")
            ...
            loComandoSeleccionar.AppendLine(" ORDER BY #tablaResVer.Cod_Rev, #tablaResVer.Año, #tablaResVer.Mes")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("grCobros_MensualesRevision", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvgrCobros_MensualesRevision.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' DLC: 02/09/2010: Codigo inicial (replica del reporte grCobros_MensualesSucursal)
'-------------------------------------------------------------------------------------------'
...
'				   agrupar/filtrar por la revisión de la CxC.								'
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Reclamos.aspx.vb" Inherits="rTipos_Reclamos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Reclamos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Reclamos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

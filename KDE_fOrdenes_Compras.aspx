<%@ page language="VB" autoeventwireup="false" inherits="KDE_fOrdenes_Compras" CodeFile="KDE_fOrdenes_Compras.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Compras (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_fOrdenes_Compras" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCasos_Clientes.aspx.vb" Inherits="rCasos_Clientes" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCasos_Clientes" runat="server" AutoDataBind="true"

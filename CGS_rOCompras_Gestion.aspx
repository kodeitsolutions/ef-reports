<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rOCompras_Gestion.aspx.vb" Inherits="CGS_rOCompras_Gestion" %>
...
<head runat="server">
    <title>Listado de Gestión de Órdenes de Compras (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOCompras_Gestion" runat="server" AutoDataBind="true"

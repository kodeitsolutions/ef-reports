<%@ page language="VB" autoeventwireup="false" inherits="fCuentas_Cobrar1_CBT" CodeFile="fCuentas_Cobrar1_CBT.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Cobrar1_CBT" runat="server" AutoDataBind="true"

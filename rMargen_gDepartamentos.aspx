<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gDepartamentos.aspx.vb" Inherits="rMargen_gDepartamentos" %>
...
<head runat="server">
    <title>Margen de Ganancia por Departamento</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gDepartamentos" runat="server" AutoDataBind="true"

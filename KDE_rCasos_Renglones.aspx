<%@ Page Language="VB" AutoEventWireup="false" CodeFile="KDE_rCasos_Renglones.aspx.vb" Inherits="KDE_rCasos_Renglones" %>
...
<head runat="server">
    <title>Listado de Casos con sus Renglones (KDE)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvKDE_rCasos_Renglones" runat="server" AutoDataBind="true"

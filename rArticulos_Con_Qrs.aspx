<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_Con_Qrs" CodeFile="rArticulos_Con_Qrs.aspx.vb" %>
...
<head runat="server">
    <title>Lista de Artículos con Códigos QR</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Con_Qrs" runat="server" AutoDataBind="true"

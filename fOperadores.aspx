<%@ page language="VB" autoeventwireup="false" inherits="fOperadores" CodeFile="fOperadores.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Operadores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOperadores" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Tarjetas" CodeFile="fTipos_Tarjetas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Tarjetas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Tarjetas" runat="server" AutoDataBind="true"

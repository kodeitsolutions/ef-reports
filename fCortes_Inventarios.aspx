<%@ page language="VB" autoeventwireup="false" CodeFile="fCortes_Inventarios.aspx.vb" inherits="fCortes_Inventarios" %>
...
<head runat="server">
    <title>Formato de Cortes de Inventarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCortes_Inventarios" runat="server" AutoDataBind="true"

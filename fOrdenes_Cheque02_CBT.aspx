<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Cheque02_CBT" CodeFile="fOrdenes_Cheque02_CBT.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Cheque02_CBT" runat="server" AutoDataBind="true"

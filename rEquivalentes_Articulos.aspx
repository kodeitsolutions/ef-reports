<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEquivalentes_Articulos.aspx.vb" Inherits="rEquivalentes_Articulos" %>
...
<head runat="server">
    <title>Reporte de Equivalentes de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEquivalentes_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fSeriales_Agrupados" CodeFile="fSeriales_Agrupados.aspx.vb" %>
...
<head runat="server">
    <title>Formato Seriales del Documento</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSeriales_Agrupados" runat="server" AutoDataBind="true"

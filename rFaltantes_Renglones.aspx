<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFaltantes_Renglones.aspx.vb" Inherits="rFaltantes_Renglones" %>
...
<head runat="server">
    <title>Reporte de Faltantes con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFaltantes_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

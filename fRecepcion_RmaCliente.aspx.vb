...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fRecepcion_RmaCliente"
'-------------------------------------------------------------------------------------------'
Partial Class fRecepcion_RmaCliente
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("            (CASE WHEN (Rma.Nom_Reg = '') ")
            ...
            loConsulta.AppendLine("        ON  Rma.Cod_Reg    =   Clientes.Cod_Cli")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fRecepcion_RmaCliente", laDatosReporte)
			lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".",",")
            ...
            Me.crvfRecepcion_RmaCliente.ReportSource = loObjetoReporte

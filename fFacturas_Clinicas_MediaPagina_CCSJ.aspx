<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Clinicas_MediaPagina_CCSJ" CodeFile="fFacturas_Clinicas_MediaPagina_CCSJ.aspx.vb" %>
...
<head runat="server">
    <title>Facturas Clínicas Media Pagina</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Clinicas_MediaPagina_CCSJ" runat="server" AutoDataBind="true"

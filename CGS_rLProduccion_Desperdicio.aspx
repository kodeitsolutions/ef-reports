<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rLProduccion_Desperdicio.aspx.vb" Inherits="CGS_rLProduccion_Desperdicio" %>
...
<head runat="server">
    <title>Reporte de verificación de desperdicio por lote</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rLProduccion_Desperdicio" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTrazabilidad_CyT_TipoArticulo.aspx.vb"
    Inherits="rTrazabilidad_CyT_TipoArticulo" %>
...
<head runat="server">
    <title>Trazabilidad de Compras y Traslados por Tipo de Articulo</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTrazabilidad_CyT_TipoArticulo" runat="server" AutoDataBind="true"

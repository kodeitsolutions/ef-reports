<%@ page language="VB" autoeventwireup="false" inherits="fProposiciones_Ventas_FSV1" CodeFile="fProposiciones_Ventas_FSV1.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Proposicion FSV</title>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="crvfProposiciones_Ventas_FSV1" runat="server" AutoDataBind="true"

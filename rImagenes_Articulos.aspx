<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rImagenes_Articulos.aspx.vb" Inherits="rImagenes_Articulos" %>
...
<head runat="server">
    <title>Listado de Imágenes de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrImagenes_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

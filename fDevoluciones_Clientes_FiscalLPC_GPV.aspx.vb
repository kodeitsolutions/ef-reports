...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fDevoluciones_Clientes_FiscalLPC_GPV"
'-------------------------------------------------------------------------------------------'
Partial Class fDevoluciones_Clientes_FiscalLPC_GPV
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		    LEFT(RTRIM(Renglones_DClientes.Cod_Art) +  ' - ' + ")
            loConsulta.AppendLine("		    (CASE WHEN Renglones_DClientes.Notas > '' ")        
            loConsulta.AppendLine("		        THEN Renglones_DClientes.Notas ")               
            ...
            loConsulta.AppendLine("         COALESCE(Facturas.Fiscal4, '20000101 00:00:00.000')     AS Factura_Fiscal4, ")
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' RJG: 15/10/15: Codigo inicial, a partir de fDevoluciones_Clientes_FiscalLPC.              '
'-------------------------------------------------------------------------------------------'

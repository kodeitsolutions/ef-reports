<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_FiscalLPC_GPV" CodeFile="fFacturas_Ventas_FiscalLPC_GPV.aspx.vb" %>
...
<head runat="server">
    <title>Factura de Venta Fiscal LPC - GPV</title>

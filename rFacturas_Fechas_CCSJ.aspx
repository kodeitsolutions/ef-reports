<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Fechas_CCSJ.aspx.vb"
    Inherits="rFacturas_Fechas_CCSJ" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrFacturas_Fechas_CCSJ" runat="server" AutoDataBind="true"

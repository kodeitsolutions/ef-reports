<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArchivoTXT_PagosBANESCO.aspx.vb" Inherits="rArchivoTXT_PagosBANESCO" %>
...
<head runat="server">
    <title>Transferencias de Pagos y Órdenes de Pago BANESCO (TXT)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArchivoTXT_PagosBANESCO" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

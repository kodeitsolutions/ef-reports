<%@ Page Language="VB" AutoEventWireup="false" Inherits="fCotizaciones_Clientes_IKP"
    CodeFile="fCotizaciones_Clientes_IKP.aspx.vb" %>
...
<head runat="server">
    <title>Cotizaciones a Clientes (IKP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfCotizaciones_Clientes_IKP" runat="server" AutoDataBind="true"

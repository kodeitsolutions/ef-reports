<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Proveedor.aspx.vb" Inherits="rTVentas_Proveedor" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Proveedor" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

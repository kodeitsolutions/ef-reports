<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Etapas.aspx.vb" Inherits="rTotal_Casos_Etapas" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Etapas" runat="server" AutoDataBind="true"

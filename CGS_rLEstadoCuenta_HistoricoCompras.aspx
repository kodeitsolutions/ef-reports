<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rLEstadoCuenta_HistoricoCompras.aspx.vb" Inherits="CGS_rLEstadoCuenta_HistoricoCompras" %>
...
<head runat="server">
    <title>Analítico de Proveedores (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rLEstadoCuenta_HistoricoCompras" runat="server" AutoDataBind="true"

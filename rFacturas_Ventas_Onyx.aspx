<%@ page language="VB" autoeventwireup="false" inherits="rFacturas_Ventas_Onyx" CodeFile="rFacturas_Ventas_Onyx.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Ventas_Onyx" runat="server" AutoDataBind="true"

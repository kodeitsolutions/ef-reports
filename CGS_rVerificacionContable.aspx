<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rVerificacionContable.aspx.vb" Inherits="CGS_rVerificacionContable" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rVerificacionContable" runat="server" AutoDataBind="true"

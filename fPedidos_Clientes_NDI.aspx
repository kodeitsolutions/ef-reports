<%@ page language="VB" autoeventwireup="false" inherits="fPedidos_Clientes_NDI" CodeFile="fPedidos_Clientes_NDI.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Pedido NDI</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPedidos_Clientes_NDI" runat="server" AutoDataBind="true"

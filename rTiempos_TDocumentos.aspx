<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTiempos_TDocumentos.aspx.vb" Inherits="rTiempos_TDocumentos" %>
...
<head runat="server">
    <title>Listado de Tiempos de Documentos Totalizados por Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTiempos_TDocumentos" runat="server" AutoDataBind="true"

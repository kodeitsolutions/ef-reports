<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Numeros.aspx.vb" Inherits="rLVentas_Numeros" %>
...
<head runat="server">
    <title>Reporte de Formas Libres por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLVentas_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

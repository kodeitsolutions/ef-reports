<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIndices_FinancierosII.aspx.vb" Inherits="rIndices_FinancierosII" %>
...
<head runat="server">
    <title>Reporte de Indices Financieros II</title>
...
<body>
    ...
    <div>            <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <CR:CrystalReportViewer ID="crvrIndices_FinancierosII" runat="server" AutoDataBind="true"

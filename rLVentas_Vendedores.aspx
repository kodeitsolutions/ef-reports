<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLVentas_Vendedores.aspx.vb" Inherits="rLVentas_Vendedores" %>
...
<head id="Head1" runat="server">
    <title>Reporte de Formas Libres por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLVentas_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

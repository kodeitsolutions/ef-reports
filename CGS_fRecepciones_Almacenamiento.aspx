<%@ page language="VB" autoeventwireup="false" inherits="CGS_fRecepciones_Almacenamiento" CodeFile="CGS_fRecepciones_Almacenamiento.aspx.vb" %>
...
<head runat="server">
    <title>Recepción de Almacenaje para Terceros (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fRecepciones_Almacenamiento" runat="server" AutoDataBind="true"

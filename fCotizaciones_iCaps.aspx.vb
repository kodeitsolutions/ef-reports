...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fCotizaciones_iCaps"
'-------------------------------------------------------------------------------------------'
Partial Class fCotizaciones_iCaps
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Renglones_Cotizaciones.Notas AS Nom_Art, ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCotizaciones_iCaps", laDatosReporte)
            ...
            Me.crvfCotizaciones_iCaps.ReportSource = loObjetoReporte

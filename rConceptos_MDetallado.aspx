<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConceptos_MDetallado.aspx.vb" Inherits="rConceptos_MDetallado" %>
...
<head runat="server">
    <title>Listado de Conceptos de Movimientos Detallado</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrConceptos_MDetallado" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBeneficiarios.aspx.vb" Inherits="rBeneficiarios" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBeneficiarios" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_OpcionesUsuario.aspx.vb" Inherits="rAuditorias_OpcionesUsuario" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Opciones y Usuarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_OpcionesUsuario" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

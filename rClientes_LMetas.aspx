<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_LMetas.aspx.vb" Inherits="rClientes_LMetas" %>
...
<head runat="server">
    <title>Reporte de Metas Asignadas de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClientes_LMetas" runat="server" AutoDataBind="true"

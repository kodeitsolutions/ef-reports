<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Mes.aspx.vb" Inherits="rPedidos_Mes" %>
...
<head runat="server">
    <title>Reporte de Total de Pedidos por Cliente Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Mes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

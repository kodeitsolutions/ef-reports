<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Clinicas_CCSJ" CodeFile="fFacturas_Clinicas_CCSJ.aspx.vb" %>
...
<head runat="server">
    <title>Facturas Clínicas (CCSJ)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Clinicas_CCSJ" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Articulos2.aspx.vb" Inherits="rTVentas_Articulos2" %>
...
<head runat="server">
    <title>Reporte de Total Ventas de Articulos por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Articulos2" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

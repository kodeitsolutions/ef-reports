...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "KDE_rResumen_Iva"
'-------------------------------------------------------------------------------------------'
Partial Class KDE_rResumen_Iva
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini > '20180731'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Bas1/100000) ELSE Cuentas_Pagar.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END) AS TotalBaseC,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Pagar.Mon_Imp1/100000) ELSE Cuentas_Pagar.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END) AS TotalImpuestoC")
            loComandoSeleccionar.AppendLine("INTO #tmpBaseC")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
            loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'FACT'")
            loComandoSeleccionar.AppendLine("	AND Fec_Reg BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820'  AND Cuentas_Pagar.Fec_Ini > '20180731'")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            'loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(Mon_Exe),0) AS TotalExentoV")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT Renglones_Facturas.Documento AS Documento,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Facturas.Fec_Ini < '20180820' AND Facturas.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Renglones_Facturas.Mon_Net/100000) ELSE Renglones_Facturas.Mon_Net")
            loComandoSeleccionar.AppendLine("           END) AS TotalVentaNoGravada")
            loComandoSeleccionar.AppendLine("INTO #tmpVentaNoGravada")
            loComandoSeleccionar.AppendLine("FROM Renglones_Facturas")
            loComandoSeleccionar.AppendLine("	JOIN Facturas ON Facturas.Documento = Renglones_Facturas.Documento")
            loComandoSeleccionar.AppendLine("	JOIN Articulos ON Articulos.Cod_Art = Renglones_Facturas.Cod_Art")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY Renglones_Facturas.Documento")
            loComandoSeleccionar.AppendLine("")
            'loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(Mon_Bas1),0) AS BaseVFactura,")
            'loComandoSeleccionar.AppendLine("		COALESCE(SUM(Mon_Imp1),0) AS ImpuestoVFactura")
            'loComandoSeleccionar.AppendLine("INTO #tmpBaseVFactura")
            'loComandoSeleccionar.AppendLine("FROM Cuentas_Cobrar")
            'loComandoSeleccionar.AppendLine("WHERE Cod_Tip = 'FACT'")
            'loComandoSeleccionar.AppendLine("	AND Status <> 'Anulado'")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Bas1/100000)ELSE Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END) AS BaseVFactura,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini > '20180731'")
            ...
            'loComandoSeleccionar.AppendLine("	AND Facturas.Fec_Ini BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            'loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(Mon_Bru)*-1,0) AS BaseVNotaCre,")
            'loComandoSeleccionar.AppendLine("		COALESCE(SUM(Mon_Imp1)*-1,0) AS ImpuestoVNotaCre")
            ...
            loComandoSeleccionar.AppendLine("		COALESCE(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Mon_Imp1/100000) ELSE Mon_Imp1")
            ...
            loComandoSeleccionar.AppendLine("	AND Fec_Ini BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            'loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(Cuentas_Cobrar.Mon_Bru),0) AS TotalRetenidoV")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Cuentas_Cobrar.Mon_Bru/100000) ELSE Cuentas_Cobrar.Mon_Bru")
            ...
            loComandoSeleccionar.AppendLine("		COALESCE(#tmpRetenidoC.TotalRetenidoC,0),")
            ...
            loComandoSeleccionar.AppendLine("       COALESCE((SELECT TotalVentaNoGravada FROM #tmpVentaNoGravada),0) AS TVNoGravada,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("KDE_rResumen_Iva", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrKDE_rResumen_Iva.ReportSource = loObjetoReporte

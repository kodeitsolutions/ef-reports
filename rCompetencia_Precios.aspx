<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompetencia_Precios.aspx.vb" Inherits="rCompetencia_Precios" %>
...
<head runat="server">
    <title>Reporte de Competencia con sus Precios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompetencia_Precios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

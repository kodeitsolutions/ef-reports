<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProveedores_pZona.aspx.vb" Inherits="rProveedores_pZona" %>
...
<head runat="server">
    <title>Reporte de Proveedores por Zona</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProveedores_pZona" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClases_Clientes.aspx.vb" Inherits="rClases_Clientes" %>
...
<head runat="server">
    <title>Reporte de Clases de Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClases_Clientes" runat="server" AutoDataBind="true"

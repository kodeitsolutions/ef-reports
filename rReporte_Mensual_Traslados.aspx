<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReporte_Mensual_Traslados.aspx.vb" Inherits="rReporte_Mensual_Traslados" %>
...
<head runat="server">
    <title>Reporte Mensual de Traslados</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReporte_Mensual_Traslados" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

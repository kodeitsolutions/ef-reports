<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rInventario_Fisico.aspx.vb" Inherits="rInventario_Fisico" %>
...
<head runat="server">
    <title>Planilla de Toma de Inventario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrInventario_Fisico" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOperadores.aspx.vb" Inherits="rOperadores" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOperadores" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "RAL_rLibro_Ventas_Gaceta"
'-------------------------------------------------------------------------------------------'
Partial Class RAL_rLibro_Ventas_Gaceta
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("				0                                                       AS Por_Ret, ")
            ...
            loComandoSeleccionar.AppendLine("						Retenciones_Documentos.Mon_Bas                      AS Base_Ret, ")
            ...
            loComandoSeleccionar.AppendLine("						Cuentas_Cobrar.Por_Imp1                             AS Por_Imp1,")
            loComandoSeleccionar.AppendLine("						Cuentas_Cobrar.Mon_Imp1                             AS Mon_Imp1,")
            loComandoSeleccionar.AppendLine("                       Cuentas_Cobrar.Referencia                           AS Com_Ret,")
            loComandoSeleccionar.AppendLine("						Cuentas_Cobrar.Fec_Ini                              AS Fec_Ret,")
            loComandoSeleccionar.AppendLine("						0                                                   AS Base_Ret,")
            loComandoSeleccionar.AppendLine("						0                                                   AS Por_Ret,")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("RAL_rLibro_Ventas_Gaceta", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvRAL_rLibro_Ventas_Gaceta.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Ventas_USA.aspx.vb" Inherits="rLibro_Ventas_USA" %>
...
<head runat="server">
    <title>Libro de Ventas (USA)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLibro_Ventas_USA" runat="server" AutoDataBind="true"

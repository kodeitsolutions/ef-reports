<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grVentas_MensualesMonto.aspx.vb" Inherits="grVentas_MensualesMonto" %>
...
<head runat="server">
    <title>Gráfico de Ventas Mensuales en Montos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrVentas_MensualesMonto" runat="server" AutoDataBind="true"

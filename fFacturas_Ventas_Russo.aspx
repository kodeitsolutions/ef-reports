<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Russo" CodeFile="fFacturas_Ventas_Russo.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas(Russo)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Russo" runat="server" AutoDataBind="true"

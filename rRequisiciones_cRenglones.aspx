<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRequisiciones_cRenglones.aspx.vb" Inherits="rRequisiciones_cRenglones" %>
...
<head runat="server">
    <title>Reporte de Requisiciones con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRequisiciones_cRenglones" runat="server" AutoDataBind="true"

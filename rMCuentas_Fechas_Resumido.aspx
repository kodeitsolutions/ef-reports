<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMCuentas_Fechas_Resumido.aspx.vb" Inherits="rMCuentas_Fechas_Resumido" %>
...
<head runat="server">
    <title>Reporte de Movimientos de Cuentas Bancarias por Fechas Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMCuentas_Fechas_Resumido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="CSJ_fOrdenes_Cheque_Banesco" CodeFile="CSJ_fOrdenes_Cheque_Banesco.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCSJ_fOrdenes_Cheque_Banesco" runat="server" AutoDataBind="true"

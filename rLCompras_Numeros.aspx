<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLCompras_Numeros.aspx.vb" Inherits="rLCompras_Numeros" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de Compras por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLCompras_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

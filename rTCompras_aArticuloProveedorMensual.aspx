<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTCompras_aArticuloProveedorMensual.aspx.vb" Inherits="rTCompras_aArticuloProveedorMensual" %>
...
<head runat="server">
    <title>Reporte de Compras Agrupadas por Artículo y Proveedor Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTCompras_aArticuloProveedorMensual" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fProposiciones_Prospectos_Ingles" CodeFile="fProposiciones_Prospectos_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Proposiciones a Prospectos en Inglés</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfProposiciones_Prospectos_Ingles" runat="server" AutoDataBind="true"

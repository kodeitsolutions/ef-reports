<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_Zero" CodeFile="fFacturas_Ventas_Zero.aspx.vb" %>
...
<head runat="server">
    <title>Facturas de Ventas Zero</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_Zero" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="CGS_rCRetencion_IVAProveedores" 
CodeFile="CGS_rCRetencion_IVAProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Retención de IVA de Proveedores (CEGASA)</title>

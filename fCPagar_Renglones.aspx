<%@ page language="VB" autoeventwireup="false" CodeFile="fCPagar_Renglones.aspx.vb" inherits="fCPagar_Renglones" %>
...
<head runat="server">
    <title>Formato de Cuentas por Pagar con sus renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCPagar_Renglones" runat="server" AutoDataBind="true"

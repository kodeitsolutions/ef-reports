<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTop10_Articulos.aspx.vb" Inherits="rTop10_Articulos" %>
...
<head runat="server">
    <title>Reporte de Top 10 Articulos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTop10_Articulos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

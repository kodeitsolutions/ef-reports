...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTVentas_Articulos_Ipos"
'-------------------------------------------------------------------------------------------'
Partial Class rTVentas_Articulos_Ipos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY Cod_Art, Nom_Art, Cod_Uni ")
           ...
           ' Me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTVentas_Articulos_Ipos", laDatosReporte)

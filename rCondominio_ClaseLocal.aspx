<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCondominio_ClaseLocal.aspx.vb" Inherits="rCondominio_ClaseLocal" %>
...
<head runat="server">
    <title>Listado de Condominio por Clase de Local</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCondominio_ClaseLocal" runat="server" AutoDataBind="true"

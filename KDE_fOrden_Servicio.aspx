<%@ page language="VB" autoeventwireup="false" inherits="KDE_fOrden_Servicio" CodeFile="KDE_fOrden_Servicio.aspx.vb" %>
...
<head runat="server">
    <title>Orden de Servicio (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_fOrden_Servicio" runat="server" AutoDataBind="true"

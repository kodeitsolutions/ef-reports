<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDocumentos_Vendedores.aspx.vb" Inherits="rDocumentos_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Total Documentos por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDocumentos_Vendedores" runat="server" AutoDataBind="true"

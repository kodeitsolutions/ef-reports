<%@ page language="VB" autoeventwireup="false" inherits="fPresupuestos_Proveedores_Ingles" CodeFile="fPresupuestos_Proveedores_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Presupuestos de Proveedores en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPresupuestos_Proveedores_Ingles" runat="server" AutoDataBind="true"

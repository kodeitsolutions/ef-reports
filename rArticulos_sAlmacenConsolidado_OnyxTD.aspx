<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_sAlmacenConsolidado_OnyxTD.aspx.vb"
    Inherits="rArticulos_sAlmacenConsolidado_OnyxTD" %>
...
<head runat="server">
    <title>Reporte de Artículos con su Stock por Almacén Consolidado (ONYXTD)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrArticulos_sAlmacenConsolidado_OnyxTD" runat="server"
                AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False"
                HasCrystalLogo="False" DisplayGroupTree="False" HasPrintButton="False" />
            ...
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    ...
                    <vis3Controles:pnlMensajeModal ID="PnlMensajeModal" runat="server" pcEstiloContenido="ContenidoMensajeModal"
                        ...
                        poAlto="400px" poAncho="750px" poArriba="20%" poIzquierda="30%" Style="left: -24px;
                        top: 61px" />

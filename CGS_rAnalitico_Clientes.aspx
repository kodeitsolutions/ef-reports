<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rAnalitico_Clientes.aspx.vb" Inherits="CGS_rAnalitico_Clientes" %>
...
<head runat="server">
    <title>Analítico de Clientes (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rAnalitico_Clientes" runat="server" AutoDataBind="true"

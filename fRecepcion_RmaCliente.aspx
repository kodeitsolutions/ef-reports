<%@ page language="VB" autoeventwireup="false" inherits="fRecepcion_RmaCliente" CodeFile="fRecepcion_RmaCliente.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Recepción de RMA de Cliente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfRecepcion_RmaCliente" runat="server" AutoDataBind="true"

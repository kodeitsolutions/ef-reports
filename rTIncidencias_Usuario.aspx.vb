...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTIncidencias_Usuario"
'-------------------------------------------------------------------------------------------'
Partial Class rTIncidencias_Usuario
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    (CASE WHEN Cod_Usu = '' THEN 'Vacio' ELSE Cod_Usu END)    AS  Cod_Usu, ")
            ...
            loComandoSeleccionar.AppendLine(" SELECT    Cod_Usu                 AS  Cod_Usu, ")
            loComandoSeleccionar.AppendLine("           SUM(Can_Opc)            AS  Can_Opc, ")
            loComandoSeleccionar.AppendLine("           SUM(Can_Err)            AS  Can_Err, ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTIncidencias_Usuario", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTIncidencias_Usuario.ReportSource = loObjetoReporte

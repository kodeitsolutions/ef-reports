<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Cheque_BOD_GPV" CodeFile="fPagos_Cheque_BOD_GPV.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Cheque_BOD_GPV" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rVentas_Articulos_MONO.aspx.vb" Inherits="CGS_rVentas_Articulos_MONO" %>
...
<head runat="server">
    <title>Listado Contable de Ventas por Artículos [MONOESPACIO] (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rVentas_Articulos_MONO" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class rCotizaciones_vMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			lcComandoSeleccionar.AppendLine(" SELECT	SUBSTRING(vendedores.nom_ven,0,30) as nom_vendedor, ")
			...
			lcComandoSeleccionar.AppendLine("from renglones_cotizaciones, cotizaciones, articulos, vendedores, departamentos ")
			...
			lcComandoSeleccionar.AppendLine("select		nom_vendedor,	")
			...
			'lcComandoSeleccionar.AppendLine("ORDER BY   nom_vendedor ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCotizaciones_vMes", laDatosReporte)
            ...
            Me.crvrCotizaciones_vMes.ReportSource = loObjetoReporte

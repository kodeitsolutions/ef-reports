<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Ventas_TECHNOIP" CodeFile="fFacturas_Ventas_TECHNOIP.aspx.vb" %>
...
<head runat="server">
    <title>Packing List (TECHNOIP)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Ventas_TECHNOIP" runat="server" AutoDataBind="true"

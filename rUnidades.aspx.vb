...
Partial Class rUnidades
	...
	Try	
            ...
            loComandoSeleccionar.AppendLine("           Nom_Uni, ")
            loComandoSeleccionar.AppendLine("           Status, ")
            loComandoSeleccionar.AppendLine("           (Case When Status = 'A' Then 'Activo' Else 'Inactivo' End) as Status_Unidades ")
            ...
            'loComandoSeleccionar.AppendLine("ORDER BY Cod_Uni, ")
            'loComandoSeleccionar.AppendLine("           Nom_Uni ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rUnidades", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrUnidades.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="CGS_fRequisiciones_Internas_Auto" CodeFile="CGS_fRequisiciones_Internas_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Requisiciones Internas Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fRequisiciones_Internas_Auto" runat="server" AutoDataBind="true"

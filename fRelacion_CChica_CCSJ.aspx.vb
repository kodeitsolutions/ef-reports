...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fRelacion_CChica_CCSJ"
'-------------------------------------------------------------------------------------------'
Partial Class fRelacion_CChica_CCSJ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("            CASE WHEN Renglones_oPagos.Comentario = '' THEN Conceptos.Nom_Con ")
            loComandoSeleccionar.AppendLine("               ELSE Renglones_oPagos.Comentario END            AS  Comentario,")
            ...
            loComandoSeleccionar.AppendLine("            0.00                                               AS  Numerico1 ")
            ...
            loComandoSeleccionar.AppendLine("          Cajas.Numerico1 AS  Numerico1")
            loComandoSeleccionar.AppendLine("INTO      #tmpTiposPagos6")
            loComandoSeleccionar.AppendLine("FROM      #tmpTiposPagos5 LEFT JOIN Cajas ")
            loComandoSeleccionar.AppendLine("          ON  #tmpTiposPagos5.Cod_Caj =   Cajas.Cod_Caj ")
      ...
      vis3Controles.wbcAdministradorMensajeModal.enumTipoMensaje.KN_Informacion, _
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fRelacion_CChica_CCSJ", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfRelacion_CChica_CCSJ.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOProduccion_Fechas.aspx.vb" Inherits="rOProduccion_Fechas" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Producción por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOProduccion_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

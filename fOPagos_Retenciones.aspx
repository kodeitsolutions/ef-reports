<%@ page language="VB" autoeventwireup="false" inherits="fOPagos_Retenciones" CodeFile="fOPagos_Retenciones.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOPagos_Retenciones" runat="server" AutoDataBind="true"

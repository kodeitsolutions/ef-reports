<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCCobrar_Renglones.aspx.vb" Inherits="rCCobrar_Renglones" %>
...
<head runat="server">
    <title>Reporte de Documentos de Cuentas por Cobrar con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCCobrar_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

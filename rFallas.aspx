<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFallas.aspx.vb" Inherits="rFallas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFallas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

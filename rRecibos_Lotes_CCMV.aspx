<%@ page language="VB" autoeventwireup="false" inherits="rRecibos_Lotes_CCMV" CodeFile="rRecibos_Lotes_CCMV.aspx.vb" %>
...
<head runat="server">
    <title>Cuenta por Cobrar CCMV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRecibos_Lotes_CCMV" runat="server" AutoDataBind="true"

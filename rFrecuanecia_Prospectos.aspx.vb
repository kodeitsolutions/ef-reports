...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFrecuanecia_Prospectos"
'-------------------------------------------------------------------------------------------'
Partial Class rFrecuanecia_Prospectos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" JOIN Prospectos ON (Prospectos.Cod_Pro = Frecuencias.Cod_Reg) AND ('Prospectos' = Frecuencias.origen) AND (Frecuencias.Adicional = 'Prospectos') AND (Prospectos.origen = 'Prospectos') ")
            loComandoSeleccionar.AppendLine(" WHERE     Prospectos.Cod_Pro	Between " & lcParametro0Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFrecuanecia_Prospectos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFrecuanecia_Prospectos.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "RAL_rLibro_Compras"
'-------------------------------------------------------------------------------------------'
Partial Class RAL_rLibro_Compras
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("			CASE WHEN Documentos.Cod_Tip = 'N/CR'")
            loComandoSeleccionar.AppendLine("				 THEN (CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Ini >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("				 ELSE (CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820'")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("RAL_rLibro_Compras", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRAL_rLibro_Compras.ReportSource = loObjetoReporte

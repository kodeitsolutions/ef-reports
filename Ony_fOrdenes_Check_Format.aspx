<%@ page language="VB" autoeventwireup="false" inherits="Ony_fOrdenes_Check_Format" CodeFile="Ony_fOrdenes_Check_Format.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvOny_fOrdenes_Check_Format" runat="server" AutoDataBind="true"

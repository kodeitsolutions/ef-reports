<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCompras_Articulos_ADM.aspx.vb" Inherits="CGS_rCompras_Articulos_ADM" %>
...
<head runat="server">
    <title>Listado Admisnistrativo de Compras por Artículos (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rCompras_Articulos_ADM" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

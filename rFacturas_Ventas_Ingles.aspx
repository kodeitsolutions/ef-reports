<%@ page language="VB" autoeventwireup="false" inherits="rFacturas_Ventas_Ingles" CodeFile="rFacturas_Ventas_Ingles.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Ventas_Ingles" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="KDE_fCotizaciones_Clientes" CodeFile="KDE_fCotizaciones_Clientes.aspx.vb" %>
...
<head runat="server">
    <title>Cotizaciones a Clientes (KDE)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvKDE_fCotizaciones_Clientes" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fClases_Articulos" CodeFile="fClases_Articulos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Clases de Artículos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfClases_Articulos" runat="server" AutoDataBind="true"

...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFacturas_Ventas_Onyx_Ingles"
'-------------------------------------------------------------------------------------------'
Partial Class rFacturas_Ventas_Onyx_Ingles
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           AND Facturas.Documento = " & lcParametro0Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rFacturas_Ventas_Onyx_Ingles", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrFacturas_Ventas_Onyx_Ingles.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 25/01/13: Codigo inicial, a partir de Ony_fFacturas_Ventas_Ingles.					'
'-------------------------------------------------------------------------------------------'

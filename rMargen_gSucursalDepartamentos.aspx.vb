...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gSucursalDepartamentos"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gSucursalDepartamentos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("							Cod_Dep		CHAR(30),			")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Suc, Nom_Suc, Cod_Dep, Nom_Dep, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Sucursales.Cod_Suc, Sucursales.Nom_Suc, Departamentos.Cod_Dep, Departamentos.Nom_Dep")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Suc, Nom_Suc, Cod_Dep, Nom_Dep, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Cod_Suc, Nom_Suc, Cod_Dep, Nom_Dep")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gSucursalDepartamentos", laDatosReporte)
            ...
            Me.crvrMargen_gSucursalDepartamentos.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' JJD: 11/05/11: Programacion inicial
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTNotasRecepcion_vAñoMes.aspx.vb" Inherits="rTNotasRecepcion_vAñoMes" %>
...
<head runat="server">
    <title>Reporte de Total Notas de recepción por Vendedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTNotasRecepcion_vAñoMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

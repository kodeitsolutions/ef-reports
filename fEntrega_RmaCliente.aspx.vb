...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fEntrega_RmaCliente"
'-------------------------------------------------------------------------------------------'
Partial Class fEntrega_RmaCliente
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fEntrega_RmaCliente", laDatosReporte)
			lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".",",")
            ...
            Me.crvfEntrega_RmaCliente.ReportSource = loObjetoReporte

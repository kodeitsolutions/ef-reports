<%@ Page Language="VB" AutoEventWireup="false" CodeFile="PAS_MCL_rNRecepcion_ProduccionSP.aspx.vb" Inherits="PAS_MCL_rNRecepcion_ProduccionSP" %>
...
<head runat="server">
    <title>Listado de Recepciones de Producción (PAS - MCL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvPAS_MCL_rNRecepcion_ProduccionSP" runat="server" AutoDataBind="true"

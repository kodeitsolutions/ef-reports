<%@ page language="VB" autoeventwireup="false" inherits="rCDiario_TipoOrigen" CodeFile="rCDiario_TipoOrigen.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Agrupados por Tipo de Origen</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_TipoOrigen" runat="server" AutoDataBind="true"

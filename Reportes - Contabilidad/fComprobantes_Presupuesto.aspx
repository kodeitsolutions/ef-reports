<%@ page language="VB" autoeventwireup="false" inherits="fComprobantes_Presupuesto" CodeFile="fComprobantes_Presupuesto.aspx.vb" %>
...
<head runat="server">
    <title>Comprobantes de Presupuesto</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfComprobantes_Presupuesto" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fComprobantes_Diario_Revision" CodeFile="fComprobantes_Diario_Revision.aspx.vb" %>
...
<head runat="server">
    <title>Comprobantes de Diario para Revisión</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfComprobantes_Diario_Revision" runat="server" AutoDataBind="true"

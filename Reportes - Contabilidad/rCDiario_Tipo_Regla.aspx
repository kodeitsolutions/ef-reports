<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCDiario_Tipo_Regla.aspx.vb" Inherits="rCDiario_Tipo_Regla" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Agrupado por Tipo y Regla</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_Tipo_Regla" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

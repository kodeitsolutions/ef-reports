...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCDiario_CentroCosto_CuentaContable"
'-------------------------------------------------------------------------------------------'
Partial Class rCDiario_CentroCosto_CuentaContable
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		Centros_Costos.Cod_Cen				AS Cod_Cen,")
            ...
            loComandoSeleccionar.AppendLine("			GROUP BY Documento, Cod_Cue, Cod_Cen ")
            ...
            loComandoSeleccionar.AppendLine("	JOIN	Centros_Costos ON Centros_Costos.Cod_Cen = RC.Cod_Cen")
            loComandoSeleccionar.AppendLine("	JOIN	Cuentas_Contables ON Cuentas_Contables.Cod_Cue = RC.Cod_Cue   ")
            loComandoSeleccionar.AppendLine("GROUP BY	Centros_Costos.Cod_Cen, Centros_Costos.Nom_Cen, ")
        ...
        '-------------------------------------------------------------------------------------------------------
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCDiario_CentroCosto_CuentaContable", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCDiario_CentroCosto_CuentaContable.ReportSource = loObjetoReporte

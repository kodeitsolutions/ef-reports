<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCuentas_Contables2.aspx.vb" Inherits="rCuentas_Contables2" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCuentas_Contables2" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rReglas_Integracion.aspx.vb" Inherits="rReglas_Integracion" %>
...
<head runat="server">
    <title>Reporte de Reglas de Integración</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrReglas_Integracion" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCuentas_Gastos.aspx.vb" Inherits="rCuentas_Gastos" %>
...
<head runat="server">
    <title>Reporte de Cuentas de Gastos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCuentas_Gastos" runat="server" AutoDataBind="true"

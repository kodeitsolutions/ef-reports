<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_Tipo_Origen" CodeFile="fCDiario_Tipo_Origen.aspx.vb" %>
...
<head runat="server">
    <title>Comprobantes de Diario Agrupados por Tipo de Origen</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_Tipo_Origen" runat="server" AutoDataBind="true"

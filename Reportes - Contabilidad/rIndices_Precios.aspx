<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIndices_Precios.aspx.vb" Inherits="rIndices_Precios" %>
...
<head runat="server">
    <title>Reporte de Indices de Precios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrIndices_Precios" runat="server" AutoDataBind="true"

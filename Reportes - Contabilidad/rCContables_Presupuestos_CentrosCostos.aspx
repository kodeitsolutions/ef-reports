<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCContables_Presupuestos_CentrosCostos.aspx.vb" Inherits="rCContables_Presupuestos_CentrosCostos" %>
...
<head runat="server">
    <title>Listado de Cuentas Contables con su Presupuesto por Centro de Costos</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCContables_Presupuestos_CentrosCostos" runat="server" AutoDataBind="true"

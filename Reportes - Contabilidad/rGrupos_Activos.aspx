<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGrupos_Activos.aspx.vb" Inherits="rGrupos_Activos" %>
...
<head runat="server">
    <title>Reporte de Grupos de Activos</title>
...
<body>
    ...
    <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <CR:CrystalReportViewer ID="crvrGrupos_Activos" runat="server" AutoDataBind="true"

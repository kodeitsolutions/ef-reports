<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_UsuariosFechas.aspx.vb" Inherits="rAuditorias_UsuariosFechas" %>
...
<head runat="server">
    <title>Auditorias por Usuarios por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_UsuariosFechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

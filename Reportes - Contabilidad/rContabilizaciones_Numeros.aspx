<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rContabilizaciones_Numeros.aspx.vb" Inherits="rContabilizaciones_Numeros" %>
...
<head runat="server">
    <title>Listado de Contabilizaciones por Número</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrContabilizaciones_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rActivos_Fijos_Ampliado.aspx.vb" Inherits="rActivos_Fijos_Ampliado" %>
...
<head runat="server">
    <title>Reporte de Activos Fijos Ampliado</title>
...
<body>
    ...
    <div>
      <asp:ScriptManager ID="ScriptManager1" runat="server">
        ...
        <CR:CrystalReportViewer ID="crvrActivos_Fijos_Ampliado" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEGanancias_Perdidas_Detalle.aspx.vb" Inherits="rEGanancias_Perdidas_Detalle" %>
...
<head runat="server">
    <title>Estado de Ganancias y Pérdidas con Detalle de Saldo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEGanancias_Perdidas_Detalle" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

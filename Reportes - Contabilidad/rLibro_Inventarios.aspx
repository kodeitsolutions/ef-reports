<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Inventarios.aspx.vb"
    Inherits="rLibro_Inventarios" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrLibro_Inventarios" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_General_Mensual.aspx.vb" Inherits="rBalance_General_Mensual" %>
...
<head runat="server">
    <title>Balance General por Meses</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_General_Mensual" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

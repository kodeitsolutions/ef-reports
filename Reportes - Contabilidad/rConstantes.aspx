<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rConstantes.aspx.vb" Inherits="rConstantes" %>
...
<head runat="server">
    <title>Reporte de Constantes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrConstantes" runat="server" AutoDataBind="true"

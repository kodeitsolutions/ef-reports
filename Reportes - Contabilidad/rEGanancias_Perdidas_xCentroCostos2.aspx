<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEGanancias_Perdidas_xCentroCostos2.aspx.vb" Inherits="rEGanancias_Perdidas_xCentroCostos2" %>
...
<head runat="server">
    <title>Estado de Ganancias y Pérdidas por Centros de Costos 2</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEGanancias_Perdidas_xCentroCostos2" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

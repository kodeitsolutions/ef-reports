<%@ page language="VB" autoeventwireup="false" inherits="fFicha_CentrosCostos" CodeFile="fFicha_CentrosCostos.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Centros de Costos </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_CentrosCostos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rComprobantes_fPeriodo" CodeFile="rComprobantes_fPeriodo.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Fuera del Periodo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrComprobantes_fPeriodo" runat="server" AutoDataBind="true"

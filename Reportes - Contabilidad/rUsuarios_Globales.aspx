<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUsuarios_Globales.aspx.vb" Inherits="rUsuarios_Globales" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrUsuarios_Globales" runat="server" AutoDataBind="true"

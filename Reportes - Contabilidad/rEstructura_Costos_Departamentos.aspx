<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEstructura_Costos_Departamentos.aspx.vb" Inherits="rEstructura_Costos_Departamentos" %>
...
<head runat="server">
    <title>Estructura de Costos por Departamentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEstructura_Costos_Departamentos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

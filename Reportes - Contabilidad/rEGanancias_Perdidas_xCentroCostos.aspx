<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEGanancias_Perdidas_xCentroCostos.aspx.vb" Inherits="rEGanancias_Perdidas_xCentroCostos" %>
...
<head runat="server">
    <title>Estado de Ganancias y Pérdidas por Centros de Costos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEGanancias_Perdidas_xCentroCostos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_General.aspx.vb" Inherits="rBalance_General" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_General" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCDiario_CContable.aspx.vb" Inherits="rCDiario_CContable" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Agrupado por Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_CContable" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

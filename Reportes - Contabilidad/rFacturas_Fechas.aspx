<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_Fechas.aspx.vb" Inherits="rFacturas_Fechas" %>
...
<head runat="server">
    <title>Reporte de Facturas por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

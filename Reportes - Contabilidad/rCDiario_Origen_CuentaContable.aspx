<%@ page language="VB" autoeventwireup="false" inherits="rCDiario_Origen_CuentaContable" CodeFile="rCDiario_Origen_CuentaContable.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Agrupados por Origen y Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_Origen_CuentaContable" runat="server" AutoDataBind="true"

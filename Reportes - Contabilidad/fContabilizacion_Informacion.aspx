<%@ page language="VB" autoeventwireup="false" inherits="fContabilizacion_Informacion" CodeFile="fContabilizacion_Informacion.aspx.vb" %>
...
<head runat="server">
    <title> Formato de Contabilización de Información</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfContabilizacion_Informacion" runat="server" AutoDataBind="true"

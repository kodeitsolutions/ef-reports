<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCDiario_RIntegracion.aspx.vb" Inherits="rCDiario_RIntegracion" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Agrupado por Regla de Integración</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_RIntegracion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

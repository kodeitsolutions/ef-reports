<%@ page language="VB" autoeventwireup="false" inherits="rCDiario_Origen" CodeFile="rCDiario_Origen.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_Origen" runat="server" AutoDataBind="true"

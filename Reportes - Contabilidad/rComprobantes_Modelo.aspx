<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rComprobantes_Modelo.aspx.vb" Inherits="rComprobantes_Modelo" %>
...
<head runat="server">
    <title>Listado de Comprobantes Modelo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrComprobantes_Modelo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

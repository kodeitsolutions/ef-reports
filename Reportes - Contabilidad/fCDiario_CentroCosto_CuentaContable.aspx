<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_CentroCosto_CuentaContable" CodeFile="fCDiario_CentroCosto_CuentaContable.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Diario Agrupado por Centro de Costo y Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_CentroCosto_CuentaContable" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUbicacion_Activos_Fijos.aspx.vb" Inherits="rUbicacion_Activos_Fijos" %>
...
<head runat="server">
    <title>Reporte de Activos Fijos por Ubicacion de Activos</title>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="crvrUbicacion_Activos_Fijos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_Comprobacion_Vzla.aspx.vb" Inherits="rBalance_Comprobacion_Vzla" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_Comprobacion_Vzla" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

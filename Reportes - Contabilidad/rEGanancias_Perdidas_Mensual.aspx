<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEGanancias_Perdidas_Mensual.aspx.vb" Inherits="rEGanancias_Perdidas_Mensual" %>
...
<head runat="server">
    <title>Estado de Ganancias y Pérdidas por Meses</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEGanancias_Perdidas_Mensual" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

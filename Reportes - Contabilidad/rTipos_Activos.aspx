<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Activos.aspx.vb" Inherits="rTipos_Activos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Activos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Activos" runat="server" AutoDataBind="true"

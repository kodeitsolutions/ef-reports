<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_CentroCostos" CodeFile="fCDiario_CentroCostos.aspx.vb" %>
...
<head runat="server">
    <title> Formato de Comprobante de Diario Agrupado por Centros de Costos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_CentroCostos" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_Comprobacion_xCentroCostos2.aspx.vb" Inherits="rBalance_Comprobacion_xCentroCostos2" %>
...
<head runat="server">
    <title>Balance de Comprobación por Centros de Costos 2</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_Comprobacion_xCentroCostos2" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

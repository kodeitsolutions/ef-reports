<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCContables_Ampliado.aspx.vb" Inherits="rCContables_Ampliado" %>
...
<head runat="server">
    <title>Reporte de Cuentas Contables</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCContables_Ampliado" runat="server" AutoDataBind="true"

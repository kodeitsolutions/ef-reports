<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_Regla_CuentaContable" CodeFile="fCDiario_Regla_CuentaContable.aspx.vb" %>
...
<head runat="server">
    <title>Comprobantes de Diario Agrupados por Regla y Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_Regla_CuentaContable" runat="server" AutoDataBind="true"

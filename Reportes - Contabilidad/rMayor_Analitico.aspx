<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMayor_Analitico.aspx.vb" Inherits="rMayor_Analitico" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMayor_Analitico" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

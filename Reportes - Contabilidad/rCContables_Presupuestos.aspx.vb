...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCContables_Presupuestos"
'-------------------------------------------------------------------------------------------'
Partial Class rCContables_Presupuestos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        llSoloCuentasDeMovimiento = (lcParametro3Desde.Trim().ToUpper() = "SI")
        llSoloCuentasConPresupuestoAsignado = (lcParametro4Desde.Trim().ToUpper() = "SI")
		...
		Try	
			...
			loConsulta.AppendLine("        AND Metas.Adicional = ''")
			loConsulta.AppendLine("        AND Metas.Clase = 'Presupuesto'")
			loConsulta.AppendLine("		   AND Metas.Tip_Met = 'Cuentas_Contables_Mensualmente'")
            ...
            End If
			loConsulta.AppendLine("ORDER BY    " & lcOrdenamiento & ", Metas.Año, Metas.Mes")
			loConsulta.AppendLine("")
			loConsulta.AppendLine("")
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCContables_Presupuestos", laDatosReporte)
			
			Me.mTraducirReporte(loObjetoReporte)
			            
			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrCContables_Presupuestos.ReportSource = loObjetoReporte

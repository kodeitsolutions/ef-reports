<%@ page language="VB" autoeventwireup="false" inherits="fComprobantes_Diario" CodeFile="fComprobantes_Diario.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfComprobantes_Diario" runat="server" AutoDataBind="true"

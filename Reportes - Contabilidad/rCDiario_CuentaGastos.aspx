<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCDiario_CuentaGastos.aspx.vb" Inherits="rCDiario_CuentaGastos" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Diario Agrupado por Cuentas de Gastos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_CuentaGastos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rBalance_General_Mensual"
'-------------------------------------------------------------------------------------------'
Partial Class rBalance_General_Mensual
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		'Establece las longitudes de todos los niveles
			...
			loComandoSeleccionar.AppendLine("			WHEN Cuentas_Contables.Cod_Cue LIKE @lcActivo THEN 0	")
			loComandoSeleccionar.AppendLine("			WHEN Cuentas_Contables.Cod_Cue LIKE @lcPasivo THEN 1	")
			loComandoSeleccionar.AppendLine("			WHEN Cuentas_Contables.Cod_Cue LIKE @lcCapital THEN 2	")
			loComandoSeleccionar.AppendLine("			ELSE 3									")
			loComandoSeleccionar.AppendLine("		END)													AS Orden_Cuenta") 
			...
			loComandoSeleccionar.AppendLine("WHERE		(	    Cuentas_Contables.Cod_Cue LIKE @lcActivo ")
			loComandoSeleccionar.AppendLine("				OR  Cuentas_Contables.Cod_Cue LIKE @lcPasivo ")
			loComandoSeleccionar.AppendLine("				OR  Cuentas_Contables.Cod_Cue LIKE @lcCapital ")
			loComandoSeleccionar.AppendLine("			)")
			...
			End If
			loComandoSeleccionar.AppendLine("ORDER BY	(CASE														") 
			loComandoSeleccionar.AppendLine("				WHEN Cuentas_Contables.Cod_Cue LIKE @lcActivo THEN 0	") 
			loComandoSeleccionar.AppendLine("				WHEN Cuentas_Contables.Cod_Cue LIKE @lcPasivo THEN 1	") 
			loComandoSeleccionar.AppendLine("				WHEN Cuentas_Contables.Cod_Cue LIKE @lcCapital THEN 2	") 
			loComandoSeleccionar.AppendLine("				ELSE 3													") 
			loComandoSeleccionar.AppendLine("			END),														") 
			loComandoSeleccionar.AppendLine("			" & lcOrdenamiento) 
			loComandoSeleccionar.AppendLine("") 
		...
		'-------------------------------------------------------------------------------------------------------
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rBalance_General_Mensual", laDatosReporte)

			Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrBalance_General_Mensual.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 23/06/15: Codigo inicial, a partir de rBalance_General.						        '
'-------------------------------------------------------------------------------------------' 

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_Comprobacion_2Detalle.aspx.vb" Inherits="rBalance_Comprobacion_2Detalle" %>
...
<head runat="server">
    <title>Balance de Comprobación con Detalle de Saldo</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_Comprobacion_2Detalle" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

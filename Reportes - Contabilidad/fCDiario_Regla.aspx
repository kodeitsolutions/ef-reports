<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_Regla" CodeFile="fCDiario_Regla.aspx.vb" %>
...
<head runat="server">
    <title>Comprobantes de Diario Agrupados por Regla</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_Regla" runat="server" AutoDataBind="true"

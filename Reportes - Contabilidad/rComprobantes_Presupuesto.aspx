<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rComprobantes_Presupuesto.aspx.vb" Inherits="rComprobantes_Presupuesto" %>
...
<head runat="server">
    <title>Listado de Comprobantes Presupuesto</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrComprobantes_Presupuesto" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

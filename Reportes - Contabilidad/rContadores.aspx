<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rContadores.aspx.vb" Inherits="rContadores" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrContadores" runat="server" AutoDataBind="true"

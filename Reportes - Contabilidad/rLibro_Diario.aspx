<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Diario.aspx.vb" Inherits="rLibro_Diario" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLibro_Diario" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="rCDiario_CentroCosto_CuentaContable" CodeFile="rCDiario_CentroCosto_CuentaContable.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Agrupados por Centro de Costo y Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_CentroCosto_CuentaContable" runat="server" AutoDataBind="true"

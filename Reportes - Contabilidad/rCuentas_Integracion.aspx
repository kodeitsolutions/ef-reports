<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCuentas_Integracion.aspx.vb" Inherits="rCuentas_Integracion" %>
...
<head runat="server">
    <title>Reporte de Cuentas de Integración</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCuentas_Integracion" runat="server" AutoDataBind="true"

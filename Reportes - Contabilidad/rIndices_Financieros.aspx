<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rIndices_Financieros.aspx.vb" Inherits="rIndices_Financieros" %>
...
<head runat="server">
    <title>Reporte de Indices Financieros</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrIndices_Financieros" runat="server" AutoDataBind="true"

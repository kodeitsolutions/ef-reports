<%@ page language="VB" autoeventwireup="false" inherits="fComprobantes_Modelo" CodeFile="fComprobantes_Modelo.aspx.vb" %>
...
<head runat="server">
    <title>Comprobantes de Diario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfComprobantes_Modelo" runat="server" AutoDataBind="true"

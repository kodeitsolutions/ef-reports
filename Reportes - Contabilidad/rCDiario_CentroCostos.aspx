<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCDiario_CentroCostos.aspx.vb" Inherits="rCDiario_CentroCostos" %>
...
<head runat="server">
    <title>Reporte de Comprobantes de Diario Agrupado por Centros de Costos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_CentroCostos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

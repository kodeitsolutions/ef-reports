<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rComprobantes_Diario.aspx.vb" Inherits="rComprobantes_Diario" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrComprobantes_Diario" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

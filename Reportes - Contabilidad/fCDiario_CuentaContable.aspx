<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_CuentaContable" CodeFile="fCDiario_CuentaContable.aspx.vb" %>
...
<head runat="server">
    <title> Formato de Comprobante de Diario Agrupado por Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_CuentaContable" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rActivos_Fijos.aspx.vb" Inherits="rActivos_Fijos" %>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="crvrActivos_Fijos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fFicha_Auxiliares" CodeFile="fFicha_Auxiliares.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Auxiliares</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_Auxiliares" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEmpresas.aspx.vb" Inherits="rEmpresas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEmpresas" runat="server" AutoDataBind="true"

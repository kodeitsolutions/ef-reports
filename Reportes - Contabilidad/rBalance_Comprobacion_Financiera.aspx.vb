...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rBalance_Comprobacion_Financiera"													'
'-------------------------------------------------------------------------------------------'
Partial Class rBalance_Comprobacion_Financiera
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT	COALESCE(renglones_ccontables.cod_reg, Cuentas_Contables.cod_cue) as Padre,")
            loComandoSeleccionar.AppendLine("		Cuentas_Contables.*")
            loComandoSeleccionar.AppendLine("INTO #tmpAuxiliar")
            loComandoSeleccionar.AppendLine("FROM Cuentas_Contables")
            loComandoSeleccionar.AppendLine("	LEFT JOIN renglones_ccontables ON  renglones_ccontables.cod_cue=Cuentas_Contables.cod_cue")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT	SUBSTRING(CC.Cod_Cue, 1, @lnLongMaxima)	AS Cod_Cue,")
            loComandoSeleccionar.AppendLine("       SUBSTRING(CC.padre, 1, @lnLongMaxima)	AS Padre,")
            loComandoSeleccionar.AppendLine("		SUBSTRING(CC.padre, 1, CASE WHEN (LEN(RTRIM(CC.padre))>@lnTamaño1 AND @lnNivelMax > 1) THEN @lnTamaño1 ELSE 0 END)	AS Cod_Niv_1,")
            loComandoSeleccionar.AppendLine("		SUBSTRING(CC.padre, 1, CASE WHEN (LEN(RTRIM(CC.padre))>@lnTamaño2 AND @lnNivelMax > 2) THEN @lnTamaño2 ELSE 0 END)	AS Cod_Niv_2,")
            loComandoSeleccionar.AppendLine("		SUBSTRING(CC.padre, 1, CASE WHEN (LEN(RTRIM(CC.padre))>@lnTamaño3 AND @lnNivelMax > 3) THEN @lnTamaño3 ELSE 0 END)	AS Cod_Niv_3,")
            loComandoSeleccionar.AppendLine("		SUBSTRING(CC.padre, 1, CASE WHEN (LEN(RTRIM(CC.padre))>@lnTamaño4 AND @lnNivelMax > 4) THEN @lnTamaño4 ELSE 0 END)	AS Cod_Niv_4,")
            loComandoSeleccionar.AppendLine("		SUBSTRING(CC.padre, 1, CASE WHEN (LEN(RTRIM(CC.padre))>@lnTamaño5 AND @lnNivelMax > 5) THEN @lnTamaño5 ELSE 0 END)	AS Cod_Niv_5,")
            loComandoSeleccionar.AppendLine("		SUBSTRING(CC.padre, 1, CASE WHEN (LEN(RTRIM(CC.padre))>@lnTamaño6 AND @lnNivelMax > 6) THEN @lnTamaño6 ELSE 0 END)	AS Cod_Niv_6,")
            ...
            loComandoSeleccionar.AppendLine("FROM	#tmpAuxiliar AS CC")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY CC.Padre,CC.Cod_Cue ")
            loComandoSeleccionar.AppendLine("")
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT		#tmpMovimientos.Cod_Cue							    AS Cod_Cue,")
            loComandoSeleccionar.AppendLine("			#tmpMovimientos.Padre                               AS Padre, ")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	#tmpMovimientos.Cod_Cue, ")
            loComandoSeleccionar.AppendLine("			#tmpMovimientos.Padre, ")
            ...
            End If
            loComandoSeleccionar.AppendLine("ORDER BY	#tmpMovimientos.padre," & lcOrdenamiento)
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rBalance_Comprobacion_Financiera", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrBalance_Comprobacion_Financiera.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' EAG: 22/09/15: Codigo inicial, a partir Balance de Comprobación 2.									'
'-------------------------------------------------------------------------------------------' 

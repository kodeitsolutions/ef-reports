...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCDiario_Origen_CuentaContable"
'-------------------------------------------------------------------------------------------'
Partial Class rCDiario_Origen_CuentaContable
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("			GROUP BY Documento, Cod_Cue, Tip_Ori, Doc_Ori ")	
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	RC.Tip_Ori, RC.Doc_Ori, ")
        ...
        '-------------------------------------------------------------------------------------------------------
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCDiario_Origen_CuentaContable", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCDiario_Origen_CuentaContable.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMonedas.aspx.vb" Inherits="rMonedas" %>
...
<head runat="server">
    <title>Reporte de Monedas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMonedas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTipos_Documentos.aspx.vb" Inherits="rTipos_Documentos" %>
...
<head runat="server">
    <title>Reporte de Tipos de Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTipos_Documentos" runat="server" AutoDataBind="true"

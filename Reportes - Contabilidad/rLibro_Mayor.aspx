<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLibro_Mayor.aspx.vb" Inherits="rLibro_Mayor" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLibro_Mayor" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

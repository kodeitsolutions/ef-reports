<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rUbicaciones_Activos.aspx.vb" Inherits="rUbicaciones_Activos" %>
...
<head runat="server">
    <title>Reporte de Ubicaciónes de Activos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrUbicaciones_Activos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rResumen_CDiario" CodeFile="rResumen_CDiario.aspx.vb" %>
...
<head runat="server">
    <title>Resumen de Comprobantes de Diario</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrResumen_CDiario" runat="server" AutoDataBind="true"

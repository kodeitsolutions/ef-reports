<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_CResumido.aspx.vb" Inherits="rBalance_CResumido" %>
...
<head runat="server">
    <title>Balance de Comprobación Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_CResumido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

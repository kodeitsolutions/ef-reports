...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rEGanancias_Perdidas_xCentroCostos2"
'-------------------------------------------------------------------------------------------'
Partial Class rEGanancias_Perdidas_xCentroCostos2
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		'Establece las longitudes de todos los niveles
			...
			loConsulta.AppendLine("			RTRIM(#tmpMovimientos.Cod_Cen) ")
			loConsulta.AppendLine("			    + ' - ' + RTRIM(COALESCE(Centros_Costos.Nom_Cen, ''))         AS Nom_Cen,")
			...
			loConsulta.AppendLine("	LEFT JOIN Centros_Costos ON Centros_Costos.Cod_Cen = #tmpMovimientos.Cod_Cen") 
			...
			loConsulta.AppendLine("			#tmpMovimientos.Cod_Cen, ") 
			loConsulta.AppendLine("			#tmpMovimientos.Cod_Cen, ") 
			loConsulta.AppendLine("			COALESCE(Centros_Costos.Nom_Cen, ''), ")
			loConsulta.AppendLine("			#tmpMovimientos.Cod_Niv_1, ") 
			loConsulta.AppendLine("			#tmpMovimientos.Cod_Niv_2, ")
			loConsulta.AppendLine("			#tmpMovimientos.Cod_Niv_3,") 
			loConsulta.AppendLine("			#tmpMovimientos.Cod_Niv_4, ")
		...
		'-------------------------------------------------------------------------------------------------------
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rEGanancias_Perdidas_xCentroCostos2", laDatosReporte)

			Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrEGanancias_Perdidas_xCentroCostos2.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 09/10/14: Codigo inicial, a partir de rEGanancias_Perdidas_xCentroCostos.            '
'-------------------------------------------------------------------------------------------' 

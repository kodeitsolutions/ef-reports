<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_CuentasGastos" CodeFile="fCDiario_CuentasGastos.aspx.vb" %>
...
<head runat="server">
    <title> Formato de Comprobante de Diario Agrupado por Cuentas de Gastos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_CuentasGastos" runat="server" AutoDataBind="true"

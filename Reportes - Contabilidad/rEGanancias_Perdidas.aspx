<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rEGanancias_Perdidas.aspx.vb" Inherits="rEGanancias_Perdidas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrEGanancias_Perdidas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

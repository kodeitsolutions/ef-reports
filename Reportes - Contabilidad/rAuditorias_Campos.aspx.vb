...
Partial Class rAuditorias_Campos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("                            Nom_Usu VARCHAR(100) COLLATE DATABASE_DEFAULT,")
            loConsulta.AppendLine("                            Tipo_Documento VARCHAR(100) COLLATE DATABASE_DEFAULT,")
            loConsulta.AppendLine("                            Documento VARCHAR(30) COLLATE DATABASE_DEFAULT,")
            loConsulta.AppendLine("                            Codigo VARCHAR(30) COLLATE DATABASE_DEFAULT,")
            loConsulta.AppendLine("                            Registro DATETIME,")
            ...
            loConsulta.AppendLine("")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("UPDATE   #tmpDetalles")
            loConsulta.AppendLine("SET      Nom_Usu = U.Nom_Usu")
            loConsulta.AppendLine("FROM     Factory_Global.dbo.Usuarios AS U")
            loConsulta.AppendLine("WHERE    #tmpDetalles.Cod_Usu COLLATE DATABASE_DEFAULT = U.Cod_Usu COLLATE DATABASE_DEFAULT")
            loConsulta.AppendLine("     AND U.Cod_Cli COLLATE DATABASE_DEFAULT = " & goServicios.mObtenerCampoFormatoSQL(goCliente.pcCodigo))
            loConsulta.AppendLine("")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDepreciaciones_Activos.aspx.vb" Inherits="rDepreciaciones_Activos" %>
...
<head runat="server">
    <title>Listado de Depreciaciones de Activos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDepreciaciones_Activos" runat="server" AutoDataBind="true"

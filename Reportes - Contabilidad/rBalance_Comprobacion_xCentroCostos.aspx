<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rBalance_Comprobacion_xCentroCostos.aspx.vb" Inherits="rBalance_Comprobacion_xCentroCostos" %>
...
<head runat="server">
    <title>Balance de Comprobación por Centros de Costos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrBalance_Comprobacion_xCentroCostos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

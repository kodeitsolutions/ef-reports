<%@ page language="VB" autoeventwireup="false" inherits="fFicha_CuentasGastos" CodeFile="fFicha_CuentasGastos.aspx.vb" %>
...
<head runat="server">
    <title>Ficha de Datos de Cuentas de Gastos </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_CuentasGastos" runat="server" AutoDataBind="true"

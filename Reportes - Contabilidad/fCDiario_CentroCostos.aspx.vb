...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fCDiario_CentroCostos"
'-------------------------------------------------------------------------------------------'
Partial Class fCDiario_CentroCostos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
			...
			loComandoSeleccionar.AppendLine("GROUP BY 	Renglones_Comprobantes.Documento,Centros_Costos.Cod_Cen,Centros_Costos.Nom_Cen")
			loComandoSeleccionar.AppendLine("ORDER BY 	Centros_Costos.Cod_Cen, Centros_Costos.Nom_Cen")
			loComandoSeleccionar.AppendLine(" ")
			...
			loComandoSeleccionar.AppendLine(" 		#Temp2.Cod_Cen,")
			loComandoSeleccionar.AppendLine(" 		#Temp2.Nom_Cen")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCDiario_CentroCostos", laDatosReporte)
            ...
            Me.crvfCDiario_CentroCostos.ReportSource = loObjetoReporte

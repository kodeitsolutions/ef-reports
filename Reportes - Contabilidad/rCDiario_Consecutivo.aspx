<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCDiario_Consecutivo.aspx.vb" Inherits="rCDiario_Consecutivo" %>
...
<head runat="server">
    <title>Comprobantes de Diario Consecutivos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_Consecutivo" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

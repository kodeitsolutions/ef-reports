<%@ page language="VB" autoeventwireup="false" inherits="fCDiario_Origen_CuentaContable" CodeFile="fCDiario_Origen_CuentaContable.aspx.vb" %>
...
<head runat="server">
    <title>Comprobantes de Diario Agrupados por Origen y Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCDiario_Origen_CuentaContable" runat="server" AutoDataBind="true"

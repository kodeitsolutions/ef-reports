<%@ page language="VB" autoeventwireup="false" inherits="rCDiario_Regla_CuentaContable" CodeFile="rCDiario_Regla_CuentaContable.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Comprobantes de Diario Agrupados por Regla de Integración y Cuenta Contable</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCDiario_Regla_CuentaContable" runat="server" AutoDataBind="true"

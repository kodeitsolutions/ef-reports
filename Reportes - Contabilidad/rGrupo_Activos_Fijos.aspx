<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGrupo_Activos_Fijos.aspx.vb" Inherits="rGrupo_Activos_Fijos" %>
...
<head runat="server">
    <title>Reporte de Activos Fijos por Grupos de Activos</title>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="crvrGrupo_Activos_Fijos" runat="server" AutoDataBind="true"

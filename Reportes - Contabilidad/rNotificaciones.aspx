<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNotificaciones.aspx.vb" Inherits="rNotificaciones" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNotificaciones" runat="server" AutoDataBind="true"

Imports System.Data
Partial Class rCDiario_Tipo_Regla
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Reglas_Integracion.Nom_Reg As Nom_Reg, ")
            ...
            loComandoSeleccionar.AppendLine(" JOIN Reglas_Integracion ON (Reglas_Integracion.Cod_Reg = Renglones_Comprobantes.Cod_Reg)")
            ...
            loComandoSeleccionar.AppendLine("           And Renglones_Comprobantes.Cod_Cue  Between " & lcParametro3Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro3Hasta)
            loComandoSeleccionar.AppendLine("           And Renglones_Comprobantes.Cod_Reg  Between " & lcParametro4Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro4Hasta)
            loComandoSeleccionar.AppendLine("           And Renglones_Comprobantes.Cod_Tip  Between " & lcParametro5Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro5Hasta)
            loComandoSeleccionar.AppendLine("           And Renglones_Comprobantes.Cod_Aux  Between " & lcParametro6Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro6Hasta)
            loComandoSeleccionar.AppendLine("           And Renglones_Comprobantes.Cod_Gas  Between " & lcParametro7Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro7Hasta)
            loComandoSeleccionar.AppendLine("GROUP BY Renglones_Comprobantes.Tip_Ori,Renglones_Comprobantes.Cod_Reg,Reglas_Integracion.Nom_Reg,Comprobantes.Documento, Comprobantes.Fec_Ini, Comprobantes.Fec_Fin")
            loComandoSeleccionar.AppendLine(" ORDER BY " & lcOrdenamiento & ",Renglones_Comprobantes.Tip_Ori, Renglones_Comprobantes.Cod_Reg  ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCDiario_Tipo_Regla", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrCDiario_Tipo_Regla.ReportSource = loObjetoReporte

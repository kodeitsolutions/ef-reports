<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCuentas_Contables.aspx.vb" Inherits="rCuentas_Contables" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCuentas_Contables" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rReportes_Mes"
'-------------------------------------------------------------------------------------------'
Partial Class rReportes_Mes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("                Case MONTH(Factory_Global.dbo.reportes.Registro) ")
            ...
            loComandoSeleccionar.AppendLine("			WHEN 11 THEN 'NOVIEMBRE'  ")
            loComandoSeleccionar.AppendLine("			WHEN 12 THEN 'DICIEMBRE'  ")
            loComandoSeleccionar.AppendLine("            End,MONTH(Factory_Global.dbo.reportes.Registro)  ")
            loComandoSeleccionar.AppendLine("ORDER BY YEAR(Factory_Global.dbo.reportes.Registro),  ")
            loComandoSeleccionar.AppendLine("            Month(Factory_Global.dbo.reportes.Registro) ")
            ...
            Dim laDatosReporte As DataSet = loServicios.mObtenerTodosSinEsquema(loComandoSeleccionar.ToString, "curReportes_Mes")

            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rReportes_Mes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrReportes_Mes.ReportSource = loObjetoReporte

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rCDiario_Consecutivo"
'-------------------------------------------------------------------------------------------'
Partial Class rCDiario_Consecutivo
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		Try
			...
			loComandoSeleccionar.AppendLine("				PARTITION BY ")
			...
			loComandoSeleccionar.AppendLine("						Renglones_Comprobantes.Tip_Ori ASC,")
			loComandoSeleccionar.AppendLine("						Renglones_Comprobantes.Doc_Ori ASC,")
			loComandoSeleccionar.AppendLine("						CAST(CASE WHEN (Renglones_Comprobantes.Mon_Deb > 0) THEN 0 ELSE 1 END AS CHAR(1)) ASC,")
			loComandoSeleccionar.AppendLine("						RIGHT('0000000000' + CAST(Renglones_Comprobantes.Renglon AS VARCHAR(10)), 10)  ASC")
			loComandoSeleccionar.AppendLine("				) AS Numero_Orden, ")
			...
			loComandoSeleccionar.AppendLine("ORDER BY	Renglones_Comprobantes.Documento ASC,")
			loComandoSeleccionar.AppendLine("			Renglones_Comprobantes.Tip_Ori ASC,")
			loComandoSeleccionar.AppendLine("			Renglones_Comprobantes.Doc_Ori ASC,")
			loComandoSeleccionar.AppendLine("			Debe_Haber ASC,")
			loComandoSeleccionar.AppendLine("			Renglones_Comprobantes.Renglon ASC")
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCDiario_Consecutivo", laDatosReporte)

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMAnalitico_Ampliado.aspx.vb" Inherits="rMAnalitico_Ampliado" %>
...
<head runat="server">
    <title>Mayor Analítico Ampliado</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMAnalitico_Ampliado" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGrupos_Contenido.aspx.vb" Inherits="rGrupos_Contenido" %>
...
<head runat="server">
    <title>Reporte de Grupos de Usuarios con su Contenido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGrupos_Contenido" runat="server" AutoDataBind="true"

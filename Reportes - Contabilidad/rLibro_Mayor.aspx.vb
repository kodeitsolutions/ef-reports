...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLibro_Mayor"
'-------------------------------------------------------------------------------------------'
Partial Class rLibro_Mayor
...
'Dim lcParametro1Desde As String 
'Dim lcParametro1Hasta As String 
'Dim lcParametro2Desde As String 
'Dim lcParametro2Hasta As String 
'Dim lcParametro3Desde As String 
'Dim lcParametro3Hasta As String 
'Dim lcParametro4Desde As String 
'Dim lcParametro4Hasta As String 
'Dim lcParametro5Desde As String 
'Dim lcParametro5Hasta As String 
'Dim lcParametro6Desde As String 
'Dim lcParametro7Desde As String =
'Dim lcParametro8Desde As String =
		...
		Try
			...
			'Dim lcNivelMostrar			As String = goServicios.mObtenerCampoFormatoSQL(cusAplicacion.goReportes.paParametrosIniciales(8))
 			...
 			Dim llMostrarCuentasRaiz As Boolean = CStr(cusAplicacion.goReportes.paParametrosIniciales(9)).Trim().ToUpper().Equals("SI")
		

			Dim ldFechaInicio	As Date		= CDate(cusAplicacion.goReportes.paParametrosIniciales(0))
			Dim lcMesEncabezado	As String	
			Dim lcAñoEncabezado	As String	= goServicios.mObtenerCampoFormatoSQL(ldFechaInicio.Year.ToString()) 'Formato simple: sin separador de miles
			Select Case ldFechaInicio.Month
				Case 1: lcMesEncabezado = "Enero"
				Case 2: lcMesEncabezado = "Febrero"
				Case 3: lcMesEncabezado = "Marzo"
				Case 4: lcMesEncabezado = "Abril"
				Case 5: lcMesEncabezado = "Mayo"
				Case 6: lcMesEncabezado = "Junio"
				Case 7: lcMesEncabezado = "Julio"
				Case 8: lcMesEncabezado = "Agosto"
				Case 9: lcMesEncabezado = "Septiembre"
				Case 10: lcMesEncabezado = "Octubre"
				Case 11: lcMesEncabezado = "Noviembre"
				Case 12: lcMesEncabezado = "Diciembre"
				Case Else : Throw New Exception("La Fecha de Inicio no es Válida: " & goServicios.mObtenerFormatoCadena(ldFechaInicio))
			End Select
			lcMesEncabezado = goServicios.mObtenerCampoFormatoSQL(lcMesEncabezado)
		...
		'Establece las longitudes de todos los niveles
			...
			loComandoSeleccionar.AppendLine("			CAST(" & IIf(llMostrarCuentasRaiz, 1, 0) & " As BIT)				AS MostrarGrupos, ")
			loComandoSeleccionar.AppendLine("			" & lcMesEncabezado & "												AS Mes_Encabezado, ")
			loComandoSeleccionar.AppendLine("			" & lcAñoEncabezado & "												AS Año_Encabezado, ")
			loComandoSeleccionar.AppendLine("			'Mes: ' + " & lcMesEncabezado & " + '   Año: ' + " & lcAñoEncabezado & " AS Mes_Año ")
		...
		'-------------------------------------------------------------------------------------------------------
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLibro_Mayor", laDatosReporte)

			Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrLibro_Mayor.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 27/10/11: Codigo inicial, a partir de Balance General.								'
'-------------------------------------------------------------------------------------------' 

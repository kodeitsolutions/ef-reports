<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCContables_Presupuestos.aspx.vb" Inherits="rCContables_Presupuestos" %>
...
<head runat="server">
    <title>Listado de Cuentas Contables con su Presupuesto</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCContables_Presupuestos" runat="server" AutoDataBind="true"

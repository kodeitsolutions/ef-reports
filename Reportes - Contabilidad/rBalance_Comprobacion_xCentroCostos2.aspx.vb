...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rBalance_Comprobacion_xCentroCostos2"													'
'-------------------------------------------------------------------------------------------'
Partial Class rBalance_Comprobacion_xCentroCostos2
	...
	Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
		...
		'Establece las longitudes de todos los niveles
			...
			loComandoSeleccionar.AppendLine("			RTRIM(#tmpMovimientos.Cod_Cen) ")
			loComandoSeleccionar.AppendLine("			    + ' - ' + RTRIM(COALESCE(Centros_Costos.Nom_Cen, ''))         AS Nom_Cen,")
			...
			loComandoSeleccionar.AppendLine("	LEFT JOIN Centros_Costos ON Centros_Costos.Cod_Cen = #tmpMovimientos.Cod_Cen") 
			...
			loComandoSeleccionar.AppendLine("			COALESCE(Centros_Costos.Nom_Cen, ''), ")
			loComandoSeleccionar.AppendLine("			#tmpMovimientos.Cod_Niv_1, ") 
			loComandoSeleccionar.AppendLine("			#tmpMovimientos.Cod_Niv_2, ")
			loComandoSeleccionar.AppendLine("			#tmpMovimientos.Cod_Niv_3,") 
			loComandoSeleccionar.AppendLine("			#tmpMovimientos.Cod_Niv_4, ")
		...
		'-------------------------------------------------------------------------------------------------------
			...
			loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rBalance_Comprobacion_xCentroCostos2", laDatosReporte)

			Me.mTraducirReporte(loObjetoReporte)

			Me.mFormatearCamposReporte(loObjetoReporte)

			Me.crvrBalance_Comprobacion_xCentroCostos2.ReportSource = loObjetoReporte
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 08/10/14: Codigo inicial, a partir de rBalance_Comprobacion_xCentroCostos.			'
'-------------------------------------------------------------------------------------------' 

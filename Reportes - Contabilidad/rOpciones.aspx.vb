...
Partial Class rOpciones
	...
	Try	
		lcComandoSelect = "SELECT	Cod_Opc, " _
						         & "Nom_Opc, " _
						         & "Status, " _
						         & "(Case When Status = 'A' Then 'Activo' Else 'Inactivo' End) as Status_Opciones " _
				         & "FROM	 Opciones " _
				         & "WHERE Cod_Opc between '" & cusAplicacion.goReportes.paParametrosIniciales(0) & "'" _

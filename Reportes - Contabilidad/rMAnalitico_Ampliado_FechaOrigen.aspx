<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMAnalitico_Ampliado_FechaOrigen.aspx.vb" Inherits="rMAnalitico_Ampliado_FechaOrigen" %>
...
<head runat="server">
    <title>Mayor Analítico Ampliado por Fecha de Origen</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMAnalitico_Ampliado_FechaOrigen" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

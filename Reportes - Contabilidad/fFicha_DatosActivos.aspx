<%@ page language="VB" autoeventwireup="false" inherits="fFicha_DatosActivos" CodeFile="fFicha_DatosActivos.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFicha_DatosActivos" runat="server" AutoDataBind="true"

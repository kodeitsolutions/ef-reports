<%@ page language="VB" autoeventwireup="false" inherits="fPurchase_Drop_Ship" CodeFile="fPurchase_Drop_Ship.aspx.vb" %>
...
<head runat="server">
    <title>Purchase Order Drop Ship (Stratos)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPurchase_Drop_Ship" runat="server" AutoDataBind="true"

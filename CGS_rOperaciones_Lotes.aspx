<%@ page language="VB" autoeventwireup="false" inherits="CGS_rOperaciones_Lotes" CodeFile="CGS_rOperaciones_Lotes.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Operaciones Lotes (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rOperaciones_Lotes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

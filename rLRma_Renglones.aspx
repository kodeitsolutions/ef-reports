<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLRma_Renglones.aspx.vb" Inherits="rLRma_Renglones" %>
...
<head runat="server">
    <title>Reporte de Formas Libres de RMA con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLRma_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

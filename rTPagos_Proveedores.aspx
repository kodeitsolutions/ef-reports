<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTPagos_Proveedores.aspx.vb" Inherits="rTPagos_Proveedores" %>
...
<head runat="server">
    <title>Total Pagos por Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTPagos_Proveedores" runat="server" AutoDataBind="true"

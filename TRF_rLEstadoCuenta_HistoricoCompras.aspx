<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rLEstadoCuenta_HistoricoCompras.aspx.vb" Inherits="TRF_rLEstadoCuenta_HistoricoCompras" %>
...
<head runat="server">
    <title>Analítico de Proveedores (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rLEstadoCuenta_HistoricoCompras" runat="server" AutoDataBind="true"

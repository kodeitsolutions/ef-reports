<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPresupuestos_Vendedores.aspx.vb" Inherits="rPresupuestos_Vendedores" %>
...
<head runat="server">
    <title>Reporte Presupuestos por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPresupuestos_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

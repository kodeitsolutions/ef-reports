<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rVendedores_dGenerales.aspx.vb" Inherits="rVendedores_dGenerales" %>
...
<head runat="server">
    <title>Reporte de Vendedores con sus Datos Generales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrVendedores_dGenerales" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

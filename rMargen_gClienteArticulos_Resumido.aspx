<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gClienteArticulos_Resumido.aspx.vb" Inherits="rMargen_gClienteArticulos_Resumido" %>
...
<head runat="server">
    <title>Margen de Ganancia por Cliente por Artículo Resumido</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gClienteArticulos_Resumido" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFacturas_aMes.aspx.vb" Inherits="rFacturas_aMes" %>
...
<head runat="server">
    <title>Reporte de Total de Facturas por Artículos Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFacturas_aMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

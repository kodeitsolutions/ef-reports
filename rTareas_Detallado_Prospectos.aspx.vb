...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTareas_Detallado_Prospectos"
'-------------------------------------------------------------------------------------------'
Partial Class rTareas_Detallado_Prospectos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" WHERE		Tareas.Origen	=	'Prospectos'")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTareas_Detallado_Prospectos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrTareas_Detallado_Prospectos.ReportSource = loObjetoReporte

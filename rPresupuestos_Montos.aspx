<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPresupuestos_Montos.aspx.vb" Inherits="rPresupuestos_Montos" %>
...
<head runat="server">
    <title>Reporte de Presupuestos con sus Montos</title>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportViewer ID="crvrPresupuestos_Montos" runat="server" AutoDataBind="true" HasCrystalLogo="False" 
            EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" DisplayGroupTree="False" HasPrintButton="False" />

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rNEntregas_Renglones.aspx.vb" Inherits="rNEntregas_Renglones" %>
...
<head runat="server">
    <title>Reporte de las Notas de Entregas con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrNEntregas_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Devoluciones" CodeFile="fTipos_Devoluciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Devoluciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Devoluciones" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCostos_Trabajadores.aspx.vb" Inherits="CGS_rCostos_Trabajadores" %>
...
<head runat="server">
    <title>Histórico de Costos de Trabajadores (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rCostos_Trabajadores" runat="server" AutoDataBind="true"

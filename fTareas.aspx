<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fTareas.aspx.vb" Inherits="fTareas" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTareas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="rPrecios_Almacenes" CodeFile="rPrecios_Almacenes.aspx.vb"  %>
...
<head runat="server">
    <title>Listado de Precios por Departamentos y Almacén</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPrecios_Almacenes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

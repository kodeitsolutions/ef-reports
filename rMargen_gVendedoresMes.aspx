<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gVendedoresMes.aspx.vb" Inherits="rMargen_gVendedoresMes" %>
...
<head runat="server">
    <title>Margen de Ganancia por Vendedores y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gVendedoresMes" runat="server" AutoDataBind="true"

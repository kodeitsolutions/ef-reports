<%@ page language="VB" autoeventwireup="false" inherits="fPagos_Check_Format" CodeFile="fPagos_Check_Format.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPagos_Check_Format" runat="server" AutoDataBind="true"

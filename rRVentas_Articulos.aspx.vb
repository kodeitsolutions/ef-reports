...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rRVentas_Articulos"
'-------------------------------------------------------------------------------------------'
Partial Class rRVentas_Articulos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            '-------------------------------------------------------------------------------------------'
            ' Select de la tabla de Facturas (Ventas)
            '-------------------------------------------------------------------------------------------'
            loComandoSeleccionar.AppendLine(" ")
            ...
            '-------------------------------------------------------------------------------------------'
            ' Select de la tabla de Devoluciones de Clientes (Ventas)
            '-------------------------------------------------------------------------------------------'
            ...
            '-------------------------------------------------------------------------------------------'
            ' Select de la tabla de Compras (Compras)
            '-------------------------------------------------------------------------------------------'
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 		Articulos.Cod_Art,")
            loComandoSeleccionar.AppendLine(" 		Articulos.Nom_Art,")
            ...
            '-------------------------------------------------------------------------------------------'
            ' Select de la tabla de Recepciones (Compras)
            '-------------------------------------------------------------------------------------------'
			loComandoSeleccionar.AppendLine("SELECT")
 			loComandoSeleccionar.AppendLine("		Articulos.Cod_Art,")
 			loComandoSeleccionar.AppendLine("		Articulos.Nom_Art,")
            ...
            '-------------------------------------------------------------------------------------------'
            ' Select de la tabla de Devoluciones de Compra (Compras)
            '-------------------------------------------------------------------------------------------'
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine(" SELECT")
            loComandoSeleccionar.AppendLine(" 		Articulos.Cod_Art,")
            ...
            loComandoSeleccionar.AppendLine(" 		Articulos.Cos_Ult1,")
            loComandoSeleccionar.AppendLine(" 		0 AS Ventas,")
            loComandoSeleccionar.AppendLine(" 		ISNULL(-SUM(Renglones_dProveedores.Can_Art1),0) AS Compras,")
            loComandoSeleccionar.AppendLine("       CAST('' AS VARCHAR(50)) AS  Act_Req,")
            loComandoSeleccionar.AppendLine(" 		Articulos.Exi_Act1,")
            ...
            loComandoSeleccionar.AppendLine(" FROM	Articulos")
            loComandoSeleccionar.AppendLine(" JOIN Renglones_dProveedores ON Articulos.Cod_Art = Renglones_dProveedores.Cod_Art")
            loComandoSeleccionar.AppendLine(" JOIN Devoluciones_Proveedores ON Renglones_dProveedores.Documento = Devoluciones_Proveedores.Documento")
            loComandoSeleccionar.AppendLine(" JOIN Departamentos ON Articulos.Cod_dep = Departamentos.Cod_Dep")
            loComandoSeleccionar.AppendLine(" WHERE	Devoluciones_Proveedores.Fec_Ini BETWEEN @lcFecIni AND @lcFecFin")
            loComandoSeleccionar.AppendLine(" 		AND Articulos.cod_Art BETWEEN " & lcParametro1Desde & " AND " & lcParametro1Hasta)
            loComandoSeleccionar.AppendLine(" 		AND Articulos.Cod_Pro BETWEEN " & lcParametro3Desde & " AND " & lcParametro3Hasta)
            loComandoSeleccionar.AppendLine(" 		AND Departamentos.Cod_Dep BETWEEN " & lcParametro5Desde & " AND " & lcParametro5Hasta)
            loComandoSeleccionar.AppendLine("		AND Devoluciones_Proveedores.Status	IN	('Confirmado', 'Afectado', 'Procesado') ")
            loComandoSeleccionar.AppendLine(" 		AND Devoluciones_Proveedores.Cod_Rev BETWEEN " & lcParametro6Desde & " AND " & lcParametro6Hasta)
            loComandoSeleccionar.AppendLine(" 		AND Devoluciones_Proveedores.Cod_Suc BETWEEN " & lcParametro7Desde & " AND " & lcParametro7Hasta)
            loComandoSeleccionar.AppendLine(" GROUP BY Articulos.Cod_Art,Articulos.Nom_Art,Articulos.Cod_Uni1,Articulos.Cos_Ult1,Articulos.exi_act1,Departamentos.Cod_Dep,")
            loComandoSeleccionar.AppendLine(" 		Departamentos.Nom_Dep, DATEPART(YEAR,Devoluciones_Proveedores.Fec_Ini), DATEPART(MONTH,Devoluciones_Proveedores.Fec_Ini)")
            loComandoSeleccionar.AppendLine("		")
            loComandoSeleccionar.AppendLine("		")
            loComandoSeleccionar.AppendLine(" UNION ALL")
            loComandoSeleccionar.AppendLine("		")
            ...
            loComandoSeleccionar.AppendLine(" ")
            loComandoSeleccionar.AppendLine("DROP TABLE #tempDATOS ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rRVentas_Articulos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrRVentas_Articulos.ReportSource = loObjetoReporte
...
' Fin del codigo
'-------------------------------------------------------------------------------------------'
' DLC: 26/05/2010: Codigo inicial
'-------------------------------------------------------------------------------------------'
' DLC: 19/07/2010: Ajuste de la consulta a la base de datos.
'                   - A la cantidad de articulos vendidos se le resta la cantidad de articulos devueltos.
'                   - Ajuste en la condición de filtrado de los registros.
'-------------------------------------------------------------------------------------------'
' DLC: 08/09/2010: Ajuste del tipo de datos en la consulta a la base de datos,
'                   de FLOAT a DECIMAL(28,2)
'-------------------------------------------------------------------------------------------'
' MAT: 21/12/2010: Adición de los campos Costo, AVG y Action Req. 
'-------------------------------------------------------------------------------------------'
' MAT: 22/07/11: Ajuste del Select
'-------------------------------------------------------------------------------------------'

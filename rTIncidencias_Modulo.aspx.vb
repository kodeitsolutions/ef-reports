...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rTIncidencias_Modulo"
'-------------------------------------------------------------------------------------------'
Partial Class rTIncidencias_Modulo
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" SELECT    (CASE WHEN Modulo = '' THEN 'Vacio' ELSE Modulo END)    AS  Modulo, ")
            ...
            loComandoSeleccionar.AppendLine(" SELECT    Modulo                  AS  Modulo, ")
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY  Modulo ")
            ...
            loComandoSeleccionar.AppendLine(" SELECT    Modulo, ")
            loComandoSeleccionar.AppendLine("           Can_Opc, ")
            loComandoSeleccionar.AppendLine("           Can_Err, ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rTIncidencias_Modulo", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrTIncidencias_Modulo.ReportSource = loObjetoReporte

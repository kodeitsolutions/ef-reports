<%@ Page Language="VB" AutoEventWireup="false" CodeFile="reArticulos_cBarra3c.aspx.vb" Inherits="reArticulos_cBarra" %>
...
<head runat="server">
    <title>Etiquetas de Artículos con Códigos de Barra</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvreArticulos_cBarra" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

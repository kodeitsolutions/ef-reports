...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fCorte_Cuenta_Entrega_CCSJ"
'-------------------------------------------------------------------------------------------'
Partial Class fCorte_Cuenta_Entrega_CCSJ
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("-- ******************************************************************************************")
            loConsulta.AppendLine("CREATE TABLE #tmpEntrega(   Documento               CHAR(10) COLLATE DATABASE_DEFAULT,")
            ...
            loConsulta.AppendLine("")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("INSERT INTO #tmpEntrega(    Documento, Control, Fec_Ini, Fec_Fin, ")
            loConsulta.AppendLine("                            Cod_Cli, Rif, Nit, Cod_Ven, Cod_For, Cod_Tra,")
            loConsulta.AppendLine("                            Comentario_Documento, Dias_Hospitalizacion, Horas_Aproximadas,")
            ...
            loConsulta.AppendLine("FROM    #tmpEntrega;")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("-- ******************************************************************************************")
            ...
            loConsulta.AppendLine("WHERE   Vendedores.Cod_Ven = #tmpEntrega.Cod_Ven;")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("")
            loConsulta.AppendLine("-- ******************************************************************************************")
            ...
            loConsulta.AppendLine("FROM        Renglones_Entregas AS R")
            ...
            loConsulta.AppendLine("                                        WHERE cod_cli = #tmpEntrega.Paciente_Codigo AND cod_tip = 'ADEL'")
            ...
            loConsulta.AppendLine("        (-#tmpEntrega.Monto_Abonado) AS Monto_Abonado, ")
            loConsulta.AppendLine("        (-#tmpEntrega.Cobertura_Inicial) AS Cobertura_Inicial ")
            loConsulta.AppendLine("FROM    #tmpEntrega")
           ...
           ' Me.mEscribirConsulta(loConsulta.ToString())
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("fCorte_Cuenta_Entrega_CCSJ", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvfCorte_Cuenta_Entrega_CCSJ.ReportSource = loObjetoReporte

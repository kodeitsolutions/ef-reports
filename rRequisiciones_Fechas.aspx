<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRequisiciones_Fechas.aspx.vb" Inherits="rRequisiciones_Fechas" %>
...
<head runat="server">
    <title>Reporte de Requisiciones Internas por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRequisiciones_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

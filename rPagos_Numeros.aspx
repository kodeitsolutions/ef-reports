<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPagos_Numeros.aspx.vb" Inherits="rPagos_Numeros" %>
...
<head runat="server">
    <title>Reporte de Pagos por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPagos_Numeros" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Clientes_DComerciales" CodeFile="fCotizaciones_Clientes_DComerciales.aspx.vb" %>
...
<head runat="server">
    <title>Cotizaciones a Clientes con Descuentos Comerciales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Clientes_DComerciales" runat="server" AutoDataBind="true"

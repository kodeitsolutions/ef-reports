<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDetalle_Condominio005_CCMV.aspx.vb" Inherits="rDetalle_Condominio005_CCMV" %>
...
<body>
	<form id="form1" runat="server">
		<div>
			<CR:CrystalReportViewer ID="crvrDetalle_Condominio005_CCMV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False" EnableParameterPrompt="False" HasCrystalLogo="False" HasPrintButton="False" HasViewList="False" DisplayGroupTree="False" />

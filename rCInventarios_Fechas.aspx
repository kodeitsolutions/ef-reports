<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCInventarios_Fechas.aspx.vb" Inherits="rCInventarios_Fechas" %>
...
<head runat="server">
    <title>Reporte de Cortes de Inventarios por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCInventarios_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

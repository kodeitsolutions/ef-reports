...
Partial Class KDE_rResumenRetencion_ISLRProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN Ordenes_Pagos.Fec_Ini < '20180820' AND Ordenes_Pagos.Fec_Ini >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("       COALESCE((SELECT CASE WHEN Ordenes_Pagos.Fec_Ini < '20180820' AND Ordenes_Pagos.Fec_Ini >= '20180801'")
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN Renglones_Recibos.Fec_Ini < '20180820' AND Renglones_Recibos.Fec_Ini >= '20180801'")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAuditorias_uMensualmente.aspx.vb" Inherits="rAuditorias_uMensualmente" %>
...
<head runat="server">
    <title>Reporte de Auditorias por Usuario Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAuditorias_uMensualmente" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCuentas_Cobrar_SalesT" CodeFile="fCuentas_Cobrar_SalesT.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cuentas por Cobrar Sales T</title>

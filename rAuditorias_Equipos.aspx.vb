...
Partial Class rAuditorias_Equipos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" GROUP BY  Auditorias.Equipo ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAuditorias_Equipos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrAuditorias_Equipos.ReportSource = loObjetoReporte

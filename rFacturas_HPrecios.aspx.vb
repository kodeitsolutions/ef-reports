...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rFacturas_HPrecios"
'-------------------------------------------------------------------------------------------'
Partial Class rFacturas_HPrecios
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'loComandoSeleccionar.AppendLine("			CONVERT(NCHAR(10), Pedidos.Fec_Ini, 103)		AS	Fec_Ini, ")
            'loComandoSeleccionar.AppendLine("			CONVERT(NCHAR(10), Pedidos.Fec_Ini, 103)		AS	Fec_Ini1, ")
            'loComandoSeleccionar.AppendLine("			CONVERT(NCHAR(10), Pedidos.Fec_Ini, 112)     AS	Fec_Ini2, ")
            ...
            loComandoSeleccionar.AppendLine(" ORDER BY  Pedidos.Cod_Cli, Renglones_Pedidos.Cod_Art, Pedidos.Fec_Ini ")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCFormulaciones_Fechas.aspx.vb" Inherits="rCFormulaciones_Fechas" %>
...
<head runat="server">
    <title>Reporte de Control de Formulaciones por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCFormulaciones_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

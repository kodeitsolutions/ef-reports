...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rOportunidades_Prospectos"
'-------------------------------------------------------------------------------------------'
Partial Class rOportunidades_Prospectos
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine(" FROM	Oportunidades,Prospectos,Vendedores")
            loComandoSeleccionar.AppendLine(" WHERE Oportunidades.Cod_Reg  = Prospectos.Cod_Pro")
            loComandoSeleccionar.AppendLine("           AND Oportunidades.Cod_Ven  = Vendedores.Cod_Ven")
            loComandoSeleccionar.AppendLine("           AND Oportunidades.Origen    =   'Prospectos' ")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rOportunidades_Prospectos", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrOportunidades_Prospectos.ReportSource = loObjetoReporte

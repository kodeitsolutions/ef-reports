<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grCxC_MensualesRevision.aspx.vb" Inherits="grCxC_MensualesRevision" %>
...
<head runat="server">
    <title>Gráfico de Cuentas por Cobrar Mensuales por Revisión</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrCxC_MensualesRevision" runat="server" AutoDataBind="true"

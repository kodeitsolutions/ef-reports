<%@ page language="VB" autoeventwireup="false" inherits="rRGlobal_IVARetenidoV" 
CodeFile ="~/Administrativo/Reportes/rRGlobal_IVARetenidoV.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Global de IVA Retenido por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRGlobal_IVARetenidoV" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

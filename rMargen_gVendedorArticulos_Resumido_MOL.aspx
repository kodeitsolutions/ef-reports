<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rMargen_gVendedorArticulos_Resumido_MOL.aspx.vb" Inherits="rMargen_gVendedorArticulos_Resumido_MOL" %>
...
<head runat="server">
    <title>Margen de Ganancia por Vendedor por Artículo Resumido (MOL)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrMargen_gVendedorArticulos_Resumido_MOL" runat="server" AutoDataBind="true"

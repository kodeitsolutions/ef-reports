<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_Vendedores1.aspx.vb" Inherits="rTVentas_Vendedores1" %>
...
<head runat="server">
    <title>Reporte de Total Ventas por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_Vendedores1" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fCobros_IHC" CodeFile="fCobros_IHC.aspx.vb" %>
...
<head runat="server">
    <title>Cobros In Hand Customer</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCobros_Clientes" runat="server" AutoDataBind="true"

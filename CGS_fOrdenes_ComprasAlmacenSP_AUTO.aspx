<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOrdenes_ComprasAlmacenSP_AUTO" CodeFile="CGS_fOrdenes_ComprasAlmacenSP_AUTO.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Órdenes de Compras Almacén S/P (CGS) [AUTO]</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOrdenes_ComprasAlmacenSP_AUTO" runat="server" AutoDataBind="true"

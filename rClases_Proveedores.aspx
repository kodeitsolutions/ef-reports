<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClases_Proveedores.aspx.vb" Inherits="rClases_Proveedores" %>
...
<head runat="server">
    <title>Reporte de Clases de Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrClases_Proveedores" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_ProveedorAñoMes.aspx.vb" Inherits="rOPagos_ProveedorAñoMes" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos por Proveedor por Año y Mes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_ProveedorAñoMes" runat="server" AutoDataBind="true"

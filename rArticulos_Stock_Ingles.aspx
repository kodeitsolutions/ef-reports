<%@ page language="VB" autoeventwireup="false" inherits="rArticulos_Stock_Ingles" CodeFile="rArticulos_Stock_Ingles.aspx.vb"  %>
...
<head runat="server">
    <title>Report Articles with Stock</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Stock_Ingles" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

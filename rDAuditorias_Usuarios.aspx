<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDAuditorias_Usuarios.aspx.vb" Inherits="rDAuditorias_Usuarios" %>
...
<head runat="server">
    <title>Reporte de Detalle de Auditorias por Usuarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDAuditorias_Usuarios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

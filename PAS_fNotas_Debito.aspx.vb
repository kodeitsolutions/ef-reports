...
Imports System.Data
'-------------------------------------------------------------------------------------------'
' Inicio de clase "PAS_fNotas_Debito"
'-------------------------------------------------------------------------------------------'
Partial Class PAS_fNotas_Debito
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loConsulta.AppendLine("		    AND Renglones_Documentos.Cod_Tip = 'N/DB'")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("PAS_fNotas_Debito", laDatosReporte)
            'lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".", ",")
            ...
            Me.crvPAS_fNotas_Debito.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCampanasMarketing.aspx.vb"  Inherits="rCampanasMarketing" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCampanasMarketing" runat="server" AutoDataBind="true"

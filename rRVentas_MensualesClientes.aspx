<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_MensualesClientes.aspx.vb" Inherits="rRVentas_MensualesClientes" %>
...
<head runat="server">
    <title>Reporte Resumen de Ventas Mensuales por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_MensualesClientes" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rArticulos_Campos_Extras.aspx.vb" Inherits="rArticulos_Campos_Extras" %>
...
<head runat="server">
    <title>Reporte de Articulos con sus Campos Extras</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrArticulos_Campos_Extras" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

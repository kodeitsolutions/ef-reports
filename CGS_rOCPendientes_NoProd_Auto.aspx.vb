...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "CGS_rOCPendientes_NoProd_Auto"
'-------------------------------------------------------------------------------------------'
Partial Class CGS_rOCPendientes_NoProd_Auto
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("CGS_rOCPendientes_NoProd_Auto", laDatosReporte)

        Me.mTraducirReporte(loObjetoReporte)
        Me.mFormatearCamposReporte(loObjetoReporte)
        Me.crvCGS_rOCPendientes_NoProd_Auto.ReportSource = loObjetoReporte

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFaltantes_Clientes.aspx.vb" Inherits="rFaltantes_Clientes" %>
...
<head runat="server">
    <title>Reporte de Faltantes por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFaltantes_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

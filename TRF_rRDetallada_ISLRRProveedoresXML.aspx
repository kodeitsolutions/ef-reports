<%@ page language="VB" autoeventwireup="false" inherits="TRF_rRDetallada_ISLRRProveedoresXML" CodeFile="TRF_rRDetallada_ISLRRProveedoresXML.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Detallada de ISLR Retenido (CGS) XML</title>

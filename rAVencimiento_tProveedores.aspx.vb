...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rAVencimiento_tProveedores"
'-------------------------------------------------------------------------------------------'
Partial Class rAVencimiento_tProveedores
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("     AND Proveedores.Status In (" & lcParametro12Desde & ")")

            loComandoSeleccionar.AppendLine("  SELECT   ")
            loComandoSeleccionar.AppendLine("  			#Temporal.Cod_Pro,   ")
            loComandoSeleccionar.AppendLine("  			#Temporal.Nom_Pro,   ")
            ...
            loComandoSeleccionar.AppendLine("  GROUP BY #Temporal.Cod_Pro, #Temporal.Nom_Pro   ")
...
'me.mEscribirConsulta(loComandoSeleccionar.ToString)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rAVencimiento_tProveedores", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrAVencimiento_tProveedores.ReportSource = loObjetoReporte

<%@ page language="VB" autoeventwireup="false" inherits="CGS_fRequerimiento_Produccion_Auto" CodeFile="CGS_fRequerimiento_Produccion_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Requerimiento de Producción Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fRequerimiento_Produccion_Auto" runat="server" AutoDataBind="true"

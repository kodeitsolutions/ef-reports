<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Ventas_FSV1" CodeFile="fFacturas_Ventas_FSV1.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Ventas_FSV1" runat="server" AutoDataBind="true"

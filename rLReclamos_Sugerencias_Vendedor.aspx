<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLReclamos_Sugerencias_Vendedor.aspx.vb" Inherits="rLReclamos_Sugerencias_Vendedor" %>
...
<head runat="server">
    <title>Reporte de Reclamos y Sugerencias por Vendedor</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLReclamos_Sugerencias_Vendedor" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

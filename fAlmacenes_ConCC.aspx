<%@ Page Language="VB" AutoEventWireup="false" Inherits="fAlmacenes_ConCC"
    CodeFile="fAlmacenes_ConCC.aspx.vb" %>
...
<head runat="server">
    <title>Listado de Almacenes con sus Cuentas Contables</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfAlmacenes_ConCC" runat="server" AutoDataBind="true"

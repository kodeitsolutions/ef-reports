...
Partial Class CGS_rHMovimientos_Inventarios
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("		COALESCE(Operaciones_Lotes.Cod_Lot, @lcVacio)	AS	Lote, 	")
            ...
            loComandoSeleccionar.AppendLine("			THEN COALESCE(Operaciones_Lotes.Cantidad, Renglones_Ajustes.Can_Art1, @lnCero) ")
            ...
            loComandoSeleccionar.AppendLine("   AND Ajustes.Automatico = 0")
            ...
            If lcParametro5Desde.Trim() <> "''" Then
            ...
            loComandoSeleccionar.AppendLine("		Almacenes.Nom_Alm								AS  Nom_Alm, ")
            loComandoSeleccionar.AppendLine("		COALESCE(Operaciones_Lotes.Cantidad,Renglones_Traslados.Can_Art1,@lnCero) AS CanLte_Sal, ")
            ...
            loComandoSeleccionar.AppendLine(" 		COALESCE(Operaciones_Lotes.Cantidad,Renglones_Traslados.Can_Art1,@lnCero) AS CanLte_Ent, 	")
            loComandoSeleccionar.AppendLine("		@lnCero											AS	Saldo_Piezas,")
            loComandoSeleccionar.AppendLine(" 		Articulos.Saldo									AS	Saldo		")
            loComandoSeleccionar.AppendLine("FROM   Traslados")
            loComandoSeleccionar.AppendLine("	JOIN Renglones_Traslados ON Renglones_Traslados.Documento = Traslados.Documento")
            ...
            loComandoSeleccionar.AppendLine("		Almacenes.Nom_Alm								AS 	Nom_Alm,	")
            loComandoSeleccionar.AppendLine("		@lnCero											AS	CanLte_Sal, 	")
            loComandoSeleccionar.AppendLine(" 		COALESCE(Operaciones_Lotes.Cantidad,Renglones.Can_Art, @lnCero) AS CanLte_Ent,	")
            loComandoSeleccionar.AppendLine("		@lnCero											AS	Saldo_Piezas,")
            loComandoSeleccionar.AppendLine("		Articulos.Saldo									AS	Saldo ")
            ...
            loComandoSeleccionar.AppendLine(" 		Encabezados.Cod_Alm								AS	Cod_Alm, ")
            loComandoSeleccionar.AppendLine("		Almacenes.Nom_Alm								AS 	Nom_Alm,	")
            loComandoSeleccionar.AppendLine("		COALESCE(Operaciones_Lotes.Cantidad,Renglones.Can_Art, @lnCero) AS CanLte_Sal, 	")
            loComandoSeleccionar.AppendLine(" 		@lnCero											AS	CanLte_Ent,	")
            loComandoSeleccionar.AppendLine("		@lnCero											AS	Saldo_Piezas,")
            loComandoSeleccionar.AppendLine("		Articulos.Saldo									AS	Saldo ")
            loComandoSeleccionar.AppendLine("FROM Encabezados")
            ...
            loComandoSeleccionar.AppendLine("		Almacenes.Nom_Alm								AS 	Nom_Alm,	")
            loComandoSeleccionar.AppendLine("		COALESCE(Operaciones_Lotes.Cantidad,Renglones_Entregas.Can_Art1, @lnCero) AS CanLte_Sal, 	")
            loComandoSeleccionar.AppendLine(" 		@lnCero											AS	CanLte_Ent,	")
            loComandoSeleccionar.AppendLine("		@lnCero											AS	Saldo_Piezas,")
            loComandoSeleccionar.AppendLine("		Articulos.Saldo									AS	Saldo ")
            ...
            loComandoSeleccionar.AppendLine("	JOIN Almacenes ON Renglones_Entregas.Cod_Alm = Almacenes.Cod_Alm	")
            loComandoSeleccionar.AppendLine("	JOIN @tmpArticulos AS Articulos ON Articulos.Cod_Art = Renglones_Entregas.Cod_Art ")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Operaciones_Lotes ON Operaciones_Lotes.Num_Doc = Entregas.Documento")
            loComandoSeleccionar.AppendLine("		AND Operaciones_Lotes.Tip_Doc = 'Entregas'")
            loComandoSeleccionar.AppendLine("		AND Operaciones_Lotes.Tip_Ope = 'Salida'")
            loComandoSeleccionar.AppendLine("		AND Operaciones_Lotes.Ren_Ori = Renglones_Entregas.Renglon")
            loComandoSeleccionar.AppendLine("		AND Operaciones_Lotes.Cod_Art = Articulos.Cod_Art")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Mediciones ON Mediciones.Cod_Reg = Entregas.Documento")
            loComandoSeleccionar.AppendLine("		AND Mediciones.Origen = 'Entregas'")
            loComandoSeleccionar.AppendLine("		AND Mediciones.Cod_Art = Articulos.Cod_Art")
            loComandoSeleccionar.AppendLine("	    AND Mediciones.Cod_Alm = Almacenes.Cod_Alm")
            loComandoSeleccionar.AppendLine("		AND Mediciones.Adicional LIKE ('%'+RTRIM(Operaciones_Lotes.Cod_Lot)+'%')")
            loComandoSeleccionar.AppendLine("		AND Renglones_Entregas.Renglon = SUBSTRING(Mediciones.Adicional, LEN(Mediciones.Adicional), 1)")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Renglones_Mediciones AS Piezas ON Mediciones.Documento = Piezas.Documento")
            loComandoSeleccionar.AppendLine("		AND Piezas.Cod_Var = 'NENT-NPIEZ'")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Renglones_Mediciones AS Longitud ON Mediciones.Documento = Longitud.Documento")
            loComandoSeleccionar.AppendLine("		AND Longitud.Cod_Var = 'NENT-LARG'")
            loComandoSeleccionar.AppendLine("WHERE Entregas.Status IN ('Confirmado', 'Procesado') ")
            loComandoSeleccionar.AppendLine("	AND Entregas.Fec_Ini <= @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("	AND Renglones_Entregas.Cod_Alm BETWEEN @lcCodAlm_Desde AND @lcCodAlm_Hasta")
            If lcParametro5Desde.Trim() <> "''" Then
                loComandoSeleccionar.AppendLine("	AND Operaciones_Lotes.Cod_Lot BETWEEN @lcCodLot_Desde AND @lcCodLot_Hasta")
            End If
            loComandoSeleccionar.AppendLine("")
            ...
            For Each loRenglon As DataRow In laDatosReporte.Tables(0).Rows
                ...
                If (loRenglon("Documento") <> lcDocumento And loRenglon("Operacion") <> lcOperacion) Or (loRenglon("Documento") <> lcDocumento And loRenglon("Operacion") = lcOperacion) Then
                    '
                    'Or (loRenglon("Documento") = lcDocumento And loRenglon("Operacion") = lcOperacion And loRenglon("Lote") <> lcLote) Or (loRenglon("Documento") = lcDocumento And loRenglon("Operacion") = lcOperacion And loRenglon("Lote") = lcLote) 

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grPagos_Semanalmente.aspx.vb" Inherits="grPagos_Semanalmente" %>
...
<head runat="server">
    <title>Gráfico de Pagos Semanalmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrPagos_Semanalmente" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="rRGlobal_IsrlRetenido" CodeFile ="~/Administrativo/Reportes/rRGlobal_IsrlRetenido.aspx.vb" %>
...
<head runat="server">
    <title>Reporte de Relación Global de I.S.R.L. Retenido a Proveedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRGlobal_IsrlRetenido" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

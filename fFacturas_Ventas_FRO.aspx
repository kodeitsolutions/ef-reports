<%@ Page Language="VB" AutoEventWireup="false" Inherits="fFacturas_Ventas_FRO" CodeFile="fFacturas_Ventas_FRO.aspx.vb" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvfFacturas_Ventas_FRO" runat="server" AutoDataBind="true"

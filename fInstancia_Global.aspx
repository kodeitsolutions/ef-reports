<%@ Page Language="VB" AutoEventWireup="false" CodeFile="fInstancia_Global.aspx.vb" Inherits="fInstancia_Global" %>
...
<head runat="server">
    <title>Formato de Instancia Global</title>
...
<body>
    <form id="form1" runat="server">
        <div><asp:ScriptManager ID="ScriptManager1" runat="server">
            ...
            <CR:CrystalReportViewer ID="crvfInstancia_Global" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class TRF_rResumen_Iva
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT ISNULL(SUM(CASE WHEN Fec_Ini < '20180820' AND Fec_Reg > '20180731'")
            ...
            'loComandoSeleccionar.AppendLine("	AND Fec_Reg BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg > '20180731'")
            ...
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Cuentas_Pagar.Fec_Ini < '20180820' AND Cuentas_Pagar.Fec_Reg > '20180731' ")
            ...
            'loComandoSeleccionar.AppendLine("	AND Facturas.Fec_Ini BETWEEN @ldFecha_Desde AND @ldFecha_Hasta")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("SELECT SUM(CASE WHEN Facturas.Fec_Ini < '20180820' AND Facturas.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Renglones_Facturas.Mon_Bas1/100000)ELSE Renglones_Facturas.Mon_Bas1")
            loComandoSeleccionar.AppendLine("           END) AS BaseVFactura,")
            loComandoSeleccionar.AppendLine("		SUM(CASE WHEN Facturas.Fec_Ini < '20180820' AND Facturas.Fec_Ini > '20180731'")
            loComandoSeleccionar.AppendLine("					THEN (Renglones_Facturas.Mon_Imp1/100000)ELSE Renglones_Facturas.Mon_Imp1")
            loComandoSeleccionar.AppendLine("           END) AS ImpuestoVFactura")
            loComandoSeleccionar.AppendLine("FROM Renglones_Facturas")
            loComandoSeleccionar.AppendLine("	JOIN Facturas ON Facturas.Documento = Renglones_Facturas.Documento")
            loComandoSeleccionar.AppendLine("	JOIN Articulos ON Articulos.Cod_Art = Renglones_Facturas.Cod_Art")
            ...
            loComandoSeleccionar.AppendLine("SELECT COALESCE(SUM(CASE WHEN Cuentas_Cobrar.Fec_Ini < '20180820' AND Cuentas_Cobrar.Fec_Ini > '20180731'")

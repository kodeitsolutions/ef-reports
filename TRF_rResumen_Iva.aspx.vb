...
Partial Class TRF_rResumen_Iva
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("	AND Fec_Ini BETWEEN @sp_FecIni AND @sp_FecFin")
            'loComandoSeleccionar.AppendLine("	AND Documento NOT IN (SELECT Documento FROM #tmpVentaNoGravada)")
            loComandoSeleccionar.AppendLine("")
            ...
            'loComandoSeleccionar.AppendLine("		SUM(#tmpBaseVFactura.ImpuestoVFactura) + #tmpBaseVNotaCre.ImpuestoVNotaCre AS TotalImpuestoV,")
            ...
            loComandoSeleccionar.AppendLine("       #tmpVentaNoGravada.TotalVentaNoGravada AS TVNoGravada,")
            ...
            loComandoSeleccionar.AppendLine("	#tmpVentaNoGravada")
            ...
            loComandoSeleccionar.AppendLine("		#tmpBaseVFactura.ImpuestoVFactura,#tmpBaseVNotaCre.BaseVNotaCre, #tmpBaseVNotaCre.ImpuestoVNotaCre, #tmpRetenidoV.TotalRetenidoV, #tmpVentaNoGravada.TotalVentaNoGravada")
            loComandoSeleccionar.AppendLine("")

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gZona"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gZona
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpGanancia(	Cod_Zon		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Zon		CHAR(100),			")
            ...
            loComandoSeleccionar.AppendLine("CREATE TABLE #tmpFinal(	Cod_Zon		CHAR(30),			")
            loComandoSeleccionar.AppendLine("							Nom_Zon		CHAR(100),			")
            loComandoSeleccionar.AppendLine("							Can_Fac		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Can_Dev		DECIMAL(28, 10),	")
            loComandoSeleccionar.AppendLine("							Base_A		DECIMAL(28, 10),	")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Zon, Nom_Zon, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B)")
            loComandoSeleccionar.AppendLine("SELECT		Zonas.Cod_Zon														AS Cod_Zon,")
            loComandoSeleccionar.AppendLine("			Zonas.Nom_Zon														AS Nom_Zon,")
            ...
            loComandoSeleccionar.AppendLine(" 	JOIN	Zonas ")
            loComandoSeleccionar.AppendLine(" 		ON	Clientes.Cod_Zon= Zonas.Cod_Zon")
            ...
            loComandoSeleccionar.AppendLine("			AND Clientes.Cod_Zon 			BETWEEN " & lcParametro18Desde & " AND " & lcParametro18Hasta)
            loComandoSeleccionar.AppendLine("GROUP BY	Zonas.Cod_Zon, Zonas.Nom_Zon")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(Cod_Zon, Nom_Zon, Can_Fac, Can_Dev, Base_A, Base_B, Costo_A, Costo_B, Ganancia_A, Ganancia_B)")
            loComandoSeleccionar.AppendLine("SELECT	Cod_Zon				AS Cod_Zon,")
            loComandoSeleccionar.AppendLine("		Nom_Zon				AS Nom_Zon,")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Cod_Zon, Nom_Zon")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gZona", laDatosReporte)
            ...
            Me.crvrMargen_gZona.ReportSource = loObjetoReporte

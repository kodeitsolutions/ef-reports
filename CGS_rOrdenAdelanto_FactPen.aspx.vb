...
Partial Class CGS_rOrdenAdelanto_FactPen
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("	LEFT JOIN Renglones_Pagos ON Renglones_Pagos.Doc_Ori = Compras.Documento ")
            loComandoSeleccionar.AppendLine("		AND Renglones_Pagos.Cod_Tip = 'FACT'")
            loComandoSeleccionar.AppendLine("	LEFT JOIN Pagos ON Renglones_Pagos.Documento = Pagos.Documento")
            loComandoSeleccionar.AppendLine("		AND Pagos.Cod_Pro = Compras.Cod_Pro")

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grPagos_MensualesSucursal.aspx.vb" Inherits="grPagos_MensualesSucursal" %>
...
<head runat="server">
    <title>Gráfico de Pagos Mensuales por Sucursal</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrPagos_MensualesSucursal" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTIncidencias_Opcion.aspx.vb" Inherits="rTIncidencias_Opcion" %>
...
<head runat="server">
    <title>Listado Total de Incidencias por Opción</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTIncidencias_Opcion" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

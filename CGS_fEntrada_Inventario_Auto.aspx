<%@ page language="VB" autoeventwireup="false" inherits="CGS_fEntrada_Inventario_Auto" CodeFile="CGS_fEntrada_Inventario_Auto.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Entrada de Inventario Automático (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fEntrada_Inventario_Auto" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" CodeFile="CGS_rHMovimientos_Inventarios.aspx.vb" inherits="CGS_rHMovimientos_Inventarios" %>
...
<head runat="server">
    <title>Histórico de Movimientos de Inventarios (CGS) </title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rHMovimientos_Inventarios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

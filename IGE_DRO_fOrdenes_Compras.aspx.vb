Imports System.Data
Partial Class IGE_DRO_fOrdenes_Compras
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("      (CASE WHEN (Renglones_OCompras.Cod_Uni = Renglones_OCompras.Cod_Uni2) ")
            loComandoSeleccionar.AppendLine("		  THEN Renglones_OCompras.Can_Art1 ")
            loComandoSeleccionar.AppendLine("		  ELSE Renglones_OCompras.Can_Art1/Renglones_OCompras.Can_Uni2 ")
            loComandoSeleccionar.AppendLine("		END)                                                                        AS Can_Art1,")
            loComandoSeleccionar.AppendLine("      (CASE WHEN (Renglones_OCompras.Cod_Uni = Renglones_OCompras.Cod_Uni2) ")
            loComandoSeleccionar.AppendLine("		  THEN Renglones_OCompras.Cod_Uni ")
            loComandoSeleccionar.AppendLine("		  ELSE Renglones_OCompras.Cod_Uni2 ")
            loComandoSeleccionar.AppendLine("		END)                                                                        AS Cod_Uni, ")
            loComandoSeleccionar.AppendLine("      (CASE WHEN (Renglones_OCompras.Cod_Uni = Renglones_OCompras.Cod_Uni2) ")
            loComandoSeleccionar.AppendLine("		  THEN Renglones_OCompras.Precio1 ")
            loComandoSeleccionar.AppendLine("		  ELSE Renglones_OCompras.Precio1*Renglones_OCompras.Can_Uni2 ")
            ...
            loComandoSeleccionar.AppendLine("           Renglones_OCompras.Cod_Uni2    =   Unidades.Cod_Uni AND ")
            ...
            loObjetoReporte = cusAplicacion.goFormatos.mCargarInforme("IGE_DRO_fOrdenes_Compras", laDatosReporte)
            lcPorcentajesImpueto = lcPorcentajesImpueto.Replace(".", ",")
            ...
            Me.crvIGE_DRO_fOrdenes_Compras.ReportSource = loObjetoReporte

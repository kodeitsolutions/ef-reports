<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rGuias_Vendedores.aspx.vb" Inherits="rGuias_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Guias por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrGuias_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

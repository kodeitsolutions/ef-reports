<%@ page language="VB" autoeventwireup="false" inherits="fDepositos_Bancarios" CodeFile="fDepositos_Bancarios.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Depósitos Bancarios</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfDepositos_Bancarios" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fCobros_Clientes_Ingles" CodeFile="fCobros_Clientes_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Cobros a Clientes en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCobros_Clientes_Ingles" runat="server" AutoDataBind="true"

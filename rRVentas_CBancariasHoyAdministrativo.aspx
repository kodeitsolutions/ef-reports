<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRVentas_CBancariasHoyAdministrativo.aspx.vb" Inherits="rRVentas_CBancariasHoyAdministrativo" %>
...
<head runat="server">
    <title>Reporte de Ventas y Conciliacion de Caja de Hoy</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRVentas_CBancarias" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDepositos_Renglones.aspx.vb" Inherits="rDepositos_Renglones" %>
...
<head runat="server">
    <title>Reporte de Depósitos Bancarios con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDepositos_Renglones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_fComprobante_Diario.aspx.vb" Inherits="TRF_fComprobante_Diario" %>
...
<head runat="server">
    <title>Comprobante Diario (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_fComprobante_Diario" runat="server" AutoDataBind="true"

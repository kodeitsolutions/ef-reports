<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rRDocumentosCompras_Mensuales.aspx.vb" Inherits="rRDocumentosCompras_Mensuales" %>
...
<head runat="server">
    <title>Resumen de Documentos de Compras Mensuales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrRDocumentosCompras_Mensuales" runat="server" AutoDataBind="true"

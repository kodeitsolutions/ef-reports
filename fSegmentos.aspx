<%@ page language="VB" autoeventwireup="false" inherits="fSegmentos" CodeFile="fSegmentos.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Segmentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfSegmentos" runat="server" AutoDataBind="true"

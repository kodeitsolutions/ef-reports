<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rCompras_Articulos_ADM_MONO.aspx.vb" Inherits="CGS_rCompras_Articulos_ADM_MONO" %>
...
<head runat="server">
    <title>Listado Admisnistrativo de Compras por Artículos reducido (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rCompras_Articulos_ADM_MONO" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="grPagos_Fechas.aspx.vb" Inherits="grPagos_Fechas" %>
...
<head runat="server">
    <title>Gráfico de Pagos por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvgrPagos_Fechas" runat="server" AutoDataBind="true"

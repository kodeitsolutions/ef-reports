<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rResumen_StatusDocumentos.aspx.vb" Inherits="rResumen_StatusDocumentos" %>
...
<head runat="server">
    <title>Resumen de Estatus de Documentos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrResumen_StatusDocumentos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ page language="VB" autoeventwireup="false" inherits="fCuentas_Cobrar1_Ingles" CodeFile="fCuentas_Cobrar1_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cuentas por Cobrar en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCuentas_Cobrar1_Ingles" runat="server" AutoDataBind="true"

...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rMargen_gFacturasAVC"
'-------------------------------------------------------------------------------------------'
Partial Class rMargen_gFacturasAVC
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpGanancia(Cod_Art, Nom_Art, Exi_Act, Fec_Fac, Documento, Cod_Ven, Cod_Cli, Can_Art, Base_A, Base_B, Costo_A, Costo_B)")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Articulos.Cod_Art, Articulos.Nom_Art, Articulos.Exi_Act1, Facturas.Documento, Facturas.Fec_Ini, Facturas.Cod_Ven, Facturas.Cod_Cli")
            loComandoSeleccionar.AppendLine("")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("/* Cálculo de ganancia								 										*/ ")
            loComandoSeleccionar.AppendLine("/*------------------------------------------------------------------------------------------*/")
            loComandoSeleccionar.AppendLine("INSERT INTO #tmpFinal(	Cod_Art, Nom_Art, Exi_Act, Documento, Fec_Fac, Cod_Ven, Cod_Cli, Can_Art, Base_A, Base_B, ")
            ...
            loComandoSeleccionar.AppendLine("GROUP BY	Cod_Art, Nom_Art, Exi_Act, Documento, Fec_Fac, Cod_Ven, Cod_Cli")
            loComandoSeleccionar.AppendLine("")
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rMargen_gFacturasAVC", laDatosReporte)
            ...
            Me.crvrMargen_gFacturasAVC.ReportSource = loObjetoReporte
            ...
            If (Me.Request.QueryString("salida").ToLower = "xls") Then
                ...
                Dim lcFileName As String = Server.MapPath("~\Administrativo\Temporales\rMargen_gFacturasAVC_" & Guid.NewGuid().ToString("N") & ".xls")
                ...
                Me.Response.AppendHeader("content-disposition", "attachment; filename=rMargen_gFacturasAVC.xls")
        ...
        Catch loExcepcion As Exception
            ...
            Me.WbcAdministradorMensajeModal.mMostrarMensajeModal("Error", _
                 "No se pudo Completar el Proceso: " & loExcepcion.Message.Replace(vbLf, "<br/>").Replace(vbCr, "<br/>"), _
	 ...
	 '******************************************************************'
		...
		' Formato por defecto de todas las celdas			
		 ...
		 '******************************************************************'
            ...
            loRango.Value = "Margen de Ganancia por Factura, Artículo, Vendedor y Cliente"
...
' Fin del codigo																			'
'-------------------------------------------------------------------------------------------'
' RJG: 11/03/13: Programacion inicial, a partir de rMargen_gFacturasArticulos.      		'
'-------------------------------------------------------------------------------------------'

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rAjustes_Numeros.aspx.vb" Inherits="rAjustes_Numeros" %>
...
<head runat="server">
    <title>Reporte de Ajustes de Inventario por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrAjustes_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

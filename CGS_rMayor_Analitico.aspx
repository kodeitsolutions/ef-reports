<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rMayor_Analitico.aspx.vb" Inherits="CGS_rMayor_Analitico" %>
...
<head runat="server">
    <title>Mayor Analítico (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_rMayor_Analitico" runat="server" AutoDataBind="true"

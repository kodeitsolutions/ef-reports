...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rSolicitudes_Requerimientos_Clientes"
'-------------------------------------------------------------------------------------------'
Partial Class rSolicitudes_Requerimientos_Clientes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("           Solicitudes.cod_reg                  Between " & lcParametro4Desde)
            loComandoSeleccionar.AppendLine("           And " & lcParametro4Hasta)
            loComandoSeleccionar.AppendLine("           AND Solicitudes.Documento                  Between " & lcParametro0Desde)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rSolicitudes_Requerimientos_Clientes", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)
            Me.mFormatearCamposReporte(loObjetoReporte)
            Me.crvrSolicitudes_Requerimientos_Clientes.ReportSource = loObjetoReporte

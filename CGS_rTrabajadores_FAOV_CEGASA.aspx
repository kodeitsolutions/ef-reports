<%@ Page Language="VB" AutoEventWireup="false" CodeFile="CGS_rTrabajadores_FAOV_CEGASA.aspx.vb" Inherits="CGS_rTrabajadores_FAOV_CEGASA" %>
...
<head runat="server">
    <title>FAOV Retenido a Trabajadores (CGS)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvCGS_rTrabajadores_FAOV_CEGASA" runat="server" AutoDataBind="true"

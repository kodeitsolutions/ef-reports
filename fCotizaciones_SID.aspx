<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_SID" CodeFile="fCotizaciones_SID.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_SID" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCompras_cRenglones.aspx.vb" Inherits="rCompras_cRenglones" %>
...
<head runat="server">
    <title>Facturas de Compras con sus Renglones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCompras_cRenglones" runat="server" AutoDataBind="true"

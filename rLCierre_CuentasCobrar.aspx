<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLCierre_CuentasCobrar.aspx.vb" Inherits="rLCierre_CuentasCobrar" %>
...
<head runat="server">
    <title>Reporte de Cierre de Cuentas por Cobrar</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLCierre_CuentasCobrar" runat="server" AutoDataBind="true"

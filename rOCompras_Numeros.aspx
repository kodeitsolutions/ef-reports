<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOCompras_Numeros.aspx.vb" Inherits="rOCompras_Numeros" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Compras por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOCompras_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

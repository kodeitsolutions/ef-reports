<%@ page language="VB" autoeventwireup="false" inherits="fOrden_Servicio_FSV1" CodeFile="fOrden_Servicio_FSV1.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Orden de Servicio FSV</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrden_Servicio_FSV1" runat="server" AutoDataBind="true"

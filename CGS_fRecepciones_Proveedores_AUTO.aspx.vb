...
Partial Class CGS_fRecepciones_Proveedores_AUTO
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        loComandoSeleccionar.AppendLine("")
        loComandoSeleccionar.AppendLine("WITH Sumatorias (Cod_Art, Lote, Cantidad, Cantidad_Lote, Peso, Piezas) AS")
        loComandoSeleccionar.AppendLine("(")
        loComandoSeleccionar.AppendLine("   SELECT  Cod_Art, Lote,SUM(Cantidad) AS Cantidad, SUM(Cantidad_Lote) AS Cantidad_Lote,")
        loComandoSeleccionar.AppendLine("           SUM(Peso) AS Peso, SUM(Piezas) AS Piezas")
        ...
        loComandoSeleccionar.AppendLine("	#tmpRecepcion.Piezas = Sumatorias.Piezas")
        loComandoSeleccionar.AppendLine("FROM #tmpRecepcion")

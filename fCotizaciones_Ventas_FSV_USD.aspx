<%@ page language="VB" autoeventwireup="false" inherits="fCotizaciones_Ventas_FSV_USD" CodeFile="fCotizaciones_Ventas_FSV_USD.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cotización FSV (USD)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfCotizaciones_Ventas_FSV_USD" runat="server" AutoDataBind="true"

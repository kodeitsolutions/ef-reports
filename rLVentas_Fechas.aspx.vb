...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "rLVentas_Fechas"
'-------------------------------------------------------------------------------------------'
Partial Class rLVentas_Fechas
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            'loComandoSeleccionar.AppendLine(" ORDER BY  Libres_Ventas.Fec_Ini, ")
            'loComandoSeleccionar.AppendLine("           Libres_Ventas.Documento ")
            loComandoSeleccionar.AppendLine("ORDER BY    Libres_Ventas.Fec_Ini, " & lcOrdenamiento)
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rLVentas_Fechas", laDatosReporte)

            Me.mTraducirReporte(loObjetoReporte)

            Me.mFormatearCamposReporte(loObjetoReporte)

            Me.crvrLVentas_Fechas.ReportSource = loObjetoReporte

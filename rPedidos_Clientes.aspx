<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rPedidos_Clientes.aspx.vb" Inherits="rPedidos_Clientes" %>
...
<head runat="server">
    <title>Reporte de Pedidos por Clientes</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrPedidos_Clientes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

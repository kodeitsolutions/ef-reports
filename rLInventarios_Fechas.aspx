<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLInventarios_Fechas.aspx.vb" Inherits="rLInventarios_Fechas" %>
...
<head runat="server">
    <title>Listado de Formas Libres de Inventarios por Fechas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLInventarios_Fechas" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rProposiciones_Numeros.aspx.vb" Inherits="rProposiciones_Numeros" %>
...
<head runat="server">
    <title>Reporte de Proposiciones por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrProposiciones_Numeros" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rCotizaciones_Vendedores.aspx.vb" Inherits="rCotizaciones_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Cotizaciones por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrCotizaciones_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

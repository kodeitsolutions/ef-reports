<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_aArticuloClientesMensual.aspx.vb" Inherits="rTVentas_aArticuloClientesMensual" %>
...
<head runat="server">
    <title>Reporte de Ventas Agrupadas por Artículos y Clientes Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_aArticuloClientesMensual" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

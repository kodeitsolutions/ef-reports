<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rFrecuanecia_Prospectos.aspx.vb" Inherits="rFrecuanecia_Prospectos" %>
...
<head runat="server">
    <title>Reporte de Frecuencia de Prospectos</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrFrecuanecia_Prospectos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

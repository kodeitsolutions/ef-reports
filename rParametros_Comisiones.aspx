<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rParametros_Comisiones.aspx.vb" Inherits="rParametros_Comisiones" %>
...
<head runat="server">
    <title>Reporte de Ordenes de Producción por Números</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrParametros_Comisiones" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

...
Partial Class rCotizaciones_aMes
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
           ...
           ' Me.mEscribirConsulta(lcComandoSeleccionar.ToString())
            ...
            loObjetoReporte = cusAplicacion.goReportes.mCargarReporte("rCotizaciones_aMes", laDatosReporte)
            ...
            Me.crvrCotizaciones_aMes.ReportSource = loObjetoReporte
...
'-------------------------------------------------------------------------------------------'
' MAT: 14/02/11: Rediseño de la vista del reporte. 
'-------------------------------------------------------------------------------------------'

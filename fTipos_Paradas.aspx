<%@ page language="VB" autoeventwireup="false" inherits="fTipos_Paradas" CodeFile="fTipos_Paradas.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Tipos de Paradas</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfTipos_Paradas" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rDProveedores_Vendedores.aspx.vb" Inherits="rDProveedores_Vendedores" %>
...
<head runat="server">
    <title>Reporte de Devoluciones por Vendedores</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrDProveedores_Vendedores" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

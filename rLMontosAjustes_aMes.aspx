<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rLMontosAjustes_aMes.aspx.vb" Inherits="rLMontosAjustes_aMes" %>
...
<head runat="server">
    <title>Reporte de Monto de Ajustes por Artículos Totalizados Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrLMontosAjustes_aMes" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

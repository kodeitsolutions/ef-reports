<%@ page language="VB" autoeventwireup="false" CodeFile="fComprobante_IVA.aspx.vb" inherits="fComprobante_IVA" %>
...
<head runat="server">
    <title>Comprobante de IVA</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfComprobante_IVA" runat="server" AutoDataBind="true"

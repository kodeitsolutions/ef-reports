<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTotal_Casos_Cliente.aspx.vb" Inherits="rTotal_Casos_Cliente" %>
...
<head runat="server">
    <title>Total Casos por Cliente</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrTotal_Casos_Cliente" runat="server" AutoDataBind="true"

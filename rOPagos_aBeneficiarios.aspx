<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rOPagos_aBeneficiarios.aspx.vb" Inherits="rOPagos_aBeneficiarios" %>
...
<head runat="server">
    <title>Listado de Ordenes de Pagos Agrupadas por Beneficiario y Concepto Mensualmente</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrOPagos_aBeneficiarios" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

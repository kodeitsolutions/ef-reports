...
Partial Class CGS_rRDetallada_ISLR_Retenido
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        Try
            ...
            loComandoSeleccionar.AppendLine("       CASE WHEN Retenciones_Documentos.Cod_Tip = 'N/CR'")
            ...
            If Empresa <> "Industrias Cegasa, C.A." Then
                ...
                loComandoSeleccionar.AppendLine("       Facturas.Mon_Bru				AS Base_Retencion,")
                ...
                loComandoSeleccionar.AppendLine("FROM Cuentas_Pagar")
                loComandoSeleccionar.AppendLine("   JOIN Proveedores ON Proveedores.Cod_Pro = Cuentas_Pagar.Cod_Pro")
                loComandoSeleccionar.AppendLine("   JOIN Cuentas_Pagar AS Facturas ON Facturas.Factura = Cuentas_Pagar.Factura")
                loComandoSeleccionar.AppendLine("       AND Facturas.Cod_Pro = Cuentas_Pagar.Cod_Pro")
                loComandoSeleccionar.AppendLine("       AND Facturas.Cod_Tip = 'FACT'")
                loComandoSeleccionar.AppendLine("WHERE Cuentas_Pagar.Cod_Tip = 'ISLR'")
                loComandoSeleccionar.AppendLine("	AND	Cuentas_Pagar.Status <> 'Anulado'")

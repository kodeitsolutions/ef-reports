<%@ page language="VB" autoeventwireup="false" inherits="fOrdenes_Compras_Stratos" CodeFile="fOrdenes_Compras_Stratos.aspx.vb" %>
...
<head runat="server">
    <title>Purchase Order (Stratos)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfOrdenes_Compras_Stratos" runat="server" AutoDataBind="true"

<%@ page language="VB" autoeventwireup="false" inherits="fFacturas_Compras_Documento_Ingles" CodeFile="fFacturas_Compras_Documento_Ingles.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Cuentas por Pagar en Ingles</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfFacturas_Compras_Documento_Ingles" runat="server" AutoDataBind="true"

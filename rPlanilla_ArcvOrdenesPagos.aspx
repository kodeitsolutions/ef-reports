<%@ page language="VB" autoeventwireup="false" inherits="rPlanilla_ArcVOrdenesPagos" CodeFile="rPlanilla_ArcVOrdenesPagos.aspx.vb" %>
...
<head runat="server">
    <title>Planilla ARC (Órdenes de Pago)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrrPlanilla_ArcVOrdenesPagos" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

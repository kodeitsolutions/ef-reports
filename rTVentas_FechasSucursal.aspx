<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rTVentas_FechasSucursal.aspx.vb" Inherits="rTVentas_FechasSucursal" %>
...
<head runat="server">
    <title>Total de Ventas por Fechas y Sucursales</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvrTVentas_FechasSucursal" runat="server" AutoDataBind="true"

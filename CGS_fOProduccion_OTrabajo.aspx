<%@ page language="VB" autoeventwireup="false" inherits="CGS_fOProduccion_OTrabajo" CodeFile="CGS_fOProduccion_OTrabajo.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Ordenes de Producción con sus Órdenes de Trabajo (CGS)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvCGS_fOProduccion_OTrabajo" runat="server" AutoDataBind="true"

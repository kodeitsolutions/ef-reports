<%@ page language="VB" autoeventwireup="false" inherits="fAuditorias_Cotizaciones" CodeFile="fAuditorias_Cotizaciones.aspx.vb" %>
...
<head runat="server">
    <title>Formato de Auditoria de Cotizaciones</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfAuditorias_Cotizaciones" runat="server" AutoDataBind="true"

<%@ Page Language="VB" AutoEventWireup="false" CodeFile="rClientes_dGenerales.aspx.vb"
    Inherits="rClientes_dGenerales" %>
...
<head runat="server">
    <title>Reporte de Clientes con sus Datos Generales</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrClientes_dGenerales" runat="server" AutoDataBind="true"

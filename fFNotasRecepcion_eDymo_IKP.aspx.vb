...
'-------------------------------------------------------------------------------------------'
' Inicio de clase "fFNotasRecepcion_eDymo_IKP"
'-------------------------------------------------------------------------------------------'
Partial Class fFNotasRecepcion_eDymo_IKP
...
#End Region
    ...
    '*****************************************************************************
        ...
        loConsulta.AppendLine("            SELECT   Renglones_Recepciones.documento    AS Documento,")
        ...
        loConsulta.AppendLine("                     Renglones_Recepciones.Notas        AS Nom_Art, ")
        loConsulta.AppendLine("                     Renglones_Recepciones.Can_Art1     AS Can_Art1")
        loConsulta.AppendLine("            FROM     Recepciones ")
        loConsulta.AppendLine("             JOIN    Renglones_Recepciones ")
        loConsulta.AppendLine("                ON   Renglones_Recepciones.Documento = Recepciones.Documento")
        loConsulta.AppendLine("            WHERE    " & cusAplicacion.goFormatos.pcCondicionPrincipal)
        loConsulta.AppendLine("        ) AS A ")
        loConsulta.AppendLine("LEFT JOIN seriales ON seriales.ren_ent = A.Renglon")
        loConsulta.AppendLine("    AND tip_ent = 'Recepciones' ")
    ...
    '*****************************************************************************
        ...
        Dim lcArchivo As String =  "fFNotasRecepcion_eDymo_IKP_" & lcFechaDoc 

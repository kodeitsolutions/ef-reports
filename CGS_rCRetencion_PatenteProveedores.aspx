<%@ Page Language="VB" AutoEventWireup="false" Inherits="CGS_rCRetencion_PatenteProveedores" CodeFile="CGS_rCRetencion_PatenteProveedores.aspx.vb" %>
...
<head runat="server">
    <title>Comprobante de Retención de Patente de Proveedores (CEGASA)</title>
...
<body>
    <form id="form1" runat="server">
        <div>
            <CR:CrystalReportViewer ID="crvrCGS_rCRetencion_PatenteProveedores" runat="server" AutoDataBind="true"

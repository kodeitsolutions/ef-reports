<%@ Page Language="VB" AutoEventWireup="false" CodeFile="TRF_rBalance_General.aspx.vb" Inherits="TRF_rBalance_General" %>
...
<head runat="server">
    <title>Balance General (TRF)</title>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvTRF_rBalance_General" runat="server" AutoDataBind="true" EnableDatabaseLogonPrompt="False"

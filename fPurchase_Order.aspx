<%@ page language="VB" autoeventwireup="false" inherits="fPurchase_Order" CodeFile="fPurchase_Order.aspx.vb" %>
...
<body>
    ...
    <div>
        <CR:CrystalReportViewer ID="crvfPurchase_Order" runat="server" AutoDataBind="true"
